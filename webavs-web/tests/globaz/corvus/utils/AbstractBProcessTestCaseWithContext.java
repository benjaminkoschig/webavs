...
public abstract class AbstractBProcessTestCaseWithContext extends BProcess {
    ...
    private JadeContextImplementation initContext() throws Exception {
        BSession session = (BSession) GlobazServer.getCurrentSystem().getApplication(getApplicationName())
