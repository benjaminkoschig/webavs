 ...
 * @author dvh
 */
public class TestRevenuMoyenDeterminant99 {

    // ~ Static fields/initializers
    // -------------------------------------------------------------------------------------

    private static Map correspondanceSalaireMensuelRMD99 = new HashMap();
    private static Map correspondanceSalaire4SemainesRMD99 = new HashMap();
    private static Map correspondanceSalaireAnnuelRMD99 = new HashMap();
    private static Map correspondanceSalaireHorairePour10HeuresRMD99 = new HashMap();
    ...
    static {
        ...
        correspondanceSalaireMensuelRMD99.put("3180", "106");
        correspondanceSalaireMensuelRMD99.put("3180.01", "107");
        correspondanceSalaireMensuelRMD99.put("3720", "124");
        correspondanceSalaireMensuelRMD99.put("3749.99", "125");

        correspondanceSalaire4SemainesRMD99.put("2968", "106");
        correspondanceSalaire4SemainesRMD99.put("2968.01", "107");
        correspondanceSalaire4SemainesRMD99.put("3472", "124");
        correspondanceSalaire4SemainesRMD99.put("3499.99", "125");

        correspondanceSalaireAnnuelRMD99.put("38160", "106");
        correspondanceSalaireAnnuelRMD99.put("38160.01", "107");
        correspondanceSalaireAnnuelRMD99.put("44640", "124");
        correspondanceSalaireAnnuelRMD99.put("44999.99", "125");

        correspondanceSalaireHorairePour10HeuresRMD99.put("74.2", "106");
        correspondanceSalaireHorairePour10HeuresRMD99.put("74.21", "107");
        correspondanceSalaireHorairePour10HeuresRMD99.put("86.8", "124");
        correspondanceSalaireHorairePour10HeuresRMD99.put("87.49", "125");
    }
    ...
    public void testRMDSalaire4Semaines() throws Exception {
        ...
        try {
            ...
            periodeAPG.setDateDebutPeriode("01.07.2000");
            periodeAPG.setDateFinPeriode("31.07.2000");
            ...
            droitAPG.setDateDebutDroit("01.07.2000");
            droitAPG.setDateDepot("01.07.2005");
            droitAPG.setDateReception("01.07.2000");
            droitAPG.setDateFinDroit("31.07.2000");
            ...
            Set salairesMensuels = correspondanceSalaire4SemainesRMD99.keySet();
            ...
            while (iterator.hasNext()) {
                ...
                // + correspondanceSalaire4SemainesRMD99.get(salaire),
                // Double.parseDouble((String) correspondanceSalaire4SemainesRMD99.get(salaire)) == Double
    ...
    public void testRMDSalaireAnnuel() throws Exception {
        ...
        try {
            ...
            droitAPG.setIdSituationFam(situationFamilialeAPG.getIdSitFamAPG());
            droitAPG.setDateDebutDroit("01.07.2000");
            droitAPG.setDateDepot("01.07.2000");
            droitAPG.setDateReception("01.07.2000");
            droitAPG.setDateFinDroit("31.07.2000");
            droitAPG.setDuplicata(Boolean.FALSE);
            droitAPG.setEtat(IAPDroitLAPG.CS_ETAT_DROIT_ATTENTE);
            ...
            // vérifie que le RMD correspond aux tables
            Set salairesMensuels = correspondanceSalaireAnnuelRMD99.keySet();
            Iterator iterator = salairesMensuels.iterator();
            ...
            while (iterator.hasNext()) {
                ...
                // assertTrue("RMD calculé : " + prestation.getRevenuMoyenDeterminant() + " ____ RMD attendu : "
                // + correspondanceSalaireAnnuelRMD99.get(salaire) + " (Salaire = " + salaire + ")",
                // Double.parseDouble((String) correspondanceSalaireAnnuelRMD99.get(salaire)) == Double
                // .parseDouble(prestation.getRevenuMoyenDeterminant()));
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testRMDSalaireHebdo() throws Exception {
        ...
        try {
            ...
            // vérifie que le RMD correspond aux tables
            Set salairesMensuels = correspondanceSalaireHorairePour10HeuresRMD99.keySet();
            Iterator iterator = salairesMensuels.iterator();
            ...
            while (iterator.hasNext()) {
                ...
                // + correspondanceSalaireHorairePour10HeuresRMD99.get(salaire) + " (Salaire = " + salaire
                // + ")",
                // Double.parseDouble((String) correspondanceSalaireHorairePour10HeuresRMD99.get(salaire)) == Double
                // .parseDouble(prestation.getRevenuMoyenDeterminant()));
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testRMDSalaireMensuel() throws Exception {
        ...
        try {
            ...
            // vérifie que le RMD correspond aux tables
            Set salairesMensuels = correspondanceSalaireMensuelRMD99.keySet();
            Iterator iterator = salairesMensuels.iterator();
            ...
            while (iterator.hasNext()) {
                ...
                // assertTrue(Double.parseDouble((String) correspondanceSalaireMensuelRMD99.get(salaire)) == Double
                // .parseDouble(prestation.getRevenuMoyenDeterminant()));
            }
        } catch (Exception e) {
            e.printStackTrace();
