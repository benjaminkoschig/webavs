...
public class CalculTest extends ALTestCaseJU4 {

    @Parameters
    public static List<Object[]> getParametres() {
        return Arrays.asList(new Object[][] { { "01.01.2010", "33765", 0, "200.00" },
                { "01.02.2010", "33765", 0, "200.00" }, { "01.03.2010", "33765", 0, "250.00" } });
    }
    ...
    public CalculTest(String pDateCalcul, String pIdDossier, int pIndexRes, String resultatAttendu) {
