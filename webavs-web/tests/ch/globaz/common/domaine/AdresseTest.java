...
public class AdresseTest {
    ...
    public void testResolveDesignation1() throws Exception {
        ...
        adresse = new Adresse("localite", "casePostale", "attention", "npa", "pays", "cantonOFAS", "csTitre", "rue",
                "rueNumero", "", "designation2", "designation3", "designation4", "idAdresse", "designationTiers1",
    ...
    public void testResolveDesignation2() throws Exception {
        ...
        adresse = new Adresse("localite", "casePostale", "attention", "npa", "pays", "cantonOFAS", "csTitre", "rue",
                "rueNumero", "designation1", "", "designation3", "designation4", "idAdresse", "designationTiers1",
                "designationTiers2", "designationTiers3", "designationTiers4", "csTitreTiers");
        ...
        adresse = new Adresse("localite", "casePostale", "attention", "npa", "pays", "cantonOFAS", "csTitre", "rue",
                "rueNumero", "designation1", null, "designation3", "designation4", "idAdresse", "designationTiers1",
                "designationTiers2", "designationTiers3", "designationTiers4", "csTitreTiers");
        assertEquals("designationTiers2", adresse.resolveDesignation2());
    }
    ...
    public void testResolveDesignation3() throws Exception {
        ...
        adresse = new Adresse("localite", "casePostale", "attention", "npa", "pays", "cantonOFAS", "csTitre", "rue",
                "rueNumero", "designation1", "designation2", "", "designation4", "idAdresse", "designationTiers1",
                "designationTiers2", "designationTiers3", "designationTiers4", "csTitreTiers");
    ...
    public void testResolveDesignation4() throws Exception {
        ...
        adresse = new Adresse("localite", "casePostale", "attention", "npa", "pays", "cantonOFAS", "csTitre", "rue",
                "rueNumero", "designation1", "designation2", "designation3", "", "idAdresse", "designationTiers1",
                "designationTiers2", "designationTiers3", "designationTiers4", "csTitreTiers");
    ...
    public void testResolveCsTitre() throws Exception {
        ...
        adresse = new Adresse("localite", "casePostale", "attention", "npa", "pays", "cantonOFAS", "csTitre", "rue",
                "rueNumero", "", "designation2", "designation3", "", "idAdresse", "designationTiers1",
                "designationTiers2", "designationTiers3", "designationTiers4", "csTitreTiers");
