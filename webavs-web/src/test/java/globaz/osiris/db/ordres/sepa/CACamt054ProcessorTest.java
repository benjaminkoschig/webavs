...
public class CACamt054ProcessorTest {
    ...
    public void testIsCamt054BVRAndWantedType() throws Exception {
        boolean isCamt054Bvr = new CACamt054Processor().isCamt054AndWantedType(CACamt054DefinitionType.CAMT054_BVR,
                camt054Bvr);

        assertTrue("Except to have a camt054 BVR type of file", isCamt054Bvr);

        boolean isNotACamt054Bvr = new CACamt054Processor().isCamt054AndWantedType(CACamt054DefinitionType.CAMT054_BVR,
                pain002);
