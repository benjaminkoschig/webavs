...
public class VersionDroitTest {
    ...
    public void testIsInitialTrue() throws Exception {
        VersionDroit droit = new VersionDroit("1", 1, EtatDroit.AU_CALCUL, MotifDroit.MODIFICATIONS_DIVERSES);
        assertThat(droit.isInitial()).isTrue();
    }

    @Test
    public void testIsInitialFalse() throws Exception {
        VersionDroit droit = new VersionDroit("1", 2, EtatDroit.AU_CALCUL, MotifDroit.MODIFICATIONS_DIVERSES);
