...
public class MutationPcaOldSearch extends JadeSearchComplexModel {
    ...
    public static String getForOldCurentPca() {
        return MutationPcaOldSearch.FOR_OLD_CURENT_PCA;
    }
    ...
    @Override
    public Class<MutationPcaOld> whichModelClass() {
        return MutationPcaOld.class;
    }
