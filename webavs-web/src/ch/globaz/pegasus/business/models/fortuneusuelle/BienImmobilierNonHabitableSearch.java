...
public class BienImmobilierNonHabitableSearch extends AbstractDonneeFinanciereSearchModel {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    private String forIdBienImmobilierNonHabitable = null;
    private String forIdEntity = null;
    private String forNumeroVersion = null;
    private String idDroitMembreFamille = null;

    public String getForIdBienImmobilierNonHabitable() {
        return forIdBienImmobilierNonHabitable;
    }
    ...
    public void setForIdBienImmobilierNonHabitable(String forIdBienImmobilierNonHabitable) {
        this.forIdBienImmobilierNonHabitable = forIdBienImmobilierNonHabitable;
    }
    ...
    public Class whichModelClass() {
        return BienImmobilierNonHabitable.class;
    }
