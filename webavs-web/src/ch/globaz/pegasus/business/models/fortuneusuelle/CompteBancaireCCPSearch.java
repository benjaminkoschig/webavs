...
public class CompteBancaireCCPSearch extends AbstractDonneeFinanciereSearchModel {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    private String forIdCompteBancaireCCP = null;
    private String forIdEntity = null;
    private String forNumeroVersion = null;
    private String idDroitMembreFamille = null;

    public String getForIdCompteBancaireCCP() {
        return forIdCompteBancaireCCP;
    }
    ...
    public void setForIdCompteBancaireCCP(String forIdCompteBancaireCCP) {
        this.forIdCompteBancaireCCP = forIdCompteBancaireCCP;
    }
    ...
    public Class whichModelClass() {
        return CompteBancaireCCP.class;
    }
