...
public class AutresDettesProuveesSearch extends AbstractDonneeFinanciereSearchModel {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    private String forIdAutresDettesProuvees = null;
    private String forIdEntity = null;
    private String forNumeroVersion = null;
    private String idDroitMembreFamille = null;

    public String getForIdAutresDettesProuvees() {
        return forIdAutresDettesProuvees;
    }
    ...
    public void setForIdAutresDettesProuvees(String forIdAutresDettesProuvees) {
        this.forIdAutresDettesProuvees = forIdAutresDettesProuvees;
    }
    ...
    public Class whichModelClass() {
        return AutresDettesProuvees.class;
    }
