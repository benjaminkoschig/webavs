...
public class CompensationGenerationGlobaleHorloParPartiel extends CompensationGenerationGlobaleHorloPar {
    public CompensationGenerationGlobaleHorloParPartiel() {
        super();
        setPartiel(true);
    }
