...
public abstract class ALImplServiceLocator extends ALServiceLocator {
    ...
    public static AdiDecompteDetailleService getAdiDecompteDetailleService()
            throws JadeApplicationServiceNotAvailableException {
        return (AdiDecompteDetailleService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AdiDecompteDetailleService.class);
    }
    ...
    public static AdiDecompteGlobalService getAdiDecompteGlobalService()
            throws JadeApplicationServiceNotAvailableException {
        return (AdiDecompteGlobalService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AdiDecompteGlobalService.class);
    }
    ...
    public static AdiEnfantMoisModelService getAdiEnfantMoisModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AdiEnfantMoisModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AdiEnfantMoisModelService.class);
    }
    ...
    public static AffilieListComplexModelService getAffilieListComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AffilieListComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AffilieListComplexModelService.class);
    }
    ...
    public static AgricoleModelService getAgricoleModelService() throws JadeApplicationServiceNotAvailableException {
        return (AgricoleModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AgricoleModelService.class);
    }
    ...
    public static AllocataireModelService getAllocataireModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AllocataireModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AllocataireModelService.class);
    ...
    public static AnnonceRafamBusinessService getAnnonceRafamBusinessService()
        ...
        return (AnnonceRafamBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamBusinessService.class);
    ...
    public static AnnonceRafamErrorComplexModelService getAnnonceRafamErrorComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnonceRafamErrorComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamErrorComplexModelService.class);
    }
    ...
    public static AnnonceRafamEtatRegistreService getAnnonceRafamEtatRegistreService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnonceRafamEtatRegistreService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamEtatRegistreService.class);
    }

    public static AnnonceRafamProtocoleComplexModelService getAnnonceRafamProtocoleComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnonceRafamProtocoleComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamProtocoleComplexModelService.class);
    }

    public static AnnonceRafamSedexService getAnnonceRafamSedexService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnonceRafamSedexService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamSedexService.class);
    }
    ...
    public static AnnoncesRafamSearchService getAnnoncesRafamSearchService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnoncesRafamSearchService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnoncesRafamSearchService.class);
    }
    ...
    public static CalculMontantsService getCalculMontantsService() throws JadeApplicationServiceNotAvailableException {
        return (CalculMontantsService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CalculMontantsService.class);
    }
    ...
    public static CategorieTarifComplexModelService getCategorieTarifComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (CategorieTarifComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CategorieTarifComplexModelService.class);
    }
    ...
    public static CategorieTarifModelService getCategorieTarifModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (CategorieTarifModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CategorieTarifModelService.class);
    }
    ...
    public static CompensationFactureService getCompensationFactureService()
            throws JadeApplicationServiceNotAvailableException {
        return (CompensationFactureService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CompensationFactureService.class);
    }
    ...
    public static CorrespondanceIdentifiantsService getCorrespondanceIdentifiantsService()
            throws JadeApplicationServiceNotAvailableException {
        return (CorrespondanceIdentifiantsService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CorrespondanceIdentifiantsService.class);
    }
    ...
    public static CritereTarifModelService getCritereTarifModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (CritereTarifModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CritereTarifModelService.class);
    }
    ...
    public static DatesEcheancePrivateService getDatesEcheancePrivateService()
            throws JadeApplicationServiceNotAvailableException {
        return (DatesEcheancePrivateService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DatesEcheancePrivateService.class);
    }
    ...
    public static DeclarationVersementDetailleDemandeService getDeclarationVersementDetailleDemandeService()
            throws JadeApplicationServiceNotAvailableException {
        return (DeclarationVersementDetailleDemandeService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DeclarationVersementDetailleDemandeService.class);
    }
    ...
    public static DeclarationVersementDetailleDirectService getDeclarationVersementDetailleDirectService()
            throws JadeApplicationServiceNotAvailableException {
        return (DeclarationVersementDetailleDirectService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DeclarationVersementDetailleDirectService.class);
    }
    ...
    public static DeclarationVersementGlobalDirectService getDeclarationVersementGlobalDirectService()
            throws JadeApplicationServiceNotAvailableException {
        return (DeclarationVersementGlobalDirectService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DeclarationVersementGlobalDirectService.class);
    }
    ...
    public static DetailPrestationGenComplexModelService getDetailPrestationGenComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DetailPrestationGenComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DetailPrestationGenComplexModelService.class);
    }
    ...
    public static DetailPrestationModelService getDetailPrestationModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DetailPrestationModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DetailPrestationModelService.class);
    }
    ...
    public static DossierFkModelService getDossierFkModelService() throws JadeApplicationServiceNotAvailableException {
        return (DossierFkModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DossierFkModelService.class);
    }
    ...
    public static EcheanceComplexModelService getEcheanceComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (EcheanceComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EcheanceComplexModelService.class);
    }
    ...
    public static EnteteDocumentUserInfoService getEnteteDocumentUserInfoService()
            throws JadeApplicationServiceNotAvailableException {
        return (EnteteDocumentUserInfoService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnteteDocumentUserInfoService.class);
    ...
    public static EnvoiItemSimpleModelService getEnvoiItemSimpleModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (EnvoiItemSimpleModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnvoiItemSimpleModelService.class);
    ...
    public static EnvoiJobSimpleModelService getEnvoiJobSimpleModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (EnvoiJobSimpleModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnvoiJobSimpleModelService.class);
    ...
    public static EnvoiParametresSimpleModelService getEnvoiParametresSimpleModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (EnvoiParametresSimpleModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnvoiParametresSimpleModelService.class);
    ...
    public static EnvoiTemplateSimpleModelService getEnvoiTemplateSimpleModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (EnvoiTemplateSimpleModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnvoiTemplateSimpleModelService.class);
    ...
    public static HorlogerBusinessService getHorlogerBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (HorlogerBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                HorlogerBusinessService.class);
    }
    ...
    public static ImportationADIService getImportationADIService() throws JadeApplicationServiceNotAvailableException {
        return (ImportationADIService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ImportationADIService.class);
    }
    ...
    public static ImportationAllocataireService getImportationAllocataireService()
            throws JadeApplicationServiceNotAvailableException {
        return (ImportationAllocataireService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ImportationAllocataireService.class);
    }
    ...
    public static ImportationDossierService getImportationDossierService()
            throws JadeApplicationServiceNotAvailableException {
        return (ImportationDossierService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ImportationDossierService.class);
    }
    ...
    public static ImportationDroitService getImportationDroitService()
            throws JadeApplicationServiceNotAvailableException {
        return (ImportationDroitService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ImportationDroitService.class);
    }
    ...
    public static ImportationPrestationService getImportationPrestationService()
            throws JadeApplicationServiceNotAvailableException {
        return (ImportationPrestationService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ImportationPrestationService.class);
    }
    ...
    public static InitAnnoncesRafamService getInitAnnoncesRafamService()
            throws JadeApplicationServiceNotAvailableException {
        return (InitAnnoncesRafamService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                InitAnnoncesRafamService.class);
    }
    ...
    public static LegislationTarifModelService getLegislationTarifModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (LegislationTarifModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                LegislationTarifModelService.class);
    }
    ...
    public static LienDossierModelService getLienDossierModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (LienDossierModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                LienDossierModelService.class);
    }
    ...
    public static PaiementDirectProtocolesService getPaiementDirectProtocolesService()
            throws JadeApplicationServiceNotAvailableException {
        return (PaiementDirectProtocolesService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                PaiementDirectProtocolesService.class);
    }
    ...
    public static PaiementDirectService getPaiementDirectService() throws JadeApplicationServiceNotAvailableException {
        return (PaiementDirectService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                PaiementDirectService.class);
    }
    ...
    public static PrestationTarifModelService getPrestationTarifModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (PrestationTarifModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                PrestationTarifModelService.class);
    }
    ...
    public static ProtocoleCSVCompensation getProtocoleCSVCompensation()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleCSVCompensation) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleCSVCompensation.class);
    }
    ...
    public static ProtocoleCSVPaiementDirect getProtocoleCSVPaiementDirect()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleCSVPaiementDirect) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleCSVPaiementDirect.class);
    }
    ...
    public static ProtocoleDetailleCompensationService getProtocoleDetailleCompensationService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleDetailleCompensationService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleDetailleCompensationService.class);
    }
    ...
    public static ProtocoleDetaillePaiementDirectService getProtocoleDetaillePaiementDirectService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleDetaillePaiementDirectService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleDetaillePaiementDirectService.class);
    }
    ...
    public static ProtocoleErreursCompensationService getProtocoleErreursCompensationService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleErreursCompensationService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleErreursCompensationService.class);
    }
    ...
    public static ProtocoleErreursGenerationService getProtocoleErreursGenerationService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleErreursGenerationService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleErreursGenerationService.class);
    ...
    public static ProtocoleErreursImpressionEcheancesService getProtocoleErreursImpressionEcheancesService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleErreursImpressionEcheancesService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleErreursImpressionEcheancesService.class);
    }
    ...
    public static ProtocoleErreursPaiementDirectService getProtocoleErreursPaiementDirectService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleErreursPaiementDirectService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleErreursPaiementDirectService.class);
    }
    ...
    public static ProtocoleInfoDeclarationVersementService getProtocoleInfoDeclarationVersementService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleInfoDeclarationVersementService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleInfoDeclarationVersementService.class);
    }
    ...
    public static ProtocoleRecapitulatifCompensationService getProtocolesRecapitulatifCompensationService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleRecapitulatifCompensationService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleRecapitulatifCompensationService.class);
    }
    ...
    public static RecapitulatifsListeAffilieService getRecapitulatifsListeAffilieService()
            throws JadeApplicationServiceNotAvailableException {
        return (RecapitulatifsListeAffilieService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                RecapitulatifsListeAffilieService.class);
    }
    ...
    public static TarifComplexModelService getTarifComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (TarifComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                TarifComplexModelService.class);
    }
    ...
    public static TraitementHistoriqueModelService getTraitementHistoriqueModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (TraitementHistoriqueModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                TraitementHistoriqueModelService.class);
    }
    ...
    public static TransfertTucanaModelService getTransfertTucanaModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (TransfertTucanaModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                TransfertTucanaModelService.class);
