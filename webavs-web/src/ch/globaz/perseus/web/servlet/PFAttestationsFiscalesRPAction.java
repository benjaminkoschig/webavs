...
public class PFAttestationsFiscalesRPAction extends PFAbstractDefaultServletAction {

    /**
     * 
     * @param aServlet
     */
    public PFAttestationsFiscalesRPAction(FWServlet aServlet) {
        super(aServlet);
    }
    ...
    protected void actionAfficher(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        String destination = "";
        try {
            PFAttestationsFiscalesRPViewBean viewBean = new PFAttestationsFiscalesRPViewBean();
            ...
            viewBean = (PFAttestationsFiscalesRPViewBean) mainDispatcher.dispatch(viewBean, getAction());
