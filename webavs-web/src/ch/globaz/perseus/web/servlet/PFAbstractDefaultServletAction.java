...
/**
 * Classe abstraite héritant de <code>FWDefaultServletAction</code> - Controller de vue - qui va définir les
 * comportements par défauts attendus par le framework Jade
 * 
 * @author vyj
 */
public abstract class PFAbstractDefaultServletAction extends FWDefaultServletAction {

    /**
     * @param aServlet
     */
    public PFAbstractDefaultServletAction(FWServlet aServlet) {
        super(aServlet);
    }
