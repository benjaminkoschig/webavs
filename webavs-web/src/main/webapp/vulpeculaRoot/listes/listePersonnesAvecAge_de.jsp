...
<c:set var="labelTitreEcran" value="JSP_LISTES_PERSONNES_AVEC_AGE"/>
...
$("#launchListe").click(function () {
		...
		document.forms[0].elements('userAction').value="vulpecula.listes.listePersonnesAvecAge.executer";
