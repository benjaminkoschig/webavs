...
<c:set var="idEcran" value="PPT2016"/>
<c:set var="labelTitreEcran" value="JSP_IMPRESSION_LISTES_AMCAB"/>
...
$(function () {
	$('#launch').click(function () {
		...
		document.forms[0].elements('userAction').value="vulpecula.listes.listeAMCAB.executer";
