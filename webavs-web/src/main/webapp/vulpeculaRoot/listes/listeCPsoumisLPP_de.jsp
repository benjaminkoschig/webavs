...
<c:set var="idEcran" value="PPT2015"/>
<c:set var="labelTitreEcran" value="JSP_LISTES_CP_SOUMIS_LPP"/>
...
$(function () {
	$('#launch').click(function () {
		...
		document.forms[0].elements('userAction').value="vulpecula.listes.listeCPsoumisLPP.executer";
	...
	<div>
		<table>
			...
			<tr>
				...
				<td>
					<input name="annee" value="${viewBean.annee}" />
				</td>				
			</tr>
