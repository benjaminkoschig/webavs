...
<c:set var="idEcran" value="PPT1118"/>
<c:set var="labelTitreEcran" value="JSP_LETTRE_EMPLOYEUR_ACTIF_SANS_PERSONNEL"/>
...
$(function () {
	$("#launchListe").click(function () {
		$("#launchListe").prop('disabled', true);
			document.forms[0].elements('userAction').value="vulpecula.ctrlemployeur.lettreEmployeurActifSansPersonnel.executer";
...
<div style="width: 100%;text-align: center;">
	<div>
		<table>			
			...
			<tr>
				<td><label for="dateReference"><ct:FWLabel key="JSP_PERIODE_ANNEE"/></label></td>
				<td>
					<input name="dateReference" value="${viewBean.dateReference}" size="4" data-g-integer="mandatory:true,sizeMax:4" />
				</td>	
			</tr>
			<tr>
				<td><label for="dateEnvoi"><ct:FWLabel key="JSP_DATE_ENVOI"/></label></td>
				<td>
					<input name="dateEnvoi" value="${viewBean.dateEnvoi}" data-g-calendar="" />
				</td>			
			</tr>
			<tr>
