...
<TR>
	...
	<script language="Javascript">
		...
		%>
		  ...
		  /*
		  	ValidateAnnonce step possible values :
		  		- Step1
		  		- Step2
		  		- Step3
		  		- StepSendAnnonce
		  		- All
		  */
// 		  function validateAnnonce(step, jsonAnnonce) {
// 			  	var options = {
// 					serviceClassName: 'ch.globaz.apg.business.services.plausibilites.PlausibilitesApgService',
// 					serviceMethodName:'check'+step,
// 					parametres:JSON.stringify(jsonAnnonce),
// 					wantInitThreadContext: true,
...
// 						if (data.length > 0) {
// 							$tableError = $('#errorTable tbody');
// 							var html = "";
// 							// Mise en forme de toutes les erreurs dans un tableau
// 							for (var i = 0 ; i < data.length ; i++) {
// 								html += "<tr>";
// 									html += "<td>" + data[i].errorCode + "</td>";
// 									html += "<td>" + data[i].errorMessage + "</td>";
// 									html += "<td align='center'><input type='checkbox' id='breakRules_" + data[i].errorCode + "'";
// 									if (rulesToBreak.search(data[i].errorCode) > -1) {
// 										html += "checked='true'";
// 									}
// 									if (data[i].breakable) {
// 										html += "/>";
...
// 								html += "</tr>";
// 							}
// 							$tableError.html(html);
							
// 							//Ouverture de la dialogue box
// 							$( "#dialog-plausibilites" ).dialog({
// 								modal: true,
// 								width: 600,
// 								height: 500,
// 								buttons: {
// 									Ok: function() {
// 										//Voir les régles qui ont été breakés
// 										var ok = true;
// 										rulesToBreak = "";
// 										for (var i = 0 ; i < data.length ; i++) {
// 											if ($('#breakRules_' + data[i].errorCode).prop("checked")) {
// 												rulesToBreak += data[i].errorCode + ",";
// 											} else {
// 												ok = false;
// 											}
// 										}
// 										rulesToBreak = rulesToBreak.substr(0, rulesToBreak.length-1);
// 										$('#rulesToBreak').val(rulesToBreak);
...
// 										    action(COMMIT);
// 										} else {
// 											alert("<ct:FWLabel key='APG_QUITTANCER_OU_CORRIGER'/>");
// 										}
// 									},
// 									Corriger: function() {
// 										$( this ).dialog( "close" );	
...
// 								}
// 							});
// 						} else { //Si il n'y a pas d'erreur on passe directement au submit 
							
// 						    if (document.forms[0].elements('_method').value == "add"){
// 						    	alert("SUBMIT validate : droit ajouter");
// 						    	document.forms[0].elements('userAction').value = ACTION_DROIT + ".ajouter";
						        
// 						    } else {
// 						    	alert("SUBMIT validate : droit modifier");
// 						    	document.forms[0].elements('userAction').value = ACTION_DROIT + ".modifier";
// 						    }
// 						    action(COMMIT);
// 						}
