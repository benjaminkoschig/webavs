...
globaz.apg.vb.droits.APRecapitulatifDroitMatViewBean viewBean = (globaz.apg.vb.droits.APRecapitulatifDroitMatViewBean) session.getAttribute("viewBean");
...
<ct:menuChange displayId="options" menuId="ap-optionmenudroitamat" showTab="options">
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			...
			<ct:FWLabel key="JSP_TITRE_RECAPITULATIF_MAT"/>
			<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
							...
							<TD COLSPAN="5">
								...
								&nbsp;/&nbsp;<A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&selectedId=<%=viewBean.getTiers()%>" >Tiers</A>
							</TD>
						</TR>
						<TR><TD COLSPAN="6">&nbsp;</TD></TR>
						<TR>
							...
							<TD COLSPAN="5">
								<TABLE BORDER="3">
									...
									for (java.util.Iterator enfants = viewBean.getEnfants().iterator(); enfants.hasNext(); ++count) {
										...
										globaz.apg.db.droits.APEnfantMat enfant = (globaz.apg.db.droits.APEnfantMat) enfants.next();
									%>
										<TR>
