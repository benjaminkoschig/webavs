...
globaz.apg.vb.droits.APRecapitulatifDroitPatViewBean viewBean = (globaz.apg.vb.droits.APRecapitulatifDroitPatViewBean) session.getAttribute("viewBean");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			...
			<ct:FWLabel key="JSP_TITRE_RECAPITULATIF_PAT"/>
			<%-- /tpl:put --%>
