...
<%
	...
	userActionValue="apg.process.genererDecisionAPAT.executer";
	globaz.apg.vb.process.APGenererDecisionAPATViewBean viewBean = (globaz.apg.vb.process.APGenererDecisionAPATViewBean)(session.getAttribute("viewBean"));
