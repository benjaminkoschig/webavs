...
<div class="bigContainer">
	...
	<div class="bodyContainer">
		<div class="singleMenu" style="height:400;" id="menu"><ct:FWMenuTag displayId="menu"/></div>
		<div class="singleMenu" style="height:400;" id="options"><ct:FWMenuTag displayId="options" /></div>
	</div>
</div>
