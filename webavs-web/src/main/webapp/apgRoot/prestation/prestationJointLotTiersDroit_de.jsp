...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
							...
							<%if(APGUtils.isPaternite(session)) {%>
								...
								<TD><INPUT type="text" name="dateFinSaisie" value="<%=viewBean.getDateFinSaisie()%>"></TD>
							<%}else {%>
								<TD colspan="3">&nbsp;</TD>
							<%}%>
						</TR>
						<TR>
							...
							<%if(APGUtils.isPaternite(session)) {%>
								...
								<TD colspan="2"><INPUT type="text" name="nombreJoursConges" value="<%=viewBean.getNombreJoursConges()%>" onchange="validateIntegerNumber(this);recalculer();" onkeypress="return filterCharForInteger(window.event);"></TD>
								<TD><ct:FWLabel key="JSP_INDEMNITE_SUPPLEMENTAIRES"/></TD>
								<TD><INPUT type="text" name="nombreJoursSupp" value="<%=viewBean.getNombreJoursSupp()%>" onchange="validateIntegerNumber(this);recalculer();" onkeypress="return filterCharForInteger(window.event);"></TD>
