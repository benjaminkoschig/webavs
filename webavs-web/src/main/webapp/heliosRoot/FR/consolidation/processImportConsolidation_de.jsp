...
top.document.title = "Process - Importation pour la consolidation - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Process - Importation pour la consolidation<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
			...
			<TR>
          	...
          	<TR>
            <TD align="left" width="180" height="21" valign="middle">Chemin et nom du fichier XML</TD>
            <TD align="left">
