...
globaz.helios.db.consolidation.CGProcessExportConsolidationViewBean viewBean = (globaz.helios.db.consolidation.CGProcessExportConsolidationViewBean) session.getAttribute("viewBean");
userActionValue = "helios.consolidation.processExportConsolidation.executer";
...
top.document.title = "Process - Exportation pour la consolidation - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Process - Exportation pour la consolidation<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
			<TR> 
            	<TD align="left" width="180" height="21" valign="middle">Mandat</TD>
	            <TD align="left"> 
			...
			<TR> 
            	<TD align="left" width="180" height="21" valign="middle">N&deg; Caisse</TD>
	            <TD align="left"> 
			...
			<TR> 
            	<TD align="left" width="180" height="21" valign="middle">N&deg; Agence</TD>
	            <TD align="left"> 
