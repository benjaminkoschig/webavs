...
globaz.helios.db.consolidation.CGProcessImprimerConsolidationParAgenceViewBean viewBean = (globaz.helios.db.consolidation.CGProcessImprimerConsolidationParAgenceViewBean) session.getAttribute("viewBean");
userActionValue = "helios.consolidation.processImprimerConsolidationParAgence.executer";
%>
<%-- /tpl:put --%>
...
top.document.title = "Process - Imprimer annuel par agence - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Process - Imprimer annuel par agence<%-- /tpl:put --%>
