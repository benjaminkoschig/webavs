...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail de l'analyse budgétaire<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>


	<tr>
	            <TD width="204">Numéro de compte</TD>
	            <TD width="488">
...
%>		
	<tr>
	            <TD width="204">Budget <%=userCode.getLibelle()%>, code période : <%=viewBean.getCodePeriode(i)%></TD>
	            <TD width="488">
