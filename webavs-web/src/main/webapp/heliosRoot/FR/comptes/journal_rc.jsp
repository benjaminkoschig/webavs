...
<%@ include file="/theme/find/bodyStart2.jspf" %>
		...
		<tr>
	            <TD colspan="6">&nbsp;Mandat&nbsp;<input name='libelle' class="libelleLongDisabled" readonly value="<%=exerciceComptable.getMandat().getLibelle()%>">&nbsp;Exercice&nbsp;<input name='fullDescription' readonly class="libelleLongDisabled" value="<%=exerciceComptable.getFullDescription()%>">
	            </TD>
		</tr>
		<tr><td colspan="6"><hr></td></tr>

		<tr>
				<TD width="" align="right">&nbsp;Etat&nbsp;</TD>
