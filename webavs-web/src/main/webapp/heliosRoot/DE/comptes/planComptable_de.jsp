...
function onChangeMonnaieEtrangere() {
	if (document.getElementById("idNature").value!=<%=CGCompte.CS_MONNAIE_ETRANGERE%>) {
		alert(" Die Kontoart muß von Typ ausländische Währung sein. ");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail eines Kontos<%-- /tpl:put --%>
...
<tr>
            <TD width="184">Bezeichnung FR</TD>
...
<tr>
            <TD width="184">Bezeichnung DE</TD>
...
<tr>
            <TD width="184">Im Folgejahr wiedereröffnen</TD>
...
%>
	<tr>
	            ...
	            &nbsp;<a href="javascript:callAnalyseBudgetaire();" class="txtLink">Kostenanalysis</a></TD>
	</tr>
<%}%>
</table>
</td>
...
<td valign="top"><table>
		<tr>
            <TD align="left" valign="top">
            	<table>
            	<tr><td colspan="2">Kontoklasse</td></tr>
            	<tr><td>
	             ...
	             <td align="left">
	             	<ct:ifhasright element="<%=removeLink%>" crud="d">
	             		<a href="javascript:removeLink()" class="txtLink">&nbsp;Verkettungen löschen</a>
	             	</ct:ifhasright>
	             </td>
	        </tr>
        	...
        	<tr><td>
             ...
             <td align="left">
             	<ct:ifhasright element="<%=addLink%>" crud="c">
             		<a href="javascript:addLink()" class="txtLink">&nbsp;Verkettung hinzufügen</a>
             	</ct:ifhasright>
             </td>
        </tr>
		</table>
	...
	%>
	    <td align="left" valign="top">Klassifikation&nbsp;
				 ...
				 <ct:ifhasright element="helios.classifications.liaisonCompteClasse" crud="u">
					<a href="javascript:editClassification()" class="txtLink">Editieren</a>
				</ct:ifhasright>
				<script>
