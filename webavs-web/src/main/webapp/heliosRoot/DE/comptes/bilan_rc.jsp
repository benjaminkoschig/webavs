...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Bilanzübersicht<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
				...
				<tr>
					<td nowrap align="left">Periode&nbsp;</td>
					...
					<td align="right">Vorhergehende Perioden umfassen&nbsp&nbsp;</td>
				...
				<tr>
					<td nowrap align="left">Buchhaltung&nbsp;</td>
...
%>
				<tr>
					<td nowrap align="right">AHV-Bereich&nbsp;</td>
					<td nowrap align="left">
					...
					<td nowrap align="right">BSV Kontoplan&nbsp;</td>
