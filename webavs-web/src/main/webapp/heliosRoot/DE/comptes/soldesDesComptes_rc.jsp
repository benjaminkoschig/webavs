...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Uebersicht der Saldi der Konti<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
				<tr>
					<td align="left" nowrap>Mandant&nbsp;</td>
				...
				<tr>
					<td align="left" nowrap>Auswahl&nbsp;</td>
				...
				<tr>
					...
					<% if (!exerciceComptable.getMandat().isEstComptabiliteAVS().booleanValue()) {%>
						<td align="right" nowrap>Kostenstelle&nbsp;</td>
					<td align="left" nowrap>
					...
					<%} else {%>
						<td align="right" nowrap>BSV Kontoplan&nbsp;</td>
						<td align="left" nowrap>
