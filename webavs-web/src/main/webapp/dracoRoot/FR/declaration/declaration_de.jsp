...
<%-- tpl:put name="zoneTitle" --%>Déclaration de salaires - Détail <%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%>

	<tr>
		<td nowrap height="18" rowspan="3" width="128" valign="baseline"><input type="hidden" name="saisieEcran" value="true" tabindex="-1">Affilié</td>
		<td>
			<%if (viewBean.isNew()) {%>
		...
		<TR>
			<td><TEXTAREA id="descriptionTiers" cols="35" class="libelleLongDisabled" tabindex="-1" readonly="readonly" rows="4"><%=viewBean.getDescriptionTiers()%></TEXTAREA></td>
		...
		<TR>
		    ...
		    <TD nowrap height="31" width="76"><%if (viewBean.getCodeSuspendu().equals(DSDeclarationViewBean.CS_AUTOMATIQUE)) { %>jusqu'au<%}%></TD>
		...
		<TR>
		    <TD nowrap height="14" width="128">Numéro de décompte</TD>
		    <TD nowrap height="31" width="294"><INPUT name="noDecompte" size="20" maxlength="20" type="text" value="<%=viewBean.getNoDecompte()%>"></TD>
		    <TD nowrap height="31" width="76"><%if (viewBean.getCodeSuspendu().equals(DSDeclarationViewBean.CS_AUTOMATIQUE)) {%>Motif<%}%></TD>
		...
		<TR>
		    ...
		    <TD nowrap height="31" width="294"><INPUT name="masseSalTotal" size="20" maxlength="20" type="text" value="<%=viewBean.getMasseSalTotal()%>" <%if(!"022".equals(DSUtil.getNoCaisse(session))) {%>class="disabled" tabindex="-1" readonly<%}%>></TD>
		    <TD nowrap height="31" width="76"></TD>
		</TR>
		<TR>
		    <TD nowrap height="14" width="128">Masse salariale AC I</TD>
		    <TD nowrap height="31" width="294"><INPUT name="masseACTotal" size="20" maxlength="20" type="text" value="<%=viewBean.getMasseACTotal()%>" <%if(!"022".equals(DSUtil.getNoCaisse(session))) {%>class="disabled" tabindex="-1" readonly<%}%>></TD>
		    <TD nowrap height="31" width="76">Provenance</TD>
		    <TD nowrap height="31" width="350"><input type="text" value="<%=viewBean.getLabelPourProvenance(viewBean.getSession(), viewBean.getProvenance())%>" class="disabled" readonly="readonly" tabindex="-1"/></TD>
		</TR>
		<TR>
			<TD nowrap height="14" width="128">Masse salariale AC II</TD>
			<TD nowrap height="31" width="294"><INPUT name="masseAC2Total" size="20" maxlength="20" type="text" value="<%=viewBean.getMasseAC2Total()%>" <%if(!"022".equals(DSUtil.getNoCaisse(session))) {%>class="disabled" tabindex="-1" readonly<%}%>></TD>
			<TD nowrap height="31" width="150">Date d'envoi</TD>
		...
		<TR>
			...
			<TD nowrap height="31" width="150">Date de sommation</TD>
		...
		<%if(viewBean.existeCotisationPeriode()){ %>
		<TR>
			<TD nowrap height="14" width="128">Masse période</TD>
		...
		<TR>
			<TD nowrap height="14" width="128">Interêts moratoires</TD>
		<%
...
%>
 			<TD id="tdRapportControle" nowrap height="14" width="128">Rapport de contrôle</TD>
	...
	<script type="text/javascript">
		if (document.getElementById("typeDeclaration")!= null) {
			...
			<TD nowrap height="31" width="150">Date envoi lettre réclamation des NSS invalides</TD>
		...
		<TR>
			<TD nowrap height="14" width="128">Etat</TD>
			...
			<TD nowrap height="31" width="150">Date d'envoi du dernier rappel</TD>
		...
		<TR>
			...
			<TD nowrap height="31" width="150">Nombre de rappels</TD>
	...
	<%if(DSDeclarationViewBean.CS_AFACTURER.equals(viewBean.getEtat()) || DSDeclarationViewBean.CS_COMPTABILISE.equals(viewBean.getEtat())){ %>
		<TR>
			<TD nowrap height="14" width="128">Validée par</TD>
			<TD nowrap height="31" width="294"><INPUT type="text" name="validationSpy" value="<%=viewBean.getValidationSpy()%>" class="disabled" readonly="readonly"></TD>
			<TD nowrap colspan = "2">le&nbsp;<INPUT type="text" name="validationDateSpy" value="<%=viewBean.getValidationDateSpy()%>" class="disabled" readonly="readonly"></TD>
		</TR>
	<%} %>
	<%if(DSDeclarationViewBean.CS_LTN.equals(viewBean.getTypeDeclaration()) && !JadeStringUtil.isBlankOrZero(viewBean.getDateImpressionAttestations())){ %>
		<TR>
			<TD nowrap height="14" width="128">Attestations LTN du</TD>
			<TD nowrap height="31" width="294"><INPUT type="text" name="dateImpressionAttestations" value="<%=viewBean.getDateImpressionAttestations()%>" class="disabled" readonly="readonly" size="9"></TD>
			<TD nowrap height="31" width="76"></TD>
			<TD nowrap height="31" width="350"></TD>
		</TR>
	<%} %>
	<%if(DSDeclarationViewBean.CS_LTN.equals(viewBean.getTypeDeclaration()) && !JadeStringUtil.isBlankOrZero(viewBean.getDateImpressionDecompteImpots())){ %>
		<TR>
			<TD nowrap height="14" width="128">Décompte LTN du</TD>
			<TD nowrap height="31" width="100"><INPUT type="text" name="dateImpressionDecompteImpots" value="<%=viewBean.getDateImpressionDecompteImpots()%>" class="disabled" readonly="readonly" size="9"></TD>
			<TD nowrap height="31" width="76"></TD>
			<TD nowrap height="31" width="350"></TD>
		</TR>
	<%} %>
