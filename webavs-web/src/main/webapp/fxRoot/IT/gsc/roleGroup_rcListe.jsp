...
<%
		globaz.fx.gsc.client.bean.FXRoleGroupListViewBean viewBean =
		(globaz.fx.gsc.client.bean.FXRoleGroupListViewBean) request.getAttribute("viewBean");
		size= viewBean.getSize();
		target="parent.fr_detail";
		targetLocation = target + ".location.href";
		detailLink ="fx?userAction=fx.gsc.roleGroup.afficher&selectedId=";
...
<%
	actionDetail = targetLocation+ "='" +detailLink+java.net.URLEncoder.encode(viewBean.getIdRoles()[i],"iso-8859-1")+"&idRole="+java.net.URLEncoder.encode(viewBean.getIdRoles()[i],"iso-8859-1")+"&idGroup="+java.net.URLEncoder.encode(viewBean.getIdGroups()[i],"iso-8859-1")+"&dateStart="+viewBean.getDateStarts()[i]+"'";
%>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getIdRoles()[i]%>&nbsp;</TD>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getIdGroups()[i]%>&nbsp;</TD>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getDateStarts()[i]%>&nbsp;</TD>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getDateEnds()[i]%>&nbsp;</TD>
