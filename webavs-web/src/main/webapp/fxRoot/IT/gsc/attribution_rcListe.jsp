...
<%
		globaz.fx.gsc.client.bean.FXAttributionListViewBean viewBean =
		(globaz.fx.gsc.client.bean.FXAttributionListViewBean) request.getAttribute("viewBean");
		size= viewBean.getSize();
		target="parent.fr_detail";
		targetLocation = target + ".location.href";
		detailLink ="fx?userAction=fx.gsc.attribution.afficher&selectedId=";
...
<%
	actionDetail = targetLocation+ "='" +detailLink+java.net.URLEncoder.encode(viewBean.getAttributions()[i].getIdRole(),"iso-8859-1")+"&idElement="+viewBean.getAttributions()[i].getIdElement()+"&idRole="+java.net.URLEncoder.encode(viewBean.getAttributions()[i].getIdRole(),"iso-8859-1")+"'";
%>

	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getAttributions()[i].getIdRole()%>&nbsp;</TD>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getAttributions()[i].getIdElement()%>&nbsp;</TD>
	<TD class="mtd" onClick="<%=actionDetail%>" >
	<%
		for (int j=0;j<viewBean.getAttributions()[i].getRightNames().length;j++){
	%>
		<%=viewBean.getAttributions()[i].getRightNames()[j]%>&nbsp;
	<%	
		}
