...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Verbindungen zwischen Partner - Detail<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 
		<tr>
			<TD nowrap width="128"><A href='<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=request.getParameter("idTiers")%>'>Partner</A></TD>
...
<%if (!"".equals(viewBean.getIdTiersEnfant())) {%>
			<TD nowrap width="128"><A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=viewBean.getIdTiersEnfant()%>">Partner in Verbindung</A></TD>

<%} else {%>

			<td>Partner in Verbindung</TD>
<%}%>
		...
		<TD align="left" width="100%">
			...
			<script>
				document.getElementById("tiersSelector").value="Partner ...";
				document.getElementById("adminSelector").value="Verwaltung ...";
				document.getElementById("banqueSelector").value="Bank ...";
			</script>
