...
function checkModification() {
	...
	cspDesi2.setMotifElement("motifModifDesignation2");
    	...
    	cspDesi2.setLibelle("Wählen Sie den Grund der Änderung des Felds 'Name weiter 1' und das Inkrafttreten");
	...
	cspDesi3.setMotifElement("motifModifDesignation3");
    	...
    	cspDesi3.setLibelle("Wählen Sie den Grund der Änderung des Felds 'Name weiter 2' und das Inkrafttreten");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Verwaltung - Detail<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<input type ="hidden" name="oldDesignation1" value="<%=viewBean.getOldDesignation1()%>">
          ...
          <TR> 
            <TD nowrap width="100">Name weiter 1</TD>
            <TD nowrap> 
		...
		<input type ="hidden" name="oldDesignation2" value="<%=viewBean.getOldDesignation2()%>">
          ...
          <TR> 
            <TD nowrap width="100">Name weiter 2</TD>
		...
		<input type ="hidden" name="oldDesignation3" value="<%=viewBean.getOldDesignation3()%>">
          ...
          <TR> 
            <TD nowrap width="100">Sprache</TD>
	...
	<tr>
            <TD nowrap width="130">Hauptversandadresse</TD>
            <TD width="260">
