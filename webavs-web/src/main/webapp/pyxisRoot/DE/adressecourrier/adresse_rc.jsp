...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><span style="font-family:wingdings;font-weight:normal">+</span> - Versandadresse 
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
       ...
       <tr>
			<td colspan="7"><hr><b>Verwaltung : </b></td>
		</tr>
		<tr>
			<td colspan=7>
