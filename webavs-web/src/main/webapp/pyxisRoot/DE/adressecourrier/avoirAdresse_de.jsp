...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><span style="font-family:wingdings;font-weight:normal">+</span><span style="font-family:webdings;font-weight:normal">€</span> - Eine Versandadresse verketten
<%-- /tpl:put --%>
...
<table >
	...
	<%}%>
     ...
     <tr>
       <TD colspan=2>
		...
		<A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&selectedId=<%=viewBean.getIdTiers()%>">Partner</A>
	<br>
	...
	<tr>
	        <td colspan=2><br><span style="font-family:wingdings;font-size:12 pt">1</span>Bereich<br>
	...
	<tr>
	        <td colspan=2><br>Typ<br><ct:FWCodeSelectTag 
				name="typeAdresse" 
