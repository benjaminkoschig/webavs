...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><span style="font-family:wingdings;font-weight:normal">*</span><span style="font-family:webdings;font-weight:normal">€</span> - Zahlungsadresse eines Partners<%-- /tpl:put  --%>
...
<table>
	...
	<%}%>
             <tr>
                   <TD colspan=2 ><span style="font-family:webdings;font-size:12 pt">€</span><A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=viewBean.getIdTiers()%>">Partner</A>
          ...
          <tr>
                    <TD colspan =2 nowrap><span style="font-family:wingdings;font-size:12 pt">*</span>Zahlungsadresse
                    <br>
		...
		<INPUT type="hidden" name="stillInScenario" value="<%=request.getParameter("stillInScenario")%>">
		 ...
		 <tr>
                ...
                <TD colspan=2  nowrap><br><span style="font-family:wingdings;font-size:12 pt">1</span>Bereich
	...
	<tr>
		<td colspan=3 style="vertical-align: bottom; text-align: right; padding-top: 60px; padding-right: 24px;"><input type="button" id="btSynchr" value="Wohnsitzadresse synch." onclick="onClickSynchr();"/></td>
	</tr>
	<%}%>
			...
			<tr>
				...
				<td>
					<ct:ifhasright crud="r" element="pyxis.adressepaiement.avoirPaiement">
						<input name="navLink" class="navLinkTiers"  value="4 Zahlungsadresse" accesskey="4" type="button" 
