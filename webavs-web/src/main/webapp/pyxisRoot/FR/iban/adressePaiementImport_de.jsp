...
<%
	String idEcran ="GTI2007";
	globaz.pyxis.vb.iban.TIAdressePaiementImportViewBean viewBean = (globaz.pyxis.vb.iban.TIAdressePaiementImportViewBean) session.getAttribute("viewBean");
	userActionValue = "pyxis.iban.adressePaiementImport.executer";
	formAction= request.getContextPath()+mainServletPath+"Root/"+languePage+"/iban/adressePaiementImportFile_de.jsp";
	...
	<TBODY>
		<TR>
			<TH colspan="3" height="10" class="title">
				<DIV style="width: 100%">
					<SPAN class="idEcran"><%=(null==idEcran)?"":idEcran%></SPAN><ct:FWLabel key='MENU_ADRPMT_IMPORT' /></DIV>
			</TH>
		</TR>
		<TR>
