...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><span style="font-family:wingdings;font-weight:normal">+</span> - Adresse de courrier 
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
		...
		<TR>
            <TD nowrap width="100">Recherche</TD>
       ...
       <tr>
			<td colspan="7"><hr><b>Administration  : </b></td>
		</tr>
		<tr>
			<td colspan=7>
