...
<tr>
	...
	<A  href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=viewBean.getIdConjoint()%>">Conjoint</A>
	<%} else {%>
	Conjoint
	<%}%>
	<br>
	...
	<td rowspan="2">Affiliation <%if(viewBean.getNombreAffiliations()>1) { out.println("("+viewBean.getNombreAffiliations()+")");} %><br>
