...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Conjoint - Détail<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
					...
					<tr>
						<td colspan=2 >
							...
							<ct:FWPanelContainerTag style="height:200">
								<ct:FWPanelTag value="Sélection" defaultTab="yes">
									<table> 
										<col width="80">
										<TR>
								...
								<ct:FWPanelTag value="Création" >
									<table>
										...
										<TR>
											<TD nowrap width="120">Date de naissance</TD>
											<td>
					...
					<tr>
						<td nowrap>Mettre l'état civil des deux personnes à &nbsp;</td>
