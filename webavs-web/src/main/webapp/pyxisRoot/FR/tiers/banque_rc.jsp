...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Recherche d'une banque<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
		...
		<tr>
			...
			<td style="padding-left:0.5cm" align="right"><select name="critereLocaliteNpa"><option value="crLocalite">Localité</option><option value="crNPA">NPA</option></select></td>
			<td><input name="valueLocaliteNpa" type="text"></td>
			<td align="right" style="padding-left:0.5cm"><b>Pays&nbsp;</b></td>
			<td>
