...
function checkModification() {
    ...
    cspAvs.setLibelle("Choisissez le motif de la modification du NSS et la date d'entrée en vigueur");
	...
	cspContribuable.setMotifElement("motifModifContribuable");
    	...
    	cspContribuable.setLibelle("Choisissez le motif de la modification du n° du Contribuable et la date d'entrée en vigueur");
	...
	cspTitre .setMotifElement("motifModifTitre");
    	...
    	cspTitre .setLibelle("Choisissez le motif de la modification du titre et la date d'entrée en vigueur");
	...
	if (result) {
		...
		cspSexe.setLibelle("Choisissez le motif de la modification du sexe et la date d'entrée en vigueur");
	...
	cspNom.setMotifElement("motifModifDesignation1");
    	...
    	cspNom.setLibelle("Choisissez le motif de la modification du nom et la date d'entrée en vigueur");
	...
	cspDesi2.setMotifElement("motifModifDesignation2");
    	...
    	cspDesi2.setLibelle("Choisissez le motif de la modification du prénom et la date d'entrée en vigueur");
	...
	cspDesi3.setMotifElement("motifModifDesignation3");
    	...
    	cspDesi3.setLibelle("Choisissez le motif de la modification du nom (suite) 1 et la date d'entrée en vigueur");
	...
	cspDesi4.setMotifElement("motifModifDesignation4");
    	...
    	cspDesi4.setLibelle("Choisissez le motif de la modification du nom (suite) 2 et la date d'entrée en vigueur");
    ...
    if (result) {
    	...
    	cspNationalite.setLibelle("Choisissez le motif de la modification de la nationalité et la date d'entrée en vigueur");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			...
			<%} %>
			<span style="font-family:webdings;font-weight:normal">€</span> - Détail d'un tiers <%=viewBean.getDecorations()%><%-- /tpl:put  --%>
