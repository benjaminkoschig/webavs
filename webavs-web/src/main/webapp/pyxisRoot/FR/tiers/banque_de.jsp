...
top.document.title = "Tiers - Banque Détail"
...
function checkModification() {
	...
	cspNom.setMotifElement("motifModifDesignation1");
    	...
    	cspNom.setLibelle("Choisissez le motif de la modification du champ 'Banque' et la date d'entrée en vigueur");
	...
	cspDesi2.setMotifElement("motifModifDesignation2");
    	...
    	cspDesi2.setLibelle("Choisissez le motif de la modification du champ 'Banque suite' et la date d'entrée en vigueur");
    ...
    if (result) {
    	...
    	cspNationalite.setLibelle("Choisissez le motif de la modification du pays et la date d'entrée en vigueur");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Banque - Détail<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 

          
          <TR>
            <TD width="119">N° de clearing</TD>
	...
	<tr>
            <TD width="119"><span style="font-family:wingdings;font-size:12 pt">+</span>Adresse principale de courrier</TD>
            <TD width="211">
