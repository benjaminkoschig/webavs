...
<TABLE width="100%" border="0" cellspacing="0">
  ...
  <TR align="center" >
    ...
    <%
	globaz.pyxis.db.adressepaiement.TITauxMonnaieListViewBean viewBean = (globaz.pyxis.db.adressepaiement.TITauxMonnaieListViewBean )request.getAttribute ("viewBean");
	size = viewBean.getSize ();
	%>
        
    <Th nowrap width="83">Codice </Th>
      
    <Th width="486">Indicazioni</Th>
      
    <Th width="188">Tasso di cambio</Th>
    <Th width="188">Data del tasso</Th>
    <%-- /tpl:put --%> </TR>
	<%	String rowStyle = "";
...
<%-- tpl:put name="zoneList"  --%> 
    ...
    <TD class="mtd"  width="83"><%=viewBean.getCodeMonnaie(i)%>&nbsp;</TD>
      
    <TD class="mtd" width="486"><%=viewBean.getLibelle(i)%>&nbsp;</TD>
      
    <TD class="mtd" width="188">
      <div align="right"><%=viewBean.getTauxChange(i)%>&nbsp;</div>
      </TD>
    <TD class="mtd" width="188"> 
      <div align="right"><%=viewBean.getDateValeurTaux(i)%>&nbsp;</div>
     </TD>
<%-- /tpl:put --%>
    </TR>
  <%	} %>
