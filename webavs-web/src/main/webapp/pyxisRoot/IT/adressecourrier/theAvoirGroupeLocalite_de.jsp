...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%>
							<tr>
								<td><span style="font-family:webdings;font-size:12 pt">€</span>&nbsp;<A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=idTiers%>">Tiers</A></td>
								<td colspan="3">
				                     <INPUT type="text" name="nomTiers" tabindex="-1" value="<%=nomTiers%>" class="libelleLongDisabled" readonly>
								</td>
							</tr>
							<tr>
								<td>Groupe de localités</td>
								<td colspan="3">
