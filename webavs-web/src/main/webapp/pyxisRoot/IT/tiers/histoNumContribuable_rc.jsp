...
usrAction = "pyxis.tiers.histoNumContribuable.lister";
bFind = true;
</SCRIPT>
<%
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Historique N° de contribuable
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%>

	<TR>
        <TD nowrap width="60"><LABEL for="contribuable"><ct:FWLabel key="HISTORIQUE_CONTRIBUABLE_TIER"/></LABEL></TD>
	...
	<TR>
		...
		<TD><INPUT type="text" name="contribuable" value="<%=viewBean.getNumContribuableActuel()%>" class="libelleLongDisabled" readonly> </TD>
	</TR>
	<TR>
		<TD>
