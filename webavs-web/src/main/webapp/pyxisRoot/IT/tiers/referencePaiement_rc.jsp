...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Trovare un riferimento di pagamento QR<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
				<%-- tpl:put name="zoneMain"  --%>

		<tr>
			<td align="right"><b>Etichetta&nbsp;</b></td>
			<td><input name="forlibelleLike" type="text"></td>
		</tr>
		<tr>
			<td align="right" style="padding-left:0.5cm"><b>Numero di conto&nbsp;</b></td>
			<td><input name="forCompteLike" type="text"></td>
			<td align="right" style="padding-left:0.5cm"><b>Riferimento QR&nbsp;</b></td>
