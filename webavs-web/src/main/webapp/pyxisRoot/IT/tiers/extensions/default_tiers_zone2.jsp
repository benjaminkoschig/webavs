...
<tr>
	...
	<A  href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=viewBean.getIdConjoint()%>">Congiunto</A>
	<%} else {%>
	Congiunto
	<%}%>
	<br>
	...
	<td rowspan="2">Affiliazione <%if(viewBean.getNombreAffiliations()>1) { out.println("("+viewBean.getNombreAffiliations()+")");} %><br>
