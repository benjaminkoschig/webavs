...
function del() {
    if (window.confirm("Sie sind dabei, das ausgewählte Objekt zu löschen! Wollen Sie fortfahren?")){
        document.forms[0].elements('userAction').value="aquila.suiviprocedure.sursisConcordataire.supprimer";
...
top.document.title = "Detail Verfolgung des Verfahrens - Nachlassstundung - " + top.location.href;
</script>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
<%-- tpl:put name="zoneTitle" --%>Detail Verfolgung des Verfahrens - Nachlassstundung<%-- /tpl:put --%>
...
<tr>
	<td width="125" class="label"><b>Datum der Nachlassstundung</b></td>
	<td width="30">&nbsp;
...
<tr>
	<td class="label">Stundungsverfall</td>
	<td width="30">&nbsp;</td>
...
<tr>
	<td class="label">Forderungseingabe</td>
	<td width="30">&nbsp;</td>
...
<tr>
	<td class="label">Berichtigung Forderungseingabe</td>
	<td width="30">&nbsp;</td>
...
<tr>
	<td class="label">Verlängerungsverfall</td>
	<td width="30">&nbsp;</td>
...
<tr>
	<td class="label">Widerruf der Stundung</td>
	<td width="30">&nbsp;</td>
...
<tr>
	<td class="label">Gläubigerversammlung</td>
	<td width="30">&nbsp;</td>
...
<tr>
	<td class="label">Beglaubigung der Stundung</td>
	<td width="30">&nbsp;</td>
...
<tr>
	<td class="label">Ende der Stundung</td>
	<td width="30">&nbsp;</td>
