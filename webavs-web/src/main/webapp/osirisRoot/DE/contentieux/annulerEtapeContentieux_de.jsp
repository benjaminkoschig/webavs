...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Annullieren einer Etappe der Rechtspflege<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
			          ...
			          <TR> 
			            <td nowrap align="left" colspan="2">Wollen Sie wirklich die ausgewählte Etappe löschen ?</td>
			          </TR>
			          <TR><TD colspan="2">&nbsp;</TD></TR>
			          <TR> 
			            <TD width=50>Etappe</TD>
			            <TD> 
