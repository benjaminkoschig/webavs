...
<script>
	top.document.title = "Rechtspflege - Suche der Sequenzen der Rechtspflege - " + top.location.href;
  usrAction = "<%=globaz.osiris.application.CAApplication.DEFAULT_OSIRIS_NAME %>.contentieux.sequenceContentieux.lister";
  bFind = true;
</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Suche der Sequenzen der Rechtspflege<%-- /tpl:put --%>
