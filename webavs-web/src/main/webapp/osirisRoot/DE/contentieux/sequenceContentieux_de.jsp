...
function del() {
	if (window.confirm("Sie sind dabei, die ausgewählte Betreibungssequenz zu löschen! Wollen Sie fortfahren?")) {
...
top.document.title = "Betreibungen - Detail einer Betreibungssequenz -  " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail einer Sequenz der Rechtspflege<%-- /tpl:put --%>
