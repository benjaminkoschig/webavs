...
<TH colspan="2" nowrap>Abrechnungskonto</TH>
    <TH nowrap>Grund - Bemerkung</TH>
    <TH nowrap width="100">Rückkehrdatum</TH>
    <TH nowrap>Betrag</TH>
...
<%@ include file="/theme/list/lineEnd.jspf" %>
	...
	<%if(isSearchForLot){%>
	<TR>
		<TD colspan="4" style="font-style: italic; background-color: #dddddd;">Total Rückkehr des Jobs</TD>
