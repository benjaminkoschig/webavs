...
top.document.title = "Prozess - Sammelauftrag Annullierung - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Sammelauftrag Annullierung<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <TR>
            <TD nowrap width="30%">Beschreibung des Journals</TD>
            <TD nowrap width="50%">
