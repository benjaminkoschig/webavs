...
top.document.title = "Konti - Suche des Abrechnungskonto nach Sektion " + top.location.href;
// stop hiding -->
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Suche des Abrechnungskonto nach Sektion<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
				<TR>
				<TD valign="top" width="128">Konto
				...
				<TD valign="top" width="100">Periode
				<BR/><BR/><BR/>Offener Saldo
				<BR/><BR/><BR/>Ausstände blockiert
				</TD>
				<TD valign="top">
				...
				<BR/><BR/><BR/>Rechnungsart&nbsp;
				<BR/><BR/><BR/>Auswhal&nbsp;
				</TD>
				<TD valign="top">
				<BR/><BR/><BR/><select name="forSelectionSections" class="libelleCourt">
				<option value="5" selected>laufende...</option>
