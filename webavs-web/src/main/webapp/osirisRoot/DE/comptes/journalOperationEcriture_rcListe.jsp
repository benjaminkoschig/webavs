...
<%@ include file="/theme/list/javascripts.jspf" %>
    ...
    <TH width="115">BSV Rubrik</TH>
    <TH width="125" align="right">Basis / Grundlage</TH>
    <TH width="125" align="right">Betrag</TH>
...
<%
	...
	if (!globaz.jade.client.util.JadeStringUtil.isBlank(styleAndTitle)) {
		styleAndTitle += " title=\"Status '" + _ecriture.getUcEtat().getLibelle() + "'\"";
	}
%>
