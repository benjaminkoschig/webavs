...
top.document.title = "Konti - Anzeige der Abrechnungskonti - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Anzeige der Abrechnungskonti<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
		  <input type="hidden" name="idTiers" value="<%=element1.getIdTiers()%>"/>
            <TR>
              <TD width="128" align="left" valign="top">Partner</TD>
              <TD nowrap colspan="2">
                <TEXTAREA cols="40" rows="2" class="libelleLongDisabled" readonly><%=element1.getTitulaireNomLieu()%></TEXTAREA>
              </TD>
              <TD width="4"></TD>
              <TD width="515" align="right" valign="bottom">Auswahl
                des Kontos
