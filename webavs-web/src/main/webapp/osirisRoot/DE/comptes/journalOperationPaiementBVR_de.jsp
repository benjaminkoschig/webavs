...
<%
	...
	actionNew = actionNew + "&idJournal="+viewBean.getIdJournal()+"&Status="+viewBean.getEtat();
...
top.document.title = "Konti - Detail einer ESR-Zahlung " + top.location.href;
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Erfassung einer ESR-Zahlung<%-- /tpl:put --%>
...
%>
          ...
          <TR>
            <TD nowrap width="129">Buchungsbeleg Nr.</TD>
            <TD colspan="4">
...
%>
          ...
          <tr>
            ...
            <table width="100%">
            <tr>
            <td width="130">Auslösung Zahlung</td>
          ...
          <tr>
            <td width="129">Interne Referenznummer</td>
            <td width="147">
