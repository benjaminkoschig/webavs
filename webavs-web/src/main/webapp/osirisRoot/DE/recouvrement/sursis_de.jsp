...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Erstellung einer Zahlungsvereinbarung - Phase 3 - Detail einer Zahlungsvereinbarung<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	<%-- tpl:put name="zoneMain" --%>

	<tr>
		<td class="label">
			<a href="osiris?userAction=osiris.comptes.apercuComptes.afficher&selectedId=<%=viewBean.getCompteAnnexe().getIdCompteAnnexe()%>" class="external_link">Konto</a>
		</td>
		<td class="control">
		...
		<a href="pyxis?userAction=pyxis.tiers.tiers.afficher&idTiers=<%=viewBean.getCompteAnnexe().getIdTiers()%>" class="external_link">Zahlungsadresse</a>
		</td>
	...
	<tr><td colspan=4><hr /></td></tr>
		...
		<td class="label">1. Fälligkeitsdatum</td>
