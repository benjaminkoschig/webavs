...
top.document.title = "Prozess - Zahlungsvereinbarung suspendieren - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Zahlungsvereinbarung annullieren<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
			          ...
			          <TR>
			            <TD align="left" width="180" height="21" valign="middle">Annullierungsdatum</TD>
			            <TD align="left">
			              <INPUT type="text" name="dateSuspension" value="<%=viewBean.getDateSuspension()%>" class="date disabled" readonly>
			            </TD>
			          </TR>
			          <TR>
			            <TD align="left" width="180" height="21" valign="middle">Mahnung ausführen</TD>
			            <TD align="left">
