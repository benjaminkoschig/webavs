...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail einer Zahlungsvereinbarung<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	...
	<tr>
		<td class="label">Zahlungsvereinbarung-Nr.</td>
	...
	<tr>
   		<td class="label">Bewilligungsdatum</td>
	...
	<tr>
		...
		<TD class="label">Gliederungsart</TD>
		<%
		// HashSet pour définir les codes systèmes qui ne doivent pas venir dans la liste
