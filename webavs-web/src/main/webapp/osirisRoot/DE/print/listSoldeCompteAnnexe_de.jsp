...
%>
top.document.title = "Liste - Ausdruck Saldoliste nach Abrechnungskonto - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Ausdruck Saldoliste nach Abrechnungskonto<%-- /tpl:put --%>
...
%>	  
          <tr> 
            <td nowrap width="128">Datum bis</td>
            <td nowrap width="576"> 
          ...
          <tr> 
            <td nowrap width="128">1. Sortierungsstufe</td>
            <td nowrap width="576"> 
