...
<%
	String tmpEtape = "Etape 1/3";
	if (processLaunched) {
		tmpEtape = "Etape 3/3";
	}
%>

top.document.title = "Calculer intérêt moratoire - <%=tmpEtape%> - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Calculer intérêt moratoire - <%=tmpEtape%><%-- /tpl:put --%>
