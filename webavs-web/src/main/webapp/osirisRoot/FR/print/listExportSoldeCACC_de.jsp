...
%>
top.document.title = "Liste - Impression de la liste des soldes - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Impression de la liste des soldes <%-- /tpl:put --%>
...
%>  
          ...
          <tr> 
            <td nowrap width="128">Compte courant</td>
            <td nowrap width="576"> 
