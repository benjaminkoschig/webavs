...
<%-- tpl:put name="zoneTitle" --%>Ventilation d'un compte annexe<%-- /tpl:put --%>
...
<tr>
	<td class="label">Ventilation globale</td>
	<td class="control">
		<input type="checkbox" name="ventilationGlobale" id="ventilationGlobaleStr" <%=viewBean.getVentilationGlobale().booleanValue()? "checked" : "unchecked"%>><label for="ventilationGlobaleStr">&nbsp;La ventilation se fait par rubrique sur l'ensemble des sections sélectionnées.</label>
    </td>
</tr>
<%-- /tpl:put --%>
