...
<%@ page import="globaz.osiris.db.ebill.CAGenerationListeAffiliesEBillViewBean" %>
...
<%
    idEcran="GCA3036";
    CAGenerationListeAffiliesEBillViewBean viewBean = (CAGenerationListeAffiliesEBillViewBean) session.getAttribute("viewBean");
