...
<TR>
    ...
    <TD nowrap width="200">
        <input type="text" name="transactionID" tabindex="1" class="libelleLong"
               value="<%=viewBean.getTransactionID()%>">
    </TD>
    <TD width="110">No d'affili&eacute;</TD>
    <TD nowrap width="200">
        <input type="text" name="numeroAffilie" tabindex="1" class="libelleLong"
...
<TR>
    ...
    <TD width="110">Code Erreur</TD>
    <TD nowrap width="200">
        <select name="codeErreur" tabindex="2">
            <option value=""></option>
            <option value="3"><%=CATraitementCodeErreurEBillEnum.CODE_ERREUR_03.getDescription()%>
            </option>
            <option value="8"><%=CATraitementCodeErreurEBillEnum.CODE_ERREUR_08.getDescription()%>
            </option>
...
<TR>
    ...
    <TD nowrap width="200">
        <TEXTAREA cols="40" rows="3" name="texteErreurInterne"
                  class="libelleLong"><%=viewBean.getTexteErreurInterne()%></TEXTAREA>
    </TD>
</TR>
<TR>
...
<TR>
    ...
    <TD nowrap width="110">Date traitement</TD>
    <TD nowrap width="200">
...
<INPUT id="atraitemanuellement" type="button" value="<ct:FWLabel key="EBILL_ENUM_TRAITE_MANUELLEMENT"/>"
       onclick="avalider()">
<% } %>
