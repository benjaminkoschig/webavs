...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer le recouvrement sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Comptes - détail d'un recouvrement direct - " + top.location.href;
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un recouvrement direct<%-- /tpl:put --%>
...
%>
          ...
          <tr>
            <td nowrap width="129">Genre transaction recouvrement</td>
          ...
          <tr>
            <td nowrap width="129">Motif de refus</td>
            <td colspan="4">
          ...
          <tr>
            <td width="129">N&deg; de r&eacute;f&eacute;rence</td>
            <td width="147">
            ...
            <td colspan="2">
	            <table width="100%">
	              <tr>
	                <td width="130">Date d'échéance</td>
