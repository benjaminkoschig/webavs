...
top.document.title = "Process - Extourner l'opération - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Extourner l'opération<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
          <TR>
            <TD nowrap width="30%">Description de l'opération</TD>
          ...
          <TR>
            <TD nowrap width="30%">Commentaire</TD>
            <TD nowrap width="70%" colspan="2">
