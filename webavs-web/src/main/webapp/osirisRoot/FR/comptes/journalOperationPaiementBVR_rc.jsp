...
CAPaiementBVRViewBean element = (CAPaiementBVRViewBean) session.getAttribute (globaz.osiris.servlet.action.CADefaultServletAction.VB_ELEMENT);
...
usrAction = "<%=globaz.osiris.application.CAApplication.DEFAULT_OSIRIS_NAME %>.comptes.journalOperationPaiementBVR.lister";
bFind = true;
...
top.document.title = "Comptes - Recherche des paiements BVR du journal - " + top.location.href;
</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>
        <div align="left">Recherche des paiements BVR du journal</div>
        <%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
          ...
          <TR>
            ...
            <TD nowrap width="8">
              <input type="hidden" name="forIdTypeOperation" value="<%=CAOperation.CAPAIEMENTBVR%>" readonly >
            </TD>
            <TD>&nbsp;</TD>
            <TD width="4"></TD>
            <TD width="272">&nbsp; </TD>
          ...
          <TR>
			...
			String redirectUrl = "/osirisRoot/FR/comptes/journalOperationPaiementBVR_rc.jsp";
			%>
			<ct:FWSelectorTag
