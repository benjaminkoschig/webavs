...
top.document.title = "Extrait de compte - " + top.location.href;
// stop hiding -->
...
<%@ include file="/theme/find/bodyStart2.jspf" %>
          ...
          <TR>
          	<TD colspan="5">&nbsp;</TD>
			<TD align="right" valign="bottom">Tri&nbsp;
          ...
          <TR>
        	...
        	<TD align="right" valign="bottom">N° Section&nbsp;
            ...
            %>
              	...
              	<option value="" <%if (forIdSection.equals("")) {%>selected<%}%>>Toutes</option>
            <%
