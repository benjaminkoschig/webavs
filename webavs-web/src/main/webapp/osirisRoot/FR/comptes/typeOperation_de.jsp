...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer le type d'opération sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Comptes - détail d'un type d'opération - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un type d'opération<%-- /tpl:put --%>
