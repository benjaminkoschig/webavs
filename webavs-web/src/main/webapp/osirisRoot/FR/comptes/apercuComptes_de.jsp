...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer le compte annexe sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Comptes - détail d'un compte annexe - " + top.location.href;
// stop hiding -->
</SCRIPT>
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			...
			D&eacute;tail d'un compte annexe<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR>
            <TD width="125">Depuis-jusqu'au </TD>
            <TD width="30">&nbsp;</TD>
            <TD>
          ...
          <TR>
            <TD width="125">Verrouill&eacute;</TD>
            <TD width="30">&nbsp;</TD>
            <TD>
          ...
          <TR>
            <TD width="125">Sous surveillance</TD>
            <TD width="30">&nbsp;</TD>
            <TD>
              <input type="checkbox" name="aSurveiller" <%=(viewBean.isASurveiller().booleanValue())? "checked" : "unchecked"%> >
            </TD>
            <TD width="30">&nbsp;</TD>
            <TD width="10" align="left">Remarque</TD>
          </TR>
          <TR>
            <TD width="125">Solde ouvert </TD>
            <TD width="30">&nbsp;</TD>
            <TD>
	    ...
	    <TR>
            <TD nowrap width="140">Bulletin neutre</TD>
            <TD width="30">&nbsp;</TD>
            <TD>
              <%
         ...
         <%} %>  
          ...
          <TR><TD colspan="5" class="title">Contentieux</TD></TR>
          ...
          <% } %>
          <TR>
          	<td>Bloquer amende statutaire</td>
            <td>&nbsp;</td>
            <td>
          ...
          <TR>
          	<td>Bloquer taxe de sommation</td>
            <td>&nbsp;</td>
            <td>
          ...
          <TR>
          	<td>Bloquer frais de poursuite</td>
            <td>&nbsp;</td>
            <td>
