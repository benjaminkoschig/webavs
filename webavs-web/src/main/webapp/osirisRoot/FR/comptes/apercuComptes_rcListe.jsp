...
<%@ include file="/theme/list/javascripts.jspf" %>
    ...
    <TH colspan="2" nowrap width="160">Num&eacute;ro</TH>
    <TH nowrap width="100">R&ocirc;le</TH>
	<TH width="300">Description</TH>
    <TH width="110" nowrap align="right">Solde</TH>
    <TH width="4" align="center">Ctx</TH>
    <TH width="4" align="center">Surv.</TH>
	<TH width="70" nowrap>Verrouill&eacute;</TH>
    <%-- /tpl:put --%>
