...
<%			}%>
		...
		<TR>
            <TD width="20%">Propri&eacute;taire</TD>
...
<%		if (!"1".equals(viewBean.getIdJournal())) { %>
		<TR>
            <TD width="20%">Total des écritures</TD>
		...
		<TR>
            <TD width="20%">Total des ordres de versement</TD>
		...
		<TR>
            <TD width="20%">Total des ordres de recouvrement</TD>
