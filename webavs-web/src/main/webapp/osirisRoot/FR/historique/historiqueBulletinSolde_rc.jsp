...
top.document.title = "Historique des bulletins de soldes - " + top.location.href;
// stop hiding -->
</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
<%-- tpl:put name="zoneTitle" --%>Historique des bulletins de soldes<%-- /tpl:put --%>
...
<tr>
		<td valign="top"><a href="<%=request.getContextPath()%>/osiris?userAction=osiris.comptes.apercuComptes.afficher&id=<%=idCompteAnnexe%>">Compte</a>&nbsp;</td>
		<td colspan="4"><TEXTAREA cols="40" rows="4" class="libelleLongDisabled" readonly><%=compteAnnexeTitulaireEntete%></TEXTAREA></td>
</tr>
<tr>
		<td><a href="<%=request.getContextPath()%>/osiris?userAction=osiris.comptes.apercuParSection.afficher&id=<%=idSection%>">Section</a>&nbsp;</td>
		<td colspan="4">
