...
<%@page import="globaz.perseus.vb.statistiques.PFStatsRentePontViewBean"%>
...
<%-- tpl:insert attribute="zoneInit" --%>
	...
	<%
		PFStatsRentePontViewBean viewBean = (PFStatsRentePontViewBean) session.getAttribute("viewBean");
		idEcran="PPF1741";
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:insert attribute="zoneTitle" --%><ct:FWLabel key="JSP_PF_STATS_DEMANDES_RENTE_PONT_D_TITRE"/><%-- /tpl:insert --%>
			...
			<tr>
				...
				<td colspan="2" align="center">
					<a data-g-download="docType:xls,
						...
						serviceMethodName:createStatsRentePontAndSave,
						docName:statsRentePont"
					/>
				</td>
				<%} %>
			</tr>
