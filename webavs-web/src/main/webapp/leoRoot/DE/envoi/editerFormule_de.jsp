...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Formel Ausgabe<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<TR>
							<TD width="5">&nbsp;<TD>
							<TD colspan="3" align="left"><BR><B>Detail über die Sendung</B><BR>&nbsp;</TD>
						</TR>
											...
											if(c.getCsLabelAComplement().equals(globaz.leo.constantes.ILEConstantes.CS_OUI)){
												...
												if(listeChoix!=null){
													...
													%>
													 	<TR>
													 		<TD width="5">&nbsp;<TD>
													 		<TD colspan="2">Unmöglich die Texte in Babel wiederzufinden</TD>
													 	</TR>	 		
													<%
												}
											}
