...
<table class="menutable">
    <tr>
        <TD id="tdApp" width="30" class="selectable" onmouseover="chgCellStyle(this,'Over');"
            onmouseout="chgCellStyle(this,'Out');" onclick="javascript:showMainMenu();"
            style="background-color: <%=Jade.getInstance().getWebappBackgroundColor()%>;" nowrap>
            <DIV align="CENTER"><B><FONT face="Lucida Sans Unicode"><A
                    href="javascript:showMainMenu();">Applications...</A></FONT></B></DIV>
        </TD>
        <td align='right' nowrap>
            ...
            <a href="javascript:showProcess()"><IMG id="icon_process"
                                                    ...
                                                    ALT="Process" border="0"/></a>
            <a href="javascript:imprime()"><IMG id="icon_print"
                                                SRC="<%=request.getContextPath()%>/images/icon_print.png" ALT="Print"
                                                border="0"/></a>
