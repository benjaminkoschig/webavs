...
<%@page import="globaz.hercule.db.noncertifiesconformes.CESaisieReceptionNCCViewBean"%>
<%@page import="globaz.hercule.db.controleEmployeur.CEAffilieManager"%>
<%@page import="globaz.hercule.utils.CEUtils"%>

<%
	idEcran = "CCE3008";
	CESaisieReceptionNCCViewBean viewBean = (CESaisieReceptionNCCViewBean)session.getAttribute ("viewBean");
	userActionValue = "hercule.noncertifiesconformes.saisieReceptionNCC.ajouter";
...
function validate() {
	document.forms[0].elements('userAction').value="hercule.noncertifiesconformes.saisieReceptionNCC.ajouter";
...
function cancel() {
	document.forms[0].elements('userAction').value="hercule.noncertifiesconformes.saisieReceptionNCC.afficher";
}
...
<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_TITRE_ECRAN_NCC_SAISIE_MASSE_RECEPTION"/><%-- /tpl:put --%>
