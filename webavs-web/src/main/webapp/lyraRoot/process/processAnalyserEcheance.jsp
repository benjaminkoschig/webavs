...
<%
	...
	boolean afficherColloneGED = isAjournementGED
            ...
            || isRenteVeufGED
            || isEcheanceEnfantRecueilliGratuitementGED;
%>
<script type="text/javascript"
        src="<%=request.getContextPath()%>/lyraRoot/script/process/processAnalyserEcheance.js"></script>
<script type="text/javascript">
...
<div class="area mainContainerAjax masterAreaTable">
    <table width="100%" class="areaTable areaDataTable analyserProcessTable">
        ...
        <tr class="userChoice">
            <td>
                <%=BSessionUtil.getSessionFromThreadContext().getLabel("ANALYSE_ECHEANCE_ENFANT_RECUEILLI_GRATUITEMENT")%>
            </td>
            <td>
                <input type="checkbox"
