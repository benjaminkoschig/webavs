...
<%@page import="globaz.al.vb.prestation.ALGenerationGlobaleViewBean"%>
...
<%
	ALGenerationGlobaleViewBean viewBean = (ALGenerationGlobaleViewBean) session.getAttribute("viewBean"); 
...
function validate() {
    ...
    if (document.forms[0].elements('_method').value == "add")
        document.forms[0].elements('userAction').value="al.prestation.generationGlobale.ajouter";
    else 
        document.forms[0].elements('userAction').value="al.prestation.generationGlobale.modifier";
    return state;
}
...
function del() {
    ...
    if (window.confirm(msgDelete)){
        document.forms[0].elements('userAction').value="al.prestation.generationGlobale.supprimer";
...
<tr><td>
	...
	<%-- tpl:insert attribute="zoneMain" --%>
    	<table id="AL0015periodeZone" class="zone">
			<tr>
				<td class="label subtitle" colspan="2"><ct:FWLabel key="AL0013_TITRE_PERIODE"/></td>
			</tr>	
			<tr>
				<td><ct:FWLabel key="AL0013_PERIODE_GENERATION"/></td>
				<td>			
