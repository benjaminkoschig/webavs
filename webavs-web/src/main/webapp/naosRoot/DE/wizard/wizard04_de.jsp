...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TBODY> 
							<TR>
								...
								<TD nowrap width="380"><B>Versicherung</B></TD>
								<TD nowrap width="100"><B>Beginn</B></TD>
								<TD nowrap width="100"><B>Ende</B></TD>
								<TD nowrap width="150"><B>Erfassungsplan</B></TD>
							</TR>
							<% 
...
<%@ include file="/theme/detail/bodyButtons.jspf" %>
				...
				<INPUT class="btnCtrl" id="btnAjouter" type="button" value="Hinzufügen" onclick="if(validate()) action(COMMIT);" >				
				<%-- /tpl:put --%>
