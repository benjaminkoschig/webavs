...
function del() {
	if (window.confirm("Sie sind dabei, die Erfassungsverbindung zu löschen! Wollen Sie fortfahren?")) {
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
		        			...
		        			<TD nowrap colspan="2"> 
								...
								<TABLE border="0" cellspacing="0" cellpadding="0">
									<naos:AFInfoAffiliation affiliation="<%=viewBean.getLienAffiliation()%>" titleWidth="150" contentWidth="450" showTitle="Mit dem Mitglied verbunden"/>
						...
						<TR>
           				...
           				<TR>
            				<TD nowrap width="125" height="31">Verbindungstyp</TD>
           				<TD nowrap colspan="2">
            					<ct:FWCodeSelectTag 
            						name="typeLien" 
						...
						<TR>
							<TD nowrap width="125" height="31">Beginndatum</TD>
							<TD nowrap colspan="2"> 
								<ct:FWCalendarTag name="dateDebut" value="<%=viewBean.getDateDebut()%>"/>
							</TD>
						</TR>
						<TR>
							<TD nowrap width="125" height="31">Enddatum</TD>
							<TD nowrap colspan="2">
