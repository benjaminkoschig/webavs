...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	%>
	<TH width="30">&nbsp;</TH>
	<TH nowrap width="75" align="left">Abr.-Nr.</TH>
	<TH width="250">Erfassungstyp</TH>
	<TH width="100" align="center">Beginn</TH>
	<TH width="100" align="center">Ende</TH>
	<TH width="250">Abgangsgrund</TH>
	<TH width="250">Juristische Form</TH>
	<TH width="250">Ind.</TH>
	<%-- /tpl:put --%> 
