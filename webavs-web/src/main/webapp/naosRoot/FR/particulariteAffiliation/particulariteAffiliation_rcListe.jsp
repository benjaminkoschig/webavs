...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	%>
	<TH width="30">&nbsp;</TH> 
	<TH nowrap align="center">Particularit&eacute;</TH>
	<TH align="center" width="80">D&eacute;but</TH>
	<TH align="center" width="80">Fin</TH>
	<TH align="center">Valeur num&eacute;rique</TH>
	<TH align="center">Valeur alphanum&eacute;rique</TH>
      <%-- /tpl:put --%> 
