...
<%-- tpl:put name="zoneTitle" --%>Attestation de paiement des charges sociales<%-- /tpl:put --%>
...
<%-- tpl:put name="zoneMain" --%>
		...
		<TR>
			<TD width="250px">Date sur l'attestation</TD>
		...
		<TR>
			<TD>Paiements réguliers des cotisations</TD>
