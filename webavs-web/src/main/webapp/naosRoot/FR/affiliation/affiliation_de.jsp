...
<SCRIPT language="JavaScript">
    ...
    function proceedValidation() {
        ...
        fixedstring = fixedstring.split('%u0153').join('oe');
        fixedstring = fixedstring.split('%u0152').join('OE');
...
<TR>
    <TD>
        <TABLE border="0" cellspacing="0" cellpadding="0">
            ...
            <TR>
                <TD nowrap height="31" width="161">P&eacute;riode<%=libDateDebutReelle%>
                </TD>
                <TD nowrap>
        ...
        <TABLE border="0" cellspacing="0" cellpadding="0" id="tPartie1">
            ...
            <TR>
                ...
                <TD nowrap colspan="2">
                    ...
                    <% if (method != null && method.equals("add")) { %>
                    <INPUT type="checkbox"
                           name="envoiAutomatiqueLAA" <%=(viewBean.getEnvoiAutomatiqueLAA().booleanValue())? "checked" : ""%> >LAA
                    &nbsp;
                    <INPUT type="checkbox"
                           name="envoiAutomatiqueLPP" <%=(viewBean.getEnvoiAutomatiqueLPP().booleanValue())? "checked" : ""%> >LPP
                    <% } else {
