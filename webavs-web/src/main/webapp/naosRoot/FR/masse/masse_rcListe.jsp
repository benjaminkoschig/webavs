...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	<TH width="30">&nbsp;</TH>
	<TH nowrap align="left" width="110">Assurance</TH>
	<TH align="center" width="110">D&eacute;but</TH>
	<TH align="center" width="110">Fin</TH>
	<TH align="left" width="200">Masse annuelle</TH>
	<TH align="left" nowrap width="200">Masse de la p&eacute;riodicit&eacute;</TH>
	<TH align="left" nowrap width="70">Traitement</TH>
	<%-- /tpl:put --%> 
