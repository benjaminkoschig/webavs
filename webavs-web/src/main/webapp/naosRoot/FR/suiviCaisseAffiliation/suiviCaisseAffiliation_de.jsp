...
function check(elem) {
	if(/^[0-9]+$/.test(elem.getAttribute("maxlength"))) {
		...
		if (elem.value.length > maxlength) {
			alert ("Vous avez dépassé le nombre maximum de caractères autorisé");
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR id="trEnvoieCAF">
							...
							<TD rowspan="5">
								<TEXTAREA id="remarque" name="remarque" maxrow="5" maxlength="1000" rows="10" cols="40" onkeyup="check(this);" onblur="check(this);"><%=viewBean.getRemarque()%></TEXTAREA>
							</TD>
							<%
								}
							%>
