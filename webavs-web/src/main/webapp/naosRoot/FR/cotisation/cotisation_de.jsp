...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer la cotisation sélectionnée! Voulez-vous continuer?")) {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					Affiliation assurance - D&eacute;tail
					<%-- /tpl:put --%>
							...
							<TD> 
								<TABLE border="0" cellspacing="0" cellpadding="0">
									...
									<TR> 
										...
										<TD width="32">&nbsp;</TD>
										<TD nowrap width="125">Caisse - plan</TD>
										<TD width="31"></TD>
										<TD nowrap width="308"> 
											<%--
												String stCaisse = "";
								...
								<TABLE border="0" cellspacing="0" cellpadding="0" id="addUpdatePeriode">
									<TBODY>
									<TR>
										<TD nowrap width="175" height="31">P&eacute;riodicit&eacute; de Facturation</TD>
										...
										<TD width="32"></TD>
										<TD nowrap width="125">Exception &agrave; la p&eacute;riodicit&eacute; principale</TD>
										<TD width="31"></TD>
								...
								<TABLE border="0" cellspacing="0" cellpadding="0" id="displayPar">
									...
									<TR> 
										<TD nowrap width="175">Masse ou cotisation de la p&eacute;riodicit&eacute;</TD>
										...
										<TD width="32"></TD>
										<TD nowrap width="125" height="31">Masse ou cotisation annuelle</TD>
										<TD nowrap width="31"></TD>
										<TD nowrap width="307"> 
								...
								<TABLE border="0" cellspacing="0" cellpadding="0" id="displayPersTypeManuel">
                                    ...
                                    <TR> 
                                        <TD nowrap height="31"
width="175">Cotisations</TD>
                                        <TD colspan="5"></TD>
                                    </TR>
                                    <TR> 
                                        <TD nowrap height="31"
width="175">Annuelles</TD>
...
style="text-align : right;" class="montant" tabindex="-1"  >
                                        ...
                                        <TD width="32"></TD>
                                        <TD nowrap width="125">Mensuelles</TD>
                                        <TD width="31"></TD>
                                        <TD nowrap width="308"> 
...
style="text-align : right;" class="montant" tabindex="-1"  >
								...
								<TABLE border="0" cellspacing="0" cellpadding="0" id="displayPers">
									<TBODY> 
									<TR> 
										<TD nowrap height="31" width="175">Cotisations</TD>
										<TD colspan="5"></TD>
									</TR>
									<TR> 
										<TD nowrap height="31" width="175">Annuelles</TD>
										...
										<TD width="32"></TD>
										<TD nowrap width="125">Semestrielles</TD>
										<TD width="31"></TD>
										<TD nowrap width="308"> 
									...
									<TR> 
										<TD nowrap height="31"  width="175">Trimestrielles</TD>
							...
							<TABLE border="0" cellspacing="0" cellpadding="0">
								<TBODY>
									<TR> 
										<TD nowrap width="194" height="31" >D&eacute;compte &agrave; la maison m&egrave;re</TD>
										<TD nowrap width="302"> 
									...
									<TR> 
										<TD nowrap width="194" height="31">Taux forcé</TD>
										<TD nowrap width="302">
											<%
										...
										<TD nowrap width="156">Catégorie</TD>
										<TD nowrap>
											<ct:FWCodeSelectTag 
									...
									<TR> 
										<TD nowrap colspan="4"><font size="2"><b>Valeurs par d&eacute;faut de cette assurance</b></font></TD>
									</TR>
									<TR> 
									...
									<TR> 
										<TD nowrap height="31" width="194">Taux</TD>
										<TD nowrap width="302">
											<%
												String valeurTotal = "";
												String fraction = "";
									...
									<TR> 
										<TD nowrap width="194" height="31" >Montant annuel </TD>
										<TD nowrap width="302"> 
										...
										<TD nowrap width="156">P&eacute;riodicit&eacute;</TD>
										<TD nowrap> 
