...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Relev&eacute; Saisie<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
					<TR>
						<TD nowrap width="110" height="31">Num&eacute;ro d'affili&eacute;</TD>	
						<TD nowrap width="30"> 
					...
					<% } %>
					<TR>	
						<TD nowrap width="110" height="31">Type de décompte</TD>	
					...
					<TR>	
						...
						%>
							...
							<ct:FWCalendarTag name="dateFin" displayType ="month" 
								value="<%=varDateFin%>" doClientValidation="CALENDAR"/>&nbsp;(mois.ann&eacute;e)	
							&nbsp;&nbsp;<INPUT type="checkbox" name="forcePeriode"> forcer la période (décompte avant affiliation)									
						</TD>
					</TR>
					<TR>
