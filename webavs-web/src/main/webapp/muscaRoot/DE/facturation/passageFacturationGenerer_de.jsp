...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Journal generieren<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<TR>
			<TD width="250">Automatische Generierung*</TD>
			<TD> <INPUT name="auto" type="checkBox" onclick="autoVSmodule();" checked="checked">
				...
				%>
				Generiert nur die Module, die noch nicht den Status "Generiert" haben
			</TD>
		</TR>
		<!-- Ligne vide -->
		<TR><TD width="250"> &nbsp; </TD></TR>
		...
		<TR>
			<TD>* Ab dem ersten nicht nicht generiertes Modul</TD>
			<TD>** Die Generierung ist forciert auf diesem Modul und auf den weiteren</TD>
		</TR>
