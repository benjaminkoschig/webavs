...
<%
	//Récupération des beans
	 FAPassageListerIndeRevenuMinViewBean viewBean = (FAPassageListerIndeRevenuMinViewBean) session.getAttribute ("viewBean");

	//Définition de l'action pour le bouton valider
	userActionValue = "musca.facturation.passageFacturationListerIndeRevenuMin.executer";

%>
<SCRIPT language="JavaScript">
top.document.title = "Liste der Selbstständigerwerbenden mit Familienzulagen - Nicht erreichtes Mindesteinkommen"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste der Selbstständigerwerbenden mit Familienzulagen - Nicht erreichtes Mindesteinkommen<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <tr> 
            <td width="23%" height="2">E-mail</td>
            <td height="2"> 
