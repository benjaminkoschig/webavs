...
<SCRIPT language="JavaScript">
	...
	top.document.title = "Fakturierung - Journal devalidieren"
	...
	function validate() {
	    ...
	    if (window.confirm("Sie sind dabei, dieses Journal zu devalidieren! Wollen Sie fortfahren?")){
			document.forms[0].elements('userAction').value="musca.facturation.passage.devalider";
			return state;
	    }
	    return false;
	}
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Devalidierung eines Journals<%-- /tpl:put --%>
...
<%
	if(globaz.musca.db.facturation.FAPassage.CS_ETAT_COMPTABILISE.equalsIgnoreCase(passageStatus)
		|| passageLocked
		|| globaz.musca.db.facturation.FAPassage.CS_ETAT_ANNULE.equalsIgnoreCase(passageStatus) ){
		%> window.alert("Dieser Job ist bereits annulliert, verbucht oder verriegelt. Unmöglich ihn zu annullieren.");<%
	}
%>
</script>
