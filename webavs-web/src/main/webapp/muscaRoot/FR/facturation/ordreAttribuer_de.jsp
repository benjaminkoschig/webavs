...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Attribution d'un ordre et d'un regroupement<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<TR>
   	    ...
   	    <TR>
			<TD nowrap width="140">Nature</TD>
			<TD nowrap width="300">
				<INPUT name="nature" type="text" value="<%=viewBean.getNatureFromRegroupement()%>" class="libelleDisabled" style="width : 12.15cm" tabindex="-1"></TD>
	  	</TR>
	  	<TR>
            <TD nowrap width="200"></TD>
            <TD nowrap width="547">&nbsp;</TD>
