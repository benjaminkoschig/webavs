...
<%
    ...
    FAImpressionFactureEBillProcess viewBean = (FAImpressionFactureEBillProcess) session.getAttribute("viewBean");

    //Définition de l'action pour le bouton valider
    userActionValue = "musca.facturation.passageFacturationImprimerDecomptesEBill.executer";
...
<SCRIPT language="JavaScript">
    <!--hidethisscriptfromnon - javascript - enabledbrowsers-->
...
<%-- tpl:put name="zoneTitle" --%>Imprimer les décomptes<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%>

<TR id="erreurNumAffObligatoire">
    <TD colspan="2"><font color="red"><B>Vous devez saisir un numéro de débiteur</B></font></TD>
</TR>

<TR>
    <TD>Numéro</TD>
    <TD><INPUT name="idPassage" type="text" value="<%=viewBean.getIdPassage()%>" class="numeroCourtDisabled" readonly>
    </TD>
</TR>
<TR>
    <TD>Libellé</TD>
    <TD><INPUT name="libelle" type="text" value="<%=viewBean.getLibelle()%>" class="libelleLongDisabled"
               doClientValidation="NOT_EMPTY"></TD>
</TR>
            ...
            <TR>
                <TD nowrap width="547" valign="middle">
                    <TABLE width="305" cellpadding="0" cellspacing="0">
                        ...
                        <TR align="left">
                            <TD width="113">de:<BR>
                                <INPUT type="text" id="fromIdExterneRole" name="fromIdExterneRole" size="20"
                                       maxlength="40" value="<%=viewBean.getFromIdExterneRole()%>"></TD>
                            <TD width="196">à:<BR>
                                <INPUT type="text" id="tillIdExterneRole" name="tillIdExterneRole" size="20"
                                       maxlength="40" value="<%=viewBean.getTillIdExterneRole()%>"></TD>
                        </TR>
                        </TBODY>
                    </TABLE>
                </TD>
...
<TR id="oneNumAff">
    <TD>Débiteur</TD>
    <TD><INPUT type="text" id="forIdExterneRole" name="forIdExterneRole" size="20" maxlength="40"
               value="<%=viewBean.getFromIdExterneRole()%>" onchange="setPlageNumAff()"></TD>
</TR>

<tr>
    <td width="23%" height="2">Adresse E-Mail</td>
    <td height="2">
        <input type="text" name="eMailAddress" maxlength="40" size="40" style="width:8cm;"
               value="<%=(viewBean.getEMailAddress()== null)?"":viewBean.getEMailAddress()%>">*
    </td>
</tr>
<TR>
    <TD>
...
<TR>
    <TD>Factures à imprimer</TD>
    <TD><select name="aImprimer">
        <option value="tout">Toutes
        <option value="bloquees">Bloquées
