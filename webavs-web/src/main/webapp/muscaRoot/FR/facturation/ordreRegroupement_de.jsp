...
<%@page import="globaz.musca.translation.CodeSystem"%><SCRIPT language="JavaScript" src="<%=request.getContextPath()%>/scripts/calendar/AnchorPosition.js"></SCRIPT>
...
top.document.title = "Facturation - Ordre d'impression et regroupement"
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un ordre et d'un regroupement d'impression<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
   	   <TR>
            <TD nowrap width="140">Numéro de caisse</TD>
            <TD nowrap width="300">
            	<INPUT name="numCaisse" type="text" value="<%=viewBean.getNumCaisse()%>" class="numeroCourt" style="width : 2cm" tabindex="-1"></TD>
            <TD width="50"></TD>
   	   </TR> 
	   <TR>
        	<TD nowrap width="145">Ordre</TD>
            <%--TD nowrap>
			...
			<TR>
            <TD>Nature</TD>
            <TD><ct:FWSystemCodeSelectTag name="nature"
            		defaut="<%=viewBean.getNature()%>"
		...
		<TR>
            <TD nowrap width="140">Libellé de groupe</TD>
        </TR>
        <TR>
