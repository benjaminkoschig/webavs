...
<script language="javaScript">
	function getMasseParJournal(anneeCoti, idAffiliation){
		...
		parent.dernieresEcritures.location.href="<%=request.getContextPath()%>/pavoRoot/AffilieByJournal.jsp?idAffiliation="+idAffiliation+"&anneeCoti="+anneeCoti;
