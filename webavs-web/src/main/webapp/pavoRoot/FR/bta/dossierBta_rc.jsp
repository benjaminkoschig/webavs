...
<SCRIPT>
	...
	top.document.title = "BTA - Gestion des dossiers"
	timeWaiting = 1;
	bFind=false;
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Aperçu des dossiers de BTA<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
		...
		<tr>
			<td><table>				
	          <tr> 
	            <td width="150" nowrap>NSS de la personne nécessitant des soins</td>
	            <td>
	   			  <nss:nssPopup  
			...
			<td><table>				
	          <tr> 
	            <td width="150" nowrap>Nom la personne nécessitant des soins</td>
	            <td>
		...
		<tr>
			<td><table>				
	          <tr> 
	            <td width="150" nowrap>NSS du requérant</td>
	            <td>
	   			  <nss:nssPopup  
			...
			<td><table>				
	          <tr> 
	            <td width="150" nowrap>Nom du requérant </td>
	            <td>
		...
		<tr>
			<td><table>				
	          <tr> 
	            <td width="150" nowrap>Date de réception du dossier</td>
		...
		<tr>
			<td><table>				
	          <tr> 
	            <td width="150">Etat du dossier</td>
