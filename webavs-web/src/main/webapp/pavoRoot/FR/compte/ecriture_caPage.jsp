...
<HEAD>
    ...
    <%
        ...
        if (CIJournal.CS_PANDEMIE.equals(viewBeanJournal.getIdTypeInscription())) {
            pandemieJournal = true;
        }
...
<FORM>
    <TABLE id="ecrList" name="ecrList" width="100%" border="0"
        ...
        <TR align="center">
            ...
            <Th width="2%" colspan="2" align="left">&nbsp;RA</Th>
            <Th width="2%" align="left">NSS</Th>
            <Th width="12%" align="left">Montant</Th>
            <Th width="5%" align="left">Genre</Th>
            <Th width="4%" align="left">Déb.</Th>
            <Th width="4%" align="left">Fin</Th>
            <Th width="6%" align="left">Année</Th>
            <%if (affilieAMasquer) {%>
            <Th width="12%" align="left">Affilié<br>
                /Conjoint
            </Th>
            <%}%>
            <%if (BTA) {%>
            <Th width="8%" align="left">BTA</Th>
            <%}%>
            <%if (Special) {%>
            <Th width="4%" align="left">Special</Th>
            <%}%>
            <%if (BrEc) {%>
            <Th width="4%" align="left">BrEc</Th>
            <%}%>
            <%if (CAC) {%>
            <Th width="6%" align="left">CAC</Th>
            <%}%>
            <%if (codeAmasquerDec) {%>
            <Th width="3%" align="left">Code</Th>
            <%}%>
            <Th width="18%" align="left">Compte</Th>
        </TR>
        ...
        <TR id="<%="ecr"+line.getEcritureId()%>"
            ...
            <TD class="mtd" width="">
                <!--<IMG id="ecritureNonValid" style="display:none" name="suspens" src="<%=request.getContextPath()%>/images/verrou.gif" border="0">-->
            </TD>
            <TD class="mtd"
                width=""><% if (globaz.pavo.db.compte.CIEcriture.CS_CI_SUSPENS.equals(line.getIdTypeCompte()) || globaz.pavo.db.compte.CIEcriture.CS_TEMPORAIRE_SUSPENS.equals(line.getIdTypeCompte())) { %>
            ...
            <TD class="mtd" id="montant" align="right"
                onClick="javascript:resetSelection();<%=actionDetail%>" width=""><%=line.getMontantFormat()%>&nbsp;
            </TD>
            <TD class="mtd" id="gre"
                onClick="javascript:resetSelection();<%=actionDetail%>" width=""><%=line.getGreFormat()%>&nbsp;
            </TD>
            <TD class="mtd" id="moisDebut"
                onClick="javascript:resetSelection();<%=actionDetail%>" width="4%"><%=line.getMoisDebutPad()%>&nbsp;
            </TD>
            <TD class="mtd" id="moisFin"
                onClick="javascript:resetSelection();<%=actionDetail%>" width="4%"><%=line.getMoisFinPad()%>&nbsp;
            </TD>
            <TD class="mtd" id="annee"
                onClick="javascript:resetSelection();<%=actionDetail%>" width=""><%=line.getAnnee()%>&nbsp;
            </TD>
            ...
            <TD class="mtd" title="<%=line.getInfoEmployeurPartenaire()%>"
                ...
                onClick="javascript:resetSelection();<%=actionDetail%>"
                width=""><%=line.getEmployeurPartenaireForDisplay()%>&nbsp;
            </TD>
            <%} else {%>
            <TD class="mtd" title="<%=line.getInfoEmployeurPartenaire()%>"
            ...
            <TD class="mtd" id="partBtaAff"
                onClick="javascript:resetSelection();<%=actionDetail%>" width=""><%=line.getPartBtaPad()%>&nbsp;
            </TD>
            <%}%>
            <%if (Special) {%>
            <TD class="mtd" id="codeSpecialAff"
                onClick="javascript:resetSelection();<%=actionDetail%>"
                width=""><%=globaz.pavo.translation.CodeSystem.getCodeUtilisateur(line.getCodeSpecial(), session)%>&nbsp;
            </TD>
            <%}%>
            <%if (BrEc) {%>
            <TD class="mtd" id="brancheEconomiqueAff"
                onClick="javascript:resetSelection();<%=actionDetail%>"
                width=""><%=globaz.pavo.translation.CodeSystem.getCodeUtilisateur(line.getBrancheEconomique(), session)%>&nbsp;
            </TD>
            <%} else {%>
            ...
            <TD class="mtd" id="caisseChomage"
                onClick="javascript:resetSelection();<%=actionDetail%>" width=""><%=line.getCaisseChomageStr()%>&nbsp;
            </TD>
            <%}%>
            <%if (codeAmasquerDec) {%>
            <TD class="mtd" id="codeAff"
                onClick="javascript:resetSelection();<%=actionDetail%>"
                width=""><%=globaz.pavo.translation.CodeSystem.getCodeUtilisateur(line.getCode(), session)%>&nbsp;
            </TD>
            <%}%>

            <TD class="mtd" id="typeCompte"
                onClick="javascript:resetSelection();<%=actionDetail%>"
                width=""><%=globaz.pavo.translation.CodeSystem.getLibelle(line.getIdTypeCompte(), session)%>&nbsp;
            </TD>
            <TD id="partBta" style="display: none"><%=line.getPartBta()%>
            </TD>
            <TD id="codeSpecial" style="display: none"><%=line.getCodeSpecial()%>
            </TD>
            <TD id="brancheEconomique"
                style="display: none"><%=globaz.pavo.translation.CodeSystem.getCodeUtilisateur(line.getBrancheEconomique(), session)%>
            </TD>
            <TD id="code" style="display: none"><%=line.getCode()%>
            </TD>
            <TD id="idTypeCompte" style="display: none"><%=line.getIdTypeCompte()%>
            </TD>
        ...
        <TR id="<%="ecrUp"+line.getEcritureId()%>" class="<%=rowStyle%>"
            style="display: none">
            <TD class="mtd" width="">
                <!--<IMG id="ecritureNonValid" name="suspens" src="<%=request.getContextPath()%>/images/verrou.gif" border="0">-->
            </TD>
            ...
            <TD class="mtd" width="" nowrap><nss:nssPopup name="<%=nameInput%>"
                                                          cssclass="libelle" newnss="<%=line.getNumeroavsNNSS()%>"
                                                          jspName="<%=jspLocation%>" avsAutoNbrDigit="11"
                                                          avsMinNbrDigit="8" nssAutoNbrDigit="10" nssMinNbrDigit="7"
                                                          onChange="<%=valueOnChange%>"
                                                          onFailure="<%=valueOnfailure%>"/>&nbsp;
                <script>
            ...
            <TD class="mtd" onchange="validateFloatNumber(this);"
                ...
                width=""><INPUT size="15" maxLength="15" type="text" id="montant"
                                onBlur="this.value=handleAmount(this.value)">&nbsp;
            </TD>
            <TD class="mtd" width=""><INPUT
                    onkeypress="return filterCharForPositivInteger(window.event);"
                    size="2" maxLength="3" type="text" id="gre">&nbsp;
            </TD>
            <TD class="mtd" width="4%"><INPUT
                    onkeypress="return filterCharForPositivInteger(window.event);"
                    size="1" maxLength="2" type="text" id="moisDebut">&nbsp;
            </TD>
            <TD class="mtd" width="4%"><INPUT
                    onkeypress="return filterCharForPositivInteger(window.event);"
                    size="1" maxLength="2" type="text" id="moisFin">&nbsp;
            </TD>
            <TD class="mtd" width=""><INPUT
                ...
                <%}%>
                    onkeypress="return filterCharForPositivInteger(window.event);"
                    size="4" maxLength="4" type="text" id="annee">&nbsp;
            </TD>
            ...
            <%
                if (globaz.pavo.db.inscriptions.CIJournal.CS_CONTROLE_EMPLOYEUR.equals(viewBeanJournal.getIdTypeInscription())
                        ...
                        || apgJournal || pandemieJournal || amiJournal || ijJournal || acJournal) {
            %>
            <%
            ...
            <TD class="mtd" width="" nowrap><span
                ...
                <INPUT type="text"
                       size="<%=apgJournal || pandemieJournal || amiJournal||acJournal || ijJournal?14:tailleChampsAff%>"
                       name="<%=namePopup2%>" value="" tabindex='-1' className="visible" readonly>
            ...
            <TD class="mtd" width="" nowrap><span style="display: none"
                ...
                <nss:nssPopup name="<%=namePopup1%>"
                              ...
                              nssAutoNbrDigit="10" validateOnChange="true" onFailure="<%=onFailurePopup%>"
            ...
            <TD class="mtd" width=""><ct:FWCodeSelectTag name="partBta"
                                                         libelle="code" defaut="" codeType="CIPARBTA" wantBlank="true"/>
                <script>document.all("ecrUp<%=line.getEcritureId()%>").all("partBta").style.width = "1.2cm"</script>
                <!--INPUT type="text" size="2" maxLength="2" id="partBta"-->&nbsp;
            </TD>
            <%} else {%>
            ...
            <TD class="mtd" width=""><ct:FWCodeSelectTag name="codeSpecial"
                                                         libelle="code" defaut="" codeType="CICODSPE" wantBlank="true"/>
                <script>document.all("ecrUp<%=line.getEcritureId()%>").all("codeSpecial").style.width = "1.2cm"</script>
                <!--INPUT type="text" size="2" maxLength="2" id="codeSpecial"-->&nbsp;
            </TD>
            <%} else {%>
            ...
            <TD class="mtd" width="">
                <INPUT type="text" size="2" name="brancheEconomique" value="" readonly tabindex='-1'>
                <script>document.all("ecrUp<%=line.getEcritureId()%>").all("brancheEconomique").style.width = "1.2cm"</script>&nbsp;
            </TD>
            ...
            <TD class="mtd" width="">
                <ct:FWCodeSelectTag name="code"
                                    libelle="code" defaut="" codeType="CICODAMO" wantBlank="true"/>
                <script>document.all("ecrUp<%=line.getEcritureId()%>").all("code").style.width = "1cm"</script>&nbsp;
            </TD>
            <%} else {%>
        ...
        <TR id="newEcrUp" class="row" style="display: none">
            ...
            <TD class="mtd" width="" nowrap><nss:nssPopup name="avsNewUp"
                                                          ...
                                                          avsAutoNbrDigit="11" nssAutoNbrDigit="10" avsMinNbrDigit="8"
                                                          nssMinNbrDigit="7" onChange="updateForm(tag);"
                                                          onFailure="resetAssure(); "/>&nbsp;
                <script>
            ...
            <TD class="mtd" width="">
                <INPUT
				 ...
				 {%>
                    ...
                    <%}%>
                        onkeypress="return filterCharForPositivInteger(window.event);"
                        type="text" size="4" maxLength="4" id="annee">&nbsp;
            </TD>
            <%
                if (globaz.pavo.db.inscriptions.CIJournal.CS_CONTROLE_EMPLOYEUR.equals(viewBeanJournal.getIdTypeInscription())
                        || globaz.pavo.db.inscriptions.CIJournal.CS_CORRECTIF.equals(viewBeanJournal.getIdTypeInscription())
            ...
            <TD class="mtd" width="" nowrap>
                    ...
                    ><%=mitglied%></span>
                <INPUT type="text" name="partnerNumnewEcrUp"
                       size="<%=apgJournal || pandemieJournal || amiJournal || acJournal ||ijJournal?14:tailleChampsAff%>"
            ...
            <TD class="mtd" width=""><ct:FWCodeSelectTag name="partBta"
                                                         libelle="code" defaut="" codeType="CIPARBTA" wantBlank="true"/>
                <script>document.all("newEcrUp").all("partBta").style.width = "1.2cm"</script>
                <!--INPUT type="text" size="2" maxLength="2" id="partBta"-->&nbsp;
            </TD>
            <%} else {%>
            <INPUT type="hidden" name="partBta" value="">
            ...
            <TD class="mtd" width=""><ct:FWCodeSelectTag name="codeSpecial"
                                                         libelle="code" defaut="" codeType="CICODSPE" wantBlank="true"/>
                <script>document.all("newEcrUp").all("codeSpecial").style.width = "1.2cm"</script>
                <!--INPUT type="text" size="2" maxLength="2" id="codeSpecial"-->&nbsp;
            </TD>
            <%} else {%>
            <INPUT type="hidden" name="codeSpecial" value="">
            ...
            <TD class="mtd" width="">
                <ct:FWCodeSelectTag name="code"
                                    libelle="code" defaut="" codeType="CICODAMO" wantBlank="true"/>
                <script>document.all("newEcrUp").all("code").style.width = "1cm"</script>&nbsp;
            </TD>
            <%} else {%>
            <input type="hidden" name="code" value="">
            <%}%>
            <TD class="mtd" width="18%">
                ...
                <INPUT type="hidden" size="10" readonly name="idTypeCompte"
                       value="<%="303006"%>">
                <script>document.all("newEcrUp").all("idTypeCompte").style.width = "3cm"</script>&nbsp;
            </TD>
        </TR>
        <TR id="newEcriture" style="display: none" class="<%=rowStyle%>">
            ...
            <TD class="mtd" width="" nowrap><nss:nssPopup name="avsNew"
                                                          ...
                                                          onChange="updateForm(tag);" onFailure="resetAssure();"/>&nbsp;
                <script>
            ...
            <TD class="mtd" width=""><INPUT
                    onkeypress="return filterCharForPositivInteger(window.event);"
                    type="text" size="1" maxLength="2" id="moisDebut">&nbsp;
            </TD>
            <TD class="mtd" width=""><INPUT
                    onkeypress="return filterCharForPositivInteger(window.event);"
                    type="text" size="1" maxLength="2" id="moisFin">&nbsp;
            </TD>
            <TD class="mtd" width=""><INPUT
                <%if(globaz.pavo.db.inscriptions.CIJournal.CS_CONTROLE_EMPLOYEUR.equals(viewBeanJournal.getIdTypeInscription())
				 || "301001".equals(viewBeanJournal.getIdTypeInscription()) || "301002".equals(viewBeanJournal.getIdTypeInscription())){%>
            ...
            <TD class="mtd" width="" nowrap>
                ...
                ><%=mitglied%></span>
                <INPUT type="text" name="partnerNumnewEcriture"
                       size="<%=apgJournal || pandemieJournal || amiJournal || acJournal || ijJournal?14:tailleChampsAff%>"
                    <%if(amiJournal){%>
                    ...
                    <%}else if(pandemieJournal){%>
                       value="555.55.555.555"
            ...
            <%} else {%>
            <TD class="mtd" width="" nowrap>
			<span id="partnermitgliedernewEcriture" <%if(!cotPersJournal && !splitJournal ){%>class="selected"
                  onclick="switchPartnerMitglieder('newEcriture');"
            ...
            /> <ct:FWPopupList
                    ...
                    jspName="<%=jspLocation2%>" minNbrDigit="3" autoNbrDigit="<%=autoDigitAff%>"
                    size="<%=tailleChampsAff%>"/>
                <script>
            ...
            <TD class="mtd" width=""><ct:FWCodeSelectTag name="partBta"
                                                         libelle="code" defaut="" codeType="CIPARBTA" wantBlank="true"/>
                <script>document.all("newEcriture").all("partBta").style.width = "1.2cm"</script>&nbsp;
            </TD>
            <%} else {%>
            <INPUT type="hidden" name="partBta" value="">
            <%}%>
            ...
            <TD class="mtd" width=""><ct:FWCodeSelectTag name="codeSpecial"
                                                         libelle="code" defaut="" codeType="CICODSPE" wantBlank="true"/>
                <script>document.all("newEcriture").all("codeSpecial").style.width = "1.2cm"</script>&nbsp;
            </TD>
            <%} else {%>
            <INPUT type="hidden" name="codeSpecial" value="">
            <%}%>
            ...
            <TD class="mtd" width="">
                <ct:FWCodeSelectTag name="code"
                                    libelle="code" defaut="" codeType="CICODAMO" wantBlank="true"/>
                <script>document.all("newEcriture").all("code").style.width = "1cm"</script>&nbsp;
            </TD>
            <%} else {%>
            <input type="hidden" name="code" value="">
            <%}%>
    ...
    <input style=" font-size :7pt;" type="button" value="&lt;&lt;" accesskey=","
           onclick="this.disabled=true;location.href='<%=findPreviousLink%>'">
    <% } else {%>
    <input style=" font-size :7pt;" type="button" value="&lt;&lt;" disabled>
    <%}%>
    <%if (viewBean.canDoNext()) {%>
    <input style=" font-size :7pt;" type="button" value=";&gt;&gt;" accesskey="."
           onclick="this.disabled=true;location.href='<%=findNextLink%>'">
    <%} else {%>
    <input style=" font-size :7pt;" type="button" value="&gt;&gt;" disabled>
    <%}%>
    <%}%>
