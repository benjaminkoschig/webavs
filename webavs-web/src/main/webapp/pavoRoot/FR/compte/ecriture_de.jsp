<%-- tpl:insert page="/theme/detail.jtpl" --%><%@page import="globaz.pavo.db.inscriptions.CIJournal"%>
...
top.document.title = "CI - Détail d'une inscriptions";
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail de l'inscription<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
					...
					<tr>
						...
						<input name='nomPrenom' class='disabled' size="79" readonly
					...
					<tr>
						...
						<select name="genreAff" onChange="updateGenreAff(this.options[this.selectedIndex].value);" onClick="resetAfterError(this.options[this.selectedIndex].value);">
							<option name="affilieSelec" <%=(viewBean.getAijApgAmi().equals("1"))?"selected":""%> value="1">Affilié</option>
							<option name="partenaireSelec" <%=(viewBean.getAijApgAmi().equals("2"))?"selected":""%> value="2">Partenaire</option>
							<option name="caisseCho" <%=(viewBean.getAijApgAmi().equals("3"))?"selected":""%> value="3">Caisse de chomage</option>
							<%if (BtaAff){%>
          ...
          <tr> 
            ...
            <td colspan="4"> 
              ...
              <% } %>
					...
					<tr >
						<td>Dates</td>
						<td width="60" align="left">Ordre</td>
						<td width="60" align="left">Clôture</td>
						<td width="60" align="left">Transmission</td>
						<td width="60" align="left">Centrale</td>
...
%> <input name='dateSaisieInv' class='disabled' size='11' readonly
							value='<%=saisie.getDate()%>' tabindex="-1"> à <input
							...
							tabindex="-1"> à <input name='timeSaisieInv' class='disabled'
							size='9' readonly value='' tabindex="-1"> <% } %> &nbsp;par&nbsp;
	...
	if(viewBean.getIdTypeCompte().equals(viewBean.CS_CI_SUSPENS_SUPPRIMES)){
		BSpy saisie = new BSpy(viewBean.getEspionSaisieSup());%>
					<tr>
						...
						<td colspan="4"><INPUT name='dateSuppression'class='disabled' size='11' readonly value='<%=saisie.getDate()%>'> à 
						...
						<td colspan="4"><INPUT name='dateSuppression'class='disabled' size='11' readonly value=''> à 
