...
<TR>
    <TD colpsan="6">
        <TABLE cellspacing="2">
            <TR>
                <TD colspan="6">
                    <input type="hidden" name="isBasesCalculModifiable"
                           value="<%=viewBean.getIsBasesCalculModifiable().booleanValue()%>">
            ...
            <TR>
                <TD colspan="6">
                    ...
                    <ct1:nssPopup name="nssTiersBeneficiairea" onFailure="" onChange="nssChange(tag);"
                                  params="<%=params%>"
                                  value="<%=viewBean.getNssTiersBeneficiaireWithoutPrefix()%>" newnss=""
                                  jspName="<%=jspLocation%>" avsMinNbrDigit="3" nssMinNbrDigit="3" avsAutoNbrDigit="11"
                                  nssAutoNbrDigit="10"/>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="idBasesCalcul" value="<%=viewBean.getIdBasesCalcul()%>" class="disabled"
                           readonly></TD>
                <TD colspan="2">&nbsp;</TD>
            ...
            <TR>
                ...
                <TD>
                    <INPUT type="text" name="genrePrestationRenteAccordee" size="8"
                           value="<%=viewBean.getGenrePrestationRenteAccordee()%>" onkeyup="metAJourCodePrestation()">
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="RAMBasesCalcul"
                           value="<%=viewBean.getRAMBasesCalcul()%>" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                ...
                <TD><INPUT type="text" name="echelleBasesCalcul" size="2" maxlength="2"
                           value="<%=viewBean.getEchelleBasesCalcul()%>" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>></TD>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="dureeCotAv73BasesCalcul" value="<%=viewBean.getDureeCotAv73BasesCalcul()%>"
                           onchange="formatAAMMField(this);"
                           size="5" maxlength="5" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>>
                </TD>
                <TD><ct:FWLabel key="JSP_SAM_D_D_COT_AP_73"/></TD>
                <TD><INPUT type="text" name="dureeCotAp73BasesCalcul" value="<%=viewBean.getDureeCotAp73BasesCalcul()%>"
                           onchange="formatAAMMField(this);"
                           size="5" maxlength="5" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>></TD>
                <TD colspan="2">&nbsp;</TD>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="moisAppAv73BasesCalcul" value="<%=viewBean.getMoisAppAv73BasesCalcul()%>"
                           size="2" maxlength="2" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>></TD>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="dureeCotClasseBasesCalcul"
                           value="<%=viewBean.getDureeCotClasseBasesCalcul()%>"
                           size="2" maxlength="2" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>></TD>
                ...
                <TD><INPUT type="text" name="dureeCotRAMBasesCalcul" value="<%=viewBean.getDureeCotRAMBasesCalcul()%>"
                           onchange="formatAAMMField(this);"
                           size="5" maxlength="5" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>></TD>
            </TR>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="degreInvaliditeDemandeRente"
                           value="<%=viewBean.getDegreInvaliditeDemandeRente()%>" class="disabled" readonly></TD>
                <TD><ct:FWLabel key="JSP_SAM_D_CLE_INFIRMITE"/></TD>
                <TD><INPUT type="text" name="cleInfirmiteDemandeRente"
                           value="<%=viewBean.getCleInfirmiteDemandeRente()%>" class="disabled" readonly></TD>
                <TD><ct:FWLabel key="JSP_SAM_D_SURV_EV_ASS"/></TD>
                <TD><INPUT type="text" name="survEvAssDemandeRente" value="<%=viewBean.getSurvEvAssDemandeRente()%>"
                           class="disabled" readonly></TD>
            </TR>
            <TR>
                <TD><ct:FWLabel key="JSP_SAM_D_INVALIDITE_PRECOCE"/></TD>
                <TD><INPUT type="checkbox"
                           name="invaliditePrecoceBasesCalcul" <%=viewBean.getInvaliditePrecoceBasesCalcul().booleanValue()?"CHECKED":""%>>
                </TD>
                <TD><ct:FWLabel key="JSP_SAM_D_OFFICE_AI"/></TD>
                <TD><INPUT type="text" name="codeOfficeAIDemandeRente"
                           value="<%=viewBean.getCodeOfficeAIDemandeRente()%>" class="disabled" readonly></TD>
                <TD colspan="2">&nbsp;</TD>
            </TR>
            <TR>
                <TD><ct:FWLabel key="JSP_SAM_D_D_COT_ETR_AV_73"/></TD>
                <TD><INPUT type="text" name="dureeCotEtrAv73BasesCalcul"
                           value="<%=viewBean.getDureeCotEtrAv73BasesCalcul()%>" size="5" maxlength="5"
                           onchange="formatAAMMField(this);"
                    <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%> class="disabled" readonly<%}%>>
                </TD>
                <TD><ct:FWLabel key="JSP_SAM_D_D_COT_ETR_AP_73"/></TD>
                <TD><INPUT type="text" name="dureeCotEtrAp73BasesCalcul"
                           value="<%=viewBean.getDureeCotEtrAp73BasesCalcul()%>" size="5" maxlength="5"
                           onchange="formatAAMMField(this);"
                    <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%> class="disabled" readonly<%}%>>
                </TD>
                <TD colspan="2">&nbsp;</TD>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="suppAIRAMBasesCalcul"
                           value="<%=viewBean.getSuppAIRAMBasesCalcul()%>" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>></TD>
                ...
                <TD>
                    ...
                    <INPUT type="hidden" name="fractionRenteRenteAccordee"
                           value="<%=viewBean.getFractionRenteRenteAccordee()%>">
                </TD>
                <TD colspan="2">&nbsp;</TD>
            </TR>
            <TR>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="bonusEducatifBasesCalcul"
                           value="<%=viewBean.getBonusEducatifBasesCalcul()%>" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>></TD>
                <TD colspan="2">&nbsp;</TD>
                <TD colspan="2">&nbsp;</TD>
            </TR>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="supplementAjournementRenteAccordee"
                           value="<%=viewBean.getSupplementAjournementRenteAccordee()%>"></TD>
                <TD><ct:FWLabel key="JSP_SAM_D_DATE_REVOC"/></TD>
                <TD><INPUT type="text" name="dateRevocationDemandeRente"
                           size="7" maxlength="7" value="<%=viewBean.getDateRevocationDemandeRente()%>" class="disabled"
                           readonly>
                </TD>
            </TR>
            <TR>
                ...
                <TD><INPUT type="text" name="reductionAnticipationRenteAccordee"
                           value="<%=viewBean.getReductionAnticipationRenteAccordee()%>"></TD>
            ...
            <TR>
                ...
                <TD>
                    <INPUT type="checkbox"
                           name="isAjourneDemandeRente" <%=viewBean.getIsAjourneDemandeRente().booleanValue()?"CHECKED":""%>
                           class="forceDisable" disabled="disabled">
                </TD>
                <TD><ct:FWLabel key="JSP_SAM_D_TAUX_RED_ANTIC"/></TD>
                <TD><INPUT type="text" name="tauxReductionAnticipation"
                           value="<%=viewBean.getTauxReductionAnticipation()%>"></TD>
            </TR>
            <TR>
                <TD colspan="6">&nbsp;</TD>
            </TR>
            ...
            <TR>
                ...
                <TD colspan="3">
                    <INPUT type="text" name="codesCasSpecialRenteAccordee1" size="2" maxlength="2"
                           value="<%=viewBean.getCodesCasSpecialRenteAccordee1()%>"
                           onchange="metAJourCodeCasSpeciaux()">
                    <INPUT type="text" name="codesCasSpecialRenteAccordee2" size="2" maxlength="2"
                           value="<%=viewBean.getCodesCasSpecialRenteAccordee2()%>"
                           onchange="metAJourCodeCasSpeciaux()">
                    <INPUT type="text" name="codesCasSpecialRenteAccordee3" size="2" maxlength="2"
                           value="<%=viewBean.getCodesCasSpecialRenteAccordee3()%>"
                           onchange="metAJourCodeCasSpeciaux()">
                    <INPUT type="text" name="codesCasSpecialRenteAccordee4" size="2" maxlength="2"
                           value="<%=viewBean.getCodesCasSpecialRenteAccordee4()%>"
                           onchange="metAJourCodeCasSpeciaux()">
                    <INPUT type="text" name="codesCasSpecialRenteAccordee5" size="2" maxlength="2"
                           value="<%=viewBean.getCodesCasSpecialRenteAccordee5()%>"
                           onchange="metAJourCodeCasSpeciaux()">
            ...
            <TR>
                ...
                <TD>
                    <INPUT type="checkbox" value="on"
                           name="codeRevenusSplittesBasesCalcul" <%=viewBean.getCodeRevenusSplittesBasesCalcul().booleanValue()?"CHECKED":""%> <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="forceDisable" disabled="disabled" <%}%>>
                </TD>
                ...
                <TD><INPUT type="text" name="codeRevenu9emeBasesCalcul"
                           value="<%=viewBean.getCodeRevenu9emeBasesCalcul()%>" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>></TD>
            </TR>
            <TR>
                <TD colspan="6">&nbsp;</TD>
            ...
            <TR>
                ...
                <TD><INPUT type="text" name="droitBasesCalcul" size="2" maxlength="2"
                           value="<%=viewBean.getDroitBasesCalcul()%>" <%if (!viewBean.getIsBasesCalculModifiable().booleanValue()) {%>
                           class="disabled" readonly<%}%>>
                </TD>
                <TD><ct:FWLabel key="JSP_SAM_D_TRANSFERE"/></TD>
                <TD>
                    <INPUT type="checkbox" name="isTransfere" <%=viewBean.getIsTransfere().booleanValue()?"CHECKED":""%>
                           class="forceDisable" disabled="disabled">
