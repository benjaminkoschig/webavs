...
<%
    ...
    Map<String, String> codesMutations = PRCodeSystem.getCUCSinMap(viewBean.getSession(), IRERenteAccordee.CS_GROUPE_CODE_MUTATION);
...
<script type="text/javascript">
    ...
    var o_mapCodesMutations = <%=new Gson().toJson(codesMutations)%>;
    ...
    function miseAJourCodeMutation() {
        if ($codeMutation.val() == "" || typeof (o_mapCodesMutations[$codeMutation.val()]) !== 'undefined') {
            $imageCodeMutationKo.hide();
            $imageCodeMutationOk.show();
        } else {
            $imageCodeMutationKo.show();
            $imageCodeMutationOk.hide();
        }
    }
    ...
    $(document).ready(function () {
        ...
        $imageCodeMutationOk = $('#imageOKCodeMutation');
        $imageCodeMutationKo = $('#imageKOCodeMutation');
        ...
        $codeMutation.keyup(function () {
            miseAJourCodeMutation();
        });
            ...
            <tr>
                <td colspan="6">
                    <table>
                        ...
                        <input type="hidden" name="isPrendreEnCompteCalculAcor"
                               value="<%=viewBean.getIsPrendreEnCompteCalculAcor()%>">
                ...
                <td colspan="6" class="areaGlobazBlue">
                    <table>
                        <tr>
                            ...
                            <td>
                                <ct:FWLabel key="JSP_SAM_D_CODE_MUTATION"/>
                            </td>
                            <td>
                                <input type="text"
                                       id="codeMutation"
                                       ...
                                       size="2"
                                       maxlength="2"
                                       value="<%=viewBean.getCodeMutation()%>"/>
                                <img id="imageOKCodeMutation"
                                     name="imageOKCodeMutation"
                                     src="<%=request.getContextPath()%>/images/ok.gif"
                                     alt=""/>
                                <img id="imageKOCodeMutation"
                                     name="imageKOCodeMutation"
                                     src="<%=request.getContextPath()%>/images/erreur.gif"
                                     alt=""/>
                            </td>
                            <td>
