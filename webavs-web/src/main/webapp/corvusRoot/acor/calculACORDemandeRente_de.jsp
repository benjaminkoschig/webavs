...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#lienAcorWeb').one('click', function () {
            ajaxUtils.addOverlay($('html'));
            window.location.href = "corvus?userAction=corvus.rentesaccordees.renteAccordeeJointDemandeRente.actionAfficherCalcul&noDemandeRente=" + <%=viewBean.loadDemandeRente(null).getIdDemandeRente()%> + "&idTierRequerant=" + <%=viewBean.getIdTiers()%>;
        });
    });
</script>
...
<%
    ...
    String token = Acor2020TokenRentesServiceImpl.createToken(viewBean, day, JadeDateUtil.getHMTime(actualDate), day, bSession);
