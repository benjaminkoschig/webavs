			...
			<div id="idConteneurDeclarationImpots" class="conteneurDeclarationImpots">
				...
				<tr>
					...
					<%if (!isOldRevenu) { %>
						...
						<td><input disabled="disabled" id="perteActIndep"
							name="revenuFullComplex.simpleRevenuContribuable.perteActIndep" type="text"
							data-g-amount=" "
							style="width:100px"
				...
				<tr>
					...
					<%if (!isOldRevenu) { %>
						...
						<td>Fr.</td>
						<td><input disabled="disabled"
							name="revenuFullComplex.simpleRevenuContribuable.perteActAgricole" id="perteActAgricole" type="text" 
							data-g-amount=" "
							style="width:100px"
					...
					<td><input disabled="disabled" id="excedDepPropImmoComm"
						name="revenuFullComplex.simpleRevenuContribuable.excedDepPropImmoComm" type="text"
						data-g-amount=" "
						style="width:100px"
				...
				<tr>
					...
					<%if (!isOldRevenu) { %>
						...
						<td><input disabled="disabled" id="perteSociete"
							name="revenuFullComplex.simpleRevenuContribuable.perteSociete" type="text"
							data-g-amount=" "
							style="width:100px"
					...
					<td><input disabled="disabled" id="revenuIndep"
						name="revenuFullComplex.simpleRevenuContribuable.revenuActIndep" type="text"
						data-g-amount=" "
						style="width:100px"
						value="<%=viewBean.getRevenuFullComplex().getSimpleRevenuContribuable().getRevenuActIndep()%>" />
					</td>
					...
					<%if (!isOldRevenu) { %>
						...
						<td><input disabled="disabled" id="excDepSuccNp"
							name="revenuFullComplex.simpleRevenuContribuable.excDepSuccNp" type="text"
							data-g-amount=" "
							style="width:100px"
					...
					<% } else { %>
						...
						<td><input disabled="disabled" id="perteExercicesComm"
							name="revenuFullComplex.simpleRevenuContribuable.perteExercicesComm" type="text"
							data-g-amount=" "
							style="width:100px"
				...
				<tr>
					...
					<%if (!isOldRevenu) { %>
						...
						<td><input disabled="disabled" id="perteActAccInd"
							name="revenuFullComplex.simpleRevenuContribuable.perteActAccInd" type="text" 
							data-g-amount=" "
							style="width:100px"
					...
					<td><input disabled="disabled" id="revenuIndepEpouse"
						name="revenuFullComplex.simpleRevenuContribuable.revenuActIndepEpouse" type="text"
						data-g-amount=" "
						style="width:100px"
						value="<%=viewBean.getRevenuFullComplex().getSimpleRevenuContribuable().getRevenuActIndepEpouse()%>" />
					</td>
				...
				<tr>
					...
					<td><input disabled="disabled" id="perteCommercial"
						name="revenuFullComplex.simpleRevenuContribuable.perteCommercial" type="text"
						data-g-amount=" "
						style="width:100px"
					...
					<td><input disabled="disabled" id="revenuActAgricole"
						name="revenuFullComplex.simpleRevenuContribuable.revenuActAgricole" type="text"
						data-g-amount=" "
						style="width:100px"
						value="<%=viewBean.getRevenuFullComplex().getSimpleRevenuContribuable().getRevenuActAgricole()%>" />
					</td>
				...
				<tr>
					...
					<%if (!isOldRevenu) { %>
						...
						<td><input disabled="disabled" id="perteLiquidation"
							name="revenuFullComplex.simpleRevenuContribuable.perteLiquidation" type="text" 
							data-g-amount=" "
							style="width:100px"
					...
					<td><input disabled="disabled" id="revenuActAgricoleEpouse"
						name="revenuFullComplex.simpleRevenuContribuable.revenuActAgricoleEpouse" type="text"
						data-g-amount=" "
						style="width:100px"
						value="<%=viewBean.getRevenuFullComplex().getSimpleRevenuContribuable().getRevenuActAgricoleEpouse()%>" />
					</td>
				...
				<tr>
					...
					<td><input disabled="disabled" id="deducAppEtu"
						name="revenuFullComplex.simpleRevenuContribuable.deducAppEtu" type="text" 
						data-g-amount=" "
						style="width:100px"
				...
				<tr>
					...
					<td><input disabled="disabled" id="deducCouplesMaries"
						name="revenuFullComplex.simpleRevenuContribuable.deductionCouplesMaries" type="text" 
						data-g-amount=" "
						style="width:100px"
				...
				<tr>
					...
					<td><input disabled="disabled" id="excedDepPropImmoPriv"
						name="revenuFullComplex.simpleRevenuContribuable.excedDepPropImmoPriv" type="text"
						data-g-amount=" "
						style="width:100px"
					...
					<td><input disabled="disabled" id="revenuImposable"
						name="revenuFullComplex.simpleRevenuContribuable.revenuImposable" type="text" 
						data-g-amount=" "
						style="width:100px"
				...
				<tr>
					...
					<td><input disabled="disabled" id="revenuTaux"
						name="revenuFullComplex.simpleRevenuContribuable.revenuTaux" type="text" 
						data-g-amount=" "
						style="width:100px"
				...
				<tr>
					...
					<td><input disabled="disabled" id="fortuneTaux"
						name="revenuFullComplex.simpleRevenuContribuable.fortuneTaux" type="text" 
						data-g-amount=" "
						style="width:100px"
