...
idEcran="CCP1017";
globaz.phenix.db.communications.CPCommunicationFiscaleRetourVDViewBean viewBean = (globaz.phenix.db.communications.CPCommunicationFiscaleRetourVDViewBean)session.getAttribute ("viewBean");
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	 	...
	 	<TR>
           <TD nowrap width="180">N° Caisse</TD>
            <TD nowrap >
 	        ...
 	        <TD width="10"></TD>
 	        <TD nowrap width="140">Nom, Prénom reçu</TD>
           <TD nowrap >
 	    ...
 	    <TR>
           <TD nowrap width="180">N° Demande</TD>
            <TD nowrap >
 	        ...
 	        <TD width="10"></TD>
 	        <TD nowrap width="140">NSS reçu</TD>
           <TD nowrap >
        ...
        <TR>
 	    ...
 	    <TR>
            <TD nowrap width="140">Début Période</TD>
       	...
       	<TR>
            <TD nowrap width="140">Numéro localité</TD>
       	...
       	<TR>
            <TD nowrap width="140">Début Assujetissement</TD>
       	...
       	<TR>
            ...
            <TD></TD>
            <TD nowrap>Date Déterminante Capital Investi</TD>
       	...
       	<TR>
            <TD nowrap width="140">Revenu Activité Indépendante</TD>
       	...
       	<TR>
            ...
            <TD></TD>
            <TD nowrap>Date Déterminante Fortune</TD>
       	...
       	<TR>
            <TD nowrap width="140">Revenu Activités Lucratives</TD>
