...
<%
	...
	selectedIdValue = "";
	userActionValue = "phenix.communications.journalRetour.executerGenererEnMasse";
	subTableWidth = "75%";
...
top.document.title = "Communications fiscales - Générer en masse"
</SCRIPT>
<%-- /tpl:put --%>
...
<%-- tpl:put name="zoneTitle" --%>Générer en masse les décisions <%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%> 

		  <TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Ce programme génére les décisions selon les données fiscales.</TD>
          </TR>
          <TR>
...
<!------------------------------------------------------------------------------
	Permet de stocker la liste des id des journaux a généré
------------------------------------------------------------------------------->	
