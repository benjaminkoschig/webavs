...
<%
	...
	userActionValue = "phenix.communications.apercuCommunicationFiscaleRetour.genererEnMasse";
...
<%-- tpl:put name="zoneTitle" --%>Génération des communications en retour<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%> 

<TR>
	<TD colspan="2"><b><u><%=viewBean.getListIdRetour() == null ? "0" : ""+viewBean.getListIdRetour().length%></u> communications fiscales en retour vont être générées </b></TD>
</TR>
<TR>
