...
top.document.title = "Communications fiscales - Abandon en masse"
</SCRIPT>
<%-- /tpl:put --%>
...
<%-- tpl:put name="zoneTitle" --%>Abandon des communications fiscales en retour<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%> 

		<TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Ce programme permet d'abandonner, selon la sélection choisie, les communications en retour.</TD>
          </TR>
          <TR>
