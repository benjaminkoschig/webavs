...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste des concordances Cot.Pers. - CI<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
         <tr>
            <TD width="300">Année de la décision</TD>
            <TD>
         ...
         <tr> 
            <TD width="300" height="20">N° affilié de départ</TD>
             <td>
	           	<ct:FWPopupList 
	           		name="fromNoAffilie" 
          ...
          <tr> 
            <TD width="300">N° affilié de fin</TD>
            <td>
            <ct:FWPopupList 
	           		name="tillNoAffilie" 
          ...
          <tr>
            <TD width="300">Différence admise</TD>
            <TD> 
      	 ...
      	 <TR>
            <TD width="300">Adresse E-Mail</TD>
