...
<%-- tpl:insert page="/theme/process.jtpl" --%><%@page import="globaz.musca.application.FAApplication"%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Création des acomptes<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <tr>
             <TD width="50%" height="20">Année</TD>
            <TD width="50%">
              <INPUT type="text" name="forAnneeReprise" maxlength="4" data-g-string="mandatory:true" size="4">
            </TD>
          </tr>
          <tr>
		...
		/>
          ...
          <tr>
          <TD nowrap width="150" height="20">P&eacute;riodicit&eacute;</TD>
		   <TD nowrap>
				<ct:FWCodeSelectTag 
		    		name="forPeriodicite" 
					defaut=""
