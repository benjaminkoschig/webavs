...
<SCRIPT>
// menu 
top.document.title = "Cotisation - Remarque type"
usrAction = "phenix.principale.remarqueType.lister";
servlet = "phenix";
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Remarques types<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
       <TR>
            <TD nowrap width="120">Remarque</TD>
            <TD nowrap colspan="4">
	...
	<TR>
		...
		/> 
	     ...
	     <TD width="50"><INPUT type="hidden" name="colonneSelection" value="<%=request.getParameter("colonneSelection")%>"></TD>
            <TD width="100" nowrap valign="middle" align="center">Type </TD>
            <TD width="184">
