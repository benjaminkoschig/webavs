...
<%-- tpl:insert page="/theme/detail.jtpl" --%><%@page import="globaz.phenix.db.principale.CPDonneesBase"%>
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" id="tPartie1">
        ...
        <TBODY>
          ...
          <TR>
            ...
            <TD nowrap width="184"> pour <INPUT name="nbMoisExercice1" type="text" value="<%=viewBean.getNbMoisExercice1()%>" size="2" maxlength="2"> mois
            </TD>
		<TD nowrap width="24">&nbsp; </TD>
            <TD nowrap width="108"></TD>
          ...
          <TR id="ligneRevenuAutre">
            ...
            <TD nowrap width="184"> pour <INPUT name="nbMoisRevenuAutre1" type="text" value="<%=viewBean.getNbMoisRevenuAutre1()%>" size="2" maxlength="2"> mois
         	 </TD>
            <TD nowrap width="24">&nbsp;</TD>
            <TD nowrap width="108"></TD>
            <TD nowrap width="98"><INPUT name="revenuAutre2" type="text" value="<%=viewBean.getRevenuAutre2()%>" class="montant" style="width : 2.45cm;"> </TD>
            <TD id="nbMoisAutre2" nowrap width="110"> pour <INPUT name="nbMoisRevenuAutre2" type="text" value="<%=viewBean.getNbMoisRevenuAutre2()%>" size="2" maxlength="2"> mois
        	 </TD>
          </TR>
	<TR id="ligneExercice">
	  ...
	  /> &nbsp;au&nbsp; <ct:FWCalendarTag name="finExercice1"
	 ...
	 /> </TD>
		...
		errorMessage="la date de début est incorrecte"
		doClientValidation="CALENDAR"
	  /> au<ct:FWCalendarTag name="finExercice2"
	 ...
	 /> </TD>
		...
		doClientValidation="CALENDAR,NOT_EMPTY"
	  	/></TD>
            ...
            <TD nowrap height="31" colspan="2"></TD>
					...
					<TR>
						<TD nowrap width="157">Fortune totale</TD>
      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" id="tPartie2">
           <TBODY>
          <TR>
            <TD nowrap width="200">Biens immobliers</TD>
            <TD nowrap width="150" align="center">Valeur</TD>
            <TD nowrap width="50"></TD>
            <TD nowrap align="left" width="165">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Canton</TD>
            <TD nowrap width="46"></TD>
            <TD nowrap align="left" width="196">&nbsp;&nbsp;Type de terrain</TD>
          </TR>
	   <TR>
           <TD nowrap>&nbsp;</TD>
	 ...
	 <TR>
	  ...
	  <TR>
            ...
            <TD nowrap width="280"></TD>
            <TD nowrap width="25"></TD>
            <TD id="titreCotSalarie" nowrap width="108">Cotisation sur salaire</TD>
	...
	<TR>
            <TD nowrap width="200"></TD>
            <TD nowrap width="150" align="center">Fortune totale</TD>
            <TD nowrap width="50"></TD>
            <TD nowrap align="center" width="165">Fortune déterminante</TD>
            <TD nowrap width="46"></TD>
