...
<%-- tpl:insert page="/theme/detail.jtpl" --%><%@page import="globaz.phenix.db.communications.CPSedexConjoint"%>
...
bButtonDelete = false;
idEcran="CCP1017";
CPSedexConjoint viewBean = (CPSedexConjoint)session.getAttribute ("viewBean");
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<ul>
  			...
  			<li><a class="selected">Ehepartner</a></li>
		...
		<TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_VN", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_PERSONIDCATEGORY", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_PERSONID", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_OFFICIALNAME", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_FIRSTNAME", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_SEX", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_YEARMONTHDAY", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_STREET", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_HOUSENUMBER", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_TOWN", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_SWISSZIPCODE", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_COUNTRY", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_MARITALSTATUS", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_DATEOFMARITALSTATUS", "DE")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SP_DATEOFENTRY", "DE")%>" type="text" class="libelleLongDisabled" readonly>
