...
bButtonDelete = false;
idEcran="CCP1017";
globaz.phenix.db.communications.CPSedexDonneesCommerciales viewBean = (globaz.phenix.db.communications.CPSedexDonneesCommerciales)session.getAttribute ("viewBean");
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<TR style="font-size : 14px;">
		  ...
		  <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("COMMENCEMENTOFSELFEMPLOYMENT", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
		  ...
		  <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("ENDOFSELFEMPLOYMENT", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	      ...
	      <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("MAININCOME", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	   ...
	   <TR>
        ...
        <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("MAININCOMEINREALESTATETRADE", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	      ...
	      <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("PARTTIMEEMPLOYMENT", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("PARTTIMEEMPLOYMENTINAGRICULTURE", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("PARTTIMEEMPLOYMENTINREALESTATETRADE", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("REALISATIONPROFIT", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("COOPERATIVESHARES", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	    ...
	    <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("SECURITIESINCOME", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("OTHERINCOME", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	    ...
	    <TR>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("INCOMEREALESTATE", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	      ...
	      <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("DEBTINTEREST", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
       ...
       <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("DONATIONS", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
	    ...
	    <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("TOTALASSETS", "DE")%>" type="text" class="libelleLongDisabled" readonly>
            </TD>
	     	<TD>
