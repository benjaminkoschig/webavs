...
<%@ include file="/theme/list/javascripts.jspf" %>
	    ...
	    <th width="20">&nbsp;</th>
	    <TH width="*" align="center">Journal-Nr.</TH>
      	<TH width="*" align="center">Jahr</TH>
      	<TH width="*" align="center">Mitglied-Nr.</TH>
      	<TH width="*" align="center">Name</TH>
      	<th  width="*" align="center"> Extraktion</th>
		<th  width="*" align="center">Einschätzung</th>
		<th  width="*">Einkommen oder Rente</th>
		<%if(((globaz.phenix.application.CPApplication) viewBean.getSession().getApplication()).isRevenuAgricole()) {%>
			<th  width="*" align="center"><%=viewBean.getSession().getApplication().getLabel("REVENU_AGRICOLE", "DE")%></th>
		<%}else{ %>
			<th  width="*" align="center"><%=viewBean.getSession().getApplication().getLabel("REVENU_AUTRE", "DE")%></th>
		<%}%>
