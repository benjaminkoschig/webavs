...
<%-- tpl:put name="zoneTitle" --%>Zurücksetzung der Steuermeldungen zurück<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%> 

<TR>
	<TD colspan="2"><b><u><%=viewBean.getListIdRetour() == null ? "0" : ""+viewBean.getListIdRetour().length%></u> Steuermeldungen zurück werden zurückgesetzt </b></TD>
</TR>
<TR>
