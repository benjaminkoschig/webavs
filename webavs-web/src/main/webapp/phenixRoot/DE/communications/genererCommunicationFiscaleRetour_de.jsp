...
<%-- tpl:put name="zoneTitle" --%>Generierung der Steuermeldungen zurück<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%> 

<TR>
	<TD colspan="2"><b><u><%=viewBean.getListIdRetour() == null ? "0" : ""+viewBean.getListIdRetour().length%></u> Steuermeldungen zurück werden generiert </b></TD>
</TR>
<TR>
