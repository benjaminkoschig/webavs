...
<SCRIPT>
// menu 
top.document.title = "Beiträge - Verfügung"
...
<span class="postItIcon"><ct:FWNote sourceId="<%=viewBean.getIdTiers()%>" tableSource="globaz.phenix.db.principale.CPEnteteViewBean"/></span>Verfügung persönliche Beiträge<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
	...
	<TD width="10"></TD>
            ...
            <TD nowrap width="128">
            	...
            	%>
            		<ct:ifhasright element="osiris.comptes.apercuComptes.afficher" crud="r">
             		<A href="<%=request.getContextPath()%>\osiris?userAction=osiris.comptes.apercuComptes.afficher&idCompteAnnexe=<%=idCompteAnnexe%>" class="external_link">Abrechnungskonto</A>
             		</ct:ifhasright>
            	<%
           		if(viewBean.getIrrecouvrable().equals(Boolean.TRUE)){
            	%>
             		<IMG title="Uneinbringlich" src="<%=request.getContextPath()%>/images/avertissement.gif" border="0">
           		<%
           		}}
           		%>	 
            </TD>
		...
		<TD nowrap width="128">
			...
			<A href="<%=request.getContextPath()%>\naos?userAction=naos.affiliation.chercher&idTiers=<%=viewBean.getIdTiers()%>" class="external_link">Erfassung</A>
			</ct:ifhasright>
		</TD>
            <TD nowrap colspan="2">
	...
	<TD width="10"></TD>
            ...
            <TD nowrap width="128">
            	...
            	<ct:ifhasright element="pavo.compte.ecriture.chercherEcriture" crud="r">
             	<A href="<%=request.getContextPath()%>\pavo?userAction=pavo.compte.ecriture.chercherEcriture&compteIndividuelId=<%=viewBean.getIdCompteIndividuel()%>" class="external_link">IK</A>
             	</ct:ifhasright>
           		<%
           		}
           		%>
		  ...
		  <tr>
		  	...
		  	<ct:ifhasright element="phenix.communications.communicationFiscaleAffichage.chercher" crud="r">
             		<A href="<%=request.getContextPath()%>\phenix?userAction=phenix.communications.communicationFiscaleAffichage.chercher&likeNumAffilie=<%=viewBean.getAffiliation().getAffilieNumero()%>" class="external_link">Verwaltung Anfragen Steuermeldungen</A>
             	</ct:ifhasright>
             	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
