...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Erlassung<%-- /tpl:put --%>
	...
	<!-- Entete -->
	  ...
	  <TR>
	   <TD nowrap  height="11" colspan="5"> 
          ...
          <TR>
            <TD nowrap width="157">Verfügung für</TD>
            <TD nowrap width="244"> 
          ...
          <TR>
            ...
            <TD nowrap width="25"></TD>
            <TD nowrap width="110">Verknüpfte Steuerpflichtiger-Nr.</TD>
	 ...
	 /> </TD>
	   ...
	   <TR> 
		  ...
		  <TR>
            <TD nowrap width="157">Beitrag</TD>
          ...
          <TR>
            <TD nowrap width="157">Bettrofene Gemeinde</TD>
