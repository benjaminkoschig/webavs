...
top.document.title = "Beitrag - Verfügung Selbständigerwerber"
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
         		...
         		<TABLE border="0" cellspacing="0" cellpadding="0" width="<%=subTableWidth%>">
          			...
          			<TR>
            			<TD nowrap width="157">Verfügungsart</TD>
            			<TD nowrap width="244">
            			...
            			<TD nowrap width="25"></TD>
            			<TD nowrap width="110">Verantwortlicher</TD>
            			<TD nowrap width="171">
          			...
          			<TR>
            			<TD nowrap width="157">Verfügungstyp</TD>
			            ...
			            <TD nowrap width="25"></TD>
			            <TD nowrap width="110">DBG-Nr. Gesellschafter</TD>
	    			...
	    			<TR>
            			...
            			<TD nowrap colspan="4"><INPUT type="text" name="selectionCjt" value="<%=viewBean.getSelectionCjt()%>" class="numeroId" style="color : purple;">
							...
							<input type="checkbox" name="division2" <%=(viewBean.getDivision2().booleanValue())? "checked" : "unchecked"%>> (Ehepartner simulieren)</TD>
          			</TR>
	   				<TR>
			            <TD nowrap width="157">Verfügungsjahr</TD>
		   		...
		   		<%} else {%>
		   		  ...
		   		  <%}%>
          			...
          			<TR>
			            ...
			            <TD nowrap width="25"></TD>
			            <TD nowrap width="110">Hinweis am</TD>
			            <TD nowrap width="171">
           			...
           			<TR>
			             <TD nowrap height="31" width="110">Totalperiode</TD>
	            		<TD nowrap height="31">
      ...
      <!-- Page 1 -->
        ...
        <!--<COL span="1" width="100">-->
          			...
          			<TR>
			            <TD nowrap width="157">Einkommen</TD>
		      		...
		      		%>
			            <TD nowrap width="157"><%=viewBean.getSession().getApplication().getLabel("REVENU_AGRICOLE", "DE")%></TD>
			        <% } else { %>
						<TD nowrap width="157"><%=viewBean.getSession().getApplication().getLabel("REVENU_AUTRE", "DE")%></TD>
			        <% } %>
           			...
           			<TR>
			            <TD nowrap width="157">Beiträge</TD>
			            ...
			            <%
		      			...
		      			%>
			            	<TD nowrap colspan="5">&nbsp;<%=viewBean.getSession().getApplication().getLabel(
                                "CP_COTISATION_CALCULEE_AUTO", "DE") %></TD>
			            <% } else { %>
			             	<TD nowrap width="184"></TD>
				          	<TD nowrap width="24">&nbsp; </TD>
				            <TD nowrap width="108"></TD>
					...
					<TR>
						<TD nowrap width="157">Investiertes Eigenkapital</TD>
						<TD nowrap height="31" colspan="2">
      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" id="tPartie6">
          ...
          <TR>
          	<TD nowrap>Massgebendes Einkommen</TD>
          	<TD nowrap width="150">
      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" id="tPartie5" style="display:none">
			<TR>
	            ...
	            <TD nowrap height="31" width="110">Verfügungs-Nr.</TD>
       ...
       <!--     <TD nowrap height="31" width="110">Valeur à 0 ?</TD>
	       ...
	       <!-- <TD nowrap height="31" width="110">Suspend</TD>
         	...
         	<TR>
	            <TD nowrap width="157" height="14">Tätigkeitsbeginn</TD>
	            ...
	            <TD nowrap height="31" width="25"></TD>
	            <TD nowrap width="110" height="31">Erste Versicherung</TD>
	   		...
	   		<TR>
	            ...
	            <TD nowrap height="31"><input type="checkbox" name="cotiMinimumPayeEnSalarie" <%=(viewBean.getCotiMinimumPayeEnSalarie().booleanValue())? "checked" : "unchecked"%>>
	             &nbsp;(Minimaler Beitrag, der als Arbeitnehmer bezahlt ist)</TD>
	      	</TR>
          	<TR>
	            <TD nowrap width="157" height="14">Beschwerde</TD>
	            <TD nowrap height="31" width="259"><input type="checkbox" name="recours" <%=(viewBean.getRecours().booleanValue())? "checked" : "unchecked"%>></TD>
	            <TD nowrap height="31" width="25"></TD>
	            <TD nowrap width="110" height="31">Einschreiben</TD>
