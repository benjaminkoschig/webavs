...
<span class="postItIcon"><ct:FWNote sourceId="<%=viewBean.getIdDecision()%>" tableSource="globaz.phenix.db.principale.CPDecisionViewBean"/></span>Anrechnung - Detail<%-- /tpl:put --%>			

<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
	<!-- Entete -->
          <TR>
            <TD nowrap width="157" height="10">Versicherter</TD>
            <TD nowrap width="150"> 
	  ...
	  <TR>
	   ...
	   <TR> 
          ...
          <TR>
            ...
            <TD nowrap width="110" height="31">Fakturierung</TD>
       ...
       <TR>
         ...
         <TR>
            <TD nowrap height="31" width="110">Annulliert und ersetzt</TD>
            <TD nowrap height="31">
            	<INPUT type="checkbox" name="complementaire" <%=(viewBean.getComplementaire().booleanValue())? "checked" : "unchecked"%>>
			</TD>
            <TD nowrap width="24">&nbsp; </TD>
	        <TD nowrap height="31" width="110">Ausdrucken</TD>
