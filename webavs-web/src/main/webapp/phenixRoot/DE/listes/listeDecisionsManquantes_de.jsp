...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste der fehlenden Verfügungen<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
         <tr>
            <TD>von</TD>
            <TD> 
              <INPUT type="text" name="fromAnneeDecision" maxlength="4" size="4" data-g-string="mandatory:true" onkeypress="return filterCharForInteger(window.event);">
            </TD>
            <TD>bis</TD>
            <TD> 
         ...
         <TR> 
            <TD>Verfügungen im berechneten Zustand einschliessen</TD>
