...
<%
	idEcran="PRF0013";
	//Les labels de cette page commence par le préfix "JSP_RF_S_AUG_R_"
	
	
	actionNew =  servletContext + mainServletPath + "?userAction=" + IRFActions.ACTION_SAISIE_QD_AUGMENTATION + 
...
<SCRIPT language="JavaScript">
	...
	usrAction = "<%=IRFActions.ACTION_SAISIE_QD_AUGMENTATION%>.lister";

</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/capage/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_RF_S_AUG_R_TITRE"/><%-- /tpl:put --%>
<%@ include file="/theme/capage/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<TR>
							<TD><ct:FWLabel key="JSP_RF_S_AUG_R_QD_NO"/></TD>
							<TD>
								<span>
									<b>
