...
<%@page import="globaz.cygnus.vb.process.RFImporterFinancementSoinViewBean"%>
<%@page import="globaz.cygnus.application.RFApplication"%>
<%-- tpl:put name="zoneInit" --%>
<%
	idEcran="PRF0061";
	RFImporterFinancementSoinViewBean viewBean = (RFImporterFinancementSoinViewBean) session.getAttribute("viewBean");
	
	userActionValue=IRFActions.ACTION_IMPORTER_FINANCEMENT_SOIN + ".executer";
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_RF_IMPORT_FINANCEMENT_SOIN_TITRE"/> <%-- /tpl:put --%>
