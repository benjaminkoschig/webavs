...
<%@page import="globaz.cygnus.vb.process.RFImportationTmrViewBean"%>
...
<%
	RFImportationTmrViewBean viewBean = (RFImportationTmrViewBean) session.getAttribute("viewBean");
...
function validate() {
	...
	if($("#FILE_PATH_FOR_POPULATION").val()== ""){
		...
		alert("<ct:FWLabel key="JSP_RF_IMPORT_TMR_ERREUR_IMPORT"/>");
...
<div id="properties" >
	<div>
		<label><ct:FWLabel key="JSP_RF_IMPORT_TMR_FILE"/></label>
		<span>
