...
<script language="JavaScript">
	...
	function postInit(){
		...
		$('[name="dateFinTraitement"]').change(function() {
			demandeUtils.onChangeMontantMensuel();
		});
		
		$('[name="montantMensuel"]').change(function() {
			demandeUtils.onChangeMontantMensuel();
		});
		
		$('[name="dateDebutTraitement"]').change(function() {
			demandeUtils.onChangeMontantMensuel();
		});
...
<%-- tpl:put name="zoneMain" --%>
				...
				<TR style="vertical-align:top" >
					...
					<TD colspan="5">
						...
						<INPUT type="hidden" id="typeDemande" name="typeDemande" value="<%=RFSaisieDemandeAbstractViewBean.TYPE_DEMANDE_DEFAUT%>" />
				...
				<TR>
					...
					<TD>
						<input data-g-calendar="type:month"  name="dateDebutTraitement" value="<%=viewBean.getDateDebutTraitement()%>"/>
					</TD>
					
					
					<TD><ct:FWLabel key="JSP_RF_DEM_S_DATE_FIN_TRAITEMENT"/></TD>
					<TD colspan="3">
						<input data-g-calendar="type:month"  name="dateFinTraitement" value="<%=viewBean.getDateFinTraitement()%>"/>
					</TD>
				</TR>
                ...
                <TR class="trContainerAdresse">
                	<TD>
                		<ct:FWLabel key="JSP_RF_DEM_S_MONTANT_FACTURE_MENSUEL"/>
                	</TD>
 	            	<TD>
                		<INPUT type="text" name="montantMensuel" value="<%=viewBean.getMontantMensuel()%>" class="montant" onkeypress="return filterCharForFloat(window.event);"/>
                	</TD>
 	              	<TD  align="right">
				...
				<TR>
					<TD width="200px"><ct:FWLabel key="JSP_RF_DEM_S_MONTANT_PERIODE_DE_TRAITEMENT"/></TD>
					<TD>
				...
				<TR>
					<TD width="200px"><ct:FWLabel key="JSP_RF_DEM_S_MONTANT_PERIODE_DE_TRAITEMENT_A_PAYER"/></TD>
