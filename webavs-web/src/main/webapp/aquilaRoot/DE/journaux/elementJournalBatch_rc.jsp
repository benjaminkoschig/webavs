...
top.document.title = "Kontis - Suche der Bestandteile - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Suche der Bestandteile<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
				
			<TR>
			<TD nowrap width="70">Betreibung-Nr.</TD>
            ...
            <TD nowrap align="right">Bestandteile
                <SELECT name="forCsEtat" class="libelleCourt">
                <option value="" selected>Alle</option>
                <option value="<%=COElementJournalBatchViewBean.OUVERT%>">Offene</option>
                <option value="<%=COElementJournalBatchViewBean.TRAITE%>">Behandelte</option>
                <option value="<%=COElementJournalBatchViewBean.ERREUR%>">Fehlerhafte</option>
                <option value="<%=COElementJournalBatchViewBean.INACTIF%>">Inaktive</option>
              	</SELECT>
