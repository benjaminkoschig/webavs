...
function del() {
  if (window.confirm("Vous êtes sur le point de supprimer l'élément sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Elément du journal - " + top.location.href;
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
      <%-- tpl:put name="zoneTitle" --%>Elément du journal<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
         ...
         <TR>
           ...
           <TR>
           <TD width="125" valign="top">Compte</TD>
           <TD width="30">&nbsp;</TD>
           <TD>
           ...
           <TR>
           <TD width="125" valign="top">Section</TD>
           <TD width="30">&nbsp;</TD>
           <TD>
           <%
           ...
           <%
             ...
             %>
               ...
               <TR>
        <TD width="125">Montant créance</TD>
            <TD width="30">&nbsp;</TD>
            <TD>
            <%
            ...
            %>
              ...
              <input type="text" class="montantShortDisabled" name="montantCreance" value="<%=globaz.globall.util.JANumberFormatter.fmt(tmpMontant,true,true,false,2)%>" readonly="true" disabled="true"/>
               ...
               <TR>
        <TD width="125">Date début intérêt</TD>
            <TD width="30">&nbsp;</TD>
            <TD>
            <%
            	String dateDebut = "";
        ...
        <TD width="125">Montant taxe</TD>
           ...
           <TR>
           <TD width="125" valign="top">Erreurs</TD>
           <TD width="30">&nbsp;</TD>
           <TD>
           ...
           &nbsp;
           <A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&selectedId=<%=viewBean.getContentieux().getCompteAnnexe().getTiers().getIdTiers()%>" class="external_link">Tiers</A>
           &nbsp;
           <A href="<%=request.getContextPath()%>\osiris?userAction=osiris.comptes.apercuComptes.afficher&selectedId=<%=viewBean.getContentieux().getCompteAnnexe().getIdCompteAnnexe()%>" class="external_link">Compte</A>
           &nbsp;
           <A href="<%=request.getContextPath()%>\osiris?userAction=osiris.comptes.apercuParSection.afficher&id=<%=viewBean.getContentieux().getSection().getIdSection()%>" class="external_link">Section</A>
           </TD>
           </TR>
          <%-- /tpl:put --%>
