...
<TR>
	<TD>
		<TABLE>
			...
			<TR>
				<TD class="label">Exécuter l'étape</TD>
		...
		if (transitionViewBean.getInteretCalcule() != null && transitionViewBean.getInteretCalcule().size()!=0){%>
			<tr>
				<td colspan="8"><h5>Intérêts moratoires calculés</h5></td>
			</tr>
			<tr>
				<th>Rubrique</th>
				<th>Montant</th>
		...
		<%}%>
			...
			<tr>
				<td colspan="8"><h5>Frais et intérêts</h5></td>
			</tr>
			<tr><td colspan="8">
