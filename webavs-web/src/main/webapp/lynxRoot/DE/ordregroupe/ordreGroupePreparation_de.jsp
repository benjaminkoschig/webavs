...
<%
	idEcran="GLX0027";
	LXOrdreGroupePreparationViewBean viewBean = (LXOrdreGroupePreparationViewBean) session.getAttribute ("viewBean");
	userActionValue = "lynx.ordregroupe.ordreGroupePreparation.executer";
...
<%-- tpl:put name="zoneTitle" --%>Sammelauftrag vorbereiten<%-- /tpl:put --%>
