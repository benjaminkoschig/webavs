...
top.document.title = "Suche der Kanevas  - " + top.location.href;
// stop hiding -->
</SCRIPT>

<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
<%-- tpl:put name="zoneTitle" --%>Suche der Kanevas<%-- /tpl:put --%>
...
<ct:ifhasright element="lynx.canevas.canevas.afficher" crud="u">
	<INPUT type="button" name="btnNewCanevasBvrRouge" value="Roter ESR" onClick="document.location.href='<%=actionNewCanevasBvrRouge%>'" tabindex="1"/>
	<INPUT type="button" name="btnNewCanevasVirement" value="Überweisung" onClick="document.location.href='<%=actionNewCanevasVirement%>'" tabindex="1"/>
	<INPUT type="button" name="btnNewCanevasLSV" value=" LSV " onClick="document.location.href='<%=actionNewCanevasLsv%>'" tabindex="1"/>
	<INPUT type="button" name="btnNewCanevasCaisse" value="Kasse" onClick="document.location.href='<%=actionNewCanevasCaisse%>'" tabindex="1"/>
</ct:ifhasright>	
<%-- /tpl:put --%>
