...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer la note de crédit liée sélectionnée! Voulez-vous continuer?")) {
...
top.document.title = "Détail d'une note de crédit liée - " + top.location.href;
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
<%-- tpl:put name="zoneTitle" --%>D&eacute;tail d'une note de cr&eacute;dit li&eacute;e<%-- /tpl:put --%>
...
<%-- tpl:put name="zoneMain" --%>
		...
		<TR>
			<TD width="255">Etat facture liée</TD>
			<%
				String etatAdd = "";
