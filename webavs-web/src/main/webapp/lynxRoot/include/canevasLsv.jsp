<table border="0" cellspacing="4" class="canevasLsv">
<tr>
	<td  height="65" width="250">
		<fieldset class="fieldSetVirement">
		<legend><%= viewBean.getSession().getLabel("INCLUDE_BENEFICIAIRE") %></legend>
		&nbsp;</BR>
		<%= viewBean.getSession().getLabel("INCLUDE_NOM") %> : &nbsp;<textarea name="adressePaiementFournisseur" style="width:240px;height:85px" class="libelleLsvDisabled" readonly="readonly"><%=showValue?viewBean.getAdressePaiementFournisseur():""%></textarea>&nbsp;&nbsp;&nbsp;</br>
		<%	
		...
		<script language="JavaScript">
			element = document.getElementById("idExterneFournisseur");
		  	...
		  	document.getElementById("idExterneFournisseur").style.width = '219px';
		</script>	
		</fieldset>
	</td >
...
<tr>
	...
	<td colspan="2">
		<fieldset class="fieldSetVirement" style="height:155px;">
			...
			&nbsp;</BR>
			<textarea name="libelleSociete" style="width:320px;height:100px" class="libelleLsvDisabled" readonly="readonly"><%=viewBean.getSocieteAdresse()%></textarea>&nbsp;&nbsp;&nbsp;</br>
			...
			<script language="JavaScript">
				document.getElementById("idExterneSociete").style.width = '299px';
			</script>
		</fieldset>
	</td>	
</tr>	
