...
<%// Les labels de cette page commence par la préfix "JSP_PC_PARAM_ZONE_LOCALITE_D"
	idEcran="PPC0118";
	PCZoneLocaliteLoyerViewBean viewBean = (PCZoneLocaliteLoyerViewBean) session.getAttribute("viewBean");
...
<script type="text/javascript">
  var url = "<%=IPCActions.ACTION_PARAMETRES_ZONE_LOCALITE_LOYER%>";
...
<td>
	...
	<div id="main" class="formTableLess"> 
		<div>
			...
			<ct:select name="zoneLocalite.simpleLienZoneLocalite.idZoneForfait" notation="data-g-select='mandatory:true'">
		...
		<div>
			<label for="zoneLocalite.simpleLienZoneLocalite.pourcentage">
				<ct:FWLabel key="JSP_PC_PARAM_ZONE_LOCALITE_POURCENTAGE" />
			</label>
			<span class='td'>
				<ct:inputText name="zoneLocalite.simpleLienZoneLocalite.pourcentage"
							  defaultValue="<%=viewBean.getZoneLocalite().getSimpleLienZoneLocalite().getPourcentage()%>"
							  id="zoneLocalite.simpleLienZoneLocalite.pourcentage"
