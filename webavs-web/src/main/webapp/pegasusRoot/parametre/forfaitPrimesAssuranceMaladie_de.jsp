    ...
    <td>
        <div id="main" class="formTableLess">
            <div class="formTableLess">
                ...
                <label id="lbldatefin" for="forfaitPrimesAssuranceMaladie.simpleForfaitPrimesAssuranceMaladie.dateFin"
                ...
                <label for="forfaitPrimesAssuranceMaladie.simpleForfaitPrimesAssuranceMaladie.montantPrimeMoy" style="width: 280px">
                    <ct:FWLabel key="JSP_PC_PARAM_FORFAIT_PRIME_AM_D_MONTANT_PRIME_MOY"/>
                </label>
                <ct:inputText name="forfaitPrimesAssuranceMaladie.simpleForfaitPrimesAssuranceMaladie.montantPrimeMoy"
                              defaultValue="<%=sfpa.getMontantPrimeMoy()%>"
                              id="forfaitPrimesAssuranceMaladie.simpleForfaitPrimesAssuranceMaladie.montantPrimeMoy"
                              notation="data-g-amount='mandatory:true'"/>

                <br/>

                <label for="forfaitPrimesAssuranceMaladie.simpleForfaitPrimesAssuranceMaladie.montantPrimeReductionMaxCanton" style="width: 280px">
                    <ct:FWLabel key="JSP_PC_PARAM_FORFAIT_PRIME_AM_D_MONTANT_REDUCTION_MAX"/>
                </label>
                <ct:inputText
                        name="forfaitPrimesAssuranceMaladie.simpleForfaitPrimesAssuranceMaladie.montantPrimeReductionMaxCanton"
                        defaultValue="<%=sfpa.getMontantPrimeReductionMaxCanton()%>"
                        id="forfaitPrimesAssuranceMaladie.simpleForfaitPrimesAssuranceMaladie.montantPrimeReductionMaxCanton"
