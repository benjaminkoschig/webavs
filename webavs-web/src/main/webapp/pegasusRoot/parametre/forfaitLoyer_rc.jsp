...
<script language="JavaScript">
	...
	var usrAction = "<%=IPCActions.ACTION_PARAMETRES_FORFAIT_LOYER + ".lister" %>";
</script>
		...
		<td>
			<div class="formTableLess">
				...
				<label for="forfaitPrimesAssuranceMaladieSearch.forCsTypePrime">
					<ct:FWLabel key="JSP_PC_PARAM_FORFAIT_PRIME_AM_R_TYPE_DE_LOGEMENT"/>
				</label>
				...
				<ct:select name="forfaitPrimesAssuranceMaladieSearch.forIdZoneForfaits"
						   wantBlank="true"
