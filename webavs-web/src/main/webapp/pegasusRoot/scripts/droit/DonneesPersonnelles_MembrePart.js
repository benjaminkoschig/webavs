function DonneesPersonnellesPart(container) {
    ...
    this.onRetrieve = function ($data) {
        this.mainContainer
            ...
            .find('.isMembreCongregation').attr('checked', $data.find('isMembreCongregation').text() == 'true').end();
    ...
    this.getParametres = function () {
        return {
            ...
            "donneesPersonnelles.simpleDonneesPersonnelles.isMembreCongregation": this.mainContainer.find('.isMembreCongregation').prop('checked'),
    ...
    this.ajaxLoadVB = function () {
        ...
        $.ajax({
            data: {
                "userAction": this.ACTION_AJAX + ".afficherAJAX",
