...
<%
	...
	PCSubsideAssuranceMaladieViewBean viewBean = (PCSubsideAssuranceMaladieViewBean) session.getAttribute("viewBean");
...
<%@ page import="globaz.pegasus.vb.assurancemaladie.PCSubsideAssuranceMaladieViewBean" %>
...
<script language="JavaScript">
	...
	var ACTION_AJAX="<%=IPCActions.ACTION_DROIT_SUBSIDE_RETRO_ACCORDE_AJAX%>";
	$(function(){
		$('.cacher').hide();
	});
...
<script type="text/javascript" src="<%=servletContext%><%=(mainServletPath+"Root")%>/scripts/assurancemaladie/SubsideAssuranceMaladie_MembrePart.js"></script>
<script type="text/javascript" src="<%=servletContext%><%=(mainServletPath+"Root")%>/scripts/assurancemaladie/saisieSubsideAssuranceMaladie_de.js"></script>
			...
			<div class="conteneurMembres">
				...
				<div class="areaMembre" idMembre="<%=membreFamille.getId()%>">
					...
					<table class="areaDFDataTable"  width="100%">
						...
						<%
							...
							for(Iterator itDonnee=viewBean.getDonnees(membreFamille.getId()).iterator();itDonnee.hasNext();){
								...
								SimpleSubsideAssuranceMaladie donnee=(SimpleSubsideAssuranceMaladie)donneeComplexe.getSimpleSubsideAssuranceMaladie();
					...
					<div class="areaDFDetail">
						...
						<ct:ifhasright element="<%=IPCActions.ACTION_DROIT_SUBSIDE_RETRO_ACCORDE_AJAX%>" crud="cud">
