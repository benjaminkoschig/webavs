 ...
 * @author FGO
 */
public class APGenererDecisionAPATProcess extends BProcess {
    /**
     *
     */
    ...
    private APDroitPaternite droit = null;
     ...
     * Constructeur
     */
    public APGenererDecisionAPATProcess() {
    }
     ...
     * @param parent
     */
    public APGenererDecisionAPATProcess(BProcess parent) {
        super(parent);
    }
     ...
     * @param session
     */
    public APGenererDecisionAPATProcess(BSession session) {
        super(session);
    }
    ...
    protected boolean _executeProcess() throws Exception {
        ...
        APDecisionCommunicationAPAT decisionOriginale = createDecisionOriginale();
        Boolean paramCopie = new Boolean(getSession().getApplication().getProperty(DOC_DEC_APAT_COPIE_ASS));
    ...
    private void chargeDemande() throws Exception {
        try {
            ...
            getMemoryLog().logMessage(e.getMessage(), FWMessage.ERREUR,
                    "APGenererDecisionCommunicationAPATProcess.chargeDemande()");
            abort();
        }
    }
    ...
    private void chargeDroit() throws Exception {
        try {
            ...
            getMemoryLog().logMessage(e.getMessage(), FWMessage.ERREUR,
                    "APGenererDecisionCommunicationAPATProcess.chargeDroit()");
            abort();
        }
    }
    ...
    private void createDecisionCopy() throws FWIException, Exception {
        APDecisionCommunicationAPAT decisionCopy = new APDecisionCommunicationAPAT();
     ...
     * @throws Exception
     */
    private APDecisionCommunicationAPAT createDecisionOriginale() throws FWIException, Exception {
        APDecisionCommunicationAPAT decisionOriginale = new APDecisionCommunicationAPAT();
    ...
    private PRLettreEnTete createLettreEntete(String idTiers) throws FWIException, Exception {
        ...
        lettreEnTete.setDomaineLettreEnTete(PRLettreEnTete.DOMAINE_PAT);
