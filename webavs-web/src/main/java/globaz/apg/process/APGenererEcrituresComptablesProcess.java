...
public class APGenererEcrituresComptablesProcess extends BProcess {
    ...
    private static final String PROP_NATURE_VERSEMENT_PROCHEAIDANT = "nature.versement.procheaidant";
    ...
    private String resolveNatureProprieteOrdreVersement(String genrePrestation) {
        ...
        if (typeLot.equals(IPRDemande.CS_TYPE_MATERNITE)) {
            ...
            return APGenererEcrituresComptablesProcess.PROP_NATURE_VERSEMENT_PATERNITE;
        } else if(typeLot.equals(IPRDemande.CS_TYPE_PROCHE_AIDANT)){
    ...
    private void initRubriques(final BISession sessionOsiris) throws Exception {
        ...
        if (typeLot.equals(IPRDemande.CS_TYPE_MATERNITE)) {
            ...
            SANS_AC_EMPLOYEUR = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_EMPLOYEUR_SANS_AC);

            AVEC_AC_ASSURE = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_AVEC_AC_ASSURE);
            AVEC_AC_INDEPENDANT = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_AVEC_AC_INDEPENDANT);

            SANS_AC_ASSURE = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_SANS_AC_ASSURE);
            SANS_AC_INDEPENDANT = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_SANS_AC_INDEPENDANT);
            ...
            PRESTATION_A_RESTITUER_EMPLOYEUR = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_PRESTATION_A_RESTITUER_EMPLOYEUR);
            PRESTATION_A_RESTITUER_INDEPENDANT = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_PRESTATION_A_RESTITUER_INDEPENDANT);

            COT_AVS_ASSURE = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_COTISATION_AVS_ASSURE);
            COT_AVS_INDEPENDANT = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_COTISATION_AVS_INDEPENDANT);

            COT_AC_ASSURE = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_COTISATION_AC_ASSURE);
            COT_AC_INDEPENDANT = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_COTISATION_AC_INDEPENDANT);

            FONDS_DE_COMPENSATION_ASSURE = referenceRubrique
                    .getRubriqueByCodeReference(APIReferenceRubrique.PATERNITE_FONDS_DE_COMPENSATION_ASSURE);
            FONDS_DE_COMPENSATION_EMPLOYEUR = referenceRubrique
