...
public class APDroitLAPGJointDemandeViewBean extends APDroitLAPGJointDemande implements FWViewBeanInterface {
    ...
    public String getTitreEcran() {
        if(getTypePrestation().equals(TypePrestation.TYPE_PROCHE_AIDANT)) {
            return getSession().getLabel("JSP_TITRE_LISTE_PROCHE_AIDANT");
        }else if(getTypePrestation().equals(TypePrestation.TYPE_PATERNITE)) {
