...
import globaz.apg.db.droits.APRecapitulatifDroitAPG;
 ...
 * @author vre
 */
public class APRecapitulatifDroitAPGViewBean extends APRecapitulatifDroitAPG implements APRecapitulatifDroitViewBean {
    ...
    /**
     * Utilisé dans le cas ou l'on veut recréer une annonce liée à une prestation suite à une reprise de données Affiche
     * le bouton 'Simuler paiement avec BPID'. Par défaut à false
     */
    private boolean afficherBoutonSimulerPmtBPID = false;
