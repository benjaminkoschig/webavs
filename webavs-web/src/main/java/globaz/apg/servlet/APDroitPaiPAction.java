 ...
 * @author vre
 */
public class APDroitPaiPAction extends APAbstractDroitPAction {

    // ~ Constructors
    // ---------------------------------------------------------------------------------------------------

    /**
     * Crée une nouvelle instance de la classe APDroitPaiPAction.
     *
     * @param servlet
     */
    public APDroitPaiPAction(FWServlet servlet) {
        super(servlet);
    }
    ...
    /**
     * @see FWDefaultServletAction#_getDestAjouterSucces(HttpSession,
    ...
    protected String _getDestAjouterSucces(HttpSession session, HttpServletRequest request,
        ...
        APDroitDTO dto = new APDroitDTO(((APDroitPaiPViewBean) viewBean).getDroit());
    ...
    /**
     * @see FWDefaultServletAction#_getDestModifierSucces(HttpSession,
     *      HttpServletRequest, HttpServletResponse,
     *      FWViewBeanInterface)
     */
    @Override
    protected String _getDestModifierSucces(HttpSession session, HttpServletRequest request,
        ...
        return this.getUserActionURL(request, IAPActions.ACTION_ENFANT_PAI, FWAction.ACTION_CHERCHER + "&"
                + APAbstractDroitDTOAction.PARAM_ID_DROIT + "=" + dto.getIdDroit());
    }
    ...
    protected void actionAfficher(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        if (Objects.nonNull(viewBeanAP) && viewBeanAP instanceof APDroitPaiPViewBean && ((APDroitPaiPViewBean)viewBeanAP).getAControler()) {
            try {
                ...
                FWViewBeanInterface viewBean = new APDroitPaiPViewBean();
                ...
                boolean hasWarn = ((APDroitPaiPViewBean) viewBean).hasMessageWarn();
...
//        dto.setNomPrenom(((APDroitPatPViewBean) viewBean).getNomPrenom());
        ...
        APDroitAPGDTO dto = new APDroitAPGDTO(((APDroitPaiPViewBean) viewBean).getDroit());
    ...
    protected void actionAjouter(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        APDroitPaiPViewBean viewBean = new APDroitPaiPViewBean();
        ...
        try {
            ...
            if (viewBean.hasMessagePropError() || viewBean.hasMessageWarn()) {
                ...
                viewBean = (APDroitPaiPViewBean) mainDispatcher.dispatch(viewBean, newAction);
