 ...
 * @author dvh
 */
public class APListePrestationVerseeAction extends APDefaultProcessAction {

    public APListePrestationVerseeAction(FWServlet servlet) {
        super(servlet);
    }
    ...
    protected void actionAfficher(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            ((APListePrestationVerseeViewBean) viewBean).setDisplayGedCheckbox(false);
            if (PRGedUtils.isDocumentInGed(APListePrestationVersee_Doc.NUM_INFOROM,
                    (BSession) mainDispatcher.getSession())) {
                ((APListePrestationVerseeViewBean) viewBean).setDisplayGedCheckbox(true);
            }
