...
public class APRepartitionJointPrestation extends APRepartitionPaiements implements Comparable {
    ...
    /**
     * getter pour l'attribut nb jours de congÈs
     * retourne le nb jour de congÈ de la rÈpartition sinon celui de la prestation
     *
     * @return la valeur courante de l'attribut nb jours congÈs
     */
    ...
    /**
     * getter pour l'attribut nb jours supplÈmentaires
     * retourne le nb jour supplÈmentaires de la rÈpartition sinon celui de la prestation
     *
     * @return la valeur courante de l'attribut nb jours supplÈmentaires
     */
    ...
    /**
     * setter pour l'attribut nb jours congÈs
     *
     * @param nbJoursConges
     *            une nouvelle valeur pour cet attribut
     */
    ...
    /**
     * setter pour l'attribut nb jours supplÈmentaires
     *
     * @param nbJoursSupp
     *            une nouvelle valeur pour cet attribut
     */
