 ...
 * author fha
 */
public class RFDentistesEnvoiFactureMedecinOO extends RFAbstractDocumentOO {

    public static final String FICHIER_MODELE_DOCUMENTS_RFM = "RF_LETTRE_TYPE_DENTISTE_ENVOI_FACTURE_MEDECIN";
    ...
    public void chargerCatalogueTexte() throws Exception {
        ...
        documentHelper.setCsTypeDocument(IRFCatalogueTexte.CS_FACTURE_MEDECIN);
    ...
    public void chargerDonneesEnTete() throws Exception {
        ...
        try {
            ...
            caisseHelper = CaisseHelperFactory.getInstance().getCaisseReportHelperOO(getSession().getApplication(),
                    codeIsoLangue);
            caisseHelper.setTemplateName(RFDentistesEnvoiFactureMedecinOO.FICHIER_MODELE_DOCUMENTS_RFM);
    ...
    public void generationLettre(RFCopieDecisionsValidationData... copie) throws Exception {
        ...
        data.addData("idProcess", "RFDentistesEnvoiFactureMedecinOO");
        ...
        if (null != tiersWrapper) {
            ...
            throw new Exception("Erreur : Pas d'adresse tiers (RFDentistesEnvoiFactureMedecinOO.generationLettre())");
        }
    ...
    public JadePrintDocumentContainer remplir(JadePrintDocumentContainer documentContainer, RFDocumentsProcess process,
        ...
        return super.remplir(documentContainer, process, getIdTiers(),
                IPRConstantesExternes.RFM_LETTRE_TYPE_DENTISTE_ENVOIS_FACTURE_AU_MEDECIN_CONSEIL, isSendToGed);
    }
