...
public class RFMenageDemandeReevaluationCMSOO extends RFAbstractDocumentOO {
    ...
    public void chargerCatalogueTexte() throws Exception {
        ...
        documentHelper.setCsTypeDocument(IRFCatalogueTexte.CS_DEMANDE_REEVALUATION_BESOINS_CMS);
    ...
    public void generationLettre(RFCopieDecisionsValidationData... copie) throws Exception {
        ...
        // Chargement template
        data.addData("idProcess", "RFMenageDemandeReevaluationCMSOO");
        ...
        if (null != tiersWrapper) {
            ...
            throw new Exception("Erreur : Pas d'adresse tiers (RFMenageDemandeReevaluationCMSOO.generationLettre())");
        }
    ...
    public JadePrintDocumentContainer remplir(JadePrintDocumentContainer documentContainer, RFDocumentsProcess process,
        ...
        return super.remplir(documentContainer, process, getIdTiers(),
                IPRConstantesExternes.RFM_LETTRE_TYPE_AIDE_AU_MENAGE_PRIVE_DEMANDE_REEVALUATION_DES_BESOINS_AU_CMS,
                isSendToGed);
    }
