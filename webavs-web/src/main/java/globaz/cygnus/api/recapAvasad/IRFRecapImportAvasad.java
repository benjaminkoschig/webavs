 ...
 */
package globaz.cygnus.api.recapAvasad;

/**
 * @author mbo
 */
public interface IRFRecapImportAvasad {

    public static final String ADRESSE_AVASAD = "ADRESSE_AVASAD";
    ...
    public static final String LIGNE_DETAIL_CAS_REJETES_RECAPITULATIF = "ligneDetailRejeteRecapAvasad";
    public static final String LIGNE_DETAIL_CAS_TRAITES_RECAPITULATIF = "ligneDetailTraiteRecapAvasad";
    public static final String LIGNE_DETAIL_RECAPITULATIF = "ligneDetailRecapAvasad";
    public static final String LIGNE_DETAIL_TOTAL_CAS_REJETES_RECAPITULATIF = "ligneTotalRejeteRecapAvasad";
    public static final String LIGNE_DETAIL_TOTAL_CAS_TRAITES_RECAPITULATIF = "ligneTotalTraiteRecapAvasad";
    public static final String LIGNE_LIBELLE_MOTIF_REFUS = "ligneLibelleDemR";
    public static final String LIGNE_TOTALE_RECAPITULATIF = "ligneTotalRecapAvasad";
    ...
    public static final String TABLE_NAME_CMS = "tabCmsAvasad";
    ...
    public static final String TABLEAU_CAS_REJETES_RECAPITULATIF = "tabCasRejeteRecapAvasad";
    public static final String TABLEAU_CAS_TRAITES_RECAPITULATIF = "tabCasTraiteRecapAvasad";
    public static final String TABLEAU_RECAPITULATIF = "tabRecapAvasad";
    ...
    public static final String TITRE_DOCUMENT_DEMANDES_REJETEES_RECAP_AVASAD = "titreDocumentRecapAvasadListeRejete";
    public static final String TITRE_DOCUMENT_DEMANDES_TRAITEES_RECAP_AVASAD = "titreDocumentRecapAvasadListeTraite";
    public static final String TITRE_DOCUMENT_RECAP_AVASAD = "titreDocumentRecapAvasad";
