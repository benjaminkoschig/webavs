 ...
 */
package globaz.cygnus.api.recapTmr;

/**
 * @author mbo
 */
public interface IRFRecapImportTmr {

    public static final String ADRESSE_TMR = "ADRESSE_TMR";
    ...
    public static final String LIGNE_DETAIL_CAS_REJETES_RECAPITULATIF = "ligneDetailRejeteRecapTmr";
    public static final String LIGNE_DETAIL_CAS_TRAITES_RECAPITULATIF = "ligneDetailTraiteRecapTmr";
    public static final String LIGNE_DETAIL_RECAPITULATIF = "ligneDetailRecapTmr";
    public static final String LIGNE_DETAIL_TOTAL_CAS_REJETES_RECAPITULATIF = "ligneTotalRejeteRecapTmr";
    public static final String LIGNE_DETAIL_TOTAL_CAS_TRAITES_RECAPITULATIF = "ligneTotalTraiteRecapTmr";
    public static final String LIGNE_LIBELLE_MOTIF_REFUS = "ligneLibelleDemR";
    public static final String LIGNE_TOTALE_RECAPITULATIF = "ligneTotalRecapTmr";
    ...
    public static final String TABLE_NAME_CMS = "tabCmsTmr";
    ...
    public static final String TABLEAU_CAS_REJETES_RECAPITULATIF = "tabCasRejeteRecapTmr";
    public static final String TABLEAU_CAS_TRAITES_RECAPITULATIF = "tabCasTraiteRecapTmr";
    public static final String TABLEAU_RECAPITULATIF = "tabRecapTmr";
    ...
    public static final String TITRE_DOCUMENT_DEMANDES_REJETEES_RECAP_TMR = "titreDocumentRecapTmrListeRejete";
    public static final String TITRE_DOCUMENT_DEMANDES_TRAITEES_RECAP_TMR = "titreDocumentRecapTmrListeTraite";
    public static final String TITRE_DOCUMENT_RECAP_TMR = "titreDocumentRecapTmr";
