...
public class RFValiderDecisionTmrService extends RFValiderDecisionService {

    private static final Logger LOG = LoggerFactory.getLogger(RFValiderDecisionTmrService.class);

    private void chercherDecisionsTmr(
    ...
    public JadePrintDocumentContainer genererDecisionDocument(String dateSurDocument, DocumentData docData,
                                                              ...
                                                              RFValiderDecisionTmrProcess process, String idExecutionProcess, BSession session,
        ...
        chercherDecisionsTmr(decisionJointTiersManager, idGestionnaire, idExecutionProcess, session);
    ...
    public void logErreurs(String emailAdresse, FWMemoryLog memoryLog, Exception e,
                           RFValiderDecisionTmrProcess process, BSession session, BTransaction transaction) {
