...
import globaz.cygnus.topaz.recapitulationImportationTmr.RFGenererRecapImportationTmrServiceOO;
 ...
 * 
 */
public class RFGenererRecapDemandesTmrProcess extends AbstractJadeJob {
     ...
     * @throws Exception
     */
    public RFGenererRecapDemandesTmrProcess(String emailAdress, boolean isMiseEnGed,
    ...
    private void checkParams() {
        ...
        if (emailAdress == null) {
            throw new IllegalArgumentException("RFGenererRecapDemandesTmrProcess - The 'emailAdress' can't be null");
        }
        if (idGestionnaire == null) {
            throw new IllegalArgumentException(
                    "RFGenererRecapDemandesTmrProcess - The 'idGestionnaire' can't be null");
        }
        if (regroupementDemandesParCodeTraitementMap == null) {
            throw new IllegalArgumentException(
                    "RFGenererRecapDemandesTmrProcess - The 'regroupementDemandesParTypes' can't be null");
        }
        if (memoryLog == null) {
            throw new IllegalArgumentException("RFGenererRecapDemandesTmrProcess - The 'memoryLog' can't be null");
        }
        if (session == null) {
            throw new IllegalArgumentException("RFGenererRecapDemandesTmrProcess - The 'session' can't be null");
        }
        if (step == null) {
            throw new IllegalArgumentException("RFGenererRecapDemandesTmrProcess - The 'step' can't be null");
        }
        if (numAf == null) {
            throw new IllegalArgumentException("RFGenererRecapDemandesTmrProcess - The 'idCms' can't be null");
        }
    ...
    private JadePrintDocumentContainer preparerDocumentOO() throws Exception {
        ...
        RFGenererRecapImportationTmrServiceOO documentOO = new RFGenererRecapImportationTmrServiceOO();
        return documentOO.preparerContainerRecapTmr(regroupementDemandesParCodeTraitementMap, memoryLog,
    ...
    public void run() {
        try {
            ...
            new JadeProcessException("RFGenererRecapDemandesTmrProcess_run() : " + e.getMessage());
        }
    }
