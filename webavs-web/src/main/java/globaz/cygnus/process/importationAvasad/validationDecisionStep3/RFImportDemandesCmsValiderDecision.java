...
public class RFImportDemandesCmsValiderDecision implements JadeProcessStepInterface, JadeProcessStepAfterable,
    ...
    /**
     * Methode pour lancer la préparation des demandes et lancer la génération du document de récapitulation AVASAD
     * 
     * @param session
     * @param emailAdress
     * @param step
    ...
    private void genererRecapitulatifImportAvasad(BSession session, String emailAdress, JadeProcessStep step)
        ...
        // Appel du service générant les décisions RFM et le récapitulatif AVASAD
