...
import globaz.phenix.itext.taxation.definitive.CPListeTaxationNonDefinitive;
 ...
 * @author scr
 */
public class CPListeTaxationNonDefinitiveModuleImpl implements IntModuleFacturation {
    ...
    public boolean comptabiliser(IFAPassage passage, BProcess context) throws Exception {
        CPListeTaxationNonDefinitive lst = new CPListeTaxationNonDefinitive();
