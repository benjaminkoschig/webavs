 ...
 */
public class CPActionCustomFind extends globaz.framework.controller.FWDefaultServletAction {
     ...
     */
    public CPActionCustomFind(globaz.framework.servlets.FWServlet servlet) {
        super(servlet);
    }
