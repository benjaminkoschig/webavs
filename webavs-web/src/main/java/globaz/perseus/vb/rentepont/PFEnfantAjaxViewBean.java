...
public class PFEnfantAjaxViewBean extends BJadePersistentObjectViewBean implements FWAJAXViewBeanInterface {
    ...
    public void add() throws Exception {
        enfantFamille = PerseusImplServiceLocator.getEnfantFamilleService().createForRP(enfantFamille);
    ...
    public void delete() throws Exception {
        enfantFamille = PerseusImplServiceLocator.getEnfantFamilleService().deleteForRP(enfantFamille);
        idSituationFamiliale = enfantFamille.getSimpleEnfantFamille().getIdSituationFamiliale();
