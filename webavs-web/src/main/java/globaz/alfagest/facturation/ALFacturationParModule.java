 ...
 */
public class ALFacturationParModule extends ALFacturationModule {
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        myProcess.setTypeCotisation(ALFacturationModule.PAR_COTISATIONS);
        myProcess.setTypeModule(FAModuleFacturation.CS_MODULE_PRESTATIONSAF_PAR);
