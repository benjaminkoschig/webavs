...
public class LXEscompteDelete {

    /**
     * Effacer un escompte depuis l'écran de LYNX.
     * 
     * @param session
     * @param viewBean
     * @throws Exception
     */
    public static void deleteEscompte(BISession session, FWViewBeanInterface viewBean) throws Exception {
