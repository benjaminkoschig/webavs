 ...
 * @author bsc
 */
public class IJSaisiePrononceAitAction extends PRDefaultAction {
     ...
     *            DOCUMENT ME!
     */
    public IJSaisiePrononceAitAction(FWServlet servlet) {
        super(servlet);
    }
    ...
    protected void actionAfficher(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            viewBean = new IJPrononceAitViewBean();
     ...
     * globaz.framework.controller.FWDispatcher)
     */
    public void ecranSuivant(HttpSession session, HttpServletRequest request, HttpServletResponse response,
            FWDispatcher mainDispatcher, FWViewBeanInterface daViewBean) throws ServletException, IOException {
    ...
    protected void actionModifier(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            if (mainDispatcher.getSession().hasRight(IIJActions.ACTION_SAISIE_PRONONCE_AIT, FWSecureConstants.UPDATE)) {
                viewBean = mainDispatcher.dispatch(viewBean, _action);
            }
            session.setAttribute("viewBean", viewBean);
