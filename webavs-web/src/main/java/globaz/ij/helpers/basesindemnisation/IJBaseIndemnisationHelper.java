 ...
 * @author vre
 */
public class IJBaseIndemnisationHelper extends PRAbstractHelper {
    ...
    protected void _delete(FWViewBeanInterface viewBean, FWAction action, BISession session) throws Exception {
        ...
        try {
            IJBaseIndemnisationViewBean biViewBean = (IJBaseIndemnisationViewBean) viewBean;

            transaction = ((BSession) session).newTransaction();
            transaction.openTransaction();

            if (biViewBean.isNew()) {
                biViewBean.retrieve(transaction);
            }
    ...
    public FWViewBeanInterface creerCorrection(FWViewBeanInterface viewBean, FWAction action, BSession session)
            throws Exception {
        IJBaseIndemnisationJoinTiersViewBean baseOrigine = (IJBaseIndemnisationJoinTiersViewBean) viewBean;
        System.out.println();
