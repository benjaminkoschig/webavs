...
public class IJBaseIndemnisationJoinTiersViewBean extends IJBaseIndemnisation implements FWViewBeanInterface {
    ...
    static {
        ...
        for (int idMois = 1; idMois <= 12; ++idMois) {
            IJBaseIndemnisationJoinTiersViewBean.MONTHS.add(new String[] {
                    IJBaseIndemnisationJoinTiersViewBean.pad0(idMois),
                    IJBaseIndemnisationJoinTiersViewBean.pad0(idMois) });
        }
        ...
        for (int i = calendar.get(Calendar.YEAR) - 6; i < (calendar.get(Calendar.YEAR) + 3); i++) {
            IJBaseIndemnisationJoinTiersViewBean.YEARS.add(new String[] { String.valueOf(i), String.valueOf(i) });
        }
    }
    ...
    public Vector getDaysDebut() {
        ...
        for (int idDay = 1; idDay <= jourFin; ++idDay) {
            days.add(new String[] { IJBaseIndemnisationJoinTiersViewBean.pad0(idDay),
                    IJBaseIndemnisationJoinTiersViewBean.pad0(idDay) });
        }
    ...
    public String getJourDebut() {
        return IJBaseIndemnisationJoinTiersViewBean.pad0(getJourDebutChecked());
    }
    ...
    public String getJourFin() {
        return IJBaseIndemnisationJoinTiersViewBean.pad0(getJourFinChecked());
    }
    ...
    public String getMonth() {
        return IJBaseIndemnisationJoinTiersViewBean.pad0(dateDebut.get(Calendar.MONTH) + 1);
    }
    ...
    public Vector getMonths() {
        return IJBaseIndemnisationJoinTiersViewBean.MONTHS;
    }
    ...
    public Vector getYears() {
        return IJBaseIndemnisationJoinTiersViewBean.YEARS;
    }
