 ...
 * Traitement :
 * 
 * Proposition de compensations sur prochaines factures (mais la case "Compenser" n'est pas cochée) :
 * 
 ...
 * la prochaine facturation est égale à 12
 * 
 * 
 ...
 * @author dvh
 */
public class IJGenererCompensationsProcess001 extends BProcess implements IIJGenererCompensationProcess {
     ...
     */
    public IJGenererCompensationsProcess001() {
        super();
    }
    ...
    public IJGenererCompensationsProcess001(BProcess parent) {
        super(parent);
    }
     ...
     *            DOCUMENT ME!
     */
    public IJGenererCompensationsProcess001(BSession session) {
        super(session);
    }
