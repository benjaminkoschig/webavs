...
import globaz.musca.process.FAPassageCompenserNewProcess;
import globaz.osiris.api.APISection;
import globaz.osiris.db.comptes.CASection;
import globaz.osiris.db.comptes.CASectionManager;

public class FANewCompenserImpl implements IntModuleFacturation {

    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public FANewCompenserImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        FAPassageCompenserNewProcess cptProc = new FAPassageCompenserNewProcess();
