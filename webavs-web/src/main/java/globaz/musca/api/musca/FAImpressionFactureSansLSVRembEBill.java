...
import globaz.musca.process.FAImpressionFactureProcessSansLSVRembEBill;
 ...
 * @author: btc
 */
public class FAImpressionFactureSansLSVRembEBill extends FAImpressionGenerique {
     ...
     */
    public FAImpressionFactureSansLSVRembEBill() {
        super();
    }
    ...
    public boolean beginPrinting(IFAPassage intPassage, IFAImpressionFactureProcess c) throws Exception {
        ...
        FAImpressionFactureProcessSansLSVRembEBill context = (FAImpressionFactureProcessSansLSVRembEBill) c;
    ...
    public boolean comptabiliser(IFAPassage passage, BProcess context) throws Exception {
        try {
            FAImpressionFactureProcessSansLSVRembEBill process = new FAImpressionFactureProcessSansLSVRembEBill();
