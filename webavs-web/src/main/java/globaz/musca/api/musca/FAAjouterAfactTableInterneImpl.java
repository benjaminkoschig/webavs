...
import globaz.musca.process.FAPassageAjouterTableInterneProcess;
 ...
 * @author: btc
 */
public class FAAjouterAfactTableInterneImpl implements IntModuleFacturation {
    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public FAAjouterAfactTableInterneImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        FAPassageAjouterTableInterneProcess myProcess = new FAPassageAjouterTableInterneProcess();
