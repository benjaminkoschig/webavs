 ...
 * @author: btc
 */
public class FANewImpressionFacture_BVR extends FAImpressionGenerique {
     ...
     */
    public FANewImpressionFacture_BVR() {
        super();
    }
    ...
    public boolean comptabiliser(IFAPassage passage, BProcess context) throws Exception {
        try {
            FANewImpressionFactureProcess process = new FANewImpressionFactureProcess();
