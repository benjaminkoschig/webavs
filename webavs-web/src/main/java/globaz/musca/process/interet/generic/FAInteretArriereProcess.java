...
public class FAInteretArriereProcess extends FAInteretGenericProcess {
    ...
    protected String getIdGenreInteret() {
        return CAGenreInteret.CS_TYPE_COTISATIONS_ARRIEREES;
    }
    ...
    protected FASumMontantSoumisParPlanManager getSumMontantSoumisParPlanManager(CAPlanCalculInteret plan) {
        ...
        idSousTypeIn.add(APISection.ID_CATEGORIE_SECTION_DECISION_DE_TAXATION_OFFICE);
