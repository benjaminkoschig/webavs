 ...
 * @author: BTC
 */
public class FAPassageComptabilisationBatch extends FAPassageFacturationProcess_OLD {
    /**
     * 
     */
    ...
    public static void main(String[] args) {
        ...
        FAPassageComptabilisationBatch process = null;
        String user = "";
        String pwd = "";
        String idPassage = "";
        ...
        try {
            process = new FAPassageComptabilisationBatch();
     ...
     */
    public FAPassageComptabilisationBatch() {
        super();
    }
    ...
    protected boolean _executeProcess() {
        try {
            ...
            if ((passage != null) && !passage.isNew()) {
                setEMailObject(getSession().getLabel("5006") + passage.getLibelle() + " (" + passage.getIdPassage()
                        + ")");
            } else {
                setEMailObject(getSession().getLabel("5007") + getIdPassage());
            }
            /***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************
    ...
    public boolean doModuleAction(FAModulePassage modulePassage, String nomClasse, FAAfactManager manager) {
        ...
        boolean success = doActionComptabiliser(nomClasse, manager);
        try {
