 ...
 *         </p>
 */
public class PRDefaultAction extends FWDefaultServletAction {
    ...
    /**
     */
    protected static final String METHOD_ADD = PRDefaultAction.METHOD_PARAM + "=" + PRDefaultAction.METHOD_ADD_VALUE;
    ...
    /**
     */
    protected static final String METHOD_UPD = PRDefaultAction.METHOD_PARAM + "=" + PRDefaultAction.METHOD_UPD_VALUE;
    ...
    public static void addErrorToViewBean(FWViewBeanInterface viewBean, String message) {
        viewBean.setMsgType(FWViewBeanInterface.ERROR);
        StringBuilder messageBuilder = new StringBuilder();
        if (!JadeStringUtil.isBlank(viewBean.getMessage())) {
            messageBuilder.append(viewBean.getMessage()).append("<br/>");
        }
        messageBuilder.append(message);
        viewBean.setMessage(messageBuilder.toString());
    }
     ...
     * @param servlet
     */
    public PRDefaultAction(FWServlet servlet) {
        super(servlet);
    }
    ...
    protected boolean actionSetSession(FWViewBeanInterface viewBean, HttpSession session, HttpServletRequest request,
        ...
        try {
            action.changeActionPart(PRAbstractHelper.SET_SESSION);
    ...
    protected String getMethod(HttpServletRequest request) {
        return request.getParameter(PRDefaultAction.METHOD_PARAM);
    }
    ...
    protected String getSelectedId(HttpServletRequest request) {
        return request.getParameter(PRDefaultAction.SELECTED_ID);
    }
    ...
    protected String getSelectedIdParam(HttpServletRequest request) {
        return PRDefaultAction.SELECTED_ID + "=" + getSelectedId(request);
    }
    ...
    protected String getUserAction(HttpServletRequest request) {
        return request.getParameter(PRDefaultAction.USER_ACTION);
    }
    ...
    protected String getUserActionURL(HttpServletRequest request, String action) {
        return request.getServletPath() + "?" + PRDefaultAction.USER_ACTION + "=" + action;
    }
    ...
    protected FWViewBeanInterface loadViewBean(HttpServletRequest request) {
        return (FWViewBeanInterface) request.getAttribute(PRDefaultAction.ATTRIBUTE_VIEWBEAN);
    }
    ...
    protected FWViewBeanInterface loadViewBean(HttpSession session) {
        return (FWViewBeanInterface) session.getAttribute(PRDefaultAction.ATTRIBUTE_VIEWBEAN);
    }
    ...
    protected void saveViewBean(FWViewBeanInterface viewBean, HttpServletRequest request) {
        request.setAttribute(PRDefaultAction.ATTRIBUTE_VIEWBEAN, viewBean);
    }
    ...
    protected void saveViewBean(FWViewBeanInterface viewBean, HttpSession session) {
        session.setAttribute(PRDefaultAction.ATTRIBUTE_VIEWBEAN, viewBean);
    }
}
