 ...
 * @author vre
 */
public class PRNestedException extends JAException {
     ...
     * @param msg
     */
    public PRNestedException(String msg) {
        super(msg);
    }
     ...
     */
    public PRNestedException(String msg, Throwable cause) {
        this(msg);
        this.cause = cause;
    }
