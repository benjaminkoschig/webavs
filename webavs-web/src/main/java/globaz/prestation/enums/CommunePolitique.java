...
public enum CommunePolitique {
    ...
    LABEL_COMMUNE_POLITIQUE_NOT_FOUND_NOM_LONG("COMMUNE_POLITIQUE_NON_TROUVEE_NOM_LONG"),
    LABEL_COMMUNE_POLITIQUE_PLUSIEURS_RESULTAT_NOM_LONG("COMMUNE_POLITIQUE_PLUSIEURS_RESULTAT_NOM_LONG"),
    /**
