...
public interface IEBListeAcl {
    ...
    public final static String[] listeNoms = { IEBListeAcl.NUMERO_ASSURE, IEBListeAcl.NOM_PRENOM,
            ...
            IEBListeAcl.NUMERO_AFFILIE, IEBListeAcl.STATUT };
    public static final String MASSE_MAX_AUTORISEE = "masseMaximum";
    public static final String NATIONNALITE = "nationnalite";
    public static final String NOM_PRENOM = "nomPrenom";
    public static final String NOUVELLE_MASSE = "nouvelleMasse";
    public static final String NUMERO_AFFILIE = "numeroAffilie";
    public static final String NUMERO_ASSURE = "numeroAssure";
