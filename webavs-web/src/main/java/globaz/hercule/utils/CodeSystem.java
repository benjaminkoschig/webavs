...
public class CodeSystem {
    ...
    public static final String GENRE_CONTROLE_AUTRES_MESURES = "19130021";

    public static final String GENRE_CONTROLE_DEMANDE = "811004";
    // Genre de controle
    public static final String GENRE_CONTROLE_FACULTATIF = "811002";
    public static final String GENRE_CONTROLE_FAILLITE = "811006";

    public static final String GENRE_CONTROLE_FINAL = "811007";
    public static final String GENRE_CONTROLE_OBLIGATOIRE = "811001";
    public static final String GENRE_CONTROLE_OBLIGATOIRE_CAF = "811003";
    public static final String GENRE_CONTROLE_PERIODIQUE = "811009";
    public static final String GENRE_CONTROLE_REVISION_EXCEPTIONNELLE = "811008";

    public static final String GENRE_CONTROLE_SURSIS_CONCORDATAIRE = "811005";

    public static final String TYPE_CONTROLE_5_POURCENT = "811010";
    public static final String TYPE_CONTROLE_DS_NON_REMISE = "811013";
    public static final String TYPE_CONTROLE_EMPLOYEUR_RADIE = "811012";

    public static final String TYPE_CONTROLE_SANS_PERSONNEL = "811011";
    public static final String TYPE_LETTRE_D002 = "836100";
    public static final String TYPE_LETTRE_D005 = "836101";
