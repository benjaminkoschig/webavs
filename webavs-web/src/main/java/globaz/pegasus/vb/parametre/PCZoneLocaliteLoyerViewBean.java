 ...
 * @date 12 nov. 2010
 */
public class PCZoneLocaliteLoyerViewBean extends BJadePersistentObjectViewBean {
    final EPCForfaitType type = EPCForfaitType.LOYER;
    ZoneLocalite zoneLocalite = null;

    public PCZoneLocaliteLoyerViewBean() {
        super();
        zoneLocalite = new ZoneLocalite();
    }

    public PCZoneLocaliteLoyerViewBean(ZoneLocalite zoneLocalite) {
        super();
