 ...
 * 
 */
public class PCAutreFortuneMobiliereViewBean extends PCAbstractRequerantDonneeFinanciereViewBean {
    ...
    public void retrieve() throws Exception {
        ...
        search.setWhereKey("forVersionedAutreFortuneMobiliere");
        ...
        for (Iterator it = Arrays.asList(search.getSearchResults()).iterator(); it.hasNext();) {
            ...
            if (donnee.getDonneeFinanciere() instanceof SimpleAutreFortuneMobiliere) {
