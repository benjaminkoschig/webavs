 ...
 */
public class CGReleveAVSCptAdmin_Bean extends CGReleveAVS_Bean {
    /**
     * Constructor for CGReleveAVSCptAdmin_Bean.
     */
    public CGReleveAVSCptAdmin_Bean() {
        super();
    }
    ...
    public boolean prepareValue(BEntity bEntity, BTransaction transaction, BSession session) {
        ...
        try {
            CGMontantHelper result = traitementReleveAvsHelper.getMontantComptesAdministration(transaction, session,
                    entity, getIdExerciceComptable(), getIdPeriodeComptable(), isProvisoire());
