...
public class CGPeriodeComptableXMLService {

    private static final Logger LOG = LoggerFactory.getLogger(CGPeriodeComptableXMLService.class);

    private static final String XSD_FOLDER = "/xsd/P2020/annoncesRC/";
    private static final String XSD_NAME = "MeldungZurZas.xsd";

    private static CGPeriodeComptableXMLService instance = new CGPeriodeComptableXMLService();

    public static CGPeriodeComptableXMLService getInstance() {
        return instance;
    }
    ...
    private String getFileNameTimeStamp() throws PropertiesException {
        String fileName = "M_" + CGProperties.RACINE_NOM_FICHIER_OUTPUT_ZAS.getValue();
    ...
    public void envoiFichier(String fichier) throws JadeServiceLocatorException, JadeServiceActivatorException,
        ...
        JadeFsFacade.copyFile(fichier, CGProperties.FTP_CENTRALE_PATH.getValue() + "/" + new File(fichier).getName());
    }
