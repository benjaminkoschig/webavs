...
public interface ISFSituationFamiliale {
     ...
     * </p>
     *
     * @param idMembreFamille l'id du {@link ISFMembreFamille membre de la famille} que l'on souhaite connaître
     ...
     * </p>
     *
     * @param idMembreFamille la personne que l'on souhaite connaître à la date donnée
     * @param date            la date à laquelle on aimerait avoir le détail du membre de la famille (au format "jj.mm.aaaa")
     ...
     * @param idMembreFamille2        le deuxième conjoint
     * @param triDateDebutDecroissant <code>true</code> pour un tri décroissant, <code>false</code> pour un tri croissant des dates de début
     *                                de relation
     ...
     * @param idTiers2                le deuxième conjoint
     * @param triDateDebutDecroissant <code>true</code> pour un tri décroissant, <code>false</code> pour un tri croissant des dates de début
     *                                de relation
     * @return les {@link ISFRelationFamiliale relations familiales}
     * @throws Exception
