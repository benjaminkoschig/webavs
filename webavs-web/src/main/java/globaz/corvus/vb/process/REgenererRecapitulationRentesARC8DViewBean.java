 ...
 * @author BSC
 */
public class REgenererRecapitulationRentesARC8DViewBean extends PRAbstractViewBeanSupport {

    // ~ Instance fields
    // ------------------------------------------------------------------------------------------------

    private String eMailAddress = "";
    private boolean isChargementRecap = false;
    ...
    public boolean isChargementRecap() {
        return isChargementRecap;
    }
    ...
    public void setIsChargementRecap(boolean isChargementRecap) {
        this.isChargementRecap = isChargementRecap;
    }
