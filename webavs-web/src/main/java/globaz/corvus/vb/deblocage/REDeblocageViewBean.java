...
public class REDeblocageViewBean extends PRAbstractViewBeanSupport {
    ...
    public String getDiffMontantBloqueDebloque() {
        return diffMontantBloqueDebloque;
    }
    ...
    public List<RELigneDeblocageDette> getDettes() {
        return deblocages.getLigneDeblocageDetteEnCompta().filtreValidesAndComptabilises().toListDette();
    }
