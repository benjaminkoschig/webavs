 ...
 * 
 */
public class REDownloaderInscriptionsCI extends REAbstractDownloader {
    ...
    public REDownloaderInscriptionsCI(BTransaction transaction, BSession session) {
        super();
    ...
    private Map<String, List<REInscriptionCI>> doTraitement(IHEOutputAnnonce[] annonces) throws REDownloaderException {
        try {
            ...
            RETraitementImportAnnonces annoncesImport = new RETraitementImportAnnonces(_transaction, getBSession(), log);
        ...
        do {
            ...
            try {
                ...
                annonces = aCHelper.getAnnoncesTerminees((BTransaction) remoteTransaction,
                        REDownloaderInscriptionsCI.MAX_NB_DEMANDES);
