 ...
 * 
 * <p>
 * Un parser capable de parser le fichier xml annonce.xml retourn� par ACOR.
 * </p>
 * 
 * @author scr
 * 
    ...
    public static final List parse(BSession session, BTransaction transaction, LinkedList listIdsRA, Reader reader)
        ...
        try {
            ...
            for (int i = 0; i < annonces10.length; i++) {
                ...
                // Retrouver la rente accord�e et setter REAnnonceRente
                ...
                // On parcourt les rentes accord�es dont les ids sont pass�s en
                // param�tres dans la liste des ra cr�es pr�c�demment
                String idRA = "";
                if (raMan.size() == 1) {
                    ...
                    for (Iterator iterator = raMan.iterator(); iterator.hasNext();) {
                        ...
                        // Tests pour �tre s�r que c'est la bonne rente accord�e
    ...
    protected static REBaseCalcul09XmlDataStructure parseBaseCalcul09(Node nPrestation) throws Exception {
        ...
        for (int i = 0; i < nl.getLength(); i++) {
            ...
            if (REAnnonceXmlDataStructure.TAG_BASE_CALCUL.equals(n.getNodeName())) {
                ...
                // Traitement des info propre � la retraite flexible.
