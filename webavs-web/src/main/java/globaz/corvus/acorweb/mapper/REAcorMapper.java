package globaz.corvus.acorweb.mapper;
...
import globaz.corvus.acorweb.service.REImportationCalculAcor;
    ...
    public static ReturnedValue doMAJPrestations(BSession session, BITransaction transaction, REDemandeRente demandeSource, FCalcul fCalcul, int noCasATraiter) throws PRACORException {
        ...
        try {
            ...
            switch (noCasATraiter) {
                case REImportationCalculAcor.CAS_NOUVEAU_CALCUL:
                    break;
                case REImportationCalculAcor.CAS_RECALCUL_DEMANDE_NON_VALIDEE:
                    break;
                case REImportationCalculAcor.CAS_RECALCUL_DEMANDE_VALIDEE:
                    break;
                default:
