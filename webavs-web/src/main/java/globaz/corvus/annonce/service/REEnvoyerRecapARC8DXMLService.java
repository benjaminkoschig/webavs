...
public class REEnvoyerRecapARC8DXMLService {

    private static final Logger LOG = LoggerFactory.getLogger(REEnvoyerRecapARC8DXMLService.class);

    private static final String XSD_FOLDER = "/xsd/P2020/annoncesRC/";
    private static final String XSD_NAME = "MeldungZurZas.xsd";

    private static REEnvoyerRecapARC8DXMLService instance = new REEnvoyerRecapARC8DXMLService();

    public static REEnvoyerRecapARC8DXMLService getInstance() {
        return instance;
    }
    ...
    private String getFileNameTimeStamp() throws PropertiesException {
        String fileName = "M_" + REProperties.RECAP_RACINE_NOM_FICHIER_OUTPUT_ZAS.getValue();
     ...
     * @throws Exception
     */
    public void envoiFichier(String fichier) throws JadeServiceLocatorException, JadeServiceActivatorException,
            JadeClassCastException, PropertiesException {
        JadeFsFacade.copyFile(fichier, REProperties.RECAP_FTP_CENTRALE_PATH.getValue() + "/" + new File(fichier).getName());
    }
