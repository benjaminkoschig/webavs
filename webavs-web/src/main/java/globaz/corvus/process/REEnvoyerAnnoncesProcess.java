...
public class REEnvoyerAnnoncesProcess extends BProcess {
     ...
     */
    public REEnvoyerAnnoncesProcess() {
        super();
    }
     ...
     *            DOCUMENT ME!
     */
    public REEnvoyerAnnoncesProcess(BProcess parent) {
        super(parent);
    }
     ...
     *            DOCUMENT ME!
     */
    public REEnvoyerAnnoncesProcess(BSession session) {
        super(session);
    }
    ...
    private void envoieAnnonces() throws Exception {
        ...
        BISession remoteSession = PRSession.connectSession(getSession(), REEnvoyerAnnoncesProcess.APPLICATION_ANNONCES);
     ...
     */
    void prepareEnvoieAnnonce(REAnnoncesAbstractLevel1A annonce) throws Exception {
        ...
        switch (codeApplication) {
            ...
            case 43:
                ...
                attribs = preparerAugmentation9EmeEnregistrement01(augmentation9eme01);
                if (!attribs.isEmpty()) {
                    annoncesAEnvoyer.add(attribs);
                }

                attribs = preparerAugmentation9EmeEnregistrement02(augmentation9eme02);
                if (!attribs.isEmpty()) {
                    annoncesAEnvoyer.add(attribs);
                }
