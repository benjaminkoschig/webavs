...
public class AFAttestationPersonnelle_doc extends FWIDocumentManager {
    ...
    public AFAttestationPersonnelle_doc(BSession session) throws Exception {
    ...
    public void createDataSource() throws Exception {
        ...
        String valueLabelFactureCredit = null;
        if (FloatingDecimal.readJavaFormatString(getTotalCoti()).doubleValue() > 0) {
