...
public interface APIReferenceRubrique {
    ...
    //Paternité
//    String PATERNITE_ACM_COTISATIONS_AC = "237040";
//    String PATERNITE_ACM_COTISATIONS_AVS = "237039";
//    String PATERNITE_ACM_FONDS_DE_COMPENSATION = "237053";
//    String PATERNITE_ACM_MONTANT_BRUT = "237037";
//    String PATERNITE_ACM_RESTITUTION = "237038";

    String PATERNITE_AVEC_AC_ASSURE = "237353";
    String PATERNITE_AVEC_AC_INDEPENDANT = "237363";

    String PATERNITE_SANS_AC_ASSURE = "237354";
    String PATERNITE_SANS_AC_INDEPENDANT = "237364";

    String PATERNITE_COTISATION_AC_ASSURE = "237358";
    String PATERNITE_COTISATION_AC_INDEPENDANT = "237368";

    String PATERNITE_COTISATION_AVS_ASSURE = "237357";
    String PATERNITE_COTISATION_AVS_INDEPENDANT = "237367";

    String PATERNITE_COTISATION_LFA = "237361";
    String PATERNITE_EMPLOYEUR_AVEC_AC = "237351";
    String PATERNITE_EMPLOYEUR_SANS_AC = "237352";

    String PATERNITE_FONDS_DE_COMPENSATION_ASSURE = "237359";
    String PATERNITE_FONDS_DE_COMPENSATION_EMPLOYEUR = "237369";
    String PATERNITE_FONDS_DE_COMPENSATION_INDEPENDANT = "237370";

    String PATERNITE_FRAIS_ADMINISTRATION = "237362";

    String PATERNITE_IMPOT_A_LA_SOURCE_ASSURE = "237360";
    String PATERNITE_IMPOT_A_LA_SOURCE_INDEPENDANT = "237371";

//    String PATERNITE_IMPOT_A_LA_SOURCE_ACM = "237112";
//
//    String PATERNITE_IMPOT_A_LA_SOURCE_LAMAT_CANTONALE_ASSURE = "237111";
//    String PATERNITE_IMPOT_A_LA_SOURCE_LAMAT_CANTONALE_INDEPENDANT = "237591";

    String PATERNITE_PRESTATION_A_RESTITUER_ASSURE = "237356";
    String PATERNITE_PRESTATION_A_RESTITUER_EMPLOYEUR = "237366";
    String PATERNITE_PRESTATION_A_RESTITUER_INDEPENDANT = "237365";

    String MATERNITE_SANS_COTISATIONS = "237005";
    String PATERNITE_SANS_COTISATIONS = "237355";

    //Proche aidant
    String PROCHE_AIDANT_AVEC_AC_ASSURE = "237374";
    String PROCHE_AIDANT_AVEC_AC_INDEPENDANT = "237384";
    String PROCHE_AIDANT_SANS_AC_ASSURE = "237375";
    String PROCHE_AIDANT_SANS_AC_INDEPENDANT = "237385";
    String PROCHE_AIDANT_COTISATION_AC_ASSURE = "237379";
    String PROCHE_AIDANT_COTISATION_AC_INDEPENDANT = "237389";
    String PROCHE_AIDANT_COTISATION_AVS_ASSURE = "237378";
    String PROCHE_AIDANT_COTISATION_AVS_INDEPENDANT = "237388";
    String PROCHE_AIDANT_COTISATION_LFA = "237382";
    String PROCHE_AIDANT_EMPLOYEUR_AVEC_AC = "237372";
    String PROCHE_AIDANT_EMPLOYEUR_SANS_AC = "237373";
    String PROCHE_AIDANT_FONDS_DE_COMPENSATION_ASSURE = "237380";
    String PROCHE_AIDANT_FONDS_DE_COMPENSATION_EMPLOYEUR = "237390";
    String PROCHE_AIDANT_FONDS_DE_COMPENSATION_INDEPENDANT = "237391";
    String PROCHE_AIDANT_FRAIS_ADMINISTRATION = "237383";
    String PROCHE_AIDANT_IMPOT_A_LA_SOURCE_ASSURE = "237381";
    String PROCHE_AIDANT_IMPOT_A_LA_SOURCE_INDEPENDANT = "237392";
    String PROCHE_AIDANT_PRESTATION_A_RESTITUER_ASSURE = "237377";
    String PROCHE_AIDANT_PRESTATION_A_RESTITUER_EMPLOYEUR = "237387";
    String PROCHE_AIDANT_PRESTATION_A_RESTITUER_INDEPENDANT = "237386";
    String PROCHE_AIDANT_SANS_COTISATIONS = "237376";
    ...
    // TODO Définir rubrique comptable
    String PC_AVS_EN_HOME_SPEN = "237622";
    String PC_AVS_EN_HOME_HORS_CANTON_SPEN = "237623";
    String PC_AI_EN_HOME_SPEN = "237624";
    String PC_AI_EN_HOME_HORS_CANTON_SPEN = "237625";
    String PC_AVS_RESTITUTION_EN_HOME_HORS_CANTON_SPEN = "237626";
    String PC_AVS_RESTITUTION_EN_HOME_SPEN = "237627";
    String PC_AI_RESTITUTION_EN_HOME_HORS_CANTON_SPEN = "237628";
    String PC_AI_RESTITUTION_EN_HOME_SPEN = "237629";

    // rubrique comptable DGEJ
    // SESAF
    String PC_AVS_EN_HOME_DGEJ_SESAF = "237630";
    String PC_AVS_EN_HOME_HORS_CANTON_DGEJ_SESAF = "237631";
    String PC_AI_EN_HOME_DGEJ_SESAF = "237632";
    String PC_AI_EN_HOME_HORS_CANTON_DGEJ_SESAF = "237633";
    String PC_AVS_RESTITUTION_EN_HOME_DGEJ_SESAF = "237634";
    String PC_AVS_RESTITUTION_EN_HOME_HORS_CANTON_DGEJ_SESAF = "237635";
    String PC_AI_RESTITUTION_EN_HOME_DGEJ_SESAF = "237636";
    String PC_AI_RESTITUTION_EN_HOME_HORS_CANTON_DGEJ_SESAF = "237637";

    //FOYER
    String PC_AVS_EN_HOME_DGEJ_FOYER = "237638";
    String PC_AVS_EN_HOME_HORS_CANTON_DGEJ_FOYER = "237639";
    String PC_AI_EN_HOME_DGEJ_FOYER = "237640";
    String PC_AI_EN_HOME_HORS_CANTON_DGEJ_FOYER = "237641";
    String PC_AVS_RESTITUTION_EN_HOME_DGEJ_FOYER = "237642";
    String PC_AVS_RESTITUTION_EN_HOME_HORS_CANTON_DGEJ_FOYER = "237643";
    String PC_AI_RESTITUTION_EN_HOME_DGEJ_FOYER = "237644";
    String PC_AI_RESTITUTION_EN_HOME_HORS_CANTON_DGEJ_FOYER = "237645";

    // FA
    String PC_AVS_EN_HOME_DGEJ_FA = "237646";
    String PC_AVS_EN_HOME_HORS_CANTON_DGEJ_FA = "237647";
    String PC_AI_EN_HOME_DGEJ_FA = "237648";
    String PC_AI_EN_HOME_HORS_CANTON_DGEJ_FA = "237649";
    String PC_AVS_RESTITUTION_EN_HOME_DGEJ_FA = "237650";
    String PC_AVS_RESTITUTION_EN_HOME_HORS_CANTON_DGEJ_FA = "237651";
    String PC_AI_RESTITUTION_EN_HOME_DGEJ_FA = "237652";
    String PC_AI_RESTITUTION_EN_HOME_HORS_CANTON_DGEJ_FA = "237653";
    ...
    String  PC_REST_AI_SUB_DOMICILE = "237612";
    String  PC_REST_AI_SUB_HOME_EMS = "237613";

    String  PC_REST_AVS_CANT_DOMICILE = "237614";
    String  PC_REST_AVS_CANT_HOME_EMS = "237615";

    String  PC_REST_AI_CANT_DOMICILE = "237616";
    String  PC_REST_AI_CANT_HOME_EMS = "237617";

    String  PC_REST_AVS_RFM_DOMICILE = "237618";
    String  PC_REST_AVS_RFM_HOME_EMS = "237619";

    String  PC_REST_AI_RFM_DOMICILE = "237620";
    String  PC_REST_AI_RFM_HOME_EMS = "237621";
