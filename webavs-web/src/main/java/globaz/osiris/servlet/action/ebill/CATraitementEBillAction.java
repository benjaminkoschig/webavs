...
public class CATraitementEBillAction extends CADefaultServletAction {
    /**
     * Constructor for CADefaultServletAction.
     *
     * @param servlet
     */
    public CATraitementEBillAction(FWServlet servlet) {
        super(servlet);
    }
    ...
    private void atraiter(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            CATraitementEBillViewBean viewBean;

            if ((session.getAttribute(CADefaultServletAction.VB_ELEMENT) != null)
                    && (session.getAttribute(CADefaultServletAction.VB_ELEMENT) instanceof CATraitementEBillViewBean)) {
                viewBean = (CATraitementEBillViewBean) session.getAttribute(CADefaultServletAction.VB_ELEMENT);
            } else {
                viewBean = new CATraitementEBillViewBean();
            }
            ...
            viewBean = (CATraitementEBillViewBean) mainDispatcher.dispatch(viewBean, FWAction.newInstance("osiris.ebill.traitementEBill.modifier"));
    ...
    private void optionATraiter(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            viewBean = (CATraitementEBillViewBean) mainDispatcher.dispatch(viewBean, FWAction.newInstance("osiris.ebill.traitementEBill.afficher"));
     ...
     * @throws IOException
     */
    private void optionAValider(HttpSession session, HttpServletRequest request, HttpServletResponse response,
                          FWDispatcher mainDispatcher) throws ServletException, IOException {
