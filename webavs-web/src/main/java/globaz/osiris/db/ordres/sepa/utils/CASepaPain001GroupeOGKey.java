 ...
 * 
 */
public class CASepaPain001GroupeOGKey {
    ...
    public CASepaPain001GroupeOGKey(APICommonOdreVersement ov, CAAdressePaiementFormatter adpf) throws Exception {

        this(ov.getCodeISOMonnaieBonification(), CASepaOVConverterUtils.getTypeVersement(ov,adpf), CASepaOVConverterUtils
                .getTypeVirement(adpf), CASepaOVConverterUtils.getPaysDestination(adpf));
    }

    public CASepaPain001GroupeOGKey(String monnaieISO, String typeOrdre, String typeVirement, String paysDest) {
        super();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof CASepaPain001GroupeOGKey) {
            return getKeyString().equals(((CASepaPain001GroupeOGKey) obj).getKeyString());
        }
        return false;
