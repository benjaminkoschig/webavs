...
public class CACamt054LSVV0104 extends CACamt054VersionAbstract<iso.std.iso._20022.tech.xsd.camt_054_001.Document> {
     ...
     * @return
     */
    private String manageCdtrRefInf(EntryTransaction4 tx) {
     ...
     * @return
     */
    private String managePrtryTp(EntryTransaction4 tx) {
    ...
    private String manageDebtor(TransactionParties3 partie3) {
        ...
        if (debtor.getPstlAdr() != null && debtor.getPstlAdr().getAdrLine() != null
            ...
            if (debtor.getPstlAdr() != null) {
                final String buildingNumber = debtor.getPstlAdr().getBldgNb() != null ? debtor.getPstlAdr().getBldgNb()
                        : "";

                builder.append(debtor.getPstlAdr().getStrtNm() + " " + buildingNumber).append(newLine);
