...
public class CASepaCommonUtils {
    ...
    /**
     * VÈrifie si l'adresse de paiement contient une adresse QR-IBAN. (IBAN avec un QR-IID)
     * RËgle : l'IID se trouve en position 5 ‡ 8 de l'IBAN. Si l'IID est entre 30000 et 31999
