...
public class DSSuiviDem extends BEntity implements Serializable {
    ...
    protected void _readProperties(BStatement statement) throws Exception {
        typeAffiliation = statement.dbReadNumeric(FIELDNAME_TYPE_AFFILIE);
        genre = statement.dbReadNumeric(FIELDNAME_GENRE);
        nombre = statement.dbReadNumeric(FIELDNAME_NOMBRE);
        montant = statement.dbReadNumeric(FIELDNAME_MONTANT);
        idCanton = statement.dbReadNumeric(FIELDNAME_IDCANTON);
    }
