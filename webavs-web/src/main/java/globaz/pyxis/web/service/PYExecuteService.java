...
public class PYExecuteService extends BProcess {
    ...
    public final PYContactDTO updateContact(PYContactDTO dto, String token) {
        try {
            ...
            LOG.error("Une erreur de param�tre est survenue lors de la modification du contact: " + e);
            throw e;
        }
        catch (PYInternalException e) {
    ...
    /**
     * M�thode pour mettre � jour un contact (table TICONTP).
     *
     * @param session
     * @param idContact cl� primaire
     * @param newLastName valeur � mettre � jour
     * @param newFirstName valeur � mettre � jour
     * @throws Exception
     */
    ...
    public final PYMeanOfCommunicationCreationDTO updateMeanOfCommunication(PYMeanOfCommunicationCreationDTO dto, String token) {
        try {
            ...
            LOG.error("Une erreur de param�tre est survenue lors de la modification du moyen de communication: " + e);
            throw e;
        }
        catch (PYInternalException e) {
    ...
    /**
     * Methode pour mettre � jour un moyen de communication (table TIMCOMP).
     * <p>
     * Seul la valeur (newMoyen) peut �tre modifi�e.
     *
     * @param session
     * @param idContact cl� composite
     * @param typeCommunication cl� composite
     * @param domaineApplication cl� composite
     * @param newMoyen valeur � mettre � jour
     * @throws Exception
     */
    ...
    /**
     * Cr�ation d'un contact et de ses moyens de communication
     *
     * @param dto
     * @param token
     * @return
    ...
    public final PYContactDTO createContact(PYContactCreateDTO dto, String token) {
        try {
            ...
            LOG.error("Une erreur de param�tre est survenue lors de la cr�ation du contact: " + e);
            throw e;
        }
        catch (PYInternalException e) {
            LOG.error("Une erreur interne est survenue lors de la cr�ation du contact: " + e);
            throw e;
        }
        catch (Exception e) {
            LOG.error("Une erreur est survenue lors de la cr�ation du contact: " + e);
            throw new PYInternalException(e);
        }
        return dto;
    }
    ...
    /**
     * M�thode pour cr�er un contact avec des moyens de communication.
     *
     * @param session
     * @param idTiers
     * @param lastName
    ...
    public final String deleteContact(PYContactCreateDTO dto, String token) {
        try {
            ...
            LOG.error("Une erreur de param�tre est survenue lors de la suppression du contact: " + e);
            throw e;
        }
        catch (PYInternalException e) {
    ...
    /**
     * M�thode pour supprimer un contact.
     *
     * @param session
     * @param id
     * @param idTiers
    ...
    /**
     * Cr�ation d'un moyen de communication.
     *
     * @param dto
     * @param token
     * @return
    ...
    public final PYMeanOfCommunicationCreationDTO createMeanOfCommunication(PYMeanOfCommunicationCreationDTO dto, String token) {
        try {
            ...
            LOG.error("Une erreur de param�tre est survenue lors de la cr�ation du moyen de communication: " + e);
            throw e;
        }
        catch (PYInternalException e) {
            LOG.error("Une erreur interne est survenue lors de la cr�ation du moyen de communication: " + e);
            throw e;
        }
        catch (Exception e) {
            LOG.error("Une erreur est survenue lors de la cr�ation du moyen de communication: " + e);
            throw new PYInternalException(e);
        }
        return dto;
    }
    ...
    /**
     * M�thode pour cr�er un moyen de communication pour un contact.
     *
     * @param session
     * @param dto
     * @throws Exception
    ...
    public final String deleteMeanOfCommunication(PYMeanOfCommunicationCreationDTO dto, String token) {
        try {
            ...
            LOG.error("Une erreur de param�tre est survenue lors de la suppression du moyen de communication: " + e);
            throw e;
        }
        catch (PYInternalException e) {
    ...
    /**
     * M�thode pour supprimer un moyen de communication d'un contact.
     *
     * @param session
     * @param dto
     * @throws Exception
    ...
    /**
     * M�thode pour mettre � jour un tiers (page 2 - contacts/moyens de communication)
     *
     * @param session
     * @param dto
     * @return
    ...
    public final void updateTiersPage2(BSession session, PYTiersDTO dto) throws Exception {
        for (PYContactDTO contact: dto.getContacts()) {
            ...
            tiContact.retrieve(session.getCurrentThreadTransaction());
            if (!tiContact.isNew()) {
                throw new PYBadRequestException("PRTiersHelper#updateTiersPage2 - Le contact � modifier n'existe pas");
            }
            ...
            for (PYMeanOfCommunicationDTO mean: meansOfCommunication) {
                ...
                if (!tiMoyenCommunication.isNew()) {
                    throw new PYBadRequestException("PRTiersHelper#updateTiersPage2 - Le moyen de communication � modifier n'existe pas");
                }
        ...
        if (!JadeStringUtil.isEmpty(String.valueOf(session.getCurrentThreadTransaction().getErrors()))) {
            LOG.error("PRTiersHelper#updateTiersPage2 - Erreur rencontr�e lors de l'update de contact");
            throw new PYBadRequestException("PRTiersHelper#updateTiersPage2 - Erreur rencontr�e lors de l'update de contact: " + session.getCurrentThreadTransaction().getErrors().toString());
        } else if (!JadeThread.logIsEmpty()) {
            LOG.error("PRTiersHelper#updateTiersPage2 - Erreur rencontr�e lors de l'update de contact");
            throw new PYBadRequestException("PRTiersHelper#updateTiersPage2 - Erreur rencontr�e lors de l'update de contact: " + JadeThread.getMessage(JadeThread.logMessages()[0].getMessageId()).toString());
        }
    }
