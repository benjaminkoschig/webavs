...
public class PTDetailParamCotiAPAjaxViewBean
        extends
    ...
    public PTDetailParamCotiAPAjaxViewBean() {
        initList();
    ...
    private void validate() throws UnsatisfiedSpecificationException {
        currentEntity.getCotisationAssociationProfessionnelleSimpleModel().setIdAssociationProfessionnelle(searchModel.getForIdCotisationAssociationProfessionnelle());;
    ...
    public void setCurrentEntity(ParametreCotisationAssociationComplexModel entite) {
        ...
        currentEntity.getParametreCotisationAssociationSimpleModel().setIdCotisationAssociationProfessionnelle(
                searchModel.getForIdCotisationAssociationProfessionnelle());
    }
