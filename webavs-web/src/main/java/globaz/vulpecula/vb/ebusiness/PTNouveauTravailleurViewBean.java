...
public class PTNouveauTravailleurViewBean extends BJadePersistentObjectViewBean {
    ...
    public PTNouveauTravailleurViewBean() {
        super();
    }

    public List<Convention> getConventions() {
        return VulpeculaRepositoryLocator.getConventionRepository().findAll();
    }
