...
public abstract class AUAbstractDoc extends FWIDocumentManager {
    /**
     * 
     */
    ...
    protected String formatMessage(StringBuffer message, Object[] args) {
        return AUAbstractDoc.formatMessage(message.toString(), args);
    }
    ...
    protected String getTexte(int niveau, int position, Object[] args) throws FWIException {
        ...
        try {
            if (args != null) {
                texte = AUAbstractDoc.formatMessage(getCatalogue().getTextes(niveau).getTexte(position)
                        .getDescription(), args);
            } else {
