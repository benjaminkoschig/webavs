...
public class GFFormulaireViewBean extends BJadePersistentObjectViewBean {
    ...
    public void add() throws Exception {
        formulaire = GFEFormServiceLocator.gfEFormService().create(formulaire);
    }

    @Override
    public void delete() throws Exception {
        GFEFormServiceLocator.gfEFormService().delete(formulaire.getId());
    }
    ...
    public void retrieve() throws Exception {
        formulaire = GFEFormServiceLocator.gfEFormService().read(getId());
        try {
    ...
    public void update() throws Exception {
        ...
        GFEFormServiceLocator.gfEFormService().update(formulaire);
    }
