...
public class TUJournalRecapF1V2List extends FWIAbstractManagerDocumentList {
    ...
    public void _beforeExecuteReport() {
        ...
        _setDocumentTitle("Journal détaillé pour le mois : ");
        ...
        String title = "Journal détaillé pour le mois : " + journal.getMoisAlpha() + " " + journal.getAnnee();
    ...
    protected void summary() throws FWIException {
        ...
        while (it.hasNext()) {
            ...
            // n'affiche pas les catégories si l'ensemble est à zéro
