...
public enum SpecificationMessage {
    MESSAGE_ANNEE_MANQUANTE("MESSAGE_ANNEE_MANQUANTE"),
    MESSAGE_ANNEE_OBLIGATOIRE("MESSAGE_ANNEE_OBLIGATOIRE"),
    ANNEE_REQUISE("ANNEE_REQUISE"),
    EMPLOYEUR_MANQUANT("EMPLOYEUR_MANQUANT"),
    PT_PASSAGE_MANQUANT("PT_PASSAGE_MANQUANT"),
    ...
    PARAMETRE_COTISATION_AP_FACTEUR_MANQUANT("PARAMETRE_COTISATION_AP_FACTEUR_MANQUANT"),
    ...
    DECOMPTE_COMPLEMENTAIRE_EXISTANT("DECOMPTE_COMPLEMENTAIRE_EXISTANT"),
    DECOMPTE_DATE_RECEPTION_INEXISTANTE("DECOMPTE_DATE_RECEPTION_INEXISTANTE"),
    ...
    POSTE_TRAVAIL_DATE_DEBUT_COTISATION_APRES_DATE_DEBUT_POSTE("POSTE_TRAVAIL_DATE_DEBUT_COTISATION_APRES_DATE_DEBUT_POSTE"),
    ...
    POSTE_TRAVAIL_DATE_DEBUT_PERIODE_ACTIVITE_APRES_DEBUT_AFFILIATION("POSTE_TRAVAIL_DATE_DEBUT_PERIODE_ACTIVITE_APRES_DEBUT_AFFILIATION"),
    POSTE_TRAVAIL_DATE_DEBUT_PERIODE_ACTIVITE_AVANT_FIN_AFFILIATION("POSTE_TRAVAIL_DATE_DEBUT_PERIODE_ACTIVITE_AVANT_FIN_AFFILIATION"),
    POSTE_TRAVAIL_DATE_FIN_PERIODE_ACTIVITE_AVANT_FIN_AFFILIATION("POSTE_TRAVAIL_DATE_FIN_PERIODE_ACTIVITE_AVANT_FIN_AFFILIATION"),
    ...
    POSTE_TRAVAIL_COTISATION_AVS_REQUISE("POSTE_TRAVAIL_COTISATION_AVS_REQUISE"),
    POSTE_TRAVAIL_COTISATION_FA_REQUISE("POSTE_TRAVAIL_COTISATION_FA_REQUISE"),
    ...
    SALAIRES_AVS_LISTES_TYPE_DECOMPTE_REQUISE("SALAIRES_AVS_LISTES_TYPE_DECOMPTE_REQUISE"),
    ...
    ASSOCIATION_COTISATION_A_SUPPRIMER_UTILISEE_DANS_FACTURE("ASSOCIATION_COTISATION_A_SUPPRIMER_UTILISEE_DANS_FACTURE"),
    ASSOCIATION_COTISATION_A_MODIFIER_UTILISEE_DANS_FACTURE("ASSOCIATION_COTISATION_A_MODIFIER_UTILISEE_DANS_FACTURE"),
    ...
    AP_AUCUNE_ADRESSE_DE_PAIEMENT_ADMINISTRATION("AP_AUCUNE_ADRESSE_DE_PAIEMENT_ADMINISTRATION"),
    EMPTY_NSS("EMPTY_NSS");
