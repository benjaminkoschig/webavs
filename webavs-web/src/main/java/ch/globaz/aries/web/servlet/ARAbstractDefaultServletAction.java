...
/**
 * Default servlet action pour l'application ARIES
 * 
 * @author mmmo
 * 
 */
public abstract class ARAbstractDefaultServletAction extends FWDefaultServletAction {

    public ARAbstractDefaultServletAction(FWServlet aServlet) {
        super(aServlet);
    }
