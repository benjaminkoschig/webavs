 ...
 * @author jts
 */
public interface OverlapInformationModelService extends JadeApplicationService {
     ...
     * @see ch.globaz.al.business.models.rafam.OverlapInformationModel
     */
    public OverlapInformationModel read(String idErreurAnnonce) throws JadeApplicationException,
            JadePersistenceException;
