 ...
 * @author jts
 */
public interface ProtocoleRecapitulatifPaiementDirectService extends JadeApplicationService {

    /**
     * Charge et retourne la structure de données du protocole récapitulatif de paiement direct
     * 
     * @param listeRecap
     ...
     *             faire
     */
    public DocumentData getProtocoleDocumentData(Collection<PaiementRecapitulatifBusinessModel> listeRecap,
