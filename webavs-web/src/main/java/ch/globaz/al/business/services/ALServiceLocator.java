...
public abstract class ALServiceLocator {
    ...
    public static AdiDecompteComplexModelService getAdiDecompteComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AdiDecompteComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AdiDecompteComplexModelService.class);
    }
    ...
    public static AdiDecomptesService getAdiDecomptesService() throws JadeApplicationServiceNotAvailableException {
        return (AdiDecomptesService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AdiDecomptesService.class);
    }
    ...
    public static AdiEnfantMoisComplexModelService getAdiEnfantMoisComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AdiEnfantMoisComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AdiEnfantMoisComplexModelService.class);
    }
    ...
    public static AdiSaisieComplexModelService getAdiSaisieComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AdiSaisieComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AdiSaisieComplexModelService.class);
    }
    ...
    public static AdiSaisieModelService getAdiSaisieModelService() throws JadeApplicationServiceNotAvailableException {
        return (AdiSaisieModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AdiSaisieModelService.class);
    }
    ...
    public static AffiliationBusinessService getAffiliationBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (AffiliationBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AffiliationBusinessService.class);
    }
    ...
    public static AllocataireAgricoleComplexModelService getAllocataireAgricoleComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AllocataireAgricoleComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AllocataireAgricoleComplexModelService.class);
    }
    ...
    public static AllocataireBusinessService getAllocataireBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (AllocataireBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AllocataireBusinessService.class);
    }
    ...
    public static AllocataireComplexModelService getAllocataireComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AllocataireComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AllocataireComplexModelService.class);
    }
    ...
    public static AnnonceRafamComplexModelService getAnnonceRafamComplexModelService()
        ...
        return (AnnonceRafamComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamComplexModelService.class);
    }
    ...
    public static AnnonceRafamCreationService getAnnonceRafamCreationService()
        ...
        return (AnnonceRafamCreationService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamCreationService.class);
    ...
    public static AnnonceRafamDelegueBusinessService getAnnonceRafamDelegueBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnonceRafamDelegueBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamDelegueBusinessService.class);
    }

    public static AnnonceRafamDelegueComplexModelService getAnnonceRafamDelegueComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnonceRafamDelegueComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamDelegueComplexModelService.class);
    }
    ...
    public static AnnonceRafamImportProtocoleService getAnnonceRafamImportProtocoleService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnonceRafamImportProtocoleService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamImportProtocoleService.class);
    }
    ...
    public static AnnonceRafamModelService getAnnonceRafamModelService()
        ...
        return (AnnonceRafamModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnonceRafamModelService.class);
    ...
    public static AnnoncesRafamDelegueProtocoleService getAnnoncesRafamDelegueProtocoleService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnoncesRafamDelegueProtocoleService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnoncesRafamDelegueProtocoleService.class);
    }

    public static AnnoncesRafamErrorBusinessService getAnnoncesRafamErrorBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnoncesRafamErrorBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnoncesRafamErrorBusinessService.class);
    }
    ...
    public static AnnoncesRafamProtocoleService getAnnoncesRafamProtocoleService()
            throws JadeApplicationServiceNotAvailableException {
        return (AnnoncesRafamProtocoleService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AnnoncesRafamProtocoleService.class);
    }
    ...
    public static AttestationsVersementBusinessService getAttestationsVersementBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (AttestationsVersementBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AttestationsVersementBusinessService.class);
    }
    ...
    public static AttributEntiteBusinessService getAttributEntiteBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (AttributEntiteBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AttributEntiteBusinessService.class);
    }
    ...
    public static AttributEntiteModelService getAttributEntiteModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (AttributEntiteModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                AttributEntiteModelService.class);
    }
    ...
    public static BusinessProcessusService getBusinessProcessusService()
            throws JadeApplicationServiceNotAvailableException {
        return (BusinessProcessusService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                BusinessProcessusService.class);
    }
    ...
    public static CalculAdiBusinessService getCalculAdiBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (CalculAdiBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CalculAdiBusinessService.class);
    }
    ...
    public static CalculBusinessService getCalculBusinessService() throws JadeApplicationServiceNotAvailableException {
        return (CalculBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CalculBusinessService.class);
    }
    ...
    public static CalculDroitEditingModelService getCalculDroitEditingModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (CalculDroitEditingModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CalculDroitEditingModelService.class);
    }
    ...
    public static CommentaireModelService getCommentaireModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (CommentaireModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CommentaireModelService.class);
    }
    ...
    public static CompensationFactureBusinessService getCompensationFactureBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (CompensationFactureBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CompensationFactureBusinessService.class);
    }
    ...
    public static CompensationFactureProtocolesService getCompensationFactureProtocolesService()
            throws JadeApplicationServiceNotAvailableException {
        return (CompensationFactureProtocolesService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CompensationFactureProtocolesService.class);
    ...
    public static ComplementDelegueModelService getComplementDelegueModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (ComplementDelegueModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ComplementDelegueModelService.class);
    }
    ...
    public static ConfigProcessusModelService getConfigProcessusModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (ConfigProcessusModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ConfigProcessusModelService.class);
    }
    ...
    public static CopieComplexModelService getCopieComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (CopieComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CopieComplexModelService.class);
    }
    ...
    public static CopiesBusinessService getCopiesBusinessService() throws JadeApplicationServiceNotAvailableException {
        return (CopiesBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                CopiesBusinessService.class);
    }
    ...
    public static DatesEcheanceService getDatesEcheanceService() throws JadeApplicationServiceNotAvailableException {
        return (DatesEcheanceService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DatesEcheanceService.class);
    }
     ...
     *             Exception levée si le service n'est pas accessible
     */
    public static DecisionBuilderService getDecisionBuilderService() throws JadeApplicationServiceNotAvailableException {
        return (DecisionBuilderService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DecisionBuilderService.class);
    }
     ...
     * @throws JadeApplicationServiceNotAvailableException
     */
    public static DecisionEditingService getDecisionEditingService() throws JadeApplicationServiceNotAvailableException {
        return (DecisionEditingService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DecisionEditingService.class);
    }
    ...
    public static DecisionListService getDecisionListService() throws JadeApplicationServiceNotAvailableException {
        return (DecisionListService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DecisionListService.class);
    }
    ...
    public static DecisionProviderService getDecisionProviderService()
            throws JadeApplicationServiceNotAvailableException {
        return (DecisionProviderService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DecisionProviderService.class);
    }
    ...
    public static DeclarationsVersementService getDeclarationsVersementService()
            throws JadeApplicationServiceNotAvailableException {
        return (DeclarationsVersementService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DeclarationsVersementService.class);
    }
    ...
    public static DecompteAdiBusinessService getDecompteAdiBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (DecompteAdiBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DecompteAdiBusinessService.class);
    }
    ...
    public static DecompteAdiModelService getDecompteAdiModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DecompteAdiModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DecompteAdiModelService.class);
    }
    ...
    public static DetailPrestationComplexModelService getDetailPrestationComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DetailPrestationComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DetailPrestationComplexModelService.class);
    }
    ...
    public static DossierAgricoleComplexModelService getDossierAgricoleComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DossierAgricoleComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DossierAgricoleComplexModelService.class);
    }
     ...
     *             Exception levée si le service n'est pas accessible
     */
    public static DossierBusinessService getDossierBusinessService() throws JadeApplicationServiceNotAvailableException {
        return (DossierBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DossierBusinessService.class);
    }
    ...
    public static DossierComplexModelService getDossierComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DossierComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DossierComplexModelService.class);
    }
    ...
    public static DossierDecisionComplexModelService getDossierDecisionComplexeModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DossierDecisionComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DossierDecisionComplexModelService.class);
    }
    ...
    public static DossierLieComplexModelService getDossierLieComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DossierLieComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DossierLieComplexModelService.class);
    }
    ...
    public static DossierListComplexModelService getDossierListComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DossierListComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DossierListComplexModelService.class);
    }
    ...
    public static DossierModelService getDossierModelService() throws JadeApplicationServiceNotAvailableException {
        return (DossierModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DossierModelService.class);
    }
    ...
    public static DroitComplexModelService getDroitComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DroitComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DroitComplexModelService.class);
    }
    ...
    public static DroitEcheanceComplexModelService getDroitEcheanceComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (DroitEcheanceComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DroitEcheanceComplexModelService.class);
    }
    ...
    public static DroitEcheanceService getDroitEcheanceService() throws JadeApplicationServiceNotAvailableException {
        return (DroitEcheanceService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                DroitEcheanceService.class);
    }
    ...
    public static EnfantBusinessService getEnfantBusinessService() throws JadeApplicationServiceNotAvailableException {
        return (EnfantBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnfantBusinessService.class);
    }
    ...
    public static EnfantComplexModelService getEnfantComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (EnfantComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnfantComplexModelService.class);
    }
    ...
    public static EntetePrestationModelService getEntetePrestationModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (EntetePrestationModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EntetePrestationModelService.class);
    }
    ...
    public static EnvoiComplexModelService getEnvoiComplexService() throws JadeApplicationServiceNotAvailableException {
        return (EnvoiComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnvoiComplexModelService.class);
    }
    ...
    public static EnvoiTemplateComplexModelService getEnvoiTemplateComplexService()
            throws JadeApplicationServiceNotAvailableException {
        return (EnvoiTemplateComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                EnvoiTemplateComplexModelService.class);
    }

    public static ErreurAnnonceRafamModelService getErreurAnnonceRafamModelService()
            throws JadeApplicationServiceNotAvailableException {

        return (ErreurAnnonceRafamModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ErreurAnnonceRafamModelService.class);
    ...
    public static ErrorPeriodModelService getErrorPeriodModelService()
        ...
        return (ErrorPeriodModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ErrorPeriodModelService.class);
    ...
    public static ExportAnnoncesRafamService getExportAnnoncesRafamService()
        ...
        return (ExportAnnoncesRafamService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ExportAnnoncesRafamService.class);
    ...
    public static GenerationAffilieService getGenerationAffilieService()
            throws JadeApplicationServiceNotAvailableException {
        return (GenerationAffilieService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                GenerationAffilieService.class);
    }
    ...
    public static GenerationDossierService getGenerationDossierService()
            throws JadeApplicationServiceNotAvailableException {
        return (GenerationDossierService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                GenerationDossierService.class);
    }
    ...
    public static ImpressionEcheancesService getImpressionEcheancesServices()
            throws JadeApplicationServiceNotAvailableException {
        return (ImpressionEcheancesService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ImpressionEcheancesService.class);
    }
    ...
    public static LangueAllocAffilieService getLangueAllocAffilieService()
            throws JadeApplicationServiceNotAvailableException {
        return (LangueAllocAffilieService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                LangueAllocAffilieService.class);
    }
    ...
    public static LettreAccompagnementCopieService getLettreAccompagnementCopieService()
            throws JadeApplicationServiceNotAvailableException {
        return (LettreAccompagnementCopieService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                LettreAccompagnementCopieService.class);
    }
    ...
    public static NumeroFactureService getNumeroFactureService() throws JadeApplicationServiceNotAvailableException {
        return (NumeroFactureService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                NumeroFactureService.class);
    }

    public static OverlapInformationModelService getOverlapInformationModelService()
            throws JadeApplicationServiceNotAvailableException {

        return (OverlapInformationModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                OverlapInformationModelService.class);
    ...
    public static PeriodeAFBusinessService getPeriodeAFBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (PeriodeAFBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                PeriodeAFBusinessService.class);
    }
    ...
    public static PeriodeAFModelService getPeriodeAFModelService() throws JadeApplicationServiceNotAvailableException {
        return (PeriodeAFModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                PeriodeAFModelService.class);
    }
    ...
    public static PersonneAFComplexModelService getPersonneAFComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (PersonneAFComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                PersonneAFComplexModelService.class);
    ...
    public static PrestationBusinessService getPrestationBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (PrestationBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                PrestationBusinessService.class);
    }
    ...
    public static ProcessusPeriodiqueModelService getProcessusPeriodiqueModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProcessusPeriodiqueModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProcessusPeriodiqueModelService.class);
    }
    ...
    public static ProtocoleDecisionsMasseService getProtocoleDecisionsMasseService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleDecisionsMasseService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleDecisionsMasseService.class);
    }
    ...
    public static ProtocoleDroitEcheancesService getProtocoleDroitEcheancesService()
            throws JadeApplicationServiceNotAvailableException {
        return (ProtocoleDroitEcheancesService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                ProtocoleDroitEcheancesService.class);
    ...
    public static RadiationAffilieProtocoleService getRadiationAffilieProtocoleService()
            throws JadeApplicationServiceNotAvailableException {
        return (RadiationAffilieProtocoleService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                RadiationAffilieProtocoleService.class);
    }
    ...
    public static RadiationAffilieService getRadiationAffilieService()
            throws JadeApplicationServiceNotAvailableException {
        return (RadiationAffilieService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                RadiationAffilieService.class);
    }
    ...
    public static RadiationAutomatiqueService getRadiationAutomatiqueService()
            throws JadeApplicationServiceNotAvailableException {
        return (RadiationAutomatiqueService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                RadiationAutomatiqueService.class);
    }
    ...
    public static RecapitulatifEntrepriseBusinessService getRecapitulatifEntrepriseBusinessService()
            throws JadeApplicationServiceNotAvailableException {
        return (RecapitulatifEntrepriseBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                RecapitulatifEntrepriseBusinessService.class);
    }
    ...
    public static RecapitulatifEntrepriseImpressionService getRecapitulatifEntrepriseImpressionService()
            throws JadeApplicationServiceNotAvailableException {
        return (RecapitulatifEntrepriseImpressionService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                RecapitulatifEntrepriseImpressionService.class);
    }
    ...
    public static RecapitulatifEntrepriseModelService getRecapitulatifEntrepriseModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (RecapitulatifEntrepriseModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                RecapitulatifEntrepriseModelService.class);
    }
    ...
    public static TarifBusinessService getTarifBusinessService() throws JadeApplicationServiceNotAvailableException {
        return (TarifBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                TarifBusinessService.class);
    }
    ...
    public static TauxMonnaieEtrangereModelService getTauxMonnaieEtrangereModelService()
        ...
        return (TauxMonnaieEtrangereModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                TauxMonnaieEtrangereModelService.class);
    ...
    public static TemplateTraitementListComplexModelService getTemplateTraitementListComplexModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (TemplateTraitementListComplexModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                TemplateTraitementListComplexModelService.class);
    }
    ...
    public static TraitementPeriodiqueModelService getTraitementPeriodiqueModelService()
            throws JadeApplicationServiceNotAvailableException {
        return (TraitementPeriodiqueModelService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                TraitementPeriodiqueModelService.class);
    }
    ...
    public static TucanaBusinessService getTucanaBusinessService() throws JadeApplicationServiceNotAvailableException {
        return (TucanaBusinessService) JadeApplicationServiceLocator.getInstance().getServiceImpl(
                TucanaBusinessService.class);
    }
