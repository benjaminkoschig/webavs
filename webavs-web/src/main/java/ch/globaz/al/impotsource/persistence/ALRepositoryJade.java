...
import ch.globaz.common.persistence.*;
 ...
 */
public abstract class ALRepositoryJade<T extends DomainEntity, S extends JadeSimpleModel> implements Repository<T> {
    ...
    public static <T> List<T> searchByLot(final Collection<String> ids, final SearchLotExecutor<T> executor) {
        return ALRepositoryJade.searchByLot(ids, executor, ALRepositoryJade.NBMAX_ELEMENTS_PER_LOT);
    }
    ...
    public T create(final T entity) {
        ...
        return ALRepositoryJade.create(entity, model);
    }
        ...
        List<JadeAbstractModel> list = searchByLot(domaineJadeAbstractSearchModel.getForIds(),
                new SearchLotExecutor<JadeAbstractModel>() {
                    ...
                    public List<JadeAbstractModel> execute(List<String> ids) {
                        JadeAbstractSearchModel search = ALRepositoryJade.this.search(domaineJadeAbstractSearchModel);
