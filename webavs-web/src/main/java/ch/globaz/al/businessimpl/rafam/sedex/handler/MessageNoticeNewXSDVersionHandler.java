 ...
 *
 */
public class MessageNoticeNewXSDVersionHandler implements MessageHandler {
     ...
     *            Le message à traiter
     */
    public MessageNoticeNewXSDVersionHandler(NoticeType message) {
    ...
    private AnnonceRafamModel updateAnnonce(AnnonceRafamModel annonce)
        ...
        // return code
        if ((message.getReturnCode() == 0) && RafamTypeAnnonce._68C_ANNULATION
                .equals(RafamTypeAnnonce.getRafamTypeAnnonce(annonce.getTypeAnnonce()))) {
            annonce.setCodeRetour(RafamReturnCode.ANNULEE.getCode());
        } else {
            annonce.setCodeRetour(
                    RafamReturnCode.getRafamReturnCode(String.valueOf(message.getReturnCode())).getCode());
        }
