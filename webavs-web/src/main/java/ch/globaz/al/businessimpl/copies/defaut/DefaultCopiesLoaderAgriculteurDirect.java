...
/**
 * Classe de chargement des copies par défaut pour un agriculteur/collaborateur agricole/pêcheur/vigneron avec paiement
 * direct
 * 
 * @author jts
 * 
 */
public class DefaultCopiesLoaderAgriculteurDirect extends DefaultCopiesLoaderAbstract {
     ...
     */
    public DefaultCopiesLoaderAgriculteurDirect(ContextDefaultCopiesLoader context) {
