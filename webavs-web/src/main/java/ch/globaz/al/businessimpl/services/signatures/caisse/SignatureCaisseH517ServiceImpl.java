...
public class SignatureCaisseH517ServiceImpl extends ALAbstractBusinessServiceImpl implements SignatureCaisseH515Service {
    ...
    public String getLibelleSignature(String activiteAllocataire, String typeDocument) throws JadeApplicationException,
        ...
        return ALConstDocument.SIGNATURE_CAISSE_H517;
    }
