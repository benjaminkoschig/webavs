 ...
 *
 */
public class MessageReceiptNewXSDVersionHandler implements MessageHandler {
     ...
     *            Le message à traiter
     */
    public MessageReceiptNewXSDVersionHandler(ReceiptType message) {
    ...
    private void processErreur(AnnonceRafamModel annonce) throws JadeApplicationException, JadePersistenceException {
        ...
        ALImplServiceLocator.getAnnonceRafamBusinessService()
                .validateForRecordNumber(message.getRecordNumber().toString(), true);
    }
    ...
    private void processMessage(AnnonceRafamModel annonce) throws JadeApplicationException, JadePersistenceException {
        ...
        ALImplServiceLocator.getAnnonceRafamBusinessService()
                .validateForRecordNumber(message.getRecordNumber().toString(), false);
    ...
    private void processTraiteOuAnnule(AnnonceRafamModel annonce)
            throws JadeApplicationException, JadePersistenceException, JadeApplicationServiceNotAvailableException {

        processMessage(annonce);

        ALImplServiceLocator.getAnnonceRafamBusinessService()
                .validateEnAttenteForRecordNumber(message.getRecordNumber().toString(), true);
    }
    ...
    public AnnonceRafamModel traiterMessage(Map<String, Object> params)
        ...
        AnnonceRafamModel annonce = ALImplServiceLocator.getAnnoncesRafamNewXSDVersionSearchService()
                .getAnnonceForReceipt(message);
     ...
     *             faire
     */
    private AnnonceRafamModel updateAnnonce(AnnonceRafamModel annonce)
            throws JadeApplicationException, JadePersistenceException {
        ...
        if (RafamReturnCode.ANNULEE
                .equals(RafamReturnCode.getRafamReturnCode(String.valueOf(message.getReturnCode())).getCode())) {
