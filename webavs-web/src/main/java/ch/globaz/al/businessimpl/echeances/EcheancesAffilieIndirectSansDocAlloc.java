...
/**
 * 
 * Implémentation des services d'échéances liées aux droits à imprimer et destinés à l'affilié indirect sans document
 * pour l'allocataire
 * 
 * avec texte2
 * 
...
public class EcheancesAffilieIndirectSansDocAlloc extends EcheancesAffilieAbstract {
    ...
    /**
     * Méthode ajoutant le texte de fin dans le document à imprimer pour l'affilié indirect sans document pour
     * l'allocataire
     * 
     * @param document
     *            document à imprimer
