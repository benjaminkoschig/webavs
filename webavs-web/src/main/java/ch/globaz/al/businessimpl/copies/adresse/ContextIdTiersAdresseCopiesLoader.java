 ...
 * 
 */
public class ContextIdTiersAdresseCopiesLoader {
     ...
     */
    public static ContextIdTiersAdresseCopiesLoader getInstance(DossierComplexModel dossier, String typeCopie,
            String idTiers) throws JadeApplicationException {
        ...
        return new ContextIdTiersAdresseCopiesLoader(dossier, typeCopie, idTiers);
    }
     ...
     *            id du tiers en copie
     */
    private ContextIdTiersAdresseCopiesLoader(DossierComplexModel dossier, String typeCopie, String idTiers) {
