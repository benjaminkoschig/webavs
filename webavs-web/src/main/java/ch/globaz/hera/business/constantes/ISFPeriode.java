package ch.globaz.hera.business.constantes;

/*
 * Créé le 16 aout 2010
 */

/**
 * Copies des constantes "Type periode" contenues dans "hera interface"
 * 
 * @author bsc
 */
public interface ISFPeriode {
    ...
    public final static String CS_TYPE_PERIODE_CERTIFICAT_DE_VIE = "36002012";
