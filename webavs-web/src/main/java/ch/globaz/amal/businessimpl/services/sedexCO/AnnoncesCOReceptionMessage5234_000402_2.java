...
public class AnnoncesCOReceptionMessage5234_000402_2 extends AnnoncesCOReceptionMessage5234_000401_1 {
    ...
    private SimpleAnnonceSedexCO saveAnnonce(Class<?>[] addClasses, Message message) {
        ...
        try {
            ...
            annonceSedexCO.setStatementStartDate(AMSedexRPUtil.getDateXMLToString(message.getContent()
                    .getCertificateOfLossFinalStatement().getStatementStartDate()));
            annonceSedexCO.setStatementEndDate(AMSedexRPUtil.getDateXMLToString(message.getContent()
