...
public interface IAMCodeSysteme {
    ...
    public enum AMRubriqueRevenu {
        ...
        PERTE_ACTIVITE_AGRICOLE("150"),
        PERTE_ACTIVITE_AGRICOLE_C("150c"),
        PERTE_ACTIVITE_INDEP("140"),
        PERTE_ACTIVITE_INDEP_C("140c"),
        ...
        // IAMCodeSysteme.CS_RUBRIQUE_ALLOCATIONFAMILLE),
        // DEDUCTION_APPRENTIS_ETUDIANTS(
        // IAMCodeSysteme.CS_RUBRIQUE_DEDUCAPPRENTIETUDIANT),
        // EXCEDENT_DEPENSE_PROP_IMMO_COMMERCIALE(
        // IAMCodeSysteme.CS_RUBRIQUE_EXCEDENTDEPENSESPROPIMMOCOMM),
        // EXCEDENT_DEPENSE_PROP_IMMOB_PRIVE(
        // IAMCodeSysteme.CS_RUBRIQUE_EXCEDENTDEPENSESPROPIMMOPRIVE),
        // EXCEDENT_DEPENSE_SUCCESSION_NON_PARTAGEE(
        // IAMCodeSysteme.CS_RUBRIQUE_EXCEDENTDEPSUCCNONPART),
        // FORTUNE_IMPOSABLE(
        // IAMCodeSysteme.CS_RUBRIQUE_FORTUNEIMPOSABLE),
        // FORTUNE_TAUX(
        // IAMCodeSysteme.CS_RUBRIQUE_FORTUNETAUX),
        // INDEMNITE_IMPOSABLE(
        // IAMCodeSysteme.CS_RUBRIQUE_INDEMNITEIMPOSABLE),
        // INTERETS_PASSIFS_COMMERCIAUX(
        // IAMCodeSysteme.CS_RUBRIQUE_INTERETSPASSIFSCOMM),
        // INTERETS_PASSIFS_PRIVE(
        // IAMCodeSysteme.CS_RUBRIQUE_INTERETSPASSIFSPRIVE),
        // PERSONNE_CHARGE_OU_ENFANTS(
        // IAMCodeSysteme.CS_RUBRIQUE_PERSONNECHARGEENFANT),
        // PERTE_ACTIVITE_ACC_INDEP(
        // IAMCodeSysteme.CS_RUBRIQUE_PERTEACTIVITEACCESSINDEP),
        // PERTE_ACTIVITE_AGRICOLE(
        // IAMCodeSysteme.CS_RUBRIQUE_PERTEACTIVITEAGRIC),
        // PERTE_ACTIVITE_INDEP(
        // IAMCodeSysteme.CS_RUBRIQUE_PERTEACTIVITEINDEP),
        // PERTE_EXERCICES_COMM(
        // IAMCodeSysteme.CS_RUBRIQUE_PERTESEXERCICESCOMM),
        // PERTE_LIQUIDATION(
        // IAMCodeSysteme.CS_RUBRIQUE_PERTELIQUIDATION),
        // PERTE_SOCIETE(
        // IAMCodeSysteme.CS_RUBRIQUE_PERTESOCIETE),
        // RENDEMENT_FORTUNE_IMMOB_COMMERCIALE(
        // IAMCodeSysteme.CS_RUBRIQUE_RENDEMENTFORTUNEIMMOBCOMM),
        // RENDEMENT_FORTUNE_IMMOB_PRIVE(
        // IAMCodeSysteme.CS_RUBRIQUE_RENDEMENTFORTUNEIMMOBPRIVE),
        // REVENU_IMPOSABLE(
        // IAMCodeSysteme.CS_RUBRIQUE_REVENUIMPOSABLE),
        // REVENU_NET_EMPLOI(
        // IAMCodeSysteme.CS_RUBRIQUE_REVENUNETEMPLOI),
        // REVENU_NET_EPOUSE(
        // IAMCodeSysteme.CS_RUBRIQUE_REVENUNETEPOUSE),
        // REVENU_TAUX(
        // IAMCodeSysteme.CS_RUBRIQUE_REVENUTAUX),
        // TOTAL_REVENUS_NETS(
        // IAMCodeSysteme.CS_RUBRIQUE_TOTAUXREVENUSNETS);
        // Value storage
        private final String value;
