...
public enum PcaSitutation {
    ...
    public static PcaSitutation resolve(PcaGenre pcaGenreRequerant, PcaGenre pcaGenreConjoint,
    ...
    public boolean isCoupleSepare() {
        if (isCoupleSepareRequerantEnHome() || isCoupleSepareConjoinEnHome() || isCoupleSepareLesDeuxHome()) {
            return true;
        } else {
            return false;
        }
