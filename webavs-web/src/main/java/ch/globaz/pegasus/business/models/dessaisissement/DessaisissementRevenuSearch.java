 ...
 * 
 */
public class DessaisissementRevenuSearch extends AbstractDonneeFinanciereSearchModel {
    ...
    private String forIdDessaisissementRevenu = null;
    ...
    public String getForIdDessaisissementRevenu() {
        return forIdDessaisissementRevenu;
    }
    ...
    public void setForIdDessaisissementRevenu(String forIdDessaisissementRevenu) {
        this.forIdDessaisissementRevenu = forIdDessaisissementRevenu;
    }
    ...
    public Class whichModelClass() {
        return DessaisissementRevenu.class;
    }
