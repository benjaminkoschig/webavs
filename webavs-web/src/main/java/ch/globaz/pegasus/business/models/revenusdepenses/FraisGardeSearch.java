...
public class FraisGardeSearch extends AbstractDonneeFinanciereSearchModel {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    private String forIdFraisGarde = null;
    private String forIdEntity = null;
    private String forNumeroVersion = null;
    private String idDroitMembreFamille = null;

    public String getForIdFraisGarde() {
        return forIdFraisGarde;
    }
    ...
    public void setForIdFraisGarde(String forIdFraisGarde) {
        this.forIdFraisGarde = forIdFraisGarde;
    }
