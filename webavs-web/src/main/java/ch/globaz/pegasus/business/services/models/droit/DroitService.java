...
public interface DroitService extends JadeApplicationService {
    ...
    /**
     * Permet de charger en mémoire un sejourMoisPartielHome
     *
     * @param idSejourMoisPartielHome
     *            L'identifiant du sejourMoisPartielHome
     * @return laesejourMoisPartielHome en stock chargé en mémoire
     * @throws JadePersistenceException
     *             Levée en cas de problème dans la couche de persistence
     * @throws DroitException
     *             Levée en cas de problème métier dans l'exécution du service
     ...
     *
     * @param droit
     *            le droit dont le sejourMoisPartielHome à modifier dépend
     * @param droitMembreFamille
    ...
    /**
     * Permet de chercher les Assurances maladies liées à un droit
     *
     * @param search
     *            Le modèle de critères
     * @return Le modèle de critère avec les résultats
