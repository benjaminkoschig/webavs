...
public class AssuranceVieSearch extends AbstractDonneeFinanciereSearchModel {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    private String forIdAssuranceVie = null;
    private String forIdEntity = null;
    private String forNumeroVersion = null;
    private String idDroitMembreFamille = null;

    public String getForIdAssuranceVie() {
        return forIdAssuranceVie;
    }
    ...
    public void setForIdAssuranceVie(String forIdAssuranceVie) {
        this.forIdAssuranceVie = forIdAssuranceVie;
    }
