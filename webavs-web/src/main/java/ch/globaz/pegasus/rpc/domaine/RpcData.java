...
public class RpcData {
    ...
    private boolean isMotifDeces() {
        return ConverterDecisionCause.convert(getVersionDroit(), rpcDecisionRequerantConjoints.get(0).getRequerant().getDecision().getMotif(), false).compareTo(BigInteger.valueOf(4)) == 0;
    }
