...
public class PeriodePCAccordee implements Serializable, IPeriodePCAccordee {
    ...
    private final static Map<String, Attribut> mappageLegendesVarMetFinalisation = new HashMap<String, Attribut>() {
        ...
        {
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE, Attribut.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_LEGENDE);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_HOME, Attribut.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_HOME_LEGENDE);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_MAISON, Attribut.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_MAISON_LEGENDE);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_VIEILLESSE_ENFANT, Attribut.CS_FRACTIONS_FORTUNE_VIEILLESSE_ENFANT_LEGENDE);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_VIEILLESSE_HOME, Attribut.CS_FRACTIONS_FORTUNE_VIEILLESSE_HOME_LEGENDE);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_VIEILLESSE_MAISON, Attribut.CS_FRACTIONS_FORTUNE_VIEILLESSE_MAISON_LEGENDE);
            put(IPCVariableMetier.CS_REFORME_FRACTIONS_FORTUNE_SEPARE_VIEILLESSE_HOME, Attribut.CS_REFORME_FRACTIONS_FORTUNE_SEPARE_VIEILLESSE_HOME);
            put(IPCVariableMetier.CS_REFORME_FRACTIONS_FORTUNE_SEPARE_NON_VIEILLESSE_HOME, Attribut.CS_REFORME_FRACTIONS_FORTUNE_SEPARE_NON_VIEILLESSE_HOME);
            ...
            put(IPCVariableMetier.CS_PLAFOND_ANNUEL_SPEN, Attribut.CS_PLAFOND_ANNUEL_LITS_SPEN);
    ...
    private final static Map<String, Attribut> mappageVarMet = new HashMap<String, Attribut>() {
...

        {
            ...
            put(IPCVariableMetier.CS_TAUX_IMPUTATION_LOYER_FRAIS_ACQUISITION, Attribut.CS_TAUX_IMPUTATION_LOYER_FRAIS_ACQUISITION);
            put(IPCVariableMetier.CS_TAUX_IMPUTATION_SOUSLOCATIONS_FRAIS_ACUISITION, Attribut.CS_TAUX_IMPUTATION_SOUSLOCATIONS_FRAIS_ACUISITION);
            put(IPCVariableMetier.CS_PLAFOND_ANNUEL_EMS, Attribut.CS_PLAFOND_ANNUEL_EMS);
            put(IPCVariableMetier.CS_PLAFOND_ANNUEL_INSTITUTION, Attribut.CS_PLAFOND_ANNUEL_INSTITUTION);
            put(IPCVariableMetier.CS_PLAFOND_ANNUEL_LITS_ATTENTE, Attribut.CS_PLAFOND_ANNUEL_LITS_ATTENTE);
            put(IPCVariableMetier.CS_PLAFOND_ANNUEL_SPEN, Attribut.CS_PLAFOND_ANNUEL_LITS_SPEN);
            put(IPCVariableMetier.CS_FRACTIONS_FRAIS_ENTRETIEN_IMMEUBLE, Attribut.FRAIS_ENTRETIEN_IMMEUBLE);
            put(IPCVariableMetier.CS_FRACTIONS_FRAIS_ENTRETIEN_IMMEUBLE_MOINS_10_ANS, Attribut.FRAIS_ENTRETIEN_IMMEUBLE_MOINS_10_ANS);
            put(IPCVariableMetier.CS_FRACTIONS_FRAIS_ENTRETIEN_IMMEUBLE_PLUS_20_ANS_PRINCIPALE, Attribut.FRAIS_ENTRETIEN_IMMEUBLE_PLUS_20_ANS_PRINCIPALE);
            put(IPCVariableMetier.CS_FRACTIONS_FRAIS_ENTRETIEN_IMMEUBLE_MOINS_20_ANS_ANNEXE, Attribut.FRAIS_ENTRETIEN_IMMEUBLE_MOINS_20_ANS_ANNEXE);
            ...
            put(IPCVariableMetier.CS_REFORME_FORFAIT_FRAIS_CHAUFFAGE, Attribut.CS_REFORME_FORFAIT_FRAIS_CHAUFFAGE);
            put(IPCVariableMetier.CS_REFORME_FORFAIT_CHARGES, Attribut.CS_REFORME_FORFAIT_CHARGES);
        }
    };
    private final static Map<String, Attribut> mappageVarMetFinalisation = new HashMap<String, Attribut>() {
        ...
        {
            put(IPCVariableMetier.CS_2091_DPC, Attribut.CS_2091_DPC);
            put(IPCVariableMetier.CS_DEDUCTION_FORAITAIRE_IMMOBILIER_ASSURE, Attribut.CS_DEDUCTION_FORFAITAIRE_IMMOBILIER_ASSURE);
            put(IPCVariableMetier.CS_DEDUCTION_FORAITAIRE_FORTUNE_CELIBATAIRES, Attribut.CS_DEDUCTION_FORTUNE_CELIBATAIRE);
            ...
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_HOME, Attribut.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_HOME);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_MAISON, Attribut.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE_MAISON);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_VIEILLESSE_ENFANT, Attribut.CS_FRACTIONS_FORTUNE_VIEILLESSE_ENFANT);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_VIEILLESSE_HOME, Attribut.CS_FRACTIONS_FORTUNE_VIEILLESSE_HOME);
            put(IPCVariableMetier.CS_FRACTIONS_FORTUNE_VIEILLESSE_MAISON, Attribut.CS_FRACTIONS_FORTUNE_VIEILLESSE_MAISON);
            put(IPCVariableMetier.CS_REFORME_FRACTIONS_FORTUNE_SEPARE_VIEILLESSE_HOME, Attribut.CS_REFORME_FRACTIONS_FORTUNE_SEPARE_VIEILLESSE_HOME);
            put(IPCVariableMetier.CS_REFORME_FRACTIONS_FORTUNE_SEPARE_NON_VIEILLESSE_HOME, Attribut.CS_REFORME_FRACTIONS_FORTUNE_SEPARE_NON_VIEILLESSE_HOME);
            put(IPCVariableMetier.CS_FRANCHISE_REVENUS_PRIVILEGIERS_CELIBATAIRES, Attribut.CS_FRANCHISE_REVENUS_PRIVILEGIERS_CELIBATAIRES);
            put(IPCVariableMetier.CS_FRANCHISE_REVENUS_PRIVILEGIERS_FAMILLE, Attribut.CS_FRANCHISE_REVENUS_PRIVILEGIERS_FAMILLE);
            put(IPCVariableMetier.CS_BESOINS_VITAUX_2_ENFANTS, Attribut.CS_BESOINS_VITAUX_2_ENFANTS);
            put(IPCVariableMetier.CS_CATEGORIE_ARGENT_POCHE_LVPC_ESE_HANDICAP_PHYSIQUE, Attribut.CS_CATEGORIE_ARGENT_POCHE_LVPC_ESE_HANDICAP_PHYSIQUE);
            put(IPCVariableMetier.CS_CATEGORIE_ARGENT_POCHE_LVPC_EMS_NONMED_PSY, Attribut.CS_CATEGORIE_ARGENT_POCHE_LVPC_EMS_NONMED_PSY);
            put(IPCVariableMetier.CS_CATEGORIE_ARGENT_POCHE_LVPC_EMS_NOMMED_AGE_AVANCE, Attribut.CS_CATEGORIE_ARGENT_POCHE_LVPC_EMS_NOMMED_AGE_AVANCE);
            ...
            put(IPCVariableMetier.DEPENSE_LOYER_PLAFOND_FAUTEUIL_ROULANT, Attribut.DEPENSE_LOYER_PLAFOND_FAUTEUIL_ROULANT);
            put(IPCVariableMetier.CS_REFORME_DEPENSE_LOYER_PLAFOND_FAUTEUIL_ROULANT, Attribut.CS_REFORME_DEPENSE_LOYER_PLAFOND_FAUTEUIL_ROULANT);
            ...
            put(IPCVariableMetier.CS_DEDUCTION_FORAITAIRE_IMMOBILIER_ASSURE_HOME_API, Attribut.CS_DEDUCTION_FORFAITAIRE_IMMOBILIER_ASSURE_HOME_API);
            put(IPCVariableMetier.CS_AMORTISSEMENT_ANNUEL_DESSAISISSEMENT_FORTUNE, Attribut.CS_AMORTISSEMENT_ANNUEL_DESSAISISSEMENT_FORTUNE);
            put(IPCVariableMetier.MENSUALISATION_IJ_CHOMAGE, Attribut.MENSUALISATION_IJ_CHOMAGE);
            put(IPCVariableMetier.CS_TAUX_IMPUTATION_SOUSLOCATIONS_FRAIS_ACUISITION, Attribut.CS_TAUX_IMPUTATION_SOUSLOCATIONS_FRAIS_ACUISITION);
            put(IPCVariableMetier.CS_PLAFOND_ANNUEL_EMS, Attribut.CS_PLAFOND_ANNUEL_EMS);
            put(IPCVariableMetier.CS_FRACTIONS_FRAIS_ENTRETIEN_IMMEUBLE, Attribut.FRAIS_ENTRETIEN_IMMEUBLE);
            ...
            put(IPCVariableMetier.CS_REFORME_DEDUCTION_FORAITAIRE_FORTUNE_CELIBATAIRES, Attribut.CS_REFORME_DEDUCTION_FORTUNE_CELIBATAIRES);
            put(IPCVariableMetier.CS_REFORME_DEDUCTION_FORAITAIRE_FORTUNE_COUPLES, Attribut.CS_REFORME_DEDUCTION_FORTUNE_COUPLES);
            put(IPCVariableMetier.CS_REFORME_FORFAIT_CHARGES, Attribut.CS_REFORME_FORFAIT_CHARGES);
        }
    };
...
//            }
     ...
     *
     * @param dateReforme : la date de début de réforme
     * @throws CalculException
     *             en cas d'erreur lors du calcul
     */
