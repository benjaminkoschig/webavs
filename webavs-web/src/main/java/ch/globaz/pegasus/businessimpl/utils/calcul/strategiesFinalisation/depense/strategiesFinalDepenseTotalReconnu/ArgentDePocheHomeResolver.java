...
public class ArgentDePocheHomeResolver {
    ...
    enum CS_WITH_CALCUL_MAPPING {
        ...
        CS_SPEN(IPCTaxeJournaliere.CS_CATEGORIE_SPEN, Attribut.MONTANT_TYPE_CHAMBRE_SPEN),
        CS_DGEJ_SESAF(IPCTaxeJournaliere.CS_CATEGORIE_DGEJ_SESAF, Attribut.MONTANT_TYPE_CHAMBRE_DGEJ_SESAF),
        CS_DGEJ_FOYER(IPCTaxeJournaliere.CS_CATEGORIE_DGEJ_FOYER, Attribut.MONTANT_TYPE_CHAMBRE_DGEJ_FOYER),
        CS_DGEJ_FA(IPCTaxeJournaliere.CS_CATEGORIE_DGEJ_FA, Attribut.MONTANT_TYPE_CHAMBRE_DGEJ_FA);
