...
public class StrategieRevenuActiviteDependanteConjoint extends StrategieCalculRevenu implements IStrategieDessaisissable {
    ...
    protected TupleDonneeRapport calculeRevenu(CalculDonneesCC donnee, CalculContext context,
        ...
        String cleActiviteDependante = IPCValeursPlanCalcul.CLE_REVEN_ACT_LUCR_ACTIVITE_DEPENDANTE_CONJOINT;
        String cleRevenuActiviteDeductionsSociales = IPCValeursPlanCalcul.CLE_REVEN_ACT_LUCR_DEDUCTION_SOCIALES_CONJOINT;
        String cleRevenuActiviteDeductionsLpp = IPCValeursPlanCalcul.CLE_REVEN_ACT_LUCR_DEDUCTION_LPP_CONJOINT;
