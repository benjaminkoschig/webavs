...
public class StrategieFinalTotal implements StrategieCalculFinalisation {
    ...
    /**
     * Méthode de calcul de la strategie final total après réforme.
     *
     * @param donnee
     * @param context
    ...
    private void calculFinalReforme(TupleDonneeRapport donnee, CalculContext context) throws CalculException {
        // Calcul de la différence dépenses - revenues
    ...
    /**
     * Méthode de calcul de la stratégie final totale avant réforme.
     *
     * @param donnee
     * @param context
     * @throws CalculException
