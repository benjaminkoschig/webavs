...
public class StrategieRevenuActiviteDependanteEnfant extends StrategieCalculRevenu implements IStrategieDessaisissable {
    ...
    protected TupleDonneeRapport calculeRevenu(CalculDonneesCC donnee, CalculContext context,
        ...
        String cleActiviteDependante = IPCValeursPlanCalcul.CLE_REVEN_ACT_LUCR_ACTIVITE_DEPENDANTE_ENFANT;
        String cleRevenuActiviteDeductionsSociales = IPCValeursPlanCalcul.CLE_REVEN_ACT_LUCR_DEDUCTION_SOCIALES_ENFANT;
        String cleRevenuActiviteDeductionsLpp = IPCValeursPlanCalcul.CLE_REVEN_ACT_LUCR_DEDUCTION_LPP_ENFANT;
        String cleRevenuActiviteFraisObtention = IPCValeursPlanCalcul.CLE_REVEN_ACT_LUCR_FRAIS_OBTENTION_REVENU_ENFANT;
