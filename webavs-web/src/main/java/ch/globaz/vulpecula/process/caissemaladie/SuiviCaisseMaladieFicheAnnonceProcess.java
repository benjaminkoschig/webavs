...
public class SuiviCaisseMaladieFicheAnnonceProcess extends SuiviCaisseMaladieAbstractProcess {
    ...
    protected Map<Administration, Collection<SuiviCaisseMaladie>> getSuivis() {
        return VulpeculaServiceLocator.getSuiviCaisseMaladieService()
                .findSuivisFichesAnnoncesNonEnvoyeesGroupByCaisseAF();
    }

    @Override
    protected String getEMailObject() {
        return DocumentConstants.SUIVI_CAISSE_FA_NAME;
    }
