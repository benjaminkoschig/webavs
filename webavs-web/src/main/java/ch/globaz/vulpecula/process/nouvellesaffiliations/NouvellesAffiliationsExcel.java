...
public class NouvellesAffiliationsExcel extends AbstractListExcel {
    private static final String SHEET_TITLE = "Nouvelles affiliations";
    ...
    public NouvellesAffiliationsExcel(BSession session, String filenameRoot, String documentTitle) {
