package ch.globaz.eform.business.services.sedex.handlers;

import eform.ch.eahv_iv.xmlns.eahv_iv_2514_007440._1.HeaderType;
import eform.ch.eahv_iv.xmlns.eahv_iv_2514_007440._1.Message;
import globaz.jade.service.exception.JadeApplicationRuntimeException;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class GF2514007440Handler extends GFFormHandler {
    @Override
    protected void extractData() throws RuntimeException {
        try {
            ...
            LOG.error("GF2514007440Handler#extractData - EErreur de type de message.", e);
