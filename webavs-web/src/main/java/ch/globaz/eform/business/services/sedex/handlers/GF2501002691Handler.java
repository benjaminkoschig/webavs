...
import eform.ch.eahv_iv.xmlns.eahv_iv_2501_002691._1.HeaderType;
import eform.ch.eahv_iv.xmlns.eahv_iv_2501_002691._1.Message;
import globaz.jade.service.exception.JadeApplicationRuntimeException;
import lombok.extern.slf4j.Slf4j;

@Slf4j
public class GF2501002691Handler extends GFFormHandler {
    @Override
    protected void extractData() throws RuntimeException {
        try {
            ...
            LOG.error("2691Erreur de type de message.", e);
