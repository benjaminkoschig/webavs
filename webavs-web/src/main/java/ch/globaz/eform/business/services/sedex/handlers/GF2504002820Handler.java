...
import eform.ch.eahv_iv.xmlns.eahv_iv_2504_002820._1.HeaderType;
import eform.ch.eahv_iv.xmlns.eahv_iv_2504_002820._1.Message;
...
public class GF2504002820Handler extends GFFormHandler {
    ...
    protected void extractData() throws RuntimeException {
        try {
            ...
            LOG.error("GF2504002820#extractData - Erreur de type de message.", e);
