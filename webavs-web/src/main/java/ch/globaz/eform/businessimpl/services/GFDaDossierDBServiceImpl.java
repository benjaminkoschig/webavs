...
public class GFDaDossierDBServiceImpl implements GFDaDossierDBService {
    ...
    public GFDaDossierModel create(GFDaDossierModel gfDaDossierModel, ValidationResult validationResult) throws JadePersistenceException {
        if (Objects.isNull(gfDaDossierModel)) throw new IllegalArgumentException("Unable to create gfeFormModel, the model passed is null!");
        if (Objects.isNull(validationResult)) throw new IllegalArgumentException("Unable to create validationResult, the result passed is null!");
        if (GFDaDossierValidator.isExists(gfDaDossierModel.getMessageId())) throw new IllegalArgumentException("Unable to create gfDaDossierModel, the model passed is already in database id : " + gfDaDossierModel.getMessageId() + "!");
    ...
    public boolean delete(String messageId) throws JadePersistenceException {
        if (Objects.isNull(messageId)) throw new IllegalArgumentException("Unable to delete GFDaDossierModel, the message id passed is null!");
        if (!GFDaDossierValidator.isExists(messageId)) throw new IllegalArgumentException("Unable to delete GFDaDossierModel, the model passed is not in database!");
    ...
    public int delete(GFDaDossierSearch search) throws JadePersistenceException {
        if (Objects.isNull(search)) throw new IllegalArgumentException("Unable to delete gfDaDossierSearch, the search passed is null!");
    ...
    public GFDaDossierModel read(String id) throws JadePersistenceException {
        if (Objects.isNull(id)) throw new IllegalArgumentException("Unable to read GFDaDossierModel, the id passed is null!");
    ...
    public GFDaDossierSearch search(GFDaDossierSearch search) throws JadePersistenceException {
        if (Objects.isNull(search)) throw new IllegalArgumentException("Unable to search GFDaDossierSearch, the search passed is null!");
    ...
    public GFDaDossierModel update(GFDaDossierModel model) throws JadePersistenceException {
        if (Objects.isNull(model)) throw new IllegalArgumentException("Unable to update GFDaDossierModel, the model passed is null!");
