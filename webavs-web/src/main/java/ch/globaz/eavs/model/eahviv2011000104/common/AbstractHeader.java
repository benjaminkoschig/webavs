...
public abstract class AbstractHeader extends CommonModel implements EAVSNonFinalNode {
    ...
    public abstract AbstractExtension getExtension();
    ...
    public abstract AbstractOriginalSenderId getOriginalSenderId();
    ...
    public abstract AbstractTestData getTestData();
    ...
    public abstract void setOriginalSenderId(EAVSAbstractModel _originalSenderId);
