 ...
 */
public class CO001ExecuterPremierRappel extends COAbstractDelaiPaiementAction {
    ...
    protected void _execute(COContentieux contentieux, List taxes, BTransaction transaction)
        ...
        try {
            CO00ARappelPaiement rappel = new CO00ARappelPaiement(transaction.getSession());
