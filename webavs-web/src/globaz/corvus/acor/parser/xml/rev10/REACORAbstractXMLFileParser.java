 ...
 * @author scr
 */
public class REACORAbstractXMLFileParser {
     ...
     * est vrai et qu'il n'y a pas de node de ce nom. La date dans le noeud est au format AAAAMMJJ -> nouveau format
     * ACOR
     * 
     * @param nodes
     * @param nodeName
     ...
     * @throws PRACORException
     */
    protected static final String getNodeChildDateAAAAMMJJValue(Map nodes, String nodeName, String childName,
            boolean required) throws PRACORException {
        String date = getNodeChildValue(nodes, nodeName, childName, required);
        date = PRDateFormater.convertDate_AAAAMMJJ_to_JJxMMxAAAA(date);
    ...
    protected static final String getNodeChildValue(Map nodes, String nodeName, String childName, boolean required)
        ...
        if (parent != null) {
            Node child = null;
            try {
                child = findChildNode(parent, childName);
            } catch (Exception e) {
                child = null;
            }
     ...
     * @throws PRACORException
     */
    protected static final String getNodeDateAAAAMMJJValue(Map nodes, String name, boolean required)
            throws PRACORException {
     ...
     * @throws PRACORException
     */
    protected static final void save(BSession session, BTransaction transaction, BEntity entity) throws PRACORException {
        entity.setSession(session);
