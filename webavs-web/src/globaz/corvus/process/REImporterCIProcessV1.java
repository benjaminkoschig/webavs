...
import globaz.corvus.api.arc.downloader.REDownloaderInscriptionsCIV1;
 ...
 * @author: bsc
 */
public class REImporterCIProcessV1 extends BProcess {
    ...
    private static String[] jasperToArray(REImporterCIProcessV1 process) {
    ...
    public static void main(String[] args) {
        ...
        REImporterCIProcessV1 myProcess = new REImporterCIProcessV1();
        ...
        try {
            ...
            if (myProcess.getMemoryLog().isOnErrorLevel()) {
                ...
                REImporterCIProcessV1.sendError(new Exception(), myProcess);

                // erreur critique, je retourne un code d'erreur 200
                System.exit(REImporterCIProcessV1.CODE_RETOUR_ERREUR);
            } else {
                // le mail des resultats
                REImporterCIProcessV1.sendResult(myProcess);
                ...
                System.exit(REImporterCIProcessV1.CODE_RETOUR_OK);
            }

        } catch (Exception e) {
            try {
                REImporterCIProcessV1.sendError(e, myProcess);
            } catch (Exception e2) {
    ...
    private static void sendError(Exception e, REImporterCIProcessV1 process) throws Exception {
        // les destinataires
        List mails = REImporterCIProcessV1.loadMails(
    ...
    private static void sendResult(REImporterCIProcessV1 process) throws Exception {
        // les destinataires
        List mails = REImporterCIProcessV1.loadMails(
                process.getSession().getApplication().getProperty(REApplication.RESPONSABLE_CI), process.getSession());
        ...
        JadeSmtpClient.getInstance().sendMail(JadeConversionUtil.toStringArray(mails),
                ...
                REImporterCIProcessV1.jasperToArray(process));
    }
     ...
     * @param pwd
     */
    public REImporterCIProcessV1(String uid, String pwd) {
        super();
        setUserID(uid);
        setPwd(pwd);
    }
    ...
    protected boolean _executeProcess() throws Exception {
        ...
        REDownloaderInscriptionsCIV1 rci = new REDownloaderInscriptionsCIV1(transaction, getSession());
