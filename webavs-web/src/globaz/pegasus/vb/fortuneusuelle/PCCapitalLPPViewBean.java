 ...
 * 
 */
public class PCCapitalLPPViewBean extends PCAbstractRequerantDonneeFinanciereViewBean {
    ...
    public void retrieve() throws Exception {
        ...
        search.setWhereKey("forVersionedCapitalLPP");
        ...
        for (Iterator it = Arrays.asList(search.getSearchResults()).iterator(); it.hasNext();) {
            ...
            if (donnee.getDonneeFinanciere() instanceof CapitalLPP) {
