...
public class PCAutresRevenusViewBean extends PCAbstractRequerantDonneeFinanciereViewBean {
    ...
    public String getTypeEcheance() {
        return EcheanceType.AUTRE_REVENU.toString();
    }
    ...
    public void retrieve() throws Exception {
        ...
        search.setWhereKey("forVersionedAutresRevenus");
        ...
        for (Iterator it = Arrays.asList(search.getSearchResults()).iterator(); it.hasNext();) {
            ...
            if (donnee.getDonneeFinanciere() instanceof SimpleAutresRevenus) {
