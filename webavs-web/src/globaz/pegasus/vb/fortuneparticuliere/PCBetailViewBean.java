 ...
 * 
 */
public class PCBetailViewBean extends PCAbstractRequerantDonneeFinanciereViewBean {
    ...
    public void retrieve() throws Exception {
        ...
        search.setWhereKey("forVersionedBetail");
        ...
        for (Iterator it = Arrays.asList(search.getSearchResults()).iterator(); it.hasNext();) {
            ...
            if (donnee.getDonneeFinanciere() instanceof SimpleBetail) {
