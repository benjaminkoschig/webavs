 ...
 * @author dda
 */
public class CARecapRubriquesExcelManager extends BManager {
    ...
    protected BEntity _newEntity() throws Exception {
        return new CARecapRubriquesExcel();
    }
    ...
    private String getWhereRubriqueLike() {
        if (!JadeStringUtil.isBlank(getFromIdExterne())) {
            return " AND b." + CARubrique.FIELD_IDEXTERNE + " LIKE '" + getFromIdExterne() + "%'";
        } else {
            return "";
        }
    }
