...
public class AVSUtils {
    ...
    /**
     * Method formatAVS8Or9. Formatte un numéro AVS Si à 11, renvoit avec des points Si à 9 ou 8, renvoit sans les zéros
     * 
     * @param numAVS
     *            , numéro AVS, avec ou sans points, avec ou sans zéros
     * @return String, le numéro AVS formatté
     */
    ...
    /**
     * Method formatAVS8Or9. Formatte un numéro AVS Si à 11, renvoit avec des points Si à 9 ou 8, renvoit sans les zéros
     * Si numéro bizarre, renvoit tel que reçu
     * 
     * @param numAVS
     *            , numéro AVS, avec ou sans points, avec ou sans zéros
     * @param wantZeros
     *            si on veut les zéros significatifs
     * @return String, le numéro AVS formatté
     */
    ...
    /**
     * Method formatAVS8Or9. Formatte un numéro AVS
     * 
     * @param numAVS
     *            , numéro AVS, avec ou sans points, avec ou sans zéros
     * @param wantZeros
    ...
    public static String formatAVS8Or9(String numAVS, boolean wantZeros, boolean wantDots) {
        ...
        // on complète à 11 si nécessaire
    ...
    public static String getBirthDateFromAVS(String numAVS) throws JAException, ParseException {
        ...
        // TODO teste l'année à deux chiffres avec l'année courante
        // et détermine l'année sur 4 digits
    ...
    /**
     * Method getSexFromAVS. renvoit 1 pour un homme, 2 pour une femme, vide quand le numéro est incorrect
     * 
     * @param numAVS
     * @return String
     * @throws JAException
            ...
            while ((crt = (CICompteIndividuel) c.cursorReadNext(statement)) != null) {
                try {
                    ...
                    if (!crt.getNumeroAvs().substring(0, 2).equals(a.getNumeroAvs().substring(0, 2))) {
                        System.out.println("Numéro pas égal : calculé=" + a.getNumeroAvs() + " contre numéro ci="
     ...
     * 
     * @param nameGroup
     *            le groupe du nom (123.xx.xxx.xxx) fixé manuellement
     * @param dateNaissance
    ...
    /**
     * Method setFormat. le format par défaut est JJ.MM.AAAA si vous voulez changer le format depuis
