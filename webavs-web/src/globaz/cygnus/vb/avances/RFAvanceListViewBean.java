...
public class RFAvanceListViewBean extends REAvanceManager {
    /**
     * 
     */
    ...
    protected void _afterFind(BTransaction transaction) throws Exception {
        ...
        for (int i = 0; i < resultSet.size(); i++) {
            RFAvanceViewBean uneAvance = (RFAvanceViewBean) resultSet.get(i);
