 ...
 * 
 */
public class RFNombrePersonnesJointDemandesStatistiquesSash extends RFTypeDeSoin {
    ...
    public static final String createFromClause(String schema) {
        ...
        // Jointure entre la table des QD de base et la table des QD Base - Dossier
        fromClauseBuffer.append(innerJoin);
        fromClauseBuffer.append(schema);
    ...
    private String idDossierQd = null;
    ...
    protected void _readProperties(BStatement statement) throws Exception {
        ...
        idDossierQd = statement.dbReadString(RFAssQdDossier.FIELDNAME_ID_ASS_QD_DOSSIER);
    ...
    public String getIdDossierQd() {
        return idDossierQd;
    }

    public void setIdDossierQd(String idDossierQd) {
        this.idDossierQd = idDossierQd;
    }
