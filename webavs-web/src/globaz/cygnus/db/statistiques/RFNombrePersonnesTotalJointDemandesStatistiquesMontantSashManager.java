 ...
 * 
 */
public class RFNombrePersonnesTotalJointDemandesStatistiquesMontantSashManager extends BManager {
    ...
    public RFNombrePersonnesTotalJointDemandesStatistiquesMontantSashManager() {
        super();
    }
    ...
    protected String _getFields(BStatement statement) {
        ...
        fields.append("DISTINCT " + RFDemande.FIELDNAME_ID_DOSSIER + " "
                + RFNombrePersonnesTotalJointDemandesStatistiquesMontantSashManager.ALIAS_NOMBRE_PERSONNE);
    ...
    protected String _getFrom(BStatement statement) {
        if (fromClause == null) {
            ...
            StringBuffer from = new StringBuffer(
                    RFNombrePersonnesTotalJointDemandesStatistiquesMontantSash.createFromClause(_getCollection()));
    ...
    protected BEntity _newEntity() throws Exception {
        return new RFNombrePersonnesTotalJointDemandesStatistiquesMontantSash();
    }
