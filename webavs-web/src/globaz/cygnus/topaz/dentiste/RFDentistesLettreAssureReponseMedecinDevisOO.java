 ...
 * author fha
 */
public class RFDentistesLettreAssureReponseMedecinDevisOO extends RFAbstractDocumentOO {
    ...
    public void chargerCatalogueTexte() throws Exception {
        ...
        documentHelper.setCsTypeDocument(IRFCatalogueTexte.CS_DENTISTE_LETTRE_ASSURE_REPONSE_MEDECIN_CONSEIL_DEVIS);
    ...
    public JadePrintDocumentContainer remplir(JadePrintDocumentContainer documentContainer, RFDocumentsProcess process,
        ...
        return super.remplir(documentContainer, process, getIdTiers(),
                IPRConstantesExternes.RFM_LETTRE_TYPE_DENTISTE_LETTRE_ASSURE_SUITE_REPONSE_MEDECIN_CONSEIL_DEVIS,
                isSendToGed);
    }
