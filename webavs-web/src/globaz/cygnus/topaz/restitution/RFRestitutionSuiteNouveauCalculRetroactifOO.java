 ...
 * author mbo
 */
public class RFRestitutionSuiteNouveauCalculRetroactifOO extends RFAbstractDocumentOO {
    ...
    public void chargerCatalogueTexte() throws Exception {
        ...
        documentHelper.setCsTypeDocument(IRFCatalogueTexte.CS_RESTITUTION_SUITE_NOUVEAU_CALCUL_RETROACTIF);
    ...
    public void chargerDonneesEnTete() throws Exception {
        ...
        try {
            ...
            caisseHelper = CaisseHelperFactory.getInstance().getCaisseReportHelperOO(getSession().getApplication(),
                    codeIsoLangue);
            caisseHelper.setTemplateName(RFRestitutionSuiteNouveauCalculRetroactifOO.FICHIER_MODELE_LETTRE_TYPE_RFM);
    ...
    public JadePrintDocumentContainer remplir(JadePrintDocumentContainer documentContainer, RFDocumentsProcess process,
        ...
        return super.remplir(documentContainer, process, getIdTiers(),
                IPRConstantesExternes.RFM_LETTRE_TYPE_RESTITUTION_SUITE_A_UN_NOUVEAU_CALCUL_RETROACTIF, isSendToGed);
    }
