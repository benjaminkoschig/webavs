...
public class AFActionControlesAEffectuer extends AFDefaultActionChercher {
     ...
     *            DOCUMENT ME!
     */
    public AFActionControlesAEffectuer(FWServlet servlet) {
        super(servlet);
    }
    ...
    protected void actionAfficher(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            AFControlesAEffectuerViewBean viewBean = new AFControlesAEffectuerViewBean();
