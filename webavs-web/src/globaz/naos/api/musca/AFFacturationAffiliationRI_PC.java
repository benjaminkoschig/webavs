 ...
 * @author: btc
 */
public class AFFacturationAffiliationRI_PC extends AFFacturationGenericImpl implements IntModuleFacturation {
    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public AFFacturationAffiliationRI_PC() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        if (appAf.wantOldProcessFacturation()) {
            ...
            procFacturation.setFacturerRI_PC(true);
