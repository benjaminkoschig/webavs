 ...
 * @author: btc
 */
public class AFFacturationAffiliationPersoIndTseImpl extends AFFacturationGenericImpl implements IntModuleFacturation {
    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public AFFacturationAffiliationPersoIndTseImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        if (appAf.wantOldProcessFacturation()) {
            ...
            procFacturation.setTypeFacturationPersonnelle(AFProcessFacturation.PERIODIQUE_COT_PERS_IND);
