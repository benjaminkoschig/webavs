...
public class AFDocumentItextService {
    ...
    public static String formatMessage(String message, String[] args) {
        ...
        for (int i = 0; i < buffer.length(); i++) {
            if (buffer.charAt(i) != '{') {
                ...
                int numArg = Integer.parseInt("" + buffer.charAt(i + 1));
                if (numArg < args.length) {
                    messageFormat.append(args[numArg]);
                } else {
                    messageFormat.append("" + buffer.charAt(i + 1));
                }
                i = i + 2;
            }
        }
    ...
    public static String getTexte(ICTDocument catalogue, int niveau, int position, String[] args) throws FWIException {
        ...
        try {
            if (args != null) {
                texte = AFDocumentItextService.formatMessage(catalogue.getTextes(niveau).getTexte(position)
                        .getDescription(), args);
            } else {
    ...
    public static String getTexte(ICTDocument catalogue, int niveau, String[] args) throws FWIException {
        ...
        try {
            ...
            if (args != null) {
                resString = AFDocumentItextService.formatMessage(resString, args);
            }
    ...
    public static ICTDocument retrieveCatalogue(BSession session, String langueIso, String csDomaine,
        ...
        return AFDocumentItextService.retrieveCatalogue(session, langueIso, csDomaine, csTypeDocument, null, null);
    }
    ...
    /**
     * Constructeur de AFDocumentItextService
     */
    protected AFDocumentItextService() {
