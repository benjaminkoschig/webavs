 ...
 */
public class AFSommationLPP_Doc extends AFAbstractTiersDocument {
    ...
    public AFSommationLPP_Doc() throws Exception {
        super();
    }
     ...
     * @throws Exception
     */
    public AFSommationLPP_Doc(BSession session) throws Exception {
        super(session, session.getLabel(AFSommationLPP_Param.L_NOMDOCSOMMATION));
    }
    ...
    protected void fillDocInfo() {
        getDocumentInfo().setDocumentTypeNumber("0110CAF");
        super.fillDocInfo();
    }
    ...
    public String getCategorie() {
        return CodeSystem.TYPE_CAT_SOMMATION_LPP;
    }
    ...
    public int getNbLevel() {
        return AFSommationLPP_Param.NB_LEVEL;
    }
    ...
    public String getNomDoc() throws Exception {
        return getSession().getLabel(AFSommationLPP_Param.L_NOMDOCSOMMATION);
    }

    @Override
    protected String getTemplate() {
        return AFSommationLPP_Param.TEMPLATE_SOMMATION_LPP;
    }
    ...
    public void setFieldToCatTexte(int i, String value) throws Exception {
        switch (i) {
            case 1:
                this.setParametres(AFSommationLPP_Param.P_TITLE, value);
                break;
            case 2:
                this.setParametres(AFSommationLPP_Param.P_CORPS,
