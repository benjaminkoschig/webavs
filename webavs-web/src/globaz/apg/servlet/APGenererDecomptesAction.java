 ...
 * @author dvh
 */
public class APGenererDecomptesAction extends APDefaultProcessAction {
     ...
     *            DOCUMENT ME!
     */
    public APGenererDecomptesAction(final FWServlet servlet) {
        super(servlet);
    }
    ...
    protected void actionAfficher(final HttpSession session, final HttpServletRequest request,
        ...
        try {
            ...
            final APGenererDecomptesViewBean gcViewBean = (APGenererDecomptesViewBean) viewBean;
