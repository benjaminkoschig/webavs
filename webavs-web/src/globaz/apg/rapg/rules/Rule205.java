...
/**
 * <strong>Règles de validation des plausibilités RAPG</br> Description :</strong></br> Le montant total de l’APG doit
 * être > 0 pour une annonce de type 1. </br><strong>Champs concerné(s) :</strong></br> totalAPG
 * 
 * @author lga
 */
