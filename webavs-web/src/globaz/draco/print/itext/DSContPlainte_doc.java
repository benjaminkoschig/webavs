...
public class DSContPlainte_doc extends DSAbstractPrincipaleGenererEtape {
    /**
     * 
     */
     ...
     * @throws Exception
     */
    public DSContPlainte_doc() throws Exception {
        super();
     ...
     * @throws Exception
     */
    public DSContPlainte_doc(BSession session) throws Exception {
     ...
     * @throws Exception
     */
    public DSContPlainte_doc(BSession session, String nomDocument) throws Exception {
