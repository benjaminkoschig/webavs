...
public class DSContRappelLtn_doc extends DSAbstractPrincipaleGenererEtape {
    /**
     * 
     */
     ...
     * @throws Exception
     */
    public DSContRappelLtn_doc() throws Exception {
        super();
     ...
     * @throws Exception
     */
    public DSContRappelLtn_doc(BSession session) throws Exception {
     ...
     * @throws Exception
     */
    public DSContRappelLtn_doc(BSession session, String nomDocument) throws Exception {
