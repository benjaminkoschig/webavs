...
public class DSContSommationLtn_doc extends DSAbstractPrincipaleGenererEtape {
    /**
     * 
     */
     ...
     * @throws Exception
     */
    public DSContSommationLtn_doc() throws Exception {
        super();
     ...
     * @throws Exception
     */
    public DSContSommationLtn_doc(BSession session) throws Exception {
     ...
     * @throws Exception
     */
    public DSContSommationLtn_doc(BSession session, String nomDocument) throws Exception {
