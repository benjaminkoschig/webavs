...
import globaz.draco.process.DSProcessFacturationAmende;
 ...
 * 
 */
public class DSFacturationAmende extends DSFacturationGenericImpl implements IntModuleFacturation {
    /**
	 * 
	 */
    public DSFacturationAmende() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        DSProcessFacturationAmende procFacturation = new DSProcessFacturationAmende();
