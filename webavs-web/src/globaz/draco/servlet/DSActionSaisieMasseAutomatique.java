...
public class DSActionSaisieMasseAutomatique extends FWDefaultServletAction {
    /**
     ...
     */
    public DSActionSaisieMasseAutomatique(FWServlet servlet) {
        super(servlet);
    }
    ...
    protected void actionAjouter(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            // FWViewBeanInterface viewBean2 =
            // FWViewBeanActionFactory.newInstance(_action,mainDispatcher.getPrefix());
            // // XXX
