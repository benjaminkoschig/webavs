 ...
 * @author dvh
 */
public class IJGenererCompensationsProcess002 extends BProcess implements IIJGenererCompensationProcess {
     ...
     */
    public IJGenererCompensationsProcess002() {
        super();
    }
    ...
    public IJGenererCompensationsProcess002(BProcess parent) {
        super(parent);
    }
     ...
     *            DOCUMENT ME!
     */
    public IJGenererCompensationsProcess002(BSession session) {
        super(session);
    }
                    ...
                    if (sectionEnCours != null) {
                        ...
                        if (Math.abs(montantDejaCompenseSurSectionEnCours.doubleValue()) != Math.abs(Double
                            ...
                            if (Math.abs(Double.parseDouble(compensation.getMontantTotal())) > ((Math.abs(Double
                                ...
                                montantDejaCompenseSurSectionEnCours.add(new FWCurrency(compensation.getMontantTotal()
                                        .toString()));
                            }
