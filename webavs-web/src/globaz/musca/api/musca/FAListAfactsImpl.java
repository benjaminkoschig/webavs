 ...
 * @author: btc
 */
public class FAListAfactsImpl extends FAGenericPrintImpl implements IntModuleFacturation {
    /**
     * Commentaire relatif au constructeur FAListDecomptesMUSCA.
     */
    public FAListAfactsImpl() {
        super();
    }
    ...
    public boolean imprimer(IFAPassage passage, BProcess context) throws Exception {
        ...
        globaz.musca.itext.FAListAfacts_Doc doc = new globaz.musca.itext.FAListAfacts_Doc();
