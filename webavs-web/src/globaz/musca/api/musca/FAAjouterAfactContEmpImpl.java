...
import globaz.musca.process.FAPassageAjouterContEmpProcess;
 ...
 * @author: btc
 */
public class FAAjouterAfactContEmpImpl implements IntModuleFacturation {
    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public FAAjouterAfactContEmpImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        FAPassageAjouterContEmpProcess myProcess = new FAPassageAjouterContEmpProcess();
