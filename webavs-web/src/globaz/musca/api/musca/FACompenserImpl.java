...
public class FACompenserImpl implements IntModuleFacturation {

    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public FACompenserImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        globaz.musca.process.FAPassageCompenserProcess cptProc = new FAPassageCompenserProcess();
