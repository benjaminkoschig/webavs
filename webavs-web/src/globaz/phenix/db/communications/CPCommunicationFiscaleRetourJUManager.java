...
public class CPCommunicationFiscaleRetourJUManager extends CPCommunicationFiscaleRetourManager implements
    ...
    protected String _getFields(BStatement statement) {
        return super._getFields(statement)
                + " ,IKCAPP ,IKNCJU, IKNLOT, IKNNJ1, IKGAJU,IKGTJU,IKBEPO,IKBTMA,IKDNAI,IKNNCO";
    }
