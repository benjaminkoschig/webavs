 ...
 * 
 */
public class PFTraitementAnnuelAvecAFProcess extends PFAbstractJob {
    ...
    public String getDescription() {
        return "Traitement annuel PC Famille avec adaptation des allocations familiales";
    }
    ...
    protected void process() throws Exception {
        try {
            ...
            List<Decision> listDecisions = PerseusServiceLocator.getTraitementAnnuelService()
                    .executerTraitementsAnnuelsAvecAF(getSession(), getLogSession(), getTexteDecision());
