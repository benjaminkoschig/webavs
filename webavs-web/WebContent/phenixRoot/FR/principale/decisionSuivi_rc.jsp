...
<SCRIPT>
// menu 
top.document.title = "Décision - Recherche"
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Recherche d'une décision<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
          <TR> 
            <TD nowrap width="120" align="left">N° affilié</TD>
            <TD nowrap ><INPUT type="text" name="likeNumAffilie"  class="libelleLong"'></TD> 
            <TD width="10"></TD>
            <TD nowrap width="100" align="left">Année</TD>
            <TD nowrap ><INPUT type="text" name="forAnnee" class="numeroCourt"></TD>
            <TD width="10"></TD>
            <TD nowrap width="100">Type</TD>
          ...
          <TR> 
            <TD nowrap width="120" align="left">Nom</TD>
            <TD nowrap ><INPUT type="text" name="likeNom"  class="libelleLong"'></TD> 
            <TD width="10"></TD>
            <TD nowrap width="100" align="left">Prenom</TD>
          ...
          <TR> 
            <TD nowrap width="120" align="left">Fortune/Revenu dét.</TD>
            <TD nowrap ><INPUT type="text" name="forRevenuFortune"  class="montant"'></TD> 
            <TD width="10"></TD>
            <TD nowrap width="100" align="left">Cotisation AVS</TD>
          ...
          <TR> 
            <TD nowrap width="120" align="left">N° de passage</TD>
            <TD nowrap> 
