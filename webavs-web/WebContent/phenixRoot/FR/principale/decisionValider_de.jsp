...
top.document.title = "Cotisation - Décision valider"
function add() {
}
function upd() {
}
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Validation d'une décision<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
     	<TR>
            <TD nowrap colspan="4" style="font-weight : bolder;">Si la décision suivante est correcte, vous devez la valider. Elle sera
            traitée lors du passage indiquée.</TD>
          </TR>
          <TR> 
	   ...
	   <TR>
            <TD nowrap width="120" height="10">Tiers</TD>
            <TD nowrap> 
	   ...
	   <TR>
            <TD nowrap width="120">Décision pour</TD>
            <TD nowrap> 
          ...
          <TR>
            <TD nowrap width="120">Type de décision</TD>
            ...
            <TD nowrap>Validation forcée &nbsp;<input type="checkbox" name="validationForcee"></TD>
          </TR>
		<tr>
         <td>
        ...
        <TR>
        	<TD nowrap width="60">Passage</TD>
            <TD><INPUT type="text" name="idPassage" class="libelleLongDisabled" value="<%=JadeStringUtil.isBlankOrZero(viewBean.getIdPassage())?"":viewBean.getIdPassage()%>" readonly="readonly" >
               <%
	   ...
	   <TR>
           ...
           <% if(CPToolBox.isCaisseCCCVS() && !JadeStringUtil.isBlankOrZero(viewBean.getIdCommunication())) {  %>	
            	<TD nowrap>Mise en Ged &nbsp;<input type="checkbox" name="miseEnGEDValidationRetour"></TD>
            <% } else {  %>
            	<TD nowrap></TD>
            <% }%>
          </TR>
