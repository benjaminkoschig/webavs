...
top.document.title = "Cotisation - Décision initialisation"
function add() {
	//Initialisation
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Création d'une décision<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
	<TR>
            <TD nowrap width="132">N° d'affilié</TD>
		...
		<TD nowrap width="160">&nbsp;</TD>
          ...
          <TR>
            <TD nowrap width="160">Décision pour</TD>
     ...
     <TR> 
          ...
          <TR>
            <TD nowrap width="160">Type de décision</TD>
            <TD nowrap width="202">
