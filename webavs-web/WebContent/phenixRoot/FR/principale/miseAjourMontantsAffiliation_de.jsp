...
top.document.title = "Mise à jour affiliation"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Mise à jour des montants d'affiliations<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
         ...
         <tr>
          ...
          <%--
          <tr>
            <TD>Y compris les décisions validées</TD>
            <TD> 
