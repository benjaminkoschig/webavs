...
top.document.title = "Cotisation - Paramétrage application par canton - Détail"
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Paramétrage application/canton<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	      ...
	      <TD width="50"></TD>
           ...
           <TR>
            <TD nowrap width="160">Genre affilié</TD>
           <TD nowrap>
			<%
          ...
          <TR>
            <TD nowrap width="160">Fonctionnalité</TD>
           <TD nowrap>
			<ct:FWCodeSelectTag 
				name="typeParametre" 
         ...
         <TR id="ligneModeEnvoiSedex">
            <TD nowrap width="160" >Mode de fonctionnement</TD>
           <TD nowrap>
         ...
         <TD nowrap width="110">A partir du</TD>
			            <TD nowrap width="171">
