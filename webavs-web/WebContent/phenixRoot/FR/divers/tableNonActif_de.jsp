...
top.document.title = "Cotisation - Table non actif - Détail"
function add() {
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
  	 ...
  	 <TR> 
          ...
          <TR>
            <TD nowrap width="130">Cotisation mensuelle</TD>
            <TD width="100" nowrap> 
	...
	<TR>
            <TD nowrap width="130">Revenu CI</TD>
