...
top.document.title = "Mise à jour des communications fiscales"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Génération des demandes de communications fiscales<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
         <TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Ce programme met à jour les communications fiscales sur la base des décisions actives (non grisées).</TD>
         </TR>
         <tr>
            <TD>Année</TD>
         ...
         <tr>
          ...
          <tr> 
            <TD width="150" height="20">N° affilié de départ</TD>
             <td>
	           	<ct:FWPopupList 
          	...
          	<tr> 
            	<TD width="150" height="20">N° affilié de fin</TD>
	            <td>
	            <ct:FWPopupList 
		           		name="fromAffilieFin" 
		           		value="" 
