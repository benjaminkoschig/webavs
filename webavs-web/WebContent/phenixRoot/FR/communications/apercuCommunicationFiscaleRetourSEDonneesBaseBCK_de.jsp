...
<%-- tpl:insert page="/theme/detail.jtpl" --%><%@page import="globaz.phenix.db.communications.CPSedexDonneesBase"%>
...
bButtonDelete = false;
idEcran="CCP1017";
CPSedexDonneesBase viewBean = (CPSedexDonneesBase)session.getAttribute ("viewBean");
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<ul>
  			...
  			<li><a  class="selected">Données de base</a></li>
		...
		<TR style="font-size : 14px;">
			<TD> &nbsp;  <INPUT type="hidden"  name="isForBackup" value="<%=viewBean.isForBackup()%>"></TD>
		  ...
		  <TR>
			<TD>
				<INPUT type="text" tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("EMPLOYMENTINCOME", "FR")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("INCOMEFROMSELFEMPLOYMENT", "FR")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("PENSIONINCOME", "FR")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("CAPITAL", "FR")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("NONDOMESTICINCOMEPRESENT", "FR")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("PURCHASINGLPP", "FR")%>" type="text" class="libelleLongDisabled" readonly>
	     ...
	     <TR>
			<TD>
				<INPUT type="text"  tabindex="-1" value="<%=viewBean.getSession().getApplication().getLabel("OASIBRIDGINGPENSION", "FR")%>" type="text" class="libelleLongDisabled" readonly>
