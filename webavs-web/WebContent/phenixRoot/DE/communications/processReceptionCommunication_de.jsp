...
function validate()
{
   ...
   errorObj.text = "Sie müssen den Pfad der Empfangsdatei des Fiskus informieren !";
   showErrors();
   return false;
   }else{
   return true;
...
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<TR>
			<TD nowrap colspan="2" style="font-weight : bolder;">Dieses Programm wird ein Journal erstellen, die die von der Steuerverwaltung gesendeten Steuermeldungen enthält.</TD>
		</TR>
		<TR>
