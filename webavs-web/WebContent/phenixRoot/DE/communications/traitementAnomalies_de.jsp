...
function validate()
{
   ...
   errorObj.text = "Sie müssen den Pfad der Empfangsdatei des Fiskus angeben !";
   showErrors();
   return false;
   }else{
   return true;
...
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<TR>
			<TD nowrap colspan="2" style="font-weight : bolder;">Dieses Programm wird das Versanddatum für die von der Steuerverwaltung übermittelten Anomalienkommunikationen entfernen.</TD>
		</TR>
		<TR>
