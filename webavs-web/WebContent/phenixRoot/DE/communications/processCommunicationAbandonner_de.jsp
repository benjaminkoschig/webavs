...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Aufgabe der Steuermeldung zurück<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
		<TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Dieses Programm ermöglicht, nach der gewählten Auswahl, die Steuermeldungen zurück aufzugeben.</TD>
          </TR>
          <TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Er löscht auch die Steuermeldungen, die nach der Steuermeldung erzeugt gewesen wäre.</TD>
          </TR>
          <TR>
