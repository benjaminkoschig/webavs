...
top.document.title = "Steuermeldungen - Rücksenden"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Rücksendung von Steuermeldungen am Fiskus<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
		<TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Dieses Programm ermöglicht in einer Datei Excel die Fälle aufzulisten, die man dem Fiskus zurücksenden will.</TD>
          </TR>
          <TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Das Rücksendedatum der Steuermeldung, in Zusammenhang mit dem Fall, ist zurückgestellt, wenn das Feld "Simulation" nicht mehr aktiviert ist.</TD>
          </TR>
          <TR>
	   ...
	   <tr> 
            <TD width="50%" height="20">Datum für Excel Datei</TD>
            <TD width="50%"> 
