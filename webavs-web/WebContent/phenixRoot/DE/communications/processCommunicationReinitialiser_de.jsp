...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Zurücksetzung einer Steuermeldung<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
		<TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Dieses Programm ermöglicht zu Zurücksetzen wie bei der Ladung einer Steuermeldung zurück.</TD>
          </TR>
          <TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Er löscht auch die Verfügung, die nach der Steuermeldung erzeugt gewesen wäre.</TD>
          </TR>
          <TR>
