...
<SCRIPT language="JavaScript">
	top.document.title = "Beitrag - Mitteilungsdetail"
	function add() {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Anfrage der Steuermeldungen<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
				            <TD nowrap width="140">Mitteilungs-Nr.</TD>
						...
						<TR>
				            <TD nowrap width="140">DBG Periode-Nr.</TD>
				  ...
				  <!--          <TD nowrap>Code anomalie</TD>
				    ...
				    -->
						...
						<TR>
				            <TD nowrap width="140">An Steuerverwaltung gesendet am</TD>
				            <TD nowrap>
	            			...
	            			<TD></TD>
							<TD nowrap>Annullierter Antrag</TD>
          				...
          				<TR>
				            <TD nowrap width="140">Zurückgesendet am</TD>
				            <TD nowrap>
            				...
            				<TD></TD>
            				<TD nowrap width="140">Gebucht am</TD>
					        ...
					        <TR>
								<TD nowrap width="100">Betroffene Kasse</TD>
								<TD nowrap>
