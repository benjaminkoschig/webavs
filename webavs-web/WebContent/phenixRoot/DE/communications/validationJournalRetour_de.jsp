...
<%
	...
	String btnCustomLabel = "Nachberechnen";
    bButtonValidate = true;
    btnNewLabel = "Nachberechnen";
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Änderung der Verfügung des Journals<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
			      		...
			      		%>
				            <TD><%=viewBean.getSession().getApplication().getLabel("REVENU_AGRICOLE", "DE")%></TD>
				        <% } else { %>
							<TD><%=viewBean.getSession().getApplication().getLabel("REVENU_AUTRE", "DE")%></TD>
				        <% } %>
						...
						<%if(!viewBean.isNonActif()){%>
       					 ...
       					 <TR>
            				<TD nowrap width="200">Ehepartner</TD>
            				            				<TD nowrap width="100">
       					 ...
       					 <TR>
       					 		<TD>
       					 			...
       					 			<a href="<%=redirectCommunicationURL%>" class="external_link">Steuermeldungen zurück</a>
       					 			</ct:ifhasright>
       					 		</TD>
       					 </TR>  
						 <% String redirectDecisionURL = servletContext + "/phenix?userAction=phenix.principale.decision.chercher&selectedId="+idValidation+"&idTiers="+viewBean.getIdTiers()+"&idAffiliation="+viewBean.getIdAffiliation();%> 
       					 <TR>
       					 		<TD>
       					 			...
       					 			<a href="<%=redirectDecisionURL%>" class="external_link">Verfügungen der Person</a>
       					 			</ct:ifhasright>
       					 		</TD>
       					 </TR>
