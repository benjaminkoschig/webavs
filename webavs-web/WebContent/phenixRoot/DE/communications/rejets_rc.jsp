...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Zurückweisung der Steuermeldungen (SEDEX)<%-- /tpl:put --%>
...
<div style="color:red">Es sind <span id="listCount">0</span> Zurückweisung(en) ausgewählt.</div>
			<%-- /tpl:put --%>
