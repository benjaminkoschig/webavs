<%-- tpl:insert page="/theme/process.jtpl" --%><%@page import="globaz.pavo.db.process.CIAnnonceCentraleGenerationViewBean"%>
...
<%
	...
	CIAnnonceCentraleGenerationViewBean viewBean = (CIAnnonceCentraleGenerationViewBean) session.getAttribute ("viewBean");

	//Définition de l'action pour le bouton valider
	userActionValue = "pavo.process.annonceCentraleGeneration.executer";
%>

<SCRIPT language="JavaScript">
	top.document.title = "<ct:FWLabel key='JSP_CI_ANNONCE_CENTRALE_GENERATION_TITLE'/>";
</SCRIPT>
...
<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_CI_ANNONCE_CENTRALE_GENERATION_TITLE"/><%-- /tpl:put --%>
