...
top.document.title = "CI - Calcul de la masse salariale d'un employeur";
</script>
...
<TITLE>Calcul de la masse salariale pour un employeur</TITLE>
<SCRIPT language="JavaScript">
			...
			<TD colspan="3" height="10" class="title">
				<DIV style="width: 100%">
					<SPAN style="float:right; width:100px; font-weight: normal;text-align:right; font-size:8pt"><%=(null==idEcran)?"":idEcran%></SPAN>
						Calcul de la masse salariale d'un employeur
				</DIV>
			</TD>
				...
				<TABLE border="0" cellspacing="0" cellpadding="0" width="<%=subTableWidth%>">
					<TBODY>
						...
						<TR>
							...
							<TD>
								De <input type="text" name="anneeDebut" size="4" maxlength="4" onkeypress="return filterCharForPositivInteger(window.event);"
								value="<%=java.util.Calendar.getInstance().get(java.util.Calendar.YEAR)-2%>">
								&nbsp;
								à <input type="text" name="anneeFin" size="4" maxlength="4" onkeypress="return filterCharForPositivInteger(window.event);" 
						...
						<tr>
							<TD valign="top">
								Comparaison de la masse salariale
							</TD>
							<td colspan="2">
