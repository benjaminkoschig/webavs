...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Réaffecter l'inscription à un CI<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
							<tr>
								<td>NSS (saisi)</td><td> <input type ="text" class='disabled' readonly tabindex='-1' size = "16" value ="<%=viewBean.getNss()%>"></td>
							<tr>
								<td>Nom, Prénom</td><td> <input type ="text" class='disabled' readonly tabindex='-1' size = "80" value ="<%=viewBean.getNomPrenom()%>"></td>
							</tr>	
							<tr>
								<td>
									Employeur
