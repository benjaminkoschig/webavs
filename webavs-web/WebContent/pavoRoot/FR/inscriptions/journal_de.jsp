...
top.document.title = "CI - Détail du journal"
</SCRIPT> <%-- /tpl:put --%>
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un journal d'inscriptions aux CI<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<tr>
            				<td height="38" width="31%">Num&eacute;ro de journal</td>
	   					...
	   					<tr>
            				<td width="31%" height="2">Type d'inscription</td>
            				<td colspan="2" height="2">			
            					...
            					<td width="20%" height="2">&nbsp;</td>
          						...
          						<tr>
            						<td width="31%" height="17">Ann&eacute;e de cotisations</td>
            					...
            					<td width="20%" height="17"><div align="left"></div></td>
          						...
          						<tr>
            						<td width="31%" height="31">Affili&eacute;</td>
								...
								<td height="31" width="20%">&nbsp;</td>
          						...
          						<tr>
            						<td width="31%" height="2">Libell&eacute;</td>
            						<td colspan="2" height="2">
            						<%if ((request.getParameter("_method")!=null)&&(request.getParameter("_method").equals("add"))){%>
          						...
          						<tr>
            							<td width="31%" height="12">Date de r&eacute;ception</td>
								...
								<tr>
            							...
            							<td width="31%" height="12">Date d'inscription</td>
            							<td colspan="2" height="12">
          						...
          						<tr>
            							<td width="31%" height="12">Total des inscriptions pour contr&ocirc;le</td>
            							<td colspan="2" height="12">
									<%if (isJournalGebucht || isJournalPartiel) {%>
          						...
          						<tr>
            							<td width="31%" height="12">Correction sp&eacute;ciale du revenu</td>
            							<td colspan="2" height="12">
            							<%if (isJournalGebucht || isJournalPartiel) {%>
          						...
          						<tr>
            							<td width="31%" height="12">Total calculé des inscriptions</td>
            							<td colspan="2" height="12">
          						...
          						<tr>
            							<td width="31%" height="12">Total factur&eacute;</td>
            							<td colspan="2" height="12">
          						...
          						<tr>
            							<td width="31%" height="2" valign="top">Remarque</td>
          						...
          						<tr>
            							<td width="31%" height="2">Propri&eacute;taire</td>
            							<td colspan="2" height="2">
          						...
          						<tr>
            							...
            							<td width="31%" height="2">Date de cr&eacute;ation</td>
            							<td colspan="2" height="2">
