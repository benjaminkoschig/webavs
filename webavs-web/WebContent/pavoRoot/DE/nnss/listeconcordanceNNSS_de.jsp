...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Konkordanzliste<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						...
						<%--  	 	<td>E-mail : </td><td><input type="text" name="eMailAddress" value="usrext02@globaz.ch" maxlength="40" size="40" style="width:8cm;" >&nbsp;</td> --%>
							...
							<tr>
								<TD style="width:120px">Generierung von Dateien : </TD>
								...
								<ct:FWCodeSelectTag 
									...
									<SELECT name="choix" id="ch" onchange="affSep()">
										<OPTION value='1'>Papier Format (pdf)</OPTION>
										<OPTION value='0'>Elektronisches Format (csv)</OPTION>
									</SELECT>	
															
									&nbsp;&nbsp;&nbsp;Trenner : 								
									<SELECT name="separateur" id="sep" disabled="true">
										<OPTION value='t'>Tabulator</OPTION>
										<OPTION value='p'>Strichpunkt</OPTION> 
									</SELECT>
