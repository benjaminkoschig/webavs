...
top.document.title = "IK - Anzeige der pendente Meldungen";
timeWaiting = 1;
bFind = true;
</SCRIPT>
<%
...
<%@ include file="/theme/find/bodyStart2.jspf" %>
			...
			<tr>
				...
				<td><table>				
		          <tr> 
		            <td width="100" nowrap>Empfangsdatum</td>
			...
			<tr>
				<td><table>				
		          <tr> 
		            <td width="100" nowrap>Verarbeitung</td>
		             <td> 
