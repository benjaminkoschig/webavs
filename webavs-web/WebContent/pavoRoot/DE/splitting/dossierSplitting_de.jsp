...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <tr> 
            <td width="240">Eröffnungsdatum des Dossiers</td>
            <td colspan="5"> 
		...
		codeType="CIMOTSPL" wantBlank="false"/> 
          ...
          <tr> 
            <td width="240">IK-Auszug benötigt</td>
            <td> 
          ...
          <tr> 
            <td width="240">Empfangsbestätigung</td>
            <td colspan="5">
            	 <input type="checkbox"  id="chkAccuseReceptionAssure" name="chkAccuseReceptionAssure" <%=viewBean.getChkAccuseReceptionAssure().booleanValue()?"checked":"unchecked"%> > für den Versicherte
            </td>
          </tr>
          <tr> 
