...
<%
	COTransitionListViewBean viewBean = (COTransitionListViewBean) request.getAttribute("viewBean");
	size = viewBean.size();
	detailLink = "aquila?userAction=aquila.batch.transition.afficher&selectedId=";
%>
...
<%@ include file="/theme/list/lineStyle.jspf" %>
    ...
    <%
		COTransitionViewBean line = (COTransitionViewBean) viewBean.getEntity(i);
		actionDetail = targetLocation  + "='" + detailLink + line.getIdTransition() + "'";
	%>
