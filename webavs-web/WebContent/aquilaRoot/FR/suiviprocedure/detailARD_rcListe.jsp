...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	<TH>&nbsp;</TH>
	<TH align="left">Date ARD</TH>
	<TH align="right">Montant initial</TH>
	<TH align="left">Date opposition</TH>
	<TH align="left">Date recours TCAS</TH>
	<TH align="left">Date recours TFA</TH>
	<TH align="left">Date annulation</TH>
    <%-- /tpl:put --%> 
