...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			...
			Détail d'une ligne d'historique<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	...
	<TD>
		<TABLE>
			...
			<TR>
				<TD class="label">Numéro poursuite</TD>
...
%>
			<TR>
				<TD class="label">Etape<%=annule %></TD>
			...
			<%}%>
			<TR>
				<TD class="label">Exécution par</TD>
			...
			<TR>
				...
				<TD colspan="5">Imputé&nbsp;<INPUT type="checkbox" <%=new Boolean(info.getComplement4()).booleanValue()?"CHECKED":""%>></TD>
			</TR>
				<% } %>
			<TR>
				<TD colspan="8"><HR></TD>
			...
			<TR>
				<TD colspan="2" align="right" class="label">Solde</TD>
				<TD class="control"><INPUT type="text" value="<%=viewBean.getSolde()%>" class="montant disabled" style="width: 100%" readonly></TD>
				<TD colspan="5">&nbsp;</TD>
			</TR>
			<TR>
				<TD colspan="2" align="right" class="label">Dont taxes et intérêts</TD>
