...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Créer ARD<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						...
						<TR>
							<TD colspan="4"><H4>Administrateurs</H4></TD>
						</TR>
						<% if (viewBean.getComptes().isEmpty()) { %>
						<TR>
							<TD colspan="4">Pas d'administrateurs pour ce compte annexe</TD>
						</TR>
						<% } else { %>
						...
						<TR>
								...
								<td colspan="2">
								Responsabilité de <%=ca.getTiers().getPrenomNom()%>, CHF
								</td>
