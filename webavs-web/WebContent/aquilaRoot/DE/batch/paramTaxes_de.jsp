...
<%-- tpl:put name="zoneTitle" --%>Detail einer Gebühr<%-- /tpl:put --%>
...
<%-- tpl:put name="zoneMain" --%>
	...
	<tr>
		<td class="label">Berechnungsbasis</td>
		<td class="control">
