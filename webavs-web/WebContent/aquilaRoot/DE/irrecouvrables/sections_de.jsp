...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Aufteilung der bezahlten Beträge<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						...
						<TR>
							<TD colspan="3"><table>
								...
								<tr>
									<TD></TD>
									<td><input type="checkbox" id="extourneCI" name="extourneCI" value="on" checked><label for="extourneCI">IK-Stornierung ausführen</label></td>
								</tr>
							</table>
							</TD>
						</TR>
						...
						<TR>
							...
							<TH>Geschuldete Betrag</TH>
							<TH>Bezahlter Betrag</TH>
							<TH>Uneintreibbar</TH>
						</TR>
						<TR><TD colspan="4">&nbsp;</TD></TR>
						<TR>
							<TD><b>Verfügbarer Gesamtbetrag</b></TD>
							<TD></TD>
						...
						%>
						<TR>
							<TD><i>Gesamtbetrag für diesen Posten</i></TD>
						...
						<TR>
							<TD><b><i>Neuer verfügbarer Betrag</i></b></TD>
							<TD></TD>
						...
						<TR><TD colspan="4">&nbsp;</TD></TR>
						<TR>
							<TD><b>Gesamtbetrag uneinbringliche</b></TD>
							<TD></TD>
							<TD></TD>
