...
%>
top.document.title = "Zahlungsliste betreffend die Rechtspflege " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Zahlungsliste betreffend die Rechtspflege (Excel)<%-- /tpl:put --%>
...
<TR >
	<TD style="width:200;">Beggindatum der Rechnungsarten</TD>	
	<%
	...
	<TD >Enddatum der Rechnungsarten</td>	
	<TD>
...
<TR >          
	<TD style="width:200;">Auswahl der Rechnungsarten</TD>	
	<TD>
		<select name="forIdTypeOperation">
			<option
				value="<%=COPaiementManager.FOR_ALL_IDTYPEOPERATION%>">Alle</option>
			<%
	...
	<TD style="width:200;">Auswahl der Etappen</TD>	
	<TD><select name="forSelectionEtapes" class="libelleCourt">
		...
		%>
               <option <%=(sForSelectionEtapes.equals("1000")) ? "selected" : "" %> value="1000">Alle</option>
               <option <%=(sForSelectionEtapes.equals("1")) ? "selected" : "" %> value="1">Bis BB</option>
               <option <%=(sForSelectionEtapes.equals("2")) ? "selected" : "" %> value="2">BB und weitere</option>
              </select>
     </TD>
</tr>
