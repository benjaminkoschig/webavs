...
<%-- tpl:put name="zoneTitle" --%>
		...
		<% } %>			
			Verfolgung der Etappen<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
			          ...
			          <TR><TD colspan="8" class="title">Verlauf der Etappen</TD></TR>
						<TR>
						...
						<tr>
							<td class="label" colspan="4">
								...
								<label for="annule">Annullierte Etappen anzeigen</label>
							</td>
							<td class="label" colspan="2"> Sortiert nach
				                <SELECT name="forTriHistorique" class="libelleCourt">
				                  <option selected value="1">Verlauf id</option>
				                  <option value="2">Ausführungsdatum</option>
				                </SELECT>
				            </td>
							<td class="label" colspan="2">
								<input id="triDecroissant" type="checkbox" value="true" name="triDecroissant">
								<label for="triDecroissant">Absteigende Sortierung</label>
							</td>
						</tr>
	 					<%-- /tpl:put --%>
