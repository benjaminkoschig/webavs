...
<%
	//TODO manquant
	idEcran="";
	RFAttestationPiedDePageViewBean viewBean = (RFAttestationPiedDePageViewBean) session.getAttribute("viewBean");
...
<!-- Arrivée sur l'attestation AVS -->
<TR>
	<TD>
		<TBODY id="attestationAVS">
			<TR>
				<TD><ct:FWLabel key="JSP_RF_ATTESTATION_AVS_GENRE_TRAVAUX" /></TD>				
				<TD>
					<ct:FWCodeSelectTag name="csGenreTravauxAVS" codeType="RFGETRA" defaut="<%=viewBean.getCsGenreTravauxAVS() %>" wantBlank="true"/>					
				</TD>								
			</TR>			 
			<tr><td colspan="6"><br></td></tr>	
			<TR>
				<TD><ct:FWLabel key="JSP_RF_ATTESTATION_AVS_TAUX_HORAIRE" /></TD>
				<TD><INPUT type="text" name="tauxHoraireAVS" value="<%=viewBean.getTauxHoraireAVS()%>" /></TD>
			</TR>
			
			<TR class="hidden">
				<TD><ct:FWLabel key="JSP_RF_ATTESTATION_AVS_ID_TIERS" /></TD>
				<TD><INPUT type="text" name="idTiersAVS" value="<%=viewBean.getIdTiersAVS()%>" /></TD>
			</TR>
		</TBODY>		
	</TD>
</TR>
