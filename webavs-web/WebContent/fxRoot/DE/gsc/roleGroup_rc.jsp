...
boolean bButtonNew = objSession.hasRight("fx.gsc.roleGroup.ajouter", FWSecureConstants.ADD);
...
<script>
	usrAction = "fx.gsc.roleGroup.lister";
	...
	<TBODY style="border-width: 0px">
		<TR>
			<TH class="title" colspan="2">
				...
				<DIV style="width: 100%">
					<SPAN class="idEcran">FX0107</SPAN>
					Rollen der Gruppen
				</DIV><%--custom /tpl:put --%>
			</TH>
		</TR>
				...
				<TABLE border="0" height="<%=subTableHeight%>" cellspacing="0" cellpadding="0">
					<TBODY>
						...
						<tr>
							<td>Rolle&nbsp;</td>
							<td>
								<input type="text" class="libelleLong" name="forRoleName" value="<%=(request.getParameter("selectedId")==null)?"":request.getParameter("selectedId")%>">
							</td>
							<td>&nbsp;</td>
							<td>Gruppe&nbsp;</td>
							<td>
								<%
									String groupName = (request.getParameter("forIdGroup") != null ? request.getParameter("forIdGroup") : "");
								%>
								<input type="text" class="libelleLong" name="forGroupName" value="<%=groupName%>">
