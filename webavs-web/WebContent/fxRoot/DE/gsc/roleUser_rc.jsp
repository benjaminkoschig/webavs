...
boolean bButtonNew = objSession.hasRight("fx.gsc.roleUser.ajouter", FWSecureConstants.ADD);
...
<script>
	usrAction = "fx.gsc.roleUser.lister";
	...
	<TBODY style="border-width: 0px">
		<TR>
			<TH class="title" colspan="2">
				...
				<DIV style="width: 100%">
					<SPAN class="idEcran">FX0104</SPAN>
					Rollen der Benutzer
				</DIV>
				<%--custom /tpl:put --%>
			</TH>
				...
				<TABLE border="0" height="<%=subTableHeight%>" cellspacing="0" cellpadding="0">
					<TBODY>
						...
						<tr>
							...
							<td>Visum&nbsp;</td>
							<td>
								<input type="text" class="libelleLong" name="forVisaLike" value="<%=(request.getParameter("visa")==null)?"":request.getParameter("visa")%>">
