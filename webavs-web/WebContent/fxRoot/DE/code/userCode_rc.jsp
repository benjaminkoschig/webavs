...
boolean bButtonNew = objSession.hasRight("fx.code.userCode.ajouter", FWSecureConstants.ADD);
...
<script>
	usrAction = "fx.code.userCode.lister";
	bFind = true;
	<%
		actionNew+="&selectedId="+request.getParameter("selectedId");
	%>
	...
	<TBODY style="border-width: 0px">
		<TR>
			<TH class="title" colspan="2">
				...
				<DIV style="width: 100%">
					<SPAN class="idEcran">FX0204</SPAN>
					Wert der Parameter
				</DIV><%--custom /tpl:put --%>
			</TH>
		</TR>
			...
			<TD>
				<TABLE border="0" height="<%=subTableHeight%>" cellspacing="0" cellpadding="0">
					<TBODY>
						...
						<tr>
						<td>
						<b><%=request.getParameter("libelle")%></b>
	 					<input type="hidden" name="forIdCodeSystem" value ="<%=request.getParameter("selectedId")%>">
