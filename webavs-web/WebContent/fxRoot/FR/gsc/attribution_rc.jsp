...
boolean bButtonNew = objSession.hasRight("fx.gsc.attribution.ajouter", FWSecureConstants.ADD);
...
<TITLE>attribution_rc.jsp</TITLE>
...
<script>
	usrAction = "fx.gsc.attribution.lister";
</script>
	...
	<TBODY style="border-width: 0px">
		<TR>
			<TH class="title" colspan="2">
				...
				<DIV style="width: 100%">
					<SPAN class="idEcran">FX0110</SPAN>
					Attributions
				</DIV><%--custom /tpl:put --%>
			</TH>
		</TR>
					...
					<TBODY>
						...
						<tr>
							...
							<td>
								...
								<input 
									type="text" class="libelleLong" name="forRole" 
									onkeyup="autoComplete(this,'<%=request.getContextPath()%>/fx?userAction=fx.ajax.role.do&roleLike='+this.value)"
									value="<%=(request.getParameter("selectedId")==null)?"":request.getParameter("selectedId")%>">
							</td>
							<td>&nbsp;</td>
							<td>Element&nbsp;</td>
							<td>
								<input type="text" class="libelleLong" name="forElement" 
