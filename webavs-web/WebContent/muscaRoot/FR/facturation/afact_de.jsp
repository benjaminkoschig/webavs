...
%>
top.document.title = "Facturation - Détail afact"
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un afact<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	...
	<TR><TD>
              <TABLE border="0">
                <TBODY>
				<TR> 
					<TD nowrap width="145"><A href="<%=request.getContextPath()%>\musca?userAction=musca.facturation.passage.afficher&selectedId=<%=viewBean.getIdPassage()%>" TITLE="Editer ce passage">Passage</A></TD>
					...
					<td align="right" rowspan="4" width="370">
						<TABLE border="1" cellpadding="5" >
							<TR>
								<TH align="center">Menu auxiliaire</TH>
							</TR>
							<TR >
			              		<TD bordercolor="navy" bgcolor="#BBCCEE">
								<A href="<%=request.getContextPath()%>\musca?userAction=musca.facturation.enteteFacture.chercher&idPassage=<%=viewBean.getIdPassage()%>" tabindex="-1">Retour à la liste des décomptes</A><br>
								<A href="<%=request.getContextPath()%>\musca?userAction=musca.facturation.afact.chercher&idEnteteFacture=<%=viewBean.getIdEnteteFacture()%>" tabindex="-1">Retour à la liste des afacts</A><br>
								<ct:ifhasright element="musca.facturation.passageFacturation.aQuittancer" crud="c">
									<A href="<%=request.getContextPath()%>\musca?userAction=musca.facturation.passageFacturation.aQuittancer&selectedId=<%=viewBean.getIdPassage()%>" tabindex="-1">Retour à la liste des afacs en suspens</A><br><br>
								</ct:ifhasright>
								<%	//teste le passage avant de proposer un nouveau décompte
									if( (!globaz.musca.db.facturation.FAPassage.CS_ETAT_COMPTABILISE.equalsIgnoreCase(passageStatus))
										...
										&& (!globaz.musca.db.facturation.FAPassage.CS_ETAT_ANNULE.equalsIgnoreCase(passageStatus)) ){
											...
											<A href="<%=request.getContextPath()%>\musca?userAction=musca.facturation.enteteFacture.afficher&_method=add&idPassage=<%=viewBean.getIdPassage()%>" tabindex="-1"><b>Création d'un nouveau décompte</b></A><br>
											</ct:ifhasright>
											<%
									}%>
								</TD>
                ...
                <TR> 
					<TD nowrap width="145">Débiteur</TD>
					<TD nowrap> 
				...
				<TR>
					<TD nowrap width="145"><A href="<%=request.getContextPath()%>\musca?userAction=musca.facturation.enteteFacture.afficher&selectedId=<%=viewBean.getIdEnteteFacture()%>" TITLE="Editer ce décompte">Décompte</A></TD>
					<TD nowrap>
                ...
                <TR>
                	<TD nowrap width="145">N° Caisse</TD>
					<TD nowrap> 
      ...
      <!-- Page 1 -->
        ...
        <TBODY>       
	        <TR> 
				<TD nowrap width="145">Type d'afact</TD>
			...
			<TR>
     		...
     		<TR>
            	<TD nowrap width="145">Rubrique</TD>
	            <TD nowrap>
        ...
        <TBODY>
			<TR>
        	    <TD nowrap width="145">Montant</TD>
      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" width="701" id="tStandard">
        <TBODY>
	<TR>
            <TD nowrap width="145">Masse / Taux</TD>
      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" width="701" id="tCompensation">
        <TBODY>
	<TR>
            <TD nowrap width="144">Débiteur à compenser</TD>
            <TD nowrap>
            <ct:FWPopupList 
	...
	<TR>
	  <TD nowrap><A href="<%=request.getContextPath()%>\osiris?userAction=osiris.comptes.apercuParSection.chercher&selectedId=<%=viewBean.getIdCompteAnnexe()%>" TITLE="Editer ce décompte">Décompte à compenser</A></TD>
            <TD nowrap>
          ...
          <TR> 
              <TD nowrap width="145">Date de valeur</TD>
              <TD nowrap> 
      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" width="825" id="tTableau">
           <TBODY>
          <TR>
            <TH width="144">Elément</TH>
            <TH align="center" width="200">Base</TH>
            <TH align="center" width="200">Déjà facturé</TH>
            <TH align="center" width="200">A facturer</TH>
          </TR>
	   	  <TR>
            <TD nowrap width="144">Masse</TD>
          ...
          <TR>
	 	  ...
	 	  <TR>
            <TD nowrap width="144">Montant</TD>
      ...
      <TABLE border="0" cellspacing="0" cellpadding="0" width="701" id="tPeriode">
        <TBODY>
	<TR>
            <TD nowrap width="145" height="26">Année de cotisation </TD>
	...
	<TR>
            <TD nowrap width="145" height="26">P&eacute;riode </TD>
            <TD nowrap width="517" height="26">
	  ...
	  /> &nbsp;au&nbsp; <ct:FWCalendarTag name="finPeriode" 
	...
	<TR>
            <TD width="144">Remarque interne</TD>
