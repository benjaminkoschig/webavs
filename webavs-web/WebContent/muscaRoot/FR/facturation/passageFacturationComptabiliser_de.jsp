...
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<TR>
			<TD width="250">Comptabilisation automatique* </TD>
			<TD><INPUT name="auto" type="checkBox" onclick="autoVSmodule();" checked="checked">
				...
				%>
				Comptabilise uniquement les modules qui ne sont pas à l'état "Comptabilisé"	
			</TD>
		</TR>
		<!-- Ligne vide -->
		<TR><TD width="250"> &nbsp; </TD></TR>
		...
		<TR>
			<TD>* à partir du premier module non comptabilisé</TD>
			<TD>** la comptabilisation est forcée sur ce module et les suivants</TD>
		</TR>
          <%-- /tpl:put --%>
...
<SCRIPT>
		...
		/* Regarde si le premier module est sur l'état "COMPTABILISE", si c'est le cas,
		 ...
		 * comptabilisation d'un passage DOIT ETRE faite de manière automatique.
