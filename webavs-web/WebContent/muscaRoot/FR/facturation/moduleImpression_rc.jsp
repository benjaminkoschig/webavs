...
<SCRIPT>
usrAction = "musca.facturation.moduleImpression.lister";
bFind = true;
</SCRIPT>
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Aperçu des modules d'impression<%-- /tpl:put --%>
...
<!--
			...
			<%if(!"yes".equals(request.getParameter("colonneSelection"))) {%>
				<A href="<%=request.getContextPath()%>\musca?userAction=musca.facturation.moduleImpression.afficher&_method=add">
