...
<%@ include file="/theme/list/javascripts.jspf" %>
    ...
    <th nowrap width="16">&nbsp;</th>
      ...
      <th  width="35%">Modultyp</th>
      <th  width="8%">Veränderbare Faktzeilen</th>
      <th  width="*">Anrufstufe</th>      <%-- /tpl:put --%>
...
%>
    ...
    <TD class="mtd" width="35%" onClick="<%=actionDetail%>"><%=viewBean.getLibelleType(i)%></TD>
	...
	<% }%>
      <TD class="mtd" width="*" onClick="<%=actionDetail%>"><%=viewBean.getNiveauAppel(i)%></TD>
<%-- /tpl:put --%>
