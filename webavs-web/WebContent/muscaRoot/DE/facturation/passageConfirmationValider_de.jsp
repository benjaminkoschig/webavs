...
<SCRIPT language="JavaScript">
	...
	top.document.title = "Fakturierung - Journal validieren"
	...
	function validate() {
	    ...
	    if (window.confirm("Sie sind dabei, dieses Journal zu validieren! Wollen Sie fortfahren?")){
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Valideriung eines Journals<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	...
	<TR>
            <TD nowrap width="140">Abrechnungsplan</TD>
           <TD nowrap width="547">
            <% if( viewBean.isEtatOuvert()) { %>
