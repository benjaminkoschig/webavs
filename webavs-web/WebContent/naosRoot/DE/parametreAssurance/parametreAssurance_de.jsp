...
function del() {
	if (window.confirm("Sie sind dabei, den ausgewählten Versicherungsparameter zu löschen! Wollen Sie fortfahren?")) {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					Parameter der Versicherung - Detail
					<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR> 
							<TD height="31" width="125" >Versicherungsbezeichnung</TD>
							<TD width="30"></TD>
							<TD width="400"> 
						...
						<TR> 
							<TD width="117" height="31">Geschlecht</TD>
							<TD width="30"></TD>
							<TD width="200"> 
								<ct:FWCodeSelectTag 
									name="sexe" 
						...
						<TR> 
							<TD width="117" height="31">Beginndatum</TD>
							<TD width="30"></TD>
							<TD width="200"> 
						...
						<!--TR> 
							<TD nowrap width="120" height="31" >Periode</TD>
						...
						<TR> 
							<TD width="117" height="31">Enddatum</TD>
							<TD width="30"></TD>
							<TD width="200"> 
						...
						<TR> 
							<TD width="117" height="31">Wert</TD>
							<TD width="30"></TD>
							<TD width="200"> 
