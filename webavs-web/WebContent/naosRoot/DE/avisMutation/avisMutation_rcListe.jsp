...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	<TH width="30">&nbsp;</TH>
	<TH align="left" width="150">Meldungsart</TH>
	<TH align="center" width="100">Meldungsdatum</TH>
	<TH align="center" width="100">Empfangskasse</TH>
	<TH align="left" width="150">Oppositionsgrund</TH>
    <%-- /tpl:put --%> 
