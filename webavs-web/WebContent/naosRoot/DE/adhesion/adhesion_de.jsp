...
function del() {
	if (window.confirm("Sie sind dabei, einen Beitritt zu löschen! Wollen Sie fortfahren?")) {
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
							<TD nowrap width="157" height="14">Beginndatum</TD>
						...
						<TR>
							<TD nowrap width="157" height="14">Enddatum</TD>
						...
						<TD nowrap width="157" height="14">Beitrittstyp</TD>
						...
						<TR>
							...
							%>
							<%	if (viewBean.getAdministrationCaisse() != null) { %>
            				<TD nowrap width="120"><A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&selectedId=<%=viewBean.getAdministrationCaisse().getIdTiers()%>">Beitritt an</A></TD>
							<% 	} else if (viewBean.getAdminstrationAssocia() != null) { %>
            				<TD nowrap width="120"><A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&selectedId=<%=viewBean.getAdminstrationAssocia().getIdTiers()%>">Beitritt an</A></TD>
            				<% 	} else { %>
            				<TD nowrap width="120">Beitritt an</TD>							
							<%  } %>
