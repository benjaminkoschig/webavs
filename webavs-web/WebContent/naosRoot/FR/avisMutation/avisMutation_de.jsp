...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer l'avis de mutation sélectionnée! Voulez-vous continuer?"))
	{
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					Avis mutation- D&eacute;tail 
					<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
						<TR> 
							<TD nowrap width="157" height="31">Tiers</TD>
							<TD width="30"></TD>
							<TD nowrap width="400" > 
						...
						<TR> 
							<TD nowrap height="14" width="157">Genre d'annonce</TD>
							<TD width="30"></TD>
							<TD nowrap height="31"> 
						...
						<TR> 
							<TD nowrap height="14" width="157">Date annonce</TD>
						...
						<TR> 
							<TD nowrap width="157">Date r&eacute;ception accus&eacute; r&eacute;ception</TD>
							<TD width="30"></TD>
							<TD nowrap height="31">
						...
						<TR> 
							<TD nowrap height="31" width="132">Caisse emetteur</TD>
							<TD width="30"></TD>
							<TD nowrap height="31"> 
						...
						<TR> 
							<TD nowrap width="157">Caisse reception</TD>
							<TD width="30"></TD>
							<TD nowrap height="31"> 
