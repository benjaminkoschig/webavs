...
function del()
{
	if (window.confirm("Vous êtes sur le point de supprimer la masse sélectionnée! Voulez-vous continuer?"))
	{
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR> 
							<TD nowrap height="31" width="205">Affili&eacute;</TD>
							<TD width="30"></TD>
							<TD nowrap width="500"> 
						...
						<TR> 
							<TD nowrap height="31" width="205">Cotisation</TD>
							<TD width="30"></TD>
							<TD nowrap width="500" > 
								<%
								 	String assurance = "";
						...
						<TR> 
							<TD nowrap height="31" width="205">P&eacute;riode</TD>
						...
						<TR> 
							<TD nowrap height="31" width="205">Masse salariale annuelle</TD>
							<TD width="30"></TD>
							<TD nowrap width="500"> 
						...
						<TR> 
							<TD nowrap height="31" width="205">Masse salariale de la p&eacute;riodicit&eacute;</TD>
							<TD width="30"></TD>
							<TD nowrap width="500"> 
						...
						<TR> 
							<TD nowrap height="31" width="205">Traitement</TD>
							<TD width="30"></TD>
							<TD nowrap width="500"> 
