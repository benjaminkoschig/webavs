...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer un plan d'affiliation! Voulez-vous continuer?")) {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%> 
					Plan d'affiliation - D&eacute;tail 
					<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR> 
							<TD nowrap width="238" height="31">Plan d'affiliation</TD>
						...
						<TR> 
							<TD nowrap width="238" height="31">Libellé facture</TD>
						...
						<TR> 
							<TD nowrap width="238" height="31">Imprimer séparément</TD>
						...
						<TR> 
							<TD nowrap width="238" height="31">Plan inactif</TD>
						...
						<TR> 
							<TD nowrap width="238" height="14">Domaine Courrier</TD>
						...
						<TR> 
							<TD nowrap width="238" height="14">Domaine Recouvrement LSV</TD>
						...
						<TR> 
							<TD nowrap width="238" height="14">Domaine Remboursement</TD>
