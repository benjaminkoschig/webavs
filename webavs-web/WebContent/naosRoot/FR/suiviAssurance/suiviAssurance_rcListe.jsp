...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	<TH width="30">&nbsp;</TH>
	<TH align="left" width="250">Assurance</TH>
	<TH align="center" width="150">Statut du suivi</TH>
	<TH align="center" width="120">Date pr&eacute;vue</TH>
	<TH align="right" width="120">Date effective</TH>
	<TH align="right" width="120">Date de fin</TH>
	<%-- /tpl:put --%> 
