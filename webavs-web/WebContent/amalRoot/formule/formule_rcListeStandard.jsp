...
<%@ include file="/theme/list/javascripts.jspf" %>
    	...
    	<TH>
    		<ct:FWLabel key="JSP_AM_PARAM_NOM"/>
    	</TH>
    	<TH>
...
<%@ include file="/theme/list/lineStyle.jspf" %>
	...
	<TD class="mtd" onclick="<%=actionDetail%>"><%="".equals(line.getFormule().getDefinitionformule().getCsDocument())?"&nbsp;":objSession.getCodeLibelle(line.getFormule().getDefinitionformule().getCsDocument())%></TD>	
	<TD class="mtd" onclick="<%=actionDetail%>"><%="".equals(line.getFormule().getFormule().getLibelleDocument())?"&nbsp;":line.getFormule().getFormule().getLibelleDocument()%></TD>			
	<TD class="mtd" onclick="<%=actionDetail%>"><%=objSession.getCodeLibelle(line.getFormule().getFormule().getCsSequenceImpression())%></TD>		
	<TD class="mtd" onclick="<%=actionDetail%>"><%=objSession.getCodeLibelle(line.getFormule().getDefinitionformule().getCsManuAuto())%></TD>
<%-- /tpl:put --%>
