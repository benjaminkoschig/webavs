...
<%
	PFTraitementPonctuelViewBean viewBean = (PFTraitementPonctuelViewBean) session.getAttribute("viewBean");
	idEcran="PPF2051";

	userActionValue = "perseus.traitements.traitementPonctuel.executer";
