...
<%@page import="globaz.perseus.vb.demande.PFAnnulerDemandeViewBean"%>
...
<%
	...
	PFAnnulerDemandeViewBean viewBean = (PFAnnulerDemandeViewBean) session.getAttribute("viewBean"); 
	idEcran="PPF0341";
...
<<script type="text/javascript">
	...
	function upd() {}	
	function validate() {
	    document.forms[0].elements('userAction').value="perseus.demande.annulerDemande.modifier";
		return true;
	}
	function cancel() {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:insert attribute="zoneTitle" --%><ct:FWLabel key="JSP_PF_DEM_ANNULER_TITRE"/><%-- /tpl:insert --%>
