...
# --- Information Produit ---
PRODUCT="webavs"
APP="CIAnnonceCentraleParPeriode.sh"
...
CALL_JAVA_PROCESS="$JAVA_HOME/bin/java -DPRODUCT=${PRODUCT}_${MODULE} -Djava.awt.headless=true -Djava.ext.dirs=${JAVA_EXTDIR} -Xms512m -Xmx1024m globaz.pavo.process.CIAnnonceCentraleParPeriodeProcess $2 $3 $4"
