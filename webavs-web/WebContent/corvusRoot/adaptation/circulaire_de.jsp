...
<%
	...
	RECirculaireViewBean viewBean = (RECirculaireViewBean)session.getAttribute("viewBean");
	globaz.framework.controller.FWController controller = (globaz.framework.controller.FWController) session.getAttribute("objController");
	
	userActionValue=globaz.corvus.servlet.IREActions.ACTION_ADAPTATION_CIRCULAIRE + ".executer";
%>
<%-- /tpl:put --%>
...
<%@page import="globaz.corvus.vb.adaptation.RECirculaireViewBean"%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_CIRC_TITRE_PAGE"/> <%-- /tpl:put --%>
