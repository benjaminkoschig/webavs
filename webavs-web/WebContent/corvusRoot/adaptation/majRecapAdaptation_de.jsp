...
<%
	...
	REMajRecapAdaptationViewBean viewBean = (REMajRecapAdaptationViewBean)session.getAttribute("viewBean");
	globaz.framework.controller.FWController controller = (globaz.framework.controller.FWController) session.getAttribute("objController");
	
	userActionValue=globaz.corvus.servlet.IREActions.ACTION_ADAPTATION_MAJ_RECAP_ADAPTATION + ".executer";
%>
<%-- /tpl:put --%>
...
<%@page import="globaz.corvus.vb.adaptation.REMajRecapAdaptationViewBean"%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_RECAP_ADAP_TITRE_PAGE"/><%-- /tpl:put --%>
