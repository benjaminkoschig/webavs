...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer l'opération auxiliaire sélectionnée! Voulez-vous continuer?")) {
...
top.document.title = "Comptes - detail d'une opération auxiliaire - " + top.location.href;
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Saisir une op&eacute;ration auxiliaire<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR>
            <TD nowrap width="129">Date de l'op&eacute;ration auxiliaire</TD>
            <TD width="147">
		...
		<tr>
		 ...
		 <TR>
            ...
            <TD colspan="4" align="left">Quittancer
