...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer la section sélectionnée! Voulez-vous continuer?")) {
...
top.document.title = "Comptes - détail d'une section - " + top.location.href;
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>D&eacute;tail d'une section<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<input type="hidden" name="taxes" value="<%=viewBean.getTaxes()%>"/>
          ...
          <TR>
            <TD nowrap width="91">Type de section</TD>
            <TD width="1"></TD>
            <TD width="270">
            ...
            <TD width="164"></TD>
            <TD width="74">Mode de compensation&nbsp;</TD>
            <TD width="21"></TD>
            <TD colspan="2"> <%
          ...
          <TR>
            ...
            <TD width="164"></TD>
            <TD nowrap width="74">Remarques</TD>
            <TD width="21" height="32"></TD>
            <TD rowspan="2" colspan="2">
...
<TR>
            <TD nowrap>Imprimer séparément</TD>
            <TD width="1">&nbsp;</TD>
            <TD>
          ...
          <TR>
            <TD width="129">Caisse professionnelle</TD>
            <TD width="1">&nbsp;</TD>
          ...
          <TR>
            <TD nowrap>Référence ancien BVR</TD>
            <TD width="1">&nbsp;</TD>
            <TD>
          ...
          <TR>
          	<TD nowrap width="91" valign="top">Section principale liée</TD>
          	<TD width="1">&nbsp;</TD>
            <TD width="270">
          ...
          %>
          <TR>
          	<TD nowrap width="91" valign="top">Sections auxiliaires liées</TD>
          	<TD width="1">&nbsp;</TD>
            <TD width="270">
          ...
          <TR>
            <TD colspan="8" height="10" class="title" nowrap>Contentieux </TD>
          </TR>
          <TR>
            <TD nowrap width="91">&nbsp;</TD>
            <TD width="1"></TD>
          ...
          <TR>
            <TD nowrap width="91">Ech&eacute;ance</TD>
            <TD width="1"></TD>
            <TD width="270">
          ...
          <tr>
            <td nowrap width="91">Derni&egrave;re &eacute;tape</td>
            <td width="1"></td>
            <td width="270">
...
<!--                <option selected value="0"></option> MKA: 20.04.10 MIS EN COMMENTAIRE POUR EVITER SEQUENCE 0-->
	...
	<% if (APISection.ID_TYPE_SECTION_BULLETIN_NEUTRE.equals(viewBean.getIdTypeSection()) && !APISection.STATUTBN_DECOMPTE_FINAL.equals(viewBean.getStatutBN())) { %>
		<tr title="Statut de suspension de procédure d'encaissement BN">
			<td nowrap width="91">Statut BN</td>
			<td width="1"></td>
			<td width="270">
            	<%
	...
	<%} %>
          ...
          <% } %>
          <tr>
            <td colspan="8" height="10" class="title" nowrap>Plan de recouvrement</td>
          </tr>
          <tr>
            <td width="91">&nbsp;</td>
            <td width="1"></td>
