...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer la rubrique sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Comptes - Détail d'une rubrique - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'une rubrique <%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <tr> 
            <td nowrap width="174">Secteur</td>
            <td width="10">&nbsp;</td>
            <td width="393"> 
          ...
          <TR>
          	<TD>Gérer caisse professionnelle</TD>
          	<TD width="10">&nbsp;</TD>
          	<TD>
          ...
          <TR> 
            <TD nowrap width="174">Compte courant</TD>
            <TD width="10">&nbsp;</TD>
            <TD nowrap colspan="2"> 
          ...
          <TR> 
            <TD nowrap width="174">N&deg; compte compta. g&eacute;n&eacute;rale</TD>
            <TD width="10">&nbsp;</TD>
            <TD nowrap colspan="2"> 
          ...
          <TR> 
            <TD nowrap width="174">Références de la rubrique</TD>
            <TD width="10">&nbsp;</TD>
            <TD>
          ...
          <%}%>
		<TR> 
        	<TD nowrap width="174" height="38">Libell&eacute; pour l'extrait de compte</TD>
            <TD width="10" height="38">&nbsp;</TD>
            <TD width="393"> 
			<%	
