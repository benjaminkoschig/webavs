...
function supprimerPeriode(id){
    if (window.confirm("Vous êtes sur le point de supprimer l'objet sélectionné! Voulez-vous continuer?")){
        parent.location.href="<%=request.getContextPath()%>/osiris?userAction=osiris.retours.retours.actionSupprimerLignesRetoursSurSection&selectedId="+id+"&idRetour"+id;
    }
}
...
<%@ include file="/theme/list/lineStyle.jspf" %>
	...
	%>
	<TD class="mtd" nowrap="nowrap"><%= line.getDescriptionLigneRetourSurSection()%>&nbsp;</TD>
