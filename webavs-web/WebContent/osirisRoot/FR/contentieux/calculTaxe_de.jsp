...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer le calcul de taxe sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Contentieux - Détail d'un calcul de taxe - " + top.location.href;	
}
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR> 
            <TD nowrap width="125" height="43">Description</TD>
