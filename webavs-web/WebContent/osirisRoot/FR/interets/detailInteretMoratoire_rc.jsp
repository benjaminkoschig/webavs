...
<%@ include file="/theme/capage/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Aperçu du détail du calcul d'un intérêt moratoire<%-- /tpl:put --%>
<%@ include file="/theme/capage/bodyStart2.jspf" %>
						...
						<tr>
							<td style="padding:0 5px">
								<a href="<%=request.getContextPath()%>\osiris?userAction=osiris.interets.interetMoratoire.afficher&id=<%=viewBean.getIdInteretMoratoire()%>">D&eacute;cision d'int&eacute;r&ecirc;t</a>
							</td>
							<td style="padding:0 5px">
