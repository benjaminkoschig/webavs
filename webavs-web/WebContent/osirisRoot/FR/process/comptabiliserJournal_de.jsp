...
top.document.title = "Process - Comptabiliser le journal - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Comptabiliser le journal<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
       ...
       <tr> 
       		<TD nowrap width="30%">Imprimer le journal</TD>
            <TD nowrap width="50%"> 
