...
<%
CAOperationOrdreRecouvrementViewBean element = (CAOperationOrdreRecouvrementViewBean) session.getAttribute (globaz.osiris.servlet.action.CADefaultServletAction.VB_ELEMENT);
globaz.osiris.db.comptes.CAOperationOrdreRecouvrementManagerListViewBean viewBean = (globaz.osiris.db.comptes.CAOperationOrdreRecouvrementManagerListViewBean) session.getAttribute (globaz.osiris.servlet.action.CADefaultServletAction.VBL_ELEMENT);
...
usrAction = "<%=globaz.osiris.application.CAApplication.DEFAULT_OSIRIS_NAME %>.comptes.journalOperationOrdreRecouvrement.lister";
bFind = true;
...
top.document.title = "Konti - Suche der Inkassosaufträge des Journals - " + top.location.href;

</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>
        Suche der Inkassosaufträge des Journals
        <%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
          ...
          <TR>
            ...
            <TD nowrap width="8">
              <input type="hidden" name="forIdTypeOperation" value="<%=CAOperation.CAOPERATIONORDRERECOUVREMENT%>" readonly>
            </TD>
            <TD>&nbsp;</TD>
            <TD width="4"></TD>
            <TD width="272">&nbsp; </TD>
          ...
          <tr>
            ...
            <td height="18" colspan="5">
              <select name="forSelectionTri" style="width : 4cm;">
                ...
                <option value="5">Eingabedatum</option>
              </select>
            </td>
          <tr>
          ...
          <TR>
			...
			String redirectUrl = ((String)request.getAttribute("mainServletPath")+"Root")+"/"+globaz.framework.controller.FWDefaultServletAction.getIdLangueIso(session)+"/comptes/journalOperationOrdreRecouvrement_rc.jsp";
			%>
			<ct:FWSelectorTag
