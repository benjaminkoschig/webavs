...
<%@ include file="/theme/list/javascripts.jspf" %>
	    <%-- tpl:put name="zoneHeaders" --%>
			<TH width="160" align="left" colspan="2">Kontokorrent</TH>
			<TH nowrap width="100" align="left">Valutadatum</TH>
			<TH nowrap align="left">BSV Rubrik</TH>
			<TH nowrap align="left">Beschreibung</TH>
			<TH nowrap align="left">Jahr</TH>
			<TH nowrap align="right">Basis / Grundlage</TH>
			<TH nowrap align="right">Betrag</TH>
			<TH nowrap align="right">Saldo</TH>
			<TH nowrap align="left">Zahl. ankunft</TH>
