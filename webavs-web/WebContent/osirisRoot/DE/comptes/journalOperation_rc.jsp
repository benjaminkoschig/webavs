...
top.document.title = "Konti - Gesamtübersicht der Operationen des Journals - " + top.location.href;
</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>
        <div align="left">Gesamtübersicht der Operationen des Journals</div>
        <%-- /tpl:put --%>
...
<!--              <input type="text" name="fromDate" class="date" value="<%=viewBean.getFromDate()%>" onChange="jsFromDate()" >-->
          ...
          <TR>
            ...
            <td height="18" width="10">&nbsp; </td>
            <td height="18" width="61">Vorgang</td>
            <td width="8">&nbsp;</td>
            <td height="18">
