...
<%  if (request.getParameter("user") != null) {
      try {
	 objSession.setApplication("OSIRIS");
    ...
    if (isConnected != null) {
	%><SCRIPT>
	pageWin = window.open('../master.jsp?_type=home&_dest=home', 'winMainOsiris', 'top=0, left=0, width=' + (screen.availWidth - 10) + ', height=' + (screen.availHeight - 30) + ', scrollbars=yes, menubars=no, resizable=yes');
  	pageWin.focus();
...
<TABLE cellpadding="0" cellspacing="0" border="0" width="990" height="640">
  <TBODY>
    ...
    <TR>
      ...
      <TD colspan="3" align="center" class="gText" height="45">Der Zugriff ist nur für registrierte Benutzer erlaubt<BR>
      für registrierte Benutzer</TD>
      <TD width="500" height="45">&nbsp;</TD>
    </TR>
    <TR>
      <TD colspan="5">&nbsp;</TD>
    ...
    <TR>
      <TD height="19">&nbsp;</TD>
      <TD class="title" height="19">Benutzer</TD>
      <TD colspan="2" class="title" height="19">Passwort</TD>
      <TD height="19">&nbsp;</TD>
    </TR>
    <TR>
      <TD height="26">&nbsp;</TD>
