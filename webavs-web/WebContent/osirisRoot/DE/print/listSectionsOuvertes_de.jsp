...
%>
top.document.title = "Liste der offenen Sektionen - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste der offenen Sektionen<%-- /tpl:put --%>
          ...
          <tr> 
            ...
            <td> 
              <select name="forSelectionRole" tabindex="2">
				...
				<tr>
	            	<td width="250">Erstellungsdatum unter ...</td>
