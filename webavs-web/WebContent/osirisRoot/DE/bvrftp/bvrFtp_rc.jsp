...
top.document.title = "PostFinance Server Verbindung - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>PostFinance Server Verbindung<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
            ...
            <TD width="300" align="right">&nbsp;</TD>
            <TD width="179" align="right">Entferntes Verzeichnis&nbsp;</TD>
            <TD align="left">
            <SELECT name="distantDirectoryName">
            	<OPTION value="<%=CABvrFtpListViewBean.FTP_READ_OPAE_REMOTE_DIRECTORY%>"><%=CABvrFtpListViewBean.FTP_READ_OPAE_REMOTE_DIRECTORY%> (ESR)</OPTION>
            	<OPTION value="<%=CABvrFtpListViewBean.FTP_READ_LSV_REMOTE_DIRECTORY%>"><%=CABvrFtpListViewBean.FTP_READ_LSV_REMOTE_DIRECTORY%> (Inkasso)</OPTION>
            </SELECT>
            </TD>
			</TR>
          <%-- /tpl:put --%>
