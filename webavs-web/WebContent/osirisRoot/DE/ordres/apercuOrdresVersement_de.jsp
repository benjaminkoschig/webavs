...
function del() {
	if (window.confirm("Sie sind dabei, den ausgewählten Zahlungsauftrag zu löschen! Wollen Sie fortfahren?")) {
...
<!--              <input type="hidden" name="btnSection" value="..." onClick="jsRechercheSectionEcran()" >-->
          ...
          <TR>
            <TD nowrap width="129">Verfalldatum</TD>
            <TD width="5"></TD>
            <TD width="147">
          ...
          <TR>
            <TD nowrap width="129">Gutschrift</TD>
            ...
            <TD nowrap width="100">Depotwährung</TD>
            <TD nowrap colspan="5">
              <%	viewBean.getCsMonnaies();
          ...
          <TR>
            <TD nowrap width="129">Zahlungsadresse</TD>
            <TD width="5"></TD>
            <TD width="147">
          ...
          <TR>
            <TD nowrap width="129">Art der Ueberweisung</TD>
            <TD width="5"></TD>
            <TD width="147">
          ...
          <TR>
            <TD nowrap width="129">Sperren der Ueberweisung</TD>
            <TD width="5"></TD>
            <TD width="147">
            ...
            <TD width="20">&nbsp;</TD>
            <TD width="7">&nbsp;</TD>
            <TD width="100">Ausgeführter Rückzug</TD>
            <TD colspan="5">
