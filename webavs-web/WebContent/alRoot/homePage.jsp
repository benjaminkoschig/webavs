...
<%
String tmp = request.getContextPath()+"/alRoot/";
String logoSrc = tmp + "appLogo.jsp";
String labelSrc = tmp + "appLabel.jsp";
String iconSrc ="";
//if (globaz.jade.common.Jade.getInstance().getLanguagePath()) {
	iconSrc = request.getContextPath()+"/"+globaz.framework.controller.FWDefaultServletAction.getIdLangueIso(session)+"/appIcons.jsp?servlet=al";
//} else {
//	iconSrc = request.getContextPath()+"/appIcons.jsp?servlet=al";
//}

String menuSrc = tmp+"appMenu.jsp";
String aboutSrc = tmp+"appAbout.jsp";
String infoSrc = request.getContextPath()+"/appInfo.jsp";
...
%>
	...
	<FRAMESET cols="<%=framesetInfo.getNaviWidth()%> ,*" border="0px">
		...
		<FRAME name="fr_error" scrolling="no" src="<%=infoSrc%>" />
	</FRAMESET>
