			...
			<%-- tpl:insert attribute="zoneMain" --%>
	              ...
	              <tr>
	                  ...
	                  <td>
	                  	<%if(viewBean.getDossierComplexModel().getTiersBeneficiaireModel()!= null && !JadeNumericUtil.isEmptyOrZero(viewBean.getDossierComplexModel().getTiersBeneficiaireModel().getIdTiers())){ %>
	                  		<a href="<%=servletContext+"/pyxis?userAction=pyxis.tiers.tiers.afficher&selectedId="+viewBean.getDossierComplexModel().getTiersBeneficiaireModel().getIdTiers()%>" title="Détail bénéficaire"><%=viewBean.getDossierComplexModel().getTiersBeneficiaireModel().getDesignation1()%>&nbsp;<%=viewBean.getDossierComplexModel().getTiersBeneficiaireModel().getDesignation2()%></a>
	                  	<%}else{ %>
	              ...
	              <tr>
	              		...
	              		<td><ct:FWCalendarTag name="debutActivite" tabindex="1"
							...
							<script language="JavaScript">
								document.getElementsByName('debutActivite')[0].onblur=function(){fieldFormat(document.getElementsByName('debutActivite')[0],'CALENDAR');document.getElementById('debutActiviteValue').value = this.value;};
	              		...
	              		<td>
							...
							<script language="JavaScript">
								document.getElementsByName('finActivite')[0].onblur=function(){fieldFormat(document.getElementsByName('finActivite')[0],'CALENDAR');document.getElementById('finActiviteValue').value = this.value;};
	              ...
	              <tr>
	                    ...
	                    <td>
							...
							<script language="JavaScript">
								document.getElementsByName('debutValidite')[0].onblur=function(){fieldFormat(document.getElementsByName('debutValidite')[0],'CALENDAR');document.getElementById('debutValiditeValue').value = this.value;};
	              ...
	              <tr>   
	                    ...
	                    <td><ct:inputText tabindex="3" name="dossierComplexModel.dossierModel.nbJoursDebut" styleClass="percent"/></td>  
	                    
	                    
	                    <td class="label"><ct:FWLabel key="AL0004_DOSSIER_JOURS"/></td>
	                    <td><ct:inputText tabindex="8" name="dossierComplexModel.dossierModel.nbJoursFin" styleClass="percent"/></td>  
	              </tr>
	              <tr>
	                  ...
	                  <td>
	                       ...
	                       %>
	                       <ct:inputText tabindex="9" name="dossierComplexModel.caisseAFComplexModel.admin.codeAdministration" styleClass="small" title="<%=caisseDescription%>"/>
	              ...
	              <tr>
	                  ...
	                  <td>
	                      	<ct:select tabindex="10" name="dossierComplexModel.dossierModel.loiConjoint" wantBlank="true" defaultValue="<%=viewBean.getDossierComplexModel().getDossierModel().getLoiConjoint() %>">
              ...
              <tr>
                    ...
                    <td>
                    	<ct:inputText tabindex="11" name="dossierComplexModel.dossierModel.tauxVersement" styleClass="small"/>%
                    </td>
                    <td class="label"><ct:FWLabel key="AL0005_DOSSIER_UNITE"/></td>
                    <td>
                        <ct:select tabindex="15" name="dossierComplexModel.dossierModel.uniteCalcul" defaultValue="<%=ALCSDossier.UNITE_CALCUL_MOIS %>">
              ...
              <tr>            
                  ...
                  <td>
                   		<ct:select tabindex="13" name="dossierComplexModel.dossierModel.tarifForce" wantBlank="true"> 
	                    	<ct:optionsCodesSystems csFamille="ALTARCAT"></ct:optionsCodesSystems>	
	                    </ct:select>
	              </td>
              ...
              <tr>
                  ...
                  <td>                   
                      <ct:inputText tabindex="14" name="dossierComplexModel.dossierModel.montantForce" styleClass="montant"/><ct:FWLabel key="AL0005_DOSSIER_MONTANT_FORCE_DATE"/>
                      <ct:inputText name="dossierComplexModel.dossierModel.finValidite" readonly="readonly" styleClass="readOnly" style="width:90px;"/>                
                  </td>
                  <td class="label">&nbsp;</td>
                  <td>&nbsp;</td>     
              </tr>
