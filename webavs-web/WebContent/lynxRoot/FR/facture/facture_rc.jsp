...
top.document.title = "Recherche des factures - " + top.location.href;
// stop hiding -->
</SCRIPT>
...
<%-- tpl:put name="zoneTitle" --%>Recherche des factures<%-- /tpl:put --%>
...
<ct:ifhasright element="lynx.facture.facture.afficher" crud="u">
	<INPUT type="button" name="btnNewFactureBvrRouge" value="BVR Rouge" onClick="document.location.href='<%=actionNewFactureBvrRouge%>'" tabindex="1">
	<INPUT type="button" name="btnNewFactureVirement" value="Virement" onClick="document.location.href='<%=actionNewFactureVirement%>'" tabindex="1">
	<INPUT type="button" name="btnNewFactureLSV" value=" LSV " onClick="document.location.href='<%=actionNewFactureLsv%>'" tabindex="1">
	<INPUT type="button" name="btnNewFactureCaisse" value="Caisse" onClick="document.location.href='<%=actionNewFactureCaisse%>'" tabindex="1">
</ct:ifhasright>
<% } %>
<%-- /tpl:put --%>
