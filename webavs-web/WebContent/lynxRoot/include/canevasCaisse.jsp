<table border="0" cellspacing="4" class="canevasCaisse">
<tr>
...
<tr>
	...
	<td colspan="2">
		<fieldset class="fieldSetVirement" style="height:155px;">
			...
			&nbsp;</BR>
			<textarea name="libelleSociete" style="width:320px;height:100px" class="libelleCaisseDisabled" readonly="readonly"><%=viewBean.getSocieteAdresse()%></textarea>&nbsp;&nbsp;&nbsp;</br>
