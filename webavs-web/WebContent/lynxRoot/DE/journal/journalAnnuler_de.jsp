...
<%
	idEcran="GLX0033";
	LXJournalAnnulerViewBean viewBean = (LXJournalAnnulerViewBean) session.getAttribute ("viewBean");
	userActionValue = "lynx.journal.journalAnnuler.executer";
