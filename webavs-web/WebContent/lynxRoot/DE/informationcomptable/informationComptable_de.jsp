...
function del() {
	if (window.confirm("Sie sind dabei, die ausgewählte Buchungsinformation zu löschen! Wollen Sie fortfahren?")) {
...
top.document.title = "Detail der Buchungsinformation - " + top.location.href;
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
<%-- tpl:put name="zoneTitle" --%>Detail der Buchungsinformation<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<TR> 
         ...
         <TR>
            <TD><i>Standardwerte (optional) :</i></TD>
            <TD colspan="2">&nbsp;</TD>
        </TR>
         <TR>
            <TD>Fälligkeit </TD>
            <TD colspan="2">
				 <input type="text" name="echeance" style="width:1cm" size="5" maxlength="3" value="<%=viewBean.getEcheance()%>" class="libelle" tabindex="1"/>&nbsp;Tag(e)
            </TD>
        </TR>
         <TR>
            <TD>Rechnungsbezeichnung</TD>
            <TD colspan="2">
