...
<%@page import="globaz.hercule.db.controleEmployeur.CEEmployeurChangementMasseSalarialeViewBean"%>
...
<%
	...
	CEEmployeurChangementMasseSalarialeViewBean viewBean = (CEEmployeurChangementMasseSalarialeViewBean) session.getAttribute ("viewBean");

	//Définition de l'action pour le bouton valider
	userActionValue = "hercule.controleEmployeur.employeurChangementMasseSalariale.executer";
%>
...
<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="TITRE_ECRAN_EMPLOYEUR_CHANGEMENT_MASSE_SALARIALE"/><%-- /tpl:put --%>
