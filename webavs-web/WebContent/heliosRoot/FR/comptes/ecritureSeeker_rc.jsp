...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Recherche d'écritures<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
				<tr>
					<td colspan="6">Mandat <input class='libelleLongDisabled' readonly value='<%=exerciceComptable.getMandat().getLibelle()%>'> Exercice <input class='disabled' readonly value='<%=exerciceComptable.getFullDescription()%>'></td>
				</tr>
				<tr>
					<td colspan="6"><hr></td>
				</tr>
