...
<%
	idEcran="GCF3003";
	CGJournalExComptabiliserViewBean viewBean = (CGJournalExComptabiliserViewBean)session.getAttribute ("viewBean");
	...
	userActionValue = "helios.comptes.journalExComptabiliser.executer";
%>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
      ...
      ExComptabiliser le journal <%-- /tpl:put --%>
