...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Aperçu des définitions des listes<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>

							<tr>
						      <TD colspan="2">&nbsp;Mandat&nbsp;<input name='libelle' class="libelleLongDisabled" readonly value="<%=exerciceComptable.getMandat().getLibelle()%>"></td>						      
						      <TD colspan="2">&nbsp;Exercice&nbsp;<input name='fullDescription' readonly class="libelleLongDisabled" value="<%=exerciceComptable.getFullDescription()%>"></TD>
							</tr>
