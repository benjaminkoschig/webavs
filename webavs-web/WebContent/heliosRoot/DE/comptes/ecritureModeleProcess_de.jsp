...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Anfügung von Buchungen per Vorlage<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<TR>
							<TD nowrap>Vorlage</TD>
                            <TD nowrap>
						...
						%>
						<TR>
							<TD nowrap>Buchungsjournal-Nr.</td>
						...
						%>
						<tr>
							<TD nowrap>Bezeichnung des Journals</TD>
							<TD nowrap>
	                      			...
	                      			if (countDisplayedLine%displayMaxBlock == 0) {
	                      				%>
											...
											<TR align="center">
				                      			...
				                      			<TH width="6%">Mandant</TH>
				                      			<TH width="15%">Bezeichnung</TH>
				                      			<TH width="8%">Code</TH>
				                      			<TH width="8%">Betrag</TH>
				                      			<TH width="13%">Betrag ausländische Währung</TH>
