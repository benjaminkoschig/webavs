...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Kontobewegungsübersicht<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
				...
				<tr>
					...
					<td align="right">&nbsp;Saldo Rechnungsjahr&nbsp;</td>
					<td>
				...
				<tr>
					<td align="right">&nbsp;Bezeichnung enthält&nbsp;</td>
				...
				<tr>
					...
					<td align="right">&nbsp;<% if(exerciceComptable.getMandat().isUtiliseLivres().booleanValue() ){ %>Buch<%}%>&nbsp;</td>
					<td colspan="2">
