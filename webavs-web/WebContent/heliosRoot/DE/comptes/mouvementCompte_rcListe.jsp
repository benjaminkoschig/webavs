...
if (!CodeSystem.CS_VUE_CONSOLIDEE.equals(request.getParameter("reqVue"))) { 
	...
	String libelleContreCompte = " Sammelb.";
	String idExterneContreCompte = " Sammelb.";
