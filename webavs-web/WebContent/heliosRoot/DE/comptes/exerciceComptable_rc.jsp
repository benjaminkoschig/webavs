...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>
		  		<%if(request.getParameter(globaz.helios.db.interfaces.CGNeedExerciceComptable.SESSION_DESTINATION) !=null) {%>
					Bitte wählen Sie das Buchführungsjahr mit dem Sie arbeiten wünschen					
				<% } else { %>	
					Buchführungsjahresübersicht
				<% }%>
		  <%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
            ...
            <TD nowrap width="82" align="right">Ab dem</TD>
            <TD nowrap colspan="2" width="176">
				...
				<TR>
	      <TD colspan=2>
			Nur die offenen Rechungsjahre anzeigen
