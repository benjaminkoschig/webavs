...
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<tr>
			<td>Periode </td>
			<td>
			<input type="radio" name="searchPeriode" value="<%=CGProcessImpressionGrandLivre.SEARCH_TOUT_EXERCICE%>" onClick="javascript:clearDateFields();" checked/>Ganzes Rechnungsjahr
			<br/>
			<input type="radio" name="searchPeriode" value="<%=CGProcessImpressionGrandLivre.SEARCH_PAR_DATE%>" onClick="javascript:openDateFields();"/>Von <ct:FWCalendarTag name="fromPeriodeDate" value=""/>&nbsp;bis&nbsp;<ct:FWCalendarTag name="untilPeriodeDate" value=""/>
			</td>
		</tr>
