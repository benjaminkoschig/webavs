...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>kontoKlasse<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	...
	<tr>
		...
		<td colspan="3">
				 ...
				 &nbsp;<a href="javascript:editIdClassification();" class="txtLink">zu veröffentlichen</a>
				<script>				
