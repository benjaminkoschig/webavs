...
top.document.title = "Prozess - Konsolidierung Export - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Prozess - Konsolidierung Export<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
			...
			<TR> 
            	<TD align="left" width="180" height="21" valign="middle">Kasse-Nr.</TD>
	            <TD align="left"> 
			...
			<TR> 
            	<TD align="left" width="180" height="21" valign="middle">Agentur-Nr.</TD>
	            <TD align="left"> 
