...
<%
	globaz.tucana.vb.administration.TUValidationBouclementViewBean viewBean = (globaz.tucana.vb.administration.TUValidationBouclementViewBean) session.getAttribute("viewBean");
	idEcran = "TU-302";
...
function onClickLancer(){
    ...
    document.forms[0].elements('userAction').value="tucana.administration.validationBouclement.lancer";
	chargeUrl(state);
}
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="TIT_VALIDATION_BOUCLEMENT"/><%-- /tpl:put --%>
