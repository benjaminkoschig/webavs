...
top.document.title="MZR - Detail eines Mahnungsversandes";
</SCRIPT>

<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail eines Mahnungsversandes<%-- /tpl:put --%>
...
%>
					<TR>
						<TD nowrap align="left"><B>MZR :</B></TD>
					...
					<TR>
						<TD nowrap align="left"><B>Kassen-Nr. :</B>&nbsp; &nbsp;</TD>
						<TD nowrap align="left"><INPUT type="text" name="forCaisse"
							value="<%=viewBean.getNumeroCaisse()%>" class="disabled" readonly></TD>

					</TR>
					<TR>
						<TD nowrap align="left"><B>SZ ZIK :</B></TD>
						<TD nowrap align="left"><INPUT type="text" name="forMotif"
							value="<%=viewBean.getMotif()%>" class="disabled" readonly></TD>
	
					</TR>
					<TR>
						<TD nowrap align="left"><B>SVN :</B>&nbsp;</TD>
					...
					<TR>
						<TD nowrap align="left"><B>SVN der leistungsberechtigten Person :<br>(LA oder Ehepartner) :</B>&nbsp;</TD>
					...
					<TR>
						<TD nowrap align="left"><B>Auftragsdatum :</B>&nbsp;</TD>
					...
					<TR>
						<TD nowrap align="left"><b>Brief senden an : </b></TD>
					...
					<TR>
						<TD nowrap align="left" colspan=2><font color="red">
							<% if(viewBean.isAucuneCaisse()) {	%>
								Keine Ausgleichskasse entspricht dieser Nummer
							<% } else {%>
								Die Ausgleichskasse ist inaktiv
							<% } %>
								</font></TD>						
					</TR>					
					<TR>
