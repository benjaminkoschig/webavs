...
top.document.title = "Détail d'un CI en envoi";
bFind = true;
function onClickNew() {
	if(window.confirm("Désirez-vous vraiment supprimer cet extrait ?")){
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Détail des CI en envoi<%-- /tpl:put --%>
