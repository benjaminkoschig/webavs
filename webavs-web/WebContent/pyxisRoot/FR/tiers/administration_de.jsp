...
function checkModification() {
	...
	cspNom.setMotifElement("motifModifDesignation1");
    	...
    	cspNom.setLibelle("Choisissez le motif de la modification du champ 'Nom' et la date d'entrée en vigueur");
	...
	cspDesi2.setMotifElement("motifModifDesignation2");
    	...
    	cspDesi2.setLibelle("Choisissez le motif de la modification du champ 'Nom suite 1' et la date d'entrée en vigueur");
	...
	cspDesi3.setMotifElement("motifModifDesignation3");
    	...
    	cspDesi3.setLibelle("Choisissez le motif de la modification du champ 'Nom suite 2' et la date d'entrée en vigueur");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Administration - Détail<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<input type ="hidden" name="oldDesignation1" value="<%=viewBean.getOldDesignation1()%>">
          ...
          <TR> 
            <TD nowrap width="100">Nom suite 1</TD>
            <TD nowrap> 
		...
		<input type ="hidden" name="oldDesignation2" value="<%=viewBean.getOldDesignation2()%>">
          ...
          <TR> 
            <TD nowrap width="100">Nom suite 2</TD>
	...
	<tr>
            <TD nowrap width="130">Adresse principale de courrier</TD>
            <TD width="260">
