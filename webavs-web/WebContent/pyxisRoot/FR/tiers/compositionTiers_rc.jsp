...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Liens entre tiers<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%>

		<TR>
	    	<td nowrap>
	    		<input name="navLink" class="navLinkTiers"  value="Tiers" accesskey="2" type="button" style="cursor:hand;border : 0 0 0 0;color:blue;text-decoration:underline;background : #B3C4DB;margin : 0 0 0 0;padding : 0 0 0 0;font-weight:normal;font-size: 8pt"
		...
		<TR>
			...
			<TD width="10"></TD>
   			<TD>
				...
				Afficher seul. les liens du type : <ct:FWCodeSelectTag name="forTypeLien"
					      defaut=" "
						wantBlank="<%=true%>"
					      codeType="PYTYPELIEN"
						except="<%=except%>"
