...
<tr >
	...
	<table >
		<tr>
			<td><%=viewBean.getSession().getCodeLibelle(globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_DOMICILE)%>&nbsp;(<b><%=viewBean.getCantonDomicile()%></b>)
				
			</td>
			<td><%=viewBean.getSession().getCodeLibelle(globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_COURRIER)%>&nbsp;(<b><%=viewBean.getSession().getCodeLibelle(viewBean.getDomaineCourrier())%></b>)
			
			</td>
			<td>Auszahlungsadresse&nbsp;(<b><%=viewBean.getSession().getCodeLibelle(viewBean.getDomainePaiement())%></b>)
			...
			<tr>
				<td>
					<ct:ifhasright crud="r" element="pyxis.tiers.tiers">
						<input name="navLink"  class="navLinkTiers" value="1 Suche" accesskey="1" type="button" 
				...
				<td>
					<ct:ifhasright crud="r" element="pyxis.tiers.tiers">
						<input name="navLink" class="navLinkTiers"  value="2 Partner" accesskey="2" type="button" 
				...
				<td>
					<ct:ifhasright crud="r" element="pyxis.adressecourrier.avoirAdresse">
						<input name="navLink" class="navLinkTiers"  value="3 Versandadressen" accesskey="3" type="button" 
				...
				<td>
					<ct:ifhasright crud="r" element="pyxis.adressepaiement.avoirPaiement">
						<input name="navLink" class="navLinkTiers"  value="4 Zahlungsadressen" accesskey="4" type="button" 
				...
				<td>
					<ct:ifhasright crud="r" element="pyxis.tiers.avoirContact">
						<input name="navLink" class="navLinkTiers"  value="5 Kontakte" accesskey="5" type="button" 
				...
				<td>
					<ct:ifhasright crud="r" element="naos.affiliation.affiliation">
						<input name="navLink" class="navLinkTiers"  value="6 Erfassung" accesskey="6" type="button" 
				...
				<td>
					<ct:ifhasright crud="r" element="pyxis.tiers.compositionTiers">
						<input name="navLink" class="navLinkTiers"  value="7 Verbindungen zwischen Partner" accesskey="7" type="button" 
				...
				<td>
					<ct:ifhasright crud="u" element="pyxis.tiers.compositionTiers">
						<input name="navLink" class="navLinkTiers"  value="8 Ehepartner" accesskey="8" type="button" 
...
<tr>
	<td colspan="4" >
		...
		<u><b>Création rapide</b></u>&nbsp;(<b><%=viewBean.getSession().getCodeLibelle(viewBean.getExtDomaine())%>
		<% if (TIApplication.CS_DEFAUT.equals(viewBean.getExtDomaine())) {%>
			/ <input accesskey=" " type="radio" name="extType" <%=((globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_DOMICILE.equals(viewBean.getExtType()))?"CHECKED":"")%>
				onclick="document.getElementById('casePostaleTR').style.visibility='hidden';document.getElementById('extCasePostale').value='';"
				value="<%=globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_DOMICILE%>" ><%=viewBean.getSession().getCodeLibelle(globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_DOMICILE)%>
				&nbsp;		
			<input type="radio" name="extType" <%=((globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_COURRIER.equals(viewBean.getExtType()))?"CHECKED":"")%>
				...
				value="<%=globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_COURRIER%>"><%=viewBean.getSession().getCodeLibelle(globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_COURRIER)%>
		<%} else {%>
			/ <%=viewBean.getSession().getCodeLibelle(globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_COURRIER)%><input name="extType" type="hidden" value="<%=globaz.pyxis.db.adressecourrier.TIAvoirAdresse.CS_COURRIER%>" >
		<%}%>
		</b>)<br><br> 
						...
						<tr>
							...
							<td>
								...
								<%
									...
									except.add(globaz.pyxis.db.adressepaiement.TIAdressePaiement.CS_IBAN_INCORRECT);
									except.add(globaz.pyxis.db.adressepaiement.TIAdressePaiement.CS_IBAN_CONVERSION_OK);
									except.add(globaz.pyxis.db.adressepaiement.TIAdressePaiement.CS_IBAN_CONVERSION_INCORRECT);
									except.add(globaz.pyxis.db.adressepaiement.TIAdressePaiement.CS_IBAN_CONVERSION_INCORRECT_AUTRE);
									except.add(globaz.pyxis.db.adressepaiement.TIAdressePaiement.CS_FUSION);
								%>
		...
		<div id="zone3page2" style="display:none;">
			<b>Moyens de communication</b><br>
			<table >
