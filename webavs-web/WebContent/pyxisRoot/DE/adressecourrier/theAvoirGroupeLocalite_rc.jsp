						...
						<tr>
							...
							<input type="hidden" name="forIdTiers" value="<%=tiers.getIdTiers()%>"/>
								<table border="0" style="width: 100%;" cellpadding="3">
									<tr>
										<td><span style="font-family:webdings;font-size:12 pt">€</span>&nbsp;<A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=tiers.getIdTiers()%>">Partner</A></td>
										<td>
