...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><span style="font-family:wingdings;font-weight:normal">*</span><span style="font-family:webdings;font-weight:normal">€</span> - Zahlungsadressen eines Partners<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%>
						<TR>
								 <TD nowrap width="128"><A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.afficher&idTiers=<%=viewBean.getIdTiers()%>">Partner</A></TD>
								 <TD nowrap colspan="2">
