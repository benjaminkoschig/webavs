...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Ricerca di una banca<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
		...
		<tr>
			...
			<td style="padding-left:0.5cm" align="right"><select name="critereLocaliteNpa"><option value="crLocalite">Località</option><option value="crNPA">NAP</option></select></td>
			<td><input name="valueLocaliteNpa" type="text"></td>
			<td align="right" style="padding-left:0.5cm"><b>Paese&nbsp;</b></td>
			<td>
		...
		<tr>
			...
			<td align="right" style="padding-left:0.5cm"><b>N°CCP&nbsp;</b></td>
			<td><input name="forCCPLike" type="text"></td>
			<td align="right" style="padding-left:0.5cm"><b>N° conto&nbsp;</b></td>
