...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Definizione casa madre / succursale - Dettaglio<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 
          <TR>
            <TD nowrap width="117">Terzo selezionato</TD>
            <TD nowrap width="274" > 
              <INPUT type="text" name="nom" tabindex="-1" value="<%=viewBean.getNom(viewBean.getIdTiersParent())%>" readonly class="libelleLongDisabled">
	     </TD>
             <TD width="55"></TD>
	        <TD nowrap width="43" align="right">Affiliato</TD>
            <TD nowrap colspan="2">
	...
	<TR>
            <TD nowrap width="117">E' la casa madre</TD>
            <TD nowrap colspan="3">
		<input type="checkbox" name="maisonMere" <%=(viewBean.isMaisonMere().booleanValue())? "checked" : "unchecked"%>>
	      <I>(Vistate questa casella se il terzo selezionato è la casa madre)</I></TD>
            <TD width="134"></TD>
	...
	<TR>
            <TD nowrap colspan="2">Scelta di una casa madre o di una succursale:</TD>
            <TD width="55"></TD>
            <TD nowrap width="43"></TD>
            <TD nowrap width="134"></TD>
          </TR>
...
<TEXTAREA name="descriptionAffilie" rows="5" cols="25" class="inputDisabled" disabled readonly><%=viewBean.getDescriptionTiers(viewBean.getIdSelection())%></TEXTAREA></TD>
	...
	<TR>
            <TD nowrap width="117">Succursale a partire dal</TD>
	  ...
	  /> &nbsp;al&nbsp; <ct:FWCalendarTag name="finRelation" 
