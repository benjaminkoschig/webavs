...
<html>
<body>
	<h1>Test des adresses de courrier</h1>
	<form action="<%=request.getContextPath()%>/pyxisRoot/FR/test/adr.jsp">
	...
	<tr>
		...
		<td><ct:FWCodeSelectTag 
					name="type" 
					defaut="<%=globaz.pyxis.constantes.IConstantes.CS_AVOIR_ADRESSE_DOMICILE%>" 
					codeType="PYTYPEADR"/>
		</td>
	</tr>
	</table>
	...
	<% 
		...
		adr = tiers.getAdresseAsString(type,domaine,idExterne,date,new TIAdresseFormater(),true,"FR");
	%>
	<table>
	<tr>
	<td>
