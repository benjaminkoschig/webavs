$(function() {
	globazNotation.readwidget.applyErrorCallBack = function(jqXHR, textStatus, errorThrown) {
		if(jqXHR.errorBean && jqXHR.errorBean.exceptions[1] && jqXHR.errorBean.exceptions[1].localizedMessage!==undefined) {
			showErrorDialog(jqXHR.errorBean.exceptions[1].localizedMessage);
		} 
		else if (typeof this.options.errorCallBack === "function" && this.options.errorCallBack !== null) {
