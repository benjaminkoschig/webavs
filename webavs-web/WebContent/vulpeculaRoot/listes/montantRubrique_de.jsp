...
<c:set var="idEcran" value="PPT20??"/>
<c:set var="labelTitreEcran" value="JSP_LISTES_MONTANT_RUBRIQUE"/>
...
$(function () {
	$('#launch').click(function () {
		...
		document.forms[0].elements('userAction').value="vulpecula.listes.montantRubrique.executer";
...
<div style="width: 100%;text-align: center;">
	<div>
		<table>
			...
			<tr>
				<td><label for="date"><ct:FWLabel key="JSP_DATE_ANNONCE"/></label></td>
				<td>
					<input name="date" value="${viewBean.date}" data-g-calendar="mandatory:true,type:month" />
				</td>				
			</tr>
