...
<c:set var="idEcran" value="PPT1113"/>
<c:set var="labelTitreEcran" value="JSP_IMPRESSION_TO"/>
...
<script type="text/javascript" src="${rootPath}/decompte/imprimerTO_de.js"></script>
...
<tr>
		...
		<div class="areaSearch">
			<table>
				...
				<tr>
					...
					<td>
						<select id="etatTaxation" name="etatTaxation">
						<option value=""></option>
						<c:forEach var="etat" items="${viewBean.etatTOs}">
				...
				<thead>
					<tr>
						...
						<th class="notSortable">
							<label for="checkAll"><ct:FWLabel key="JSP_IMPRIMER"/></label>
	...
	<div style="text-align: right;">
		<input type="button" id="imprimer" value='<ct:FWLabel key="JSP_IMPRIMER"/>' />
	</div>
	</td>
</tr>
