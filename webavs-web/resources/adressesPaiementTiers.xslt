...
<xsl:element name="div">
			...
			<xsl:attribute name="name"><xsl:value-of select="idAdressePaiement"/></xsl:attribute>
	...
	<xsl:element name="a">
			...
			<xsl:attribute name="href">javascript:parent.location.href='pyxis?userAction=pyxis.adressepaiement.avoirPaiement.afficher&amp;selectedId=<xsl:value-of select="id"/>&amp;idTiers=<xsl:value-of select="/adresses/tiers/id"/>'</xsl:attribute>
	...
	<xsl:if test="showUpdateButton">
		...
		<xsl:element name="a">
				...
				<xsl:attribute name="href">javascript:parent.location.href='pyxis?synch=false&amp;userAction=pyxis.adressepaiement.avoirPaiement.copier&amp;selectedId=<xsl:value-of select="id"/>&amp;idTiers=<xsl:value-of select="/adresses/tiers/id"/>&amp;idAdressePaiement=<xsl:value-of select="idAdressePaiement"/>'</xsl:attribute>MAJ</xsl:element>		
		...
		<xsl:element name="a">
				...
				<xsl:attribute name="onblur">this.style.border=''</xsl:attribute>
				<xsl:attribute name="accesskey">m</xsl:attribute>
				<xsl:attribute name="href">javascript:parent.location.href='pyxis?synch=true&amp;userAction=pyxis.adressepaiement.avoirPaiement.copier&amp;selectedId=<xsl:value-of select="id"/>&amp;idTiers=<xsl:value-of select="/adresses/tiers/id"/>&amp;idAdressePaiement=<xsl:value-of select="idAdressePaiement"/>'</xsl:attribute>MAJ</xsl:element>		
	...
	<xsl:if test="showCorrectionButton">
		...
		<xsl:element name="a">
				...
				<xsl:attribute name="href">javascript:parent.location.href='pyxis?synch=false&amp;userAction=pyxis.adressepaiement.avoirPaiement.correction&amp;back=_sl&amp;selectedId=<xsl:value-of select="id"/>&amp;idTiers=<xsl:value-of select="/adresses/tiers/id"/>&amp;idAdressePaiement=<xsl:value-of select="idAdressePaiement"/>'</xsl:attribute>COR</xsl:element>		
		...
		<xsl:element name="a">
				...
				<xsl:attribute name="onblur">this.style.border=''</xsl:attribute>
				<xsl:attribute name="accesskey">c</xsl:attribute>
				<xsl:attribute name="href">javascript:parent.location.href='pyxis?synch=true&amp;userAction=pyxis.adressepaiement.avoirPaiement.correction&amp;back=_sl&amp;selectedId=<xsl:value-of select="id"/>&amp;idTiers=<xsl:value-of select="/adresses/tiers/id"/>&amp;idAdressePaiement=<xsl:value-of select="idAdressePaiement"/>'</xsl:attribute>COR</xsl:element>		
	</xsl:if>
