...
insert into SCHEMA.FWCOUP (pcosid,plaide,pcouid,pcolut,pspy) values ( 5200058, 'D', '', '[de]ADB Radié', 'spy'); 
...
insert into SCHEMA.FWCOUP (pcosid,plaide,pcouid,pcolut,pspy) values ( 5300058, 'D', '', '[de]Radiation ADB', 'spy'); 
