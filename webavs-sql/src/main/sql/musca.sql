...
INSERT INTO SCHEMA.FAMODUP (IDMODFAC,LIBELLEFR,LIBELLEDE,LIBELLEIT,NOMCLASSE,IDTYPEMODULE,NIVEAUAPPEL,MODIFIERAFACT,PSPY)
VALUES ((SELECT COALESCE(MAX(IDMODFAC),0) FROM SCHEMA.FAMODUP) + 1,'Bulletins de solde eBill','[de]Saldo ESR eBill','[it]Soldes BVR eBill','globaz.musca.api.musca.FASolde_EBill',905046,150,2,'20210312120000spy');
