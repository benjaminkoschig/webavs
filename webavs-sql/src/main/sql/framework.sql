...
INSERT INTO SCHEMA.FWPARP (PPARAP, PPACDI, PPARIA, PPADDE, PPARPD, PCOSID, PPARPF, PPARVA, PPRAVN, PPRADE, CSTYUN, PCOITC, PSPY)
VALUES ('FRAMEWORK', 'EWSACNT', 2, 20220101, 0.000000, 0, 0.000000, '65NXSd2aUq33Z/RZkX6yHQ==', 0.000000, 'Account WS : FVE', 0, 0, to_char(current timestamp, 'YYYYMMDDHH24MISS') concat 'globaz');