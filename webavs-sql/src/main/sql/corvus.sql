...
ALTER TABLE SCHEMA.RECREAN
    ADD COLUMN ID_REF_QR VARCHAR(27);
...
-- Table des déblocages
ALTER TABLE SCHEMA.RE_LIGNE_DEBLOCAGE
    ADD COLUMN ID_REF_QR VARCHAR(27);
REORG table SCHEMA.RE_LIGNE_DEBLOCAGE;
-- call SYSPROC.ADMIN_CMD('reorg table RE_LIGNE_DEBLOCAGE');
