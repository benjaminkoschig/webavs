...
--ALTER TABLE SCHEMA.PT_ABSENCES ADD CONSTRAINT PK_PT_ABSENCES PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_ADHESIONS_COTIS_POSTES ADD CONSTRAINT PK_PT_ADHESIONS_COTIS_POSTES PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_CONV_QUALIFICATIONS ADD CONSTRAINT PK_ConventionsQualification PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_COTISATION_DECOMPTES ADD CONSTRAINT PK_PT_COTISATION_DECOMPTES PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_DECOMPTE_LIGNES ADD CONSTRAINT PK_PT_DECOMPTE_LIGNES PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_DECOMPTES ADD CONSTRAINT PK_PT_DECOMPTES PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_EMPLOYEURS ADD CONSTRAINT PK_Employeurs PRIMARY KEY (ID_AFAFFIP);
--ALTER TABLE SCHEMA.PT_HISTORIQUE_DECOMPTES ADD CONSTRAINT PK_PT_HISTORIQUE_DECOMPTES PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_POSTES_TRAVAILS ADD CONSTRAINT PK_PosteTravail PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_TAUX_OCCUPATIONS ADD CONSTRAINT PK_PT_TAUX_OCCUPATIONS PRIMARY KEY (ID);
--ALTER TABLE SCHEMA.PT_TRAVAILLEURS ADD CONSTRAINT PK_POSTETRAVAIL PRIMARY KEY (ID);
...
ALTER TABLE SCHEMA.PT_ADHESIONS_COTIS_POSTES ADD CONSTRAINT FK_PT_ADHESIONS_COTIS_POSTES_PT_POSTES_TRAVAILS FOREIGN KEY (ID_PT_POSTES_TRAVAILS) REFERENCES SCHEMA.PT_POSTES_TRAVAILS (ID);
--ALTER TABLE SCHEMA.PT_ADHESIONS_COTIS_POSTES ADD CONSTRAINT FK_PT_ADHESIONS_COTI_AFCOTIP FOREIGN KEY (ID_AFCOTIP) REFERENCES SCHEMA.AFCOTIP (MEICOT);
--ALTER TABLE SCHEMA.PT_CONV_QUALIFICATIONS ADD CONSTRAINT FK_PT_CONV_QUALIFICATIONS_TIADMIP FOREIGN KEY (ID_TIADMIP_CONVENTION) REFERENCES SCHEMA.TIADMIP (HTITIE);
--ALTER TABLE SCHEMA.PT_DECOMPTES ADD CONSTRAINT FK_PT_DECOMPTES_PT_EMPLOYEURS FOREIGN KEY (ID_PT_EMPLOYEURS) REFERENCES SCHEMA.PT_EMPLOYEURS (ID_AFAFFIP);
...
--ALTER TABLE SCHEMA.PT_TRAVAILLEURS ADD CONSTRAINT FK_PT_TRAVAILLEURS_TITIERP FOREIGN KEY (ID_TITIERP) REFERENCES SCHEMA.TITIERP (HTITIE);
