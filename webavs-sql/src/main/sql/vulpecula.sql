...
ALTER TABLE SCHEMA.PT_PARAMETRES_COT_AP ADD CONSTRAINT FK_PT_PARAM_COTISATIONS_AP FOREIGN KEY (ID_COTISATIONS_AP) REFERENCES SCHEMA.PT_COTISATIONS_AP(ID);
ALTER TABLE SCHEMA.PT_ASSOCIATION_COTISATION ADD CONSTRAINT FK_PT_COTISATIONS_AP FOREIGN KEY (ID_PT_COTISATIONS_AP) REFERENCES SCHEMA.PT_COTISATIONS_AP(ID);
