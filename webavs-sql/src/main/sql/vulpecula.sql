...
COMMENT ON COLUMN SCHEMA.PT_POSTES_TRAVAILS.ID_AFAFFIP
    IS 'idEmployeur';
...
ALTER TABLE SCHEMA.PT_ABSENCES ADD CONSTRAINT PK_PT_ABSENCES 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_ADHESIONS_COTIS_POSTES ADD CONSTRAINT PK_PT_ADHESIONS_COTIS_POSTES 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_CONV_QUALIFICATIONS ADD CONSTRAINT PK_ConventionsQualification 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_COTISATION_DECOMPTES ADD CONSTRAINT PK_PT_COTISATION_DECOMPTES 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_DECOMPTE_LIGNES ADD CONSTRAINT PK_PT_DECOMPTE_LIGNES 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_DECOMPTES ADD CONSTRAINT PK_PT_DECOMPTES 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_EMPLOYEURS ADD CONSTRAINT PK_Employeurs 
	PRIMARY KEY (ID_AFAFFIP);


ALTER TABLE SCHEMA.PT_HISTORIQUE_DECOMPTES ADD CONSTRAINT PK_PT_HISTORIQUE_DECOMPTES 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_POSTES_TRAVAILS ADD CONSTRAINT PK_PosteTravail 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_TAUX_OCCUPATIONS ADD CONSTRAINT PK_PT_TAUX_OCCUPATIONS 
	PRIMARY KEY (ID);


ALTER TABLE SCHEMA.PT_TRAVAILLEURS ADD CONSTRAINT PK_POSTETRAVAIL 
	PRIMARY KEY (ID);
...
ALTER TABLE SCHEMA.PT_ADHESIONS_COTIS_POSTES ADD CONSTRAINT FK_PT_ADHESIONS_COTIS_POSTES_PT_POSTES_TRAVAILS 
	FOREIGN KEY (ID_PT_POSTES_TRAVAILS) REFERENCES SCHEMA.PT_POSTES_TRAVAILS (ID);

ALTER TABLE SCHEMA.PT_ADHESIONS_COTIS_POSTES ADD CONSTRAINT FK_PT_ADHESIONS_COTI_AFCOTIP 
	FOREIGN KEY (ID_AFCOTIP) REFERENCES SCHEMA.AFCOTIP (MEICOT);

ALTER TABLE SCHEMA.PT_CONV_QUALIFICATIONS ADD CONSTRAINT FK_PT_CONV_QUALIFICATIONS_TIADMIP 
	FOREIGN KEY (ID_TIADMIP_CONVENTION) REFERENCES SCHEMA.TIADMIP (HTITIE);

ALTER TABLE SCHEMA.PT_DECOMPTES ADD CONSTRAINT FK_PT_DECOMPTES_PT_EMPLOYEURS 
	FOREIGN KEY (ID_PT_EMPLOYEURS) REFERENCES SCHEMA.PT_EMPLOYEURS (ID_AFAFFIP);

ALTER TABLE SCHEMA.PT_POSTES_TRAVAILS ADD CONSTRAINT FK_PT_POSTES_PT_TRAVAILLEURS 
	FOREIGN KEY (ID_PT_TRAVAILLEURS) REFERENCES SCHEMA.PT_TRAVAILLEURS (ID);

ALTER TABLE SCHEMA.PT_POSTES_TRAVAILS ADD CONSTRAINT FK_PT_POSTES_PT_EMPLOYEUR 
	FOREIGN KEY (ID_AFAFFIP) REFERENCES SCHEMA.PT_EMPLOYEURS (ID_AFAFFIP);

ALTER TABLE SCHEMA.PT_TRAVAILLEURS ADD CONSTRAINT FK_PT_TRAVAILLEURS_TITIERP 
	FOREIGN KEY (ID_TITIERP) REFERENCES SCHEMA.TITIERP (HTITIE);

ALTER TABLE SCHEMA.PT_DECOMPTE_LIGNES ADD CONSTRAINT FK_PT_DECOMPTE_LIGNES_PT_DECOMPTES FOREIGN KEY (ID_PT_DECOMPTES) REFERENCES SCHEMA.PT_DECOMPTES (ID) ON DELETE CASCADE;
...
-- RC 1
-----------------
--DROP TABLE SCHEMA.PT_ABSENCES_JUSTIFIEES;
...
ALTER TABLE SCHEMA.PT_ABSENCES_JUSTIFIEES ADD CONSTRAINT FK_PT_ABSENCES_JUSTIFIEES_PT_POSTES_TRAVAILS FOREIGN KEY (ID_PT_POSTES_TRAVAILS) REFERENCES SCHEMA.PT_POSTES_TRAVAILS (ID);
...
--========================================================================================================================
-- SQL Script for create table (PT_COMPTEURS)
-- Simple model's class name : (ch.globaz.vulpecula.business.models.congepaye.CompteurSimpleModel)
--========================================================================================================================
--DROP TABLE SCHEMA.PT_COMPTEURS;
...
ALTER TABLE SCHEMA.PT_COMPTEURS ADD CONSTRAINT FK_PT_COMPTEURS_PT_POSTES_TRAVAILS FOREIGN KEY (ID_PT_POSTES_TRAVAILS) REFERENCES SCHEMA.PT_POSTES_TRAVAILS (ID);


--========================================================================================================================
-- SQL Script for create table (PT_CONGES_PAYES)
-- Simple model's class name : (ch.globaz.vulpecula.business.models.congepaye.CongePayeSimpleModel)
--========================================================================================================================
--DROP TABLE SCHEMA.PT_CONGES_PAYES;
...
ALTER TABLE SCHEMA.PT_CONGES_PAYES ADD CONSTRAINT FK_PT_CONGES_PAYES_PT_POSTES_TRAVAILS FOREIGN KEY (ID_PT_POSTES_TRAVAILS) REFERENCES SCHEMA.PT_POSTES_TRAVAILS (ID);
...
ALTER TABLE SCHEMA.PT_LIGNES_COMPTEURS ADD CONSTRAINT FK_PT_LIGNES_COMPTEURS_PT_COMPTEURS FOREIGN KEY (ID_PT_COMPTEURS) REFERENCES SCHEMA.PT_COMPTEURS(ID);
...
ALTER TABLE SCHEMA.PT_SERVICES_MILITAIRES ADD CONSTRAINT FK_PT_SERVICES_MILITAIRES_PT_POSTES_TRAVAIL FOREIGN KEY (ID_PT_POSTES_TRAVAILS) REFERENCES SCHEMA.PT_POSTES_TRAVAILS(ID);
...
ALTER TABLE SCHEMA.PT_ASSOCIATION_COTISATION ADD CONSTRAINT FK_PT_EMPLOYEURS FOREIGN KEY (ID_PT_EMPLOYEURS) REFERENCES SCHEMA.PT_EMPLOYEURS(ID_AFAFFIP);
ALTER TABLE SCHEMA.PT_ASSOCIATION_COTISATION ADD CONSTRAINT PK_PT_ASSOCIATION_COTISATION PRIMARY KEY (ID);
...
ALTER TABLE SCHEMA.PT_CAISSES_MALADIES ADD CONSTRAINT PK_PT_CAISSES_MALADIES PRIMARY KEY (ID);
ALTER TABLE SCHEMA.PT_CAISSES_MALADIES ADD CONSTRAINT FK_PT_CAISSES_MALADIES FOREIGN KEY (ID_PT_TRAVAILLEURS) REFERENCES SCHEMA.PT_TRAVAILLEURS (ID);
ALTER TABLE SCHEMA.PT_CAISSES_MALADIES ADD CONSTRAINT FK_PT_POSTES_TRAVAILS FOREIGN KEY (ID_PT_POSTES_TRAVAILS) REFERENCES SCHEMA.PT_POSTES_TRAVAILS(ID);
...
ALTER TABLE SCHEMA.PT_SYNDICATS ADD CONSTRAINT PK_PT_SYNDICATS	PRIMARY KEY (ID);
ALTER TABLE SCHEMA.PT_SYNDICATS ADD CONSTRAINT FK_TIADMIP FOREIGN KEY (ID_TIADMIP) REFERENCES SCHEMA.TIADMIP(HTITIE);
ALTER TABLE SCHEMA.PT_SYNDICATS ADD CONSTRAINT FK_PT_TRAVAILLEURS FOREIGN KEY (ID_PT_TRAVAILLEURS) REFERENCES SCHEMA.PT_TRAVAILLEURS(ID);
...
ALTER TABLE SCHEMA.PT_SUIVI_CAISSE_MALADIE ADD CONSTRAINT PK_PT_SUIVI_CAISSE_MALADIE PRIMARY KEY (ID);
...
ALTER TABLE SCHEMA.PT_PARAMETRES_SYNDICATS ADD CONSTRAINT PK_PT_PARAMETRES_SYNDICATS PRIMARY KEY (ID);
...
ALTER TABLE SCHEMA.PT_LIGNES_TAXATIONS ADD CONSTRAINT UN_PT_LIGNES_TAXATIONS_ID UNIQUE (ID);
ALTER TABLE SCHEMA.PT_TAXATIONS_OFFICE ADD CONSTRAINT UN_PT_TAXATIONS_OFFICE_ID UNIQUE (ID);

ALTER TABLE SCHEMA.PT_LIGNES_TAXATIONS ADD CONSTRAINT FK_PT_LIGNES_TAXATIONS_AFCOTIP FOREIGN KEY (ID_AFCOTIP) REFERENCES SCHEMA.AFCOTIP (MEICOT);
...
ALTER TABLE SCHEMA.PT_TAXATIONS_OFFICE ADD CONSTRAINT FK_PT_TAXATIONS_OFFICE_PT_DECOMPTES FOREIGN KEY (ID_PT_DECOMPTES) REFERENCES SCHEMA.PT_DECOMPTES (ID);
...
ALTER TABLE SCHEMA.PT_SUIVI_CAISSE_MALADIE ADD CONSTRAINT FK_PT_SUIVI_CAISSE_MALADIE_PT_TRAVAILLEURS FOREIGN KEY(ID_TRAVAILLEUR) REFERENCES SCHEMA.PT_TRAVAILLEURS(ID);
ALTER TABLE SCHEMA.PT_SUIVI_CAISSE_MALADIE ADD CONSTRAINT FK_PT_SUIVI_CAISSE_MALADIE_TIADMIP FOREIGN KEY(ID_CAISSE_MALADIE) REFERENCES SCHEMA.TIADMIP(HTITIE);
ALTER TABLE SCHEMA.PT_PARAMETRES_COT_AP ADD CONSTRAINT FK_PT_PARAMETRES_COT_AP_PT_COTISATIONS_AP FOREIGN KEY(ID_COTISATIONS_AP) REFERENCES SCHEMA.PT_COTISATIONS_AP(ID);
ALTER TABLE SCHEMA.PT_COTISATION_DECOMPTES ADD CONSTRAINT FK_COTISATION_DECOMPTES_AFCOTIP FOREIGN KEY(ID_AFCOTIP) REFERENCES SCHEMA.AFCOTIP(MEICOT);
ALTER TABLE SCHEMA.PT_TAXATIONS_OFFICE ADD CONSTRAINT FK_PT_TAXATIONS_OFFICE_FAPASSP FOREIGN KEY(ID_FAPASSP) REFERENCES SCHEMA.FAPASSP(IDPASSAGE);
ALTER TABLE SCHEMA.PT_CAISSES_MALADIES ADD CONSTRAINT FK_PT_CAISSES_MALADIES_TIADMIP FOREIGN KEY(ID_TIADMIP) REFERENCES SCHEMA.TIADMIP(HTITIE);
ALTER TABLE SCHEMA.PT_TAXATIONS_OFFICE ADD CONSTRAINT PK_PT_TAXATIONS_OFFICE PRIMARY KEY(ID);
ALTER TABLE SCHEMA.PT_LIGNES_TAXATIONS ADD CONSTRAINT PK_PT_LIGNES_TAXATIONS PRIMARY KEY(ID);
...
ALTER TABLE SCHEMA.PT_NOTIFICATIONS ADD CONSTRAINT PK_PT_NOTIFICATIONS PRIMARY KEY(ID);
...
ALTER TABLE SCHEMA.PT_CAISSES_MALADIES ADD CONSTRAINT FK_PT_CAISSES_MALADIES_PT_POSTES_TRAVAILS  FOREIGN KEY (ID_PT_POSTES_TRAVAILS) REFERENCES SCHEMA.PT_POSTES_TRAVAILS (ID);


ALTER TABLE CCJUWEB.PT_PARAMETRES_COT_AP ADD CONSTRAINT FK_PT_PARAM_COTISATIONS_AP FOREIGN KEY (ID_COTISATIONS_AP) REFERENCES CCJUWEB.PT_COTISATIONS_AP(ID);
ALTER TABLE CCJUWEB.PT_ASSOCIATION_COTISATION ADD CONSTRAINT FK_PT_COTISATIONS_AP FOREIGN KEY (ID_PT_COTISATIONS_AP) REFERENCES CCJUWEB.PT_COTISATIONS_AP(ID);
