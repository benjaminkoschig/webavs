...
INSERT INTO SCHEMA.FWPARP (PPARAP,PPACDI,PPARIA,PPADDE,PPARPD,PCOSID,PPARPF,PPARVA,PPRAVN,PPRADE,CSTYUN,PCOITC,PSPY) VALUES ('OSIRIS','TAUXPAND20',0,20010101,0.000000,10200030,0.000000,'',5.000000,'Taux d''intérêts pour les cas en surcis/prorogation',0,0,'20200328101910globaz');
INSERT INTO SCHEMA.FWPARP (PPARAP,PPACDI,PPARIA,PPADDE,PPARPD,PCOSID,PPARPF,PPARVA,PPRAVN,PPRADE,CSTYUN,PCOITC,PSPY) VALUES ('OSIRIS','TAUXPAND20',0,20200321,0.000000,10200030,0.000000,'',0.000000,'Taux d''intérêts pour les cas en surcis/prorogation',0,0,'20200328101910globaz');
INSERT INTO SCHEMA.FWPARP (PPARAP,PPACDI,PPARIA,PPADDE,PPARPD,PCOSID,PPARPF,PPARVA,PPRAVN,PPRADE,CSTYUN,PCOITC,PSPY) VALUES ('OSIRIS','TAUXPAND20',0,20200921,0.000000,10200030,0.000000,'',5.000000,'Taux d''intérêts pour les cas en surcis/prorogation',0,0,'20200328101910globaz');
...
INSERT INTO SCHEMA.JADEPROP (PROPNAME,PROPVAL,CSPY,PSPY) VALUES ('aquila.tauxInteret.pandemieSurcisProrogation.periodes','21.03.2020:20.09.2020','20200602120000ccjuglo   ','20200602120000ccjuglo   ');