...
CREATE TABLE schema.EBILL_FICHIER_INSCRIPTION (
...
CREATE TABLE schema.EBILL_INSCRIPTION (
...
CREATE TABLE schema.EBILL_FICHIER_TRAITEMENT (
	ID_FICHIER NUMERIC(9,0) NOT NULL,
	NOM_FICHIER VARCHAR (40),
	STATUT_FICHIER NUMERIC(1, 0),
	DATE_LECTURE NUMERIC(8, 0),
...
CREATE TABLE schema.EBILL_TRAITEMENT (
