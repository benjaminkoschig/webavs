...
ADD COLUMN EBILLETAT CHAR(1)
ADD COLUMN EBILLERREUR VARCHAR(255);
...
-- S200701_007 e-Bill: Caisses eBill valides
    ...
    -- FER-CIAM "106.1"
    INSERT INTO SCHEMA.FWPARP (PPARAP,PPACDI,PPADDE,PPARIA,PPRADE,PPARVA,PSPY)
...
INSERT INTO SCHEMA.FWCOSP (PCOSID, PPTYGR, PCONCS, PPTYCN, PPTYCL, PPTYSA, PCOSLI, PCOSDF, PCOSDM, PCOSDP, PCOIAN, PCOIDE, PCODFI, PCOITC, PCOISE, PSPY) VALUES (905046, 'MUTYPMODUL', 1, 1, 0, 0, 'Module_Bulletin_De_Soldes_EBill', 2, 1, 2, 2, 2, 2, 10900005, 0, '20210701120000spy');
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (905046, 'D', '', 'Bulletin de Soldes EBill', '20210701120000spy');
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (905046, 'F', '', 'Bulletin de Soldes EBill', '20210701120000spy');