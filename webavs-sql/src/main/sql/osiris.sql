...
ADD COLUMN EBILLID NUMERIC(20,0);
...
ALTER TABLE SCHEMA.CASECTP
ADD COLUMN EBILLETAT NUMERIC(1, 0);
...
CREATE TABLE schema.FICHIER_INSCRIPTION_EBILL (
...
CREATE TABLE schema.INSCRIPTION_EBILL (
    ID_INSCRIPTION NUMERIC(9,0) NOT NULL,
    ID_FICHIER NUMERIC(9,0) NOT NULL,
	EBILL_ACCOUNT_ID NUMERIC(20,0) NOT NULL,
...
CREATE TABLE schema.FICHIER_TRAITEMENT_EBILL (
	ID_FICHIER NUMERIC(9,0) NOT NULL,
	NOM_FICHIER VARCHAR (40),
	STATUT_FICHIER NUMERIC(1, 0),
	DATE_LECTURE NUMERIC(8, 0),
...
CREATE TABLE schema.TRAITEMENT_EBILL (
    ID_TRAITEMENT NUMERIC(9,0) NOT NULL,
    ID_FICHIER NUMERIC(9,0) NOT NULL,
	EBILL_ACCOUNT_ID VARCHAR (40),
	NUMERO_AFFILIE VARCHAR (40),
	NOM VARCHAR (40),
	PRENOM VARCHAR (40),
	ENTREPRISE VARCHAR (40),
