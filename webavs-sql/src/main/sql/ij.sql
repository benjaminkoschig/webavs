...
-- ACOR
INSERT INTO SCHEMA.JADEPROP (PROPNAME,PROPVAL,CSPY,PSPY) VALUES ('ij.acor.utiliser.version.web','false','20210729120000Globaz    ', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat 'globaz');
INSERT INTO SCHEMA.JADEPROP (PROPNAME,PROPVAL,CSPY,PSPY) VALUES ('common.acor.adresse.web','','20210729120000Globaz    ', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat 'globaz');
INSERT INTO SCHEMA.JADEPROP (PROPNAME,PROPVAL,CSPY,PSPY) VALUES ('common.acor.navigateur','','20210729120000Globaz    ', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat 'globaz');
...
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (52434001, 'D', '1', 'BGB mit Lehrvertrag (EBA oder EFZ)', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat user);
...
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (52434002, 'D', '2', 'BGB ohne Lehrvertrag (Hilfstätigkeit/geschützte Werkstätte)', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat user);
...
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (52434003, 'D', '3', 'BGB ohne bezahltes Praktikum', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat user);
...
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (52434004, 'D', '4', 'BGB mit bezahltem Praktikum', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat user);
...
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (52434005, 'D', '5', 'Andere Ausbildung (IV-Ausbildung, PRAINSOS, gezielte Vorbereitung auf eine BGB)', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat user);
...
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (52434006, 'D', '6', 'Sonderfall 1: Gemäss Art. 22 Abs. 2 Bst. b (Versicherte mit Anspruch auf medizinische Massnahmen zur Eingliederung im Sinne von Art. 12 IVG)', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat user);
...
INSERT INTO SCHEMA.FWCOUP (PCOSID, PLAIDE, PCOUID, PCOLUT, PSPY) VALUES (52434007, 'D', '7', 'Sonderfall 2: Gemäss Art. 22 Abs. 2 Bst. b (Versicherte mit Anspruch auf Integrationsmassnahmen im Sinne von Art. 14a IVG)', VARCHAR_FORMAT((current date), 'yyyymmdd') concat replace(char(current time), '.', '') concat user);
