...
--Propriété pour générer (ou pas) l'extrait de la déclaration de salaire avec le questionnaire
INSERT INTO SCHEMA.JADEPROP (PROPNAME,PROPVAL) VALUES ('naos.lpp.annuel.generation.extrait','false');
