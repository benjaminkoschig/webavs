...
--WEBAVS-6349	INFOROM - RAFam nouveau code de non plausibilité
INSERT INTO SCHEMA.FWCOSP (PCOSID,PPTYGR,PCONCS,PPTYCN,PPTYCL,PPTYSA,PCOSLI,PCOSDF,PCOSDM,PCOSDP,PCOIAN,PCOIDE,PCODFI,PCOITC,PCOISE,PSPY) VALUES (61370009,'ALRAFAMETA',1,1,0,0,'Archivé',2,1,2,2,2,2,60370000,0,'20190408Globaz          ');
INSERT INTO SCHEMA.FWCOUP (PCOSID,PLAIDE,PCOUID,PCOLUT,PSPY) VALUES (61370009,'D','7         ','Archivé','20190408Globaz          ');
INSERT INTO SCHEMA.FWCOUP (PCOSID,PLAIDE,PCOUID,PCOLUT,PSPY) VALUES (61370007,'F','7         ','Archivé','20190408Globaz          ');
