...
-- INSERT INTO SCHEMA.CTELEMEN (CCBDES,CCBEDI,CCBSBD,CCBSEL,CCIDOC,CCIELE,CCNNIV,CCNPOS,PSPY) VALUES ('','2','2','2',2000000002,9000000202,3,50,'20190523085145oca');
-- INSERT INTO SCHEMA.CTTEXTES (CDIELE,CDITXT,CDLCIL,CDLDES,PSPY) VALUES (9000000202,9000001012,'de','{nbJours} Tag(e)','20190307151704');
-- INSERT INTO SCHEMA.CTTEXTES (CDIELE,CDITXT,CDLCIL,CDLDES,PSPY) VALUES (9000000202,9000001013,'fr','{nbJours} jour(s)','20190307151704');
-- INSERT INTO SCHEMA.CTTEXTES (CDIELE,CDITXT,CDLCIL,CDLDES,PSPY) VALUES (9000000202,9000001014,'it','{nbJours} jour(s)','20190307151704');

-- INSERT INTO SCHEMA.CTELEMEN (CCBDES,CCBEDI,CCBSBD,CCBSEL,CCIDOC,CCIELE,CCNNIV,CCNPOS,PSPY) VALUES ('','2','2','2',2000000003,9000000203,3,50,'20190523085145oca');
-- INSERT INTO SCHEMA.CTTEXTES (CDIELE,CDITXT,CDLCIL,CDLDES,PSPY) VALUES (9000000203,9000001015,'de','{nbJours} Tag(e)','20190307151704');
-- INSERT INTO SCHEMA.CTTEXTES (CDIELE,CDITXT,CDLCIL,CDLDES,PSPY) VALUES (9000000203,9000001016,'fr','{nbJours} jour(s)','20190307151704');
-- INSERT INTO SCHEMA.CTTEXTES (CDIELE,CDITXT,CDLCIL,CDLDES,PSPY) VALUES (9000000203,9000001017,'it','{nbJours} jour(s)','20190307151704');

-- UPDATE SCHEMA.FWINCP SET PINCVA=203 WHERE PCOSID= (SELECT CATTYP FROM WEBAVSCIAM.CTDOCUME INNER JOIN WEBAVSCIAM.CTTYPDOC ON CBITYD=CAITYD WHERE CBIDOC=2000000002) AND PINCAN=0 AND PINCID='CTELEMEN'
