...
-- UPDATE SCHEMA.FWINCP SET PINCVA=203 WHERE PCOSID= (SELECT CATTYP FROM SCHEMA.CTDOCUME INNER JOIN SCHEMA.CTTYPDOC ON CBITYD=CAITYD WHERE CBIDOC=2000000002) AND PINCAN=0 AND PINCID='CTELEMEN'
