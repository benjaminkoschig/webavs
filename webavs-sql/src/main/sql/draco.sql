...
INSERT INTO SCHEMA.FWCOSP(pcosid,pptygr,pconcs,pptycn,pptycl,pptysa,pcosli,pcosdf,pcosdm,pcosdp,pcoian,pcoide,pcodfi,pcoitc,pcoise, pspy) values (812028,'VETYPEASSU',1,1,0,0,'Frais_d_administration_maj',2,1,2,2,2,2,10800012,0, 'spy');
