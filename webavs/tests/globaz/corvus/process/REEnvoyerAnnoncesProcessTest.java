...
public class REEnvoyerAnnoncesProcessTest {
    ...
    @Spy
    private REEnvoyerAnnoncesProcess testInstance;

    public REEnvoyerAnnoncesProcessTest() {
    ...
    public void setUp() throws Exception {
        ...
        testInstance = Mockito.spy(new REEnvoyerAnnoncesProcess());
