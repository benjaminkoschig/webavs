...
public class TarifsHorlogereTest extends ALTestCaseJU4 {
    ...
    public static List<Object[]> getParametres() {
        return Arrays.asList(new Object[][] {
                ...
                { "src/ch/globaz/al/businessimpl/services/calcul/res/tarifs_2012_CAISS_Horloger.xml" } });
    }
    ...
    public TarifsHorlogereTest(String pFile) {
        this.pFile = pFile;
    }
