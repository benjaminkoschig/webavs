...
public class TarifsFPVTest extends ALTestCaseJU4 {
    ...
    public static List<Object[]> getParametres() {
        return Arrays.asList(new Object[][] {
                ...
                { "src/ch/globaz/al/businessimpl/services/calcul/res/tarifs_2009_CAISS_FPV.xml" },
                { "src/ch/globaz/al/businessimpl/services/calcul/res/tarifs_2010_CAISS_FPV.xml" },
                { "src/ch/globaz/al/businessimpl/services/calcul/res/tarifs_2011_CAISS_FPV.xml" },
                { "src/ch/globaz/al/businessimpl/services/calcul/res/tarifs_2013_CAISS_FPV.xml" },
                { "src/ch/globaz/al/businessimpl/services/calcul/res/tarifs_2009_CAISS_FPV_VISANA.xml" } });
    }
    ...
    public TarifsFPVTest(String pFile) {
        this.pFile = pFile;
    }
