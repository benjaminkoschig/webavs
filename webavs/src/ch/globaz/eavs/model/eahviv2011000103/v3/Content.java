...
import ch.globaz.eavs.model.eahviv2011000103.common.AbstractEpPrivateData;
...
public class Content extends AbstractContent {
    ...
    private EpBusinessData epBusinessData = null;
    private EpPrivateData epPrivateData = null;
    ...
    public List getChildren() {
        ...
        result.add(epBusinessData);
        result.add(epPrivateData);
        return result;
    }
    ...
    public AbstractEpBusinessData getEpBusinessData() {
        if (epBusinessData == null) {
            epBusinessData = new EpBusinessData();
        }
        return epBusinessData;
    }

    public AbstractEpPrivateData getEpPrivateData() {
        if (epPrivateData == null) {
            epPrivateData = new EpPrivateData();
        }
        return epPrivateData;
    }
    ...
    public void setEpBusinessData(EAVSAbstractModel _epBusinessData) {
        epBusinessData = (EpBusinessData) _epBusinessData;
    }

    public void setEpPrivateData(EAVSAbstractModel _epPrivateData) {
        epPrivateData = (EpPrivateData) _epPrivateData;
    }
