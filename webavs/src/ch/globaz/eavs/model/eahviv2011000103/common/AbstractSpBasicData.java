...
public abstract class AbstractSpBasicData extends CommonModel implements EAVSNonFinalNode {
    ...
    public abstract AbstractIncomeFromParticipations getIncomeFromParticipations();
    ...
    public abstract AbstractOASIContribution getOASIContribution();
    ...
    public abstract void setIncomeFromParticipations(EAVSAbstractModel _incomeFromParticipations);
    ...
    public abstract void setOASIContribution(EAVSAbstractModel _oasiContribution);
