...
public abstract class AbstractSendingApplication extends CommonModel implements EAVSNonFinalNode {
    ...
    public abstract void setManufacturer(EAVSAbstractModel _manufacturer);

    public abstract void setProduct(EAVSAbstractModel _product);

    public abstract void setProductVersion(EAVSAbstractModel _productVersion);
