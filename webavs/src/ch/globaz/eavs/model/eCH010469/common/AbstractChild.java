...
import ch.globaz.eavs.model.eCH0044.common.AbstractVn;
import ch.globaz.eavs.model.eCH0104.common.AbstractDateOfDeath;
import ch.globaz.eavs.model.eCH0104.common.AbstractNewVn;
...
public abstract class AbstractChild extends Ech010469Model implements EAVSNonFinalNode {
    ...
    public abstract AbstractNewVn getNewVn();
    ...
    public abstract void setNewVn(EAVSAbstractModel _newVn);
