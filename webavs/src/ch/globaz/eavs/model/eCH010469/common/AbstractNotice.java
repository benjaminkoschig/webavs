...
public abstract class AbstractNotice extends Ech010469Model implements EAVSNonFinalNode {
    ...
    public abstract void setError(EAVSAbstractModel _returnCode);

    public abstract void setErrorPeriod(EAVSAbstractModel _overlapPeriod);
