...
public class ListCPExcel extends PrestationsListExcel {
    ...
    private final int LAST_COLUMN_OFFSET = 17;
    ...
    private final int COL_AJOUT_RETRAIT = 4;
    private final int COL_BENEFICIAIRE = 5;
    private final int COL_PERIODE = 6;
    private final int COL_SALAIRES = 7;
    private final int COL_TAUX = 8;
    private final int COL_BRUT = 9;
    private final int COL_MAL = 10;
    private final int COL_RET = 11;
    private final int COL_LPP = 12;
    private final int COL_AVS = 13;
    private final int COL_AC = 14;
    private final int COL_AF = 15;
    private final int COL_FCFP = 16;
    private final int COL_NET = 17;
