...
import ch.globaz.pegasus.businessimpl.checkers.variableMetier.SimpleVariableMetierChecker;
import ch.globaz.pegasus.businessimpl.services.PegasusAbstractServiceImpl;
import ch.globaz.pegasus.businessimpl.utils.Parametre;

/**
 * @author DMA
 * 
 */
public class SimpleVariableMetierServiceImpl extends PegasusAbstractServiceImpl implements SimpleVariableMetierService {
    /*
     * (non-Javadoc)
     * 
     * @seech.globaz.pegasus.business.services.models.variableMetier. SimpleVaraibleService
     * #count(ch.globaz.pegasus.business.models.variableMetier .SimpleVariableMetierSearch)
     */
     ...
     * 
     * @seech.globaz.pegasus.business.services.models.variableMetier. SimpleVaraibleService
     * #create(ch.globaz.pegasus.business.models.variableMetier .SimpleVariableMetier)
     */
    @Override
     ...
     * 
     * @seech.globaz.pegasus.business.services.models.variableMetier. SimpleVaraibleService
     * #delete(ch.globaz.pegasus'.business.models.variableMetier .SimpleVariableMetier)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @seech.globaz.pegasus.business.services.models.variableMetier. SimpleVaraibleService #read(java.lang.String)
     */
    @Override
     ...
     * 
     * @seech.globaz.pegasus.business.services.models.variableMetier. SimpleVaraibleService
     * #update(ch.globaz.pegasus.business.models.variableMetier
     */

    /*
     * (non-Javadoc)
     * 
     * @seech.globaz.pegasus.business.services.models.variableMetier. SimpleVariableMetierService
     * #search(ch.globaz.pegasus.business.models.variablemetier .SimpleVariableMetierSearch)
     */
    @Override
            ...
            if (variableMetierSearch.getSize() > 1) {
                ...
                if (!JadeDateUtil.areDatesEquals(simpleVariableMetierToUpdate.getDateDebut(),
                    ...
                    JadeThread.logError(variableMetier.getClass().getName(),
                            "pegasus.simpleVariableMetier.dateDebutEgale.mandatory");
                }
            }
        }
    }
