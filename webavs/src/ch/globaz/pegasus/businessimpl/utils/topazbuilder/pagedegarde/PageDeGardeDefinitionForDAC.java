...
/**
 * Cette classe permet de définir le contenu de la page de garde prévu pour la décision après calcul.
 * 
 * @author jwe
 * 
 */
public class PageDeGardeDefinitionForDAC implements IPageDeGardeDefinition {

    public PageDeGardeDefinitionForDAC(TextGiver<BabelTextDefinition> textGiver) {
    ...
    private static final BabelTextDefinition INTRO = new BabelTextDefinitionImpl(15, 10, "INTRO", "");
    private static final BabelTextDefinition POLITESSE = new BabelTextDefinitionImpl(18, 20, "POLITESSE",
            "Formule de politesse. Exemple: Madame, Monsieur");
    private static final BabelTextDefinition ANNEXE = new BabelTextDefinitionImpl(12, 10, "ANNEXE",
            "Annexes du document");
    private static final BabelTextDefinition ANNEXE_MENT = new BabelTextDefinitionImpl(12, 11, "ANNEXE_MENT",
            "Annexes mentionnées du document");
    private static final BabelTextDefinition SALUTATIONS_PART_1 = new BabelTextDefinitionImpl(11, 10,
            "SALUTATIONS_PART_1", "Salutations du document partie 1");
    private static final BabelTextDefinition SALUTATIONS_PART_2 = new BabelTextDefinitionImpl(11, 11,
    ...
    private static final BabelTextDefinition PERSONNE_DE_REFERENCE = new BabelTextDefinitionImpl(1, 2,
    ...
    private BabelTextDefinition N_REF = new BabelTextDefinitionImpl("N_REF");
    private BabelTextDefinition V_REF = new BabelTextDefinitionImpl("V_REF");
