...
public class VariableMetierBuilder implements ICalculDonneesHorsDroitBuilder {
    ...
    private final static List<String> champsVariableMetier = Arrays.asList(new String[] {
            ...
            IPCVariableMetier.CS_FRANCHISE_REVENUS_PRIVILEGIERS_FAMILLE, IPCVariableMetier.CS_BESOINS_VITAUX_2_ENFANTS,
            IPCVariableMetier.CS_BESOINS_VITAUX_4_ENFANTS, IPCVariableMetier.CS_BESOINS_VITAUX_5_ENFANTS,
            IPCVariableMetier.CS_BESOINS_VITAUX_CELIBATAIRES, IPCVariableMetier.CS_BESOINS_VITAUX_COUPLES,
            IPCVariableMetier.CS_ARGENT_POCHE_MEDICALISE, IPCVariableMetier.CS_ARGENT_POCHE_NON_MEDICALISE,
            ...
            IPCVariableMetier.CS_FORFAIT_REVENU_NATURE_TENUE_MENAGE,
            ...
            IPCVariableMetier.CS_TAUX_IMPUTATION_LOYER_FRAIS_ACQUISITION });
    private final static List<String> champsVariableMetierAvecFraction = Arrays
            .asList(new String[] { IPCVariableMetier.CS_FRACTIONS_FORTUNE_NON_VIEILLESSE,
