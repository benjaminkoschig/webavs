...
public class StrategieFinalRevenuAutres implements StrategieCalculFinalisation {
    private final static String[] champs = { IPCValeursPlanCalcul.CLE_REVEN_AUTREREV_IJAI,
            ...
            IPCValeursPlanCalcul.CLE_REVEN_AUTREREV_IJ_LCA,
    ...
    public void calcule(TupleDonneeRapport donnee, CalculContext context, Date dateDebut) {
        ...
        for (String champ : StrategieFinalRevenuAutres.champs) {
