...
public class Numeraire extends DonneeFinanciere implements Fortune, FortunePartPropriete, Revenu, Interet {
    ...
    public Numeraire(Montant montant, Montant interet, Part part, ProprieteType proprieteType, boolean sansInteret,
    ...
    protected void definedTypeDonneeFinanciere() {
        typeDonnneeFianciere = DonneeFinanciereType.NUMERAIRE;
    }
