...
public class MarchandiseStock extends DonneeFinanciere implements Fortune, FortunePartPropriete {
    private Montant montant;
    private ProprieteType proprieteType;
    private Part part;

    public MarchandiseStock(Montant montant, ProprieteType proprieteType, Part part, DonneeFinanciere donneeFinanciere) {
    ...
    protected void definedTypeDonneeFinanciere() {
        typeDonnneeFianciere = DonneeFinanciereType.MARCHANDISE_STOCK;
    }

    @Override
    public String toString() {
        return "MarchandiseStock [montant=" + montant + ", proprieteType=" + proprieteType + ", part=" + part
    ...
    public boolean equals(Object obj) {
        ...
        MarchandiseStock other = (MarchandiseStock) obj;
        if (montant == null) {
