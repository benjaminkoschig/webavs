...
public class DossierRCListSearch extends JadeSearchComplexModel {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    public static final String SEARCH_DEFINITION_RECHERCHE_FAMILLE = "rechercheFamille";
    ...
    public String getLikeNom() {
        return (getWhereKey() != null)
                && getWhereKey().equalsIgnoreCase(DossierRCListSearch.SEARCH_DEFINITION_RECHERCHE_FAMILLE) ? likeNom
                + "%" : likeNom;
    }
    ...
    public String getLikeNss() {
        return (getWhereKey() != null)
                && getWhereKey().equalsIgnoreCase(DossierRCListSearch.SEARCH_DEFINITION_RECHERCHE_FAMILLE) ? likeNss
                + "%" : likeNss;
    }
    ...
    public String getLikePrenom() {
        return (getWhereKey() != null)
                && getWhereKey().equalsIgnoreCase(DossierRCListSearch.SEARCH_DEFINITION_RECHERCHE_FAMILLE) ? likePrenom
                + "%" : likePrenom;
    }
