...
public class SimpleCreanceAccordeeSearch extends JadeSearchSimpleModel {
    /**
     * 
     */
    ...
    @Override
    public Class<SimpleCreanceAccordee> whichModelClass() {
        return SimpleCreanceAccordee.class;
    }
