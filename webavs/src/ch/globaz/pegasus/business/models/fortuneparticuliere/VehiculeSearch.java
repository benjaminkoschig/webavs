 ...
 * 
 */
public class VehiculeSearch extends AbstractDonneeFinanciereSearchModel {
    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    private String forIdEntity = null;
    private String forIdVehicule = null;
    ...
    /**
     * @return the forIdVehicule
     */
    public String getForIdVehicule() {
        return forIdVehicule;
    }
    ...
    /**
     * @param forIdVehicule
     *            the forIdVehicule to set
     */
    public void setForIdVehicule(String forIdVehicule) {
        this.forIdVehicule = forIdVehicule;
    }
