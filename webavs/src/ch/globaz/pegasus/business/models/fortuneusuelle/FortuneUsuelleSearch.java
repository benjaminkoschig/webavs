 ...
 * 
 */
public class FortuneUsuelleSearch extends JadeSearchComplexModel {

    /**
     * 
     */
    private static final long serialVersionUID = 1L;
    public final static String FOR_ALL_VALABLE_LE = "forAllValableFortuneUsuelle";

    public static String getForAllValableLe() {
        return FortuneUsuelleSearch.FOR_ALL_VALABLE_LE;
    }
