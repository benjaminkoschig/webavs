...
public interface SimpleVariableMetierService extends JadeCrudService<SimpleVariableMetier, SimpleVariableMetierSearch> {
     ...
     * @throws VariableMetierException Levée en cas de problème métier dans l'exécution du service
     ...
     * 
     * @param variableMetier La variable métier à créer
     ...
     * 
     * @param variablemetier La variable métier à supprimer
     ...
     * 
     * @param idVariableMetier L'identifiant de la variableMetier à charger en mémoire
     ...
     * 
     * @param variableMetierSearch Le modèle de critères
     * @return Le modèle de critère avec les résultats
     * @throws JadePersistenceException Levée en cas de problème dans la couche de persistence
     * @throws PrixChambreException Levée en cas de problème métier dans l'exécution du service
     */
    @Override
     ...
     * 
     * @param variableMetier La variableMetier à mettre à jour
