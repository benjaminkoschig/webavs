...
public class PFProcessTraitementAnnuelCalculStep implements JadeProcessStepInterface, JadeProcessStepBeforable {
    ...
    public JadeProcessEntityInterface getEntityHandler() {
        return new PFProcessTraitementAnnuelCalculEntityHandler(moisProchainPaiement);
    }
