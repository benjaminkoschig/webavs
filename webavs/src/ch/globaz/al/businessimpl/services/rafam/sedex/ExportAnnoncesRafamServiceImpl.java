...
import ch.ech.xmlns.ech_0104_68._3.ContentType;
import ch.ech.xmlns.ech_0104_68._3.HeaderType;
import ch.ech.xmlns.ech_0104_68._3.Message;
 ...
 * 
 */
public class ExportAnnoncesRafamServiceImpl extends ALAbstractBusinessServiceImpl implements ExportAnnoncesRafamService {
     ...
     */
    private HeaderType getHeader(boolean isDelegue) throws JadeSedexDirectoryInitializationException,
            DatatypeConfigurationException, ALAnnonceRafamException {
        ...
        if (JadeStringUtil.isBlank(recipientId)) {
            throw new ALAnnonceRafamException("ExportAnnoncesRafamServiceImpl#getHeader : recipientId is null or empty");
        }
        ...
        XMLGregorianCalendar nowDate = DatatypeFactory.newInstance().newXMLGregorianCalendarDate(
     ...
     */
    protected void restoreEtatAnnonces(ArrayList<AnnonceRafamModel> updatedAnnonces) throws JadeApplicationException,
    ...
    public void sendMessage() throws JadeApplicationException, JadePersistenceException,
        ...
        if (isExportEnabled()) {
            ...
            if (annonces.getSize() > 0) {
                ...
                message.setMinorVersion(new BigInteger(ALConstRafam.MINOR_VERSION_XSD));
                ...
                for (int i = 0; i < annonces.getSize(); i++) {
                    ...
                    try {
                        Object messageDroit = MessageBuilderFactory.getMessageBuilder(annonce).build();
                        ...
                        try {
                            JadeThread.rollbackSession();
                            annonce.setAnnonceRafamModel(s.setError(annonce.getAnnonceRafamModel(),
                                    "al.rafam.sedex.preparation.error"));
                            JadeThread.commitSession();
                        } catch (Exception e2) {
                            JadeLogger.error(
                                    this,
                        ...
                        errors.append(
                                "Erreur pendant la préparation d'une annonce (ID " + annonce.getId() + ") : "
                                        + e.getMessage()).append("\n");
                ...
                try {
                    if (content.getNewBenefitOrBenefitMutationOrBenefitCancellation().size() > 0) {
                        ...
                        Class<?>[] addClasses = new Class[] { Message.class, ReportType.class,
                                ch.ech.xmlns.ech_0104._3.DeliveryOfficeType.class,
                                ch.ech.xmlns.ech_0007._4.CantonAbbreviationType.class,
                                ch.ech.xmlns.ech_0044._1.PersonIdentificationType.class };
            ...
            if (annonces.getSize() > 0) {
                ...
                for (int i = 0; i < annonces.getSize(); i++) {
                    ...
                    try {
                        ...
                        try {
                            JadeThread.rollbackSession();
                            annonceComplex.setAnnonceRafamModel(s.setError(annonceSimple,
                                    "al.rafam.sedex.preparation.error"));
                            JadeThread.commitSession();
                        } catch (Exception e2) {
                        ...
                        errors.append(
                                "Erreur pendant la préparation d'une annonce (ID " + annonceSimple.getId() + ") : "
                                        + e.getMessage()).append("\n");
                        JadeLogger.error(
                                this,
                                "Erreur pendant la préparation d'une annonce (ID " + annonceSimple.getId() + ") : "
