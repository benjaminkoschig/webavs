 ...
 * 
 */
public class PaiementDirectProcessus extends BusinessProcessus {

    /**
     * constructeur du processus des paiements directs
     */
    public PaiementDirectProcessus() {
        super();
    }

    @Override
    public String getCSProcessus() {
        return ALCSProcessus.NAME_PROCESSUS_PAIEMENT_DIRECT;
    }
    ...
    public void initialize() throws JadeApplicationException, JadePersistenceException {
        ...
        PaiementDirectTraitement traitement5 = new PaiementDirectTraitement();
