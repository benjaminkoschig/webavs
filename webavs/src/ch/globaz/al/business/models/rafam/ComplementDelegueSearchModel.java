...
public class ComplementDelegueSearchModel extends JadeSearchSimpleModel {
    ...
    @Override
    public Class<ComplementDelegueModel> whichModelClass() {
        return ComplementDelegueModel.class;
    }
