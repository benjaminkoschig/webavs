 ...
 * 
 * @author jts
 * @deprecated classe à usage temporaire pour le traitement d'état du registre.
 */
@Deprecated
public class AnnonceRafamEtatRegistreModel extends JadeSimpleModel {
    ...
    /**
     * Numéro de l'autre organe concerné en dans le cas d'annonces contradictoire
     */
    ...
    /**
     * fin de période de chevauchement
     */
    private String overlapPeriodeEnd = null;

    /**
     * début de la période de chevauchement
     */
