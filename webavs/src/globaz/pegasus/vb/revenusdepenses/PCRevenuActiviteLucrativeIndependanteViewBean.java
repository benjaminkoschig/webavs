...
public class PCRevenuActiviteLucrativeIndependanteViewBean extends PCAbstractRequerantDonneeFinanciereViewBean {
    ...
    public String getTypeEcheance() {
        return EcheanceType.REVENU_ACTIVITE_LUCRATIVE_INDEPENDANTE.toString();
    }
    ...
    public void retrieve() throws Exception {
        ...
        search.setWhereKey("forVersionedRevenuActiviteLucrativeIndependante");
        ...
        for (Iterator it = Arrays.asList(search.getSearchResults()).iterator(); it.hasNext();) {
            ...
            if (donnee.getDonneeFinanciere() instanceof RevenuActiviteLucrativeIndependante) {
