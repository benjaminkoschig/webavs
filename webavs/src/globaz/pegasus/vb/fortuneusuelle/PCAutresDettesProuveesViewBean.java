 ...
 * 
 */
public class PCAutresDettesProuveesViewBean extends PCAbstractRequerantDonneeFinanciereViewBean {
    ...
    public void retrieve() throws Exception {
        ...
        search.setWhereKey("forVersionedAutresDettesProuvees");
        ...
        for (Iterator it = Arrays.asList(search.getSearchResults()).iterator(); it.hasNext();) {
            ...
            if (donnee.getDonneeFinanciere() instanceof SimpleAutresDettesProuvees) {
