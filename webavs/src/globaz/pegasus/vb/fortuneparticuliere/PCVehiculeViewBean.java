 ...
 * 
 */
public class PCVehiculeViewBean extends PCAbstractRequerantDonneeFinanciereViewBean {
    ...
    public void retrieve() throws Exception {
        ...
        search.setWhereKey("forVersionedVehicule");
        ...
        for (Iterator it = Arrays.asList(search.getSearchResults()).iterator(); it.hasNext();) {
            ...
            if (donnee.getDonneeFinanciere() instanceof SimpleVehicule) {
