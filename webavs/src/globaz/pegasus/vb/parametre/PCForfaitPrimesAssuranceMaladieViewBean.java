 ...
 * @date 12 nov. 2010
 */
public class PCForfaitPrimesAssuranceMaladieViewBean extends BJadePersistentObjectViewBean {
    ForfaitsPrimesAssuranceMaladie forfaitPrimesAssuranceMaladie = null;

    public PCForfaitPrimesAssuranceMaladieViewBean() {
        super();
        forfaitPrimesAssuranceMaladie = new ForfaitsPrimesAssuranceMaladie();
    }

    public PCForfaitPrimesAssuranceMaladieViewBean(ForfaitsPrimesAssuranceMaladie forfaitPrimesAssuranceMaladie) {
        super();
