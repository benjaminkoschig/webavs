 ...
 * @author: jpa
 */
public class CPProcessReinscriptionCI extends BProcess {
    public static void main(String[] args) {
        CPProcessReinscriptionCI process = null;
        String user = "";
        String pwd = "";
        ...
        try {
            ...
            process = new CPProcessReinscriptionCI();
     ...
     */
    public CPProcessReinscriptionCI() {
        super();
    }
     ...
     *            BProcess
     */
    public CPProcessReinscriptionCI(BProcess parent) {
        super(parent);
    }
     ...
     * @param session
     */
    public CPProcessReinscriptionCI(BSession session) {
        super(session);
    }
    ...
    protected boolean _executeProcess() {
        try {
            ...
            CPListeReinscriptionCI excelDoc = new CPListeReinscriptionCI(getSession());
