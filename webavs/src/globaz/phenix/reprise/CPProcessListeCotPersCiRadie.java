 ...
 * @author: jpa
 */
public class CPProcessListeCotPersCiRadie extends BProcess {
    public static void main(String[] args) {
        CPProcessListeCotPersCiRadie process = null;
        String user = "";
        String pwd = "";
        ...
        try {
            ...
            process = new CPProcessListeCotPersCiRadie();
     ...
     */
    public CPProcessListeCotPersCiRadie() {
        super();
    }
     ...
     *            BProcess
     */
    public CPProcessListeCotPersCiRadie(BProcess parent) {
        super(parent);
    }
     ...
     * @param session
     */
    public CPProcessListeCotPersCiRadie(BSession session) {
        super(session);
    }
    ...
    protected boolean _executeProcess() {
        try {
            ...
            manager.setIsRadie(Boolean.TRUE);
            ...
            CPListeCotPersCiRadie excelDoc = new CPListeCotPersCiRadie(getSession(), getFromAnneeDecision(),
                    getToAnneeDecision(), getFromAffilieDebut(), getFromAffilieFin());
