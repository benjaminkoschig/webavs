...
import globaz.musca.process.FAPassageAjouterPeriodiqueProcess;

public class FAAjouterAfactPeriodiqueImpl implements IntModuleFacturation {

    public FAAjouterAfactPeriodiqueImpl() {
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        FAPassageAjouterPeriodiqueProcess myProcess = new FAPassageAjouterPeriodiqueProcess();
