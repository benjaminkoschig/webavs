...
import globaz.musca.process.FAPassageAjouterDeclProcess;
 ...
 * @author: btc
 */
public class FAAjouterAfactDeclImpl implements IntModuleFacturation {
    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public FAAjouterAfactDeclImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        FAPassageAjouterDeclProcess myProcess = new FAPassageAjouterDeclProcess();
