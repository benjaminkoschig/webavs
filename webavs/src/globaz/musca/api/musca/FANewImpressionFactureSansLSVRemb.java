 ...
 * @author: btc
 */
public class FANewImpressionFactureSansLSVRemb extends FAImpressionGenerique {
     ...
     */
    public FANewImpressionFactureSansLSVRemb() {
        super();
    }
    ...
    public boolean beginPrinting(IFAPassage intPassage, IFAImpressionFactureProcess c) throws Exception {
        ...
        FANewImpressionFactureProcessSansLSVRemb context = (FANewImpressionFactureProcessSansLSVRemb) c;

        if (_document == null) {
            _document = new FANewImpressionFacture_BVR_Doc(context);
    ...
    public boolean comptabiliser(IFAPassage passage, BProcess context) throws Exception {
        try {
            FANewImpressionFactureProcessSansLSVRemb process = new FANewImpressionFactureProcessSansLSVRemb();
    ...
    public BIContainer get_documentManager(IFAImpressionFactureProcess c) {
        FANewImpressionFactureProcess context = (FANewImpressionFactureProcess) c;
     ...
     */
    public void set_document(globaz.musca.itext.FANewImpressionFacture_BVR_Doc new_document) {
