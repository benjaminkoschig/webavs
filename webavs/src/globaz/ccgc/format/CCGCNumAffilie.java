 ...
 */
public class CCGCNumAffilie implements IFormatData {

    private static String ERROR_MSG = "wrong format";
    public static int NUMBER_LENGTH = 4;
    public static char NUMBER_SEPARATOR_CHAR = '.';

    public static int NUMBER_SEPARATOR_POS = 6;
    ...
    public static void main(String[] args) {
        ...
        CCGCNumAffilie num = new CCGCNumAffilie();
