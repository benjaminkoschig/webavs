 ...
 * author fha
 */
public class RFDentistesDemandeDocumentsManquantsOO extends RFAbstractDocumentOO {
    ...
    public void chargerCatalogueTexte() throws Exception {
        ...
        documentHelper.setCsTypeDocument(IRFCatalogueTexte.CS_PRECISIONS_DENTISTE_BIS);
    ...
    public void generationLettre(RFCopieDecisionsValidationData... copie) throws Exception {
        ...
        data.addData("idProcess", "RFDentistesDemandeDocumentsManquantsOO");
    ...
    public JadePrintDocumentContainer remplir(JadePrintDocumentContainer documentContainer, RFDocumentsProcess process,
        ...
        return super
                .remplir(documentContainer, process, getIdTiers(),
                        IPRConstantesExternes.RFM_LETTRE_TYPE_DENTISTE_BIS_DEMANDE_DOCUMENTS_MANQUANTS_AU_DENTISTE,
                        isSendToGed);
    }
