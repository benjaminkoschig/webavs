 ...
 * author fha
 */
public class RFDecisionRefus2OO extends RFAbstractDocumentOO {

    public static final String FICHIER_MODELE_DOCUMENTS_RFM = "RF_LETTRE_TYPE_REGIME_DECISION_REFUS_2";

    protected final String DATE = "{date}";
    protected final String DATE_EVALUATION_OMSV = "{dateEvaluationOMSV}";
    protected String dateEvaluationOMSV = "";
    ...
    private void ajouterSignature() throws Exception {
        ...
        try {
            ...
            addErreurMail(memoryLog, e.getMessage(), "RFDecisionRefus2OO:ajouterSignature");
    ...
    public void chargerCatalogueTexte() throws Exception {
        ...
        documentHelper.setCsTypeDocument(IRFCatalogueTexte.CS_DECISION_REFUS2);
    ...
    public void chargerDonneesEnTete() throws Exception {
        ...
        try {
            ...
            caisseHelper = CaisseHelperFactory.getInstance().getCaisseReportHelperOO(getSession().getApplication(),
                    codeIsoLangue);
            caisseHelper.setTemplateName(RFDecisionRefus2OO.FICHIER_MODELE_DOCUMENTS_RFM);
    ...
    public void generationLettre(RFCopieDecisionsValidationData... copie) throws Exception {
        ...
        data.addData("idProcess", "RFDecisionRefus2OO");
    ...
    public String getDateEvaluationOMSV() {
        return dateEvaluationOMSV;
    }
    ...
    public JadePrintDocumentContainer remplir(JadePrintDocumentContainer documentContainer, RFDocumentsProcess process,
        ...
        setDateEvaluationOMSV(process.getRegimeDateEvaluationOMSV());
        setRegimeDateDemandeIndemnisationRefus2(process.getRegimeDateDemandeIndemnisationRefus2());

        return super.remplir(documentContainer, process, process.getIdTiers(),
                RFDocumentEnum.RFM_LETTRE_TYPE_REGIME_DECISION_REFUS_2.getNoInforom(), miseEnGed);
    }
    ...
    public void remplirDocument() throws Exception {
        ...
        try {
            // %=DECISION_REFUS2=%
            data.addData("DECISION_REFUS2", documentPrincipale.getTextes(1).getTexte(1).getDescription());
            // %=OBJET=%
            ...
            data.addData("DATE_DEMANDE", PRStringUtils.replaceString(documentPrincipale.getTextes(2).getTexte(2)
                    .getDescription(), DATE, regimeDateDemandeIndemnisationRefus2));
            // %=LOI=%
            data.addData("LOI", documentPrincipale.getTextes(2).getTexte(3).getDescription());
            // %=REFUS=%
            data.addData("REFUS", PRStringUtils.replaceString(documentPrincipale.getTextes(2).getTexte(4)
                    .getDescription(), DATE_EVALUATION_OMSV, dateEvaluationOMSV));
            // %=SALUTATIONS=%
    ...
    public void setDateEvaluationOMSV(String dateEvaluationOMSV) {
        this.dateEvaluationOMSV = dateEvaluationOMSV;
    }
