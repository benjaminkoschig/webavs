 ...
 * author fha
 */
public class RFSaisieSoinFournisseur extends RFConvention {
    ...
    public static final String createFromClause(String schema) {
        ...
        fromClauseBuffer.append(leftJoin);
        fromClauseBuffer.append(schema);
        fromClauseBuffer.append(RFSaisieSoinFournisseur.TABLE_TIERS);
        fromClauseBuffer.append(as);
        fromClauseBuffer.append("FOURNISSEUR");
        fromClauseBuffer.append(on);
        fromClauseBuffer.append("FOURNISSEUR");
        fromClauseBuffer.append(point);
        fromClauseBuffer.append(RFSaisieSoinFournisseur.FIELDNAME_ID_TIERS_TI);
        fromClauseBuffer.append(egal);
        fromClauseBuffer.append(schema);
        fromClauseBuffer.append(RFAssConventionFournisseurSousTypeDeSoin.TABLE_NAME);
        fromClauseBuffer.append(point);
        ...
        fromClauseBuffer.append(leftJoin);
        fromClauseBuffer.append(schema);
        fromClauseBuffer.append(RFSaisieSoinFournisseur.TABLE_AVS);
        fromClauseBuffer.append(on);
        fromClauseBuffer.append(schema);
        fromClauseBuffer.append(RFConventionAssure.TABLE_NAME);
        fromClauseBuffer.append(point);
        ...
        fromClauseBuffer.append(leftJoin);
        fromClauseBuffer.append(schema);
        fromClauseBuffer.append(RFSaisieSoinFournisseur.TABLE_PERSONNE);
        fromClauseBuffer.append(on);
        fromClauseBuffer.append(schema);
        fromClauseBuffer.append(RFSaisieSoinFournisseur.TABLE_AVS);
        fromClauseBuffer.append(point);
    ...
    protected String _getFrom(BStatement statement) {
        ...
        if (fromClause == null) {
            StringBuffer from = new StringBuffer(RFSaisieSoinFournisseur.createFromClause(_getCollection()));
    ...
    protected void _readProperties(BStatement statement) throws Exception {
        ...
        nss = NSUtil.formatAVSUnknown(statement.dbReadString(RFSaisieSoinFournisseur.FIELDNAME_NUM_AVS));
        dateNaissance = statement.dbReadDateAMJ(RFSaisieSoinFournisseur.FIELDNAME_DATENAISSANCE);
        dateDeces = statement.dbReadDateAMJ(RFSaisieSoinFournisseur.FIELDNAME_DATEDECES);
        csSexe = statement.dbReadNumeric(RFSaisieSoinFournisseur.FIELDNAME_SEXE);
        nom = statement.dbReadString(RFSaisieSoinFournisseur.FIELDNAME_NOM);
        prenom = statement.dbReadString(RFSaisieSoinFournisseur.FIELDNAME_PRENOM);
