 ...
 * @author jje
 */
public class RFQdHistoriqueAugmentationJointSelf extends RFQdAugmentation {
    ...
    public static final String FIELDNAME_ANCIEN_CONCERNE = "EVLCON_A";
    public static final String FIELDNAME_ANCIEN_DATE = "EVDMOD_A";
    public static final String FIELDNAME_ANCIEN_GESTIONNAIRE = "EVIGES_A";
    public static final String FIELDNAME_ANCIEN_MONTANT = "EVMAUQ_A";
    ...
    public static final String createFromClause(String schema) {
        ...
        fromClauseBuffer.append(RFQdAugmentation.TABLE_NAME + " n");

        // jointure entre la table des Qd et la table des QdPrinicpale

        fromClauseBuffer.leftJoin(RFQdAugmentation.TABLE_NAME + " a").appendOn()
                .append("n." + FIELDNAME_ID_AUGMENTATION_QD_MODIFE_PAR);
        fromClauseBuffer.appendEgal().append("a." + FIELDNAME_ID_AUGMENTATION_QD);
    ...
    protected String _getFields(BStatement statement) {
        return "n.*,a." + FIELDNAME_DATE_MODIFICATION + " " + FIELDNAME_ANCIEN_DATE + ",a." + FIELDNAME_CONCERNE + " "
                + FIELDNAME_ANCIEN_CONCERNE + ",a." + FIELDNAME_MONTANT_AUGMENTATION_QD + " "
                + FIELDNAME_ANCIEN_MONTANT + ",a." + FIELDNAME_VISA_GEST + " " + FIELDNAME_ANCIEN_GESTIONNAIRE;
    }
