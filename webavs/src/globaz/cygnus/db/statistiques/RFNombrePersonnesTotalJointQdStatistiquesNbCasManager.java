 ...
 * 
 */
public class RFNombrePersonnesTotalJointQdStatistiquesNbCasManager extends BManager {
    ...
    public RFNombrePersonnesTotalJointQdStatistiquesNbCasManager() {
        super();
    }
    ...
    protected String _getFields(BStatement statement) {
        ...
        fields.append("DISTINCT " + RFAssQdDossier.FIELDNAME_ID_DOSSIER + " "
                + RFNombrePersonnesTotalJointQdStatistiquesNbCasManager.ALIAS_NOMBRE_PERSONNE);
    ...
    protected BEntity _newEntity() throws Exception {
        return new RFNombrePersonnesTotalJointQdStatistiquesNbCas();
    }
