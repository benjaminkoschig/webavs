 ...
 * Description :
 */
package globaz.hera.interfaces.ci;
 ...
 * @author scr
 */
public class SFCompteIndividuelHelper {
     ...
     *             DOCUMENT ME!
     */
    public static final SFCiWrapper[] getCiLikeNoAVS(BISession session, String likeNoAVS) throws Exception {
        // fail fast
        ...
        if ((obj == null) || (obj.length == 0)) {
            ...
            SFCiWrapper[] result = new SFCiWrapper[obj.length];

            for (int i = 0; i < obj.length; i++) {
                result[i] = new SFCiWrapper((GlobazValueObject) obj[i], SFCiWrapper.CI);
            }
