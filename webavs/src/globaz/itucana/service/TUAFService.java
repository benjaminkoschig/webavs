...
/**
 * Classe de service AF permettant de récupérer les models AF
 * 
 * @author fgo date de création : 7 juin 2006
 * @version : version 1.0
 * 
 */
public class TUAFService extends TUCommonService {

    /**
     * @param afAdapter
     */
    protected TUAFService(ICommonAdapter adapter) {
        super(adapter);
    }
