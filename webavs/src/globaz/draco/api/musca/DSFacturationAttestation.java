...
import globaz.draco.process.DSProcessFacturationTaxeSommation2;
 ...
 */
public class DSFacturationAttestation extends DSFacturationGenericImpl implements IntModuleFacturation {

    /**
	 * 
	 */
    public DSFacturationAttestation() {
        super();
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        DSProcessFacturationTaxeSommation2 procFacturation = new DSProcessFacturationTaxeSommation2();
