...
import globaz.draco.process.DSProcessFacturationTaxeSommation2DSLTN;
 ...
 * 
 */
public class DSFacturationTaxeSommationDSLTN extends DSFacturationGenericImpl implements IntModuleFacturation {
    /**
	 * 
	 */
    public DSFacturationTaxeSommationDSLTN() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        DSProcessFacturationTaxeSommation2DSLTN procFacturation = new DSProcessFacturationTaxeSommation2DSLTN();
