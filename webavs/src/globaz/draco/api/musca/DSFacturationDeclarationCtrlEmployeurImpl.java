...
public class DSFacturationDeclarationCtrlEmployeurImpl extends DSFacturationDeclarationImpl implements
        IntModuleFacturation {
    public DSFacturationDeclarationCtrlEmployeurImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        procFacturation.setModeFacturation(DSProcessFacturationDeclarationSalaire.MODE_UNIQUE_CTRL_EMPL);
