...
public class DSContAmende_doc extends DSAbstractPrincipaleGenererEtape {
    /**
     * 
     */
     ...
     * @throws Exception
     */
    public DSContAmende_doc() throws Exception {
        super();
     ...
     * @throws Exception
     */
    public DSContAmende_doc(BSession session) throws Exception {
     ...
     * @throws Exception
     */
    public DSContAmende_doc(BSession session, String nomDocument) throws Exception {
    ...
    protected ICTDocument[] getICTDocument() {
        ...
        getDocumentInfo().setDocumentTypeNumber("0266CDS");
        document.setCsTypeDocument(Doc2_preImpressionDeclaration.CS_AMENDE);
