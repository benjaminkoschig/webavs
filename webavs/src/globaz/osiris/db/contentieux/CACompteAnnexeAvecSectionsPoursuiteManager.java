...
public class CACompteAnnexeAvecSectionsPoursuiteManager extends BManager {
    /**
     * 
     */
    ...
    protected String _getFrom(globaz.globall.db.BStatement statement) {
        return _getCollection() + "CAEVCTP INNER JOIN " + _getCollection() + "CAPECTP ON " + _getCollection()
                ...
                + _getCollection() + "CASECTP.IDSECTION" + " INNER JOIN " + _getCollection()
    ...
    protected String _getWhere(globaz.globall.db.BStatement statement) {
        ...
        if (getForIdCompteAnnexe().length() != 0) {
            ...
            sqlWhere += _getCollection() + "CACPTAP.IDCOMPTEANNEXE = "
