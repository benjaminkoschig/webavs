 ...
 */
public class CAIListSoldeSectionRecapTypeBean {
    ...
    private String m_typeSection = new String();

    public CAIListSoldeSectionRecapTypeBean() {
    }

    public CAIListSoldeSectionRecapTypeBean(CASection entity) {
        add(entity);
    }
    ...
    /**
     * Method _getTypeSection.
     * 
     * @param CASection
     *            section
     * @return String
     */
    private String _getTypeSection(CASection section) {
        return section.getTypeSection().getDescription();
    }
    ...
    public void add(CASection entity) {
        try {
            setTypeSection(_getTypeSection(entity));
            setNombreCas(1);
    ...
    /**
     * Returns the m_typeSection.
     * 
     * @return String
     */
    protected String getTypeSection() {
    ...
    /**
     * Sets the m_typeSection.
     * 
     * @param m_typeSection
     *            The m_typeSection to set
     */
    protected void setTypeSection(String typeSection) {
