...
import globaz.osiris.db.comptes.CASoldeCompteAnnexeAtDateManager;
...
/**
 */
public class CAIListSoldeCompteAnnexeAtDate_DS extends CASoldeCompteAnnexeAtDateManager implements
        JRCloneableDataSource, JRRewindableDataSource {
    ...
    private CASoldeCompteAnnexeAtDate entity = null;
    ...
    public boolean next() throws JRException {
        ...
        try {
            ...
            if (container.hasNext()) {
                entity = (CASoldeCompteAnnexeAtDate) container.next();
            }
        } catch (Exception e) {
        }
        if (getContext() != null) {
