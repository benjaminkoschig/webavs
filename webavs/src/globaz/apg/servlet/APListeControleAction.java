 ...
 * @author bsc
 */
public class APListeControleAction extends APDefaultProcessAction {
     ...
     *            DOCUMENT ME!
     */
    public APListeControleAction(FWServlet servlet) {
        super(servlet);
    }
    ...
    protected void actionAfficher(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            ...
            APListeControleViewBean gcViewBean = (APListeControleViewBean) viewBean;
