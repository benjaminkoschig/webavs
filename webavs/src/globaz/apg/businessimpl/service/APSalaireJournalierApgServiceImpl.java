...
public class APSalaireJournalierApgServiceImpl implements APSalaireJournalierApgService {
    ...
    public BigDecimal getSalaireJournalier(SituationProfessionnelle situationProfessionnelle) {
        ...
        if (montantJournalierMoyen.compareTo(IAPConstantes.MONTANT_JOURNALIER_MAX) > 0) {
