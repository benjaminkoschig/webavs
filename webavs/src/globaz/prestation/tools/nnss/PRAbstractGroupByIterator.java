 ...
 */
public abstract class PRAbstractGroupByIterator implements Iterator {
     ...
     */
    public PRAbstractGroupByIterator(Iterator iterator) throws NullPointerException {
        reset(iterator);
    }
     ...
     */
    protected abstract boolean areEntitiesEqual(Object e1, Object e2);
    ...
    public boolean hasNext() {
        if (!hasNext && iterator.hasNext()) {
            boolean areEntitiesEqual;
            do {
                precendant = courant;
                courant = iterator.next();
                areEntitiesEqual = areEntitiesEqual(courant, precendant);
                if (!areEntitiesEqual) {
                    hasNext = true;
                }
            } while (areEntitiesEqual && iterator.hasNext());
        }
