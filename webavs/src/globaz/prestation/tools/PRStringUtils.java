...
public class PRStringUtils {
     ...
     * @return
     */
    public static final String formatMessage(StringBuffer message, Object[] args) {
     ...
     * @return
     */
    public static final String formatMessage(StringBuffer message, String args) {
    ...
    public static final Boolean getBooleanFromACOR_0_1(String booleanValue) {

        return "1".equals(booleanValue) ? Boolean.TRUE : Boolean.FALSE;
    }
     ...
     * @return
     */
    public static final String upperCaseWithoutSpecialChars(String in) {
        String out = "";
