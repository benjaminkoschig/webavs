 ...
 */
public class CICICAMNumAffilie implements IFormatData {
    ...
    public static void main(String[] args) {
        ...
        CICICAMNumAffilie num = new CICICAMNumAffilie();
    ...
    public String check(Object value) throws Exception {
        if (value == null) {
            throw new Exception(CICICAMNumAffilie.ERROR_MSG);
        }
        String valueStr = unformat((String) value);
        // bonne longueur ?
        if (valueStr.length() < CICICAMNumAffilie.NUMBER_LENGTH) {
            throw new Exception(CICICAMNumAffilie.ERROR_MSG + " : " + (String) value);
        }
    ...
    public String format(String value) {
        ...
        if (value.length() > CICICAMNumAffilie.NUMBER_SEPARATOR_POS) {
            result.append(value.substring(0, CICICAMNumAffilie.NUMBER_SEPARATOR_POS));
            result.append(CICICAMNumAffilie.NUMBER_SEPARATOR_CHAR);
            result.append(value.substring(CICICAMNumAffilie.NUMBER_SEPARATOR_POS));
        } else {
            return value;
        }
    ...
    public String unformat(String value) {
        ...
        for (int i = 0; i < value.length(); i++) {
            ...
            if (c != CICICAMNumAffilie.NUMBER_SEPARATOR_CHAR) {
                str.append(c);
            }
        }
