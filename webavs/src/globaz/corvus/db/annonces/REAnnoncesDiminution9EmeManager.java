...
public class REAnnoncesDiminution9EmeManager extends PRAbstractManager implements
        BIGenericManager<REAnnoncesDiminution9Eme> {
    ...
    protected BEntity _newEntity() throws Exception {
        return new REAnnoncesDiminution9Eme();
    }
    ...
    @Override
    public List<REAnnoncesDiminution9Eme> getContainerAsList() {
        List<REAnnoncesDiminution9Eme> list = new ArrayList<REAnnoncesDiminution9Eme>();

        for (int i = 0; i < size(); i++) {
            list.add((REAnnoncesDiminution9Eme) get(i));
        }
