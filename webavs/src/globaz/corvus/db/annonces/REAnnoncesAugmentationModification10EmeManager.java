...
public class REAnnoncesAugmentationModification10EmeManager extends PRAbstractManager implements
        BIGenericManager<REAnnoncesAugmentationModification10Eme> {
    ...
    @Override
    public List<REAnnoncesAugmentationModification10Eme> getContainerAsList() {
        List<REAnnoncesAugmentationModification10Eme> list = new ArrayList<REAnnoncesAugmentationModification10Eme>();

        for (int i = 0; i < size(); i++) {
            list.add((REAnnoncesAugmentationModification10Eme) get(i));
        }
