 ...
 * 
 */
public class REReaderAnnonces51_53 extends REAbstractDownloader {

    // ~ Static fields/initializers
    // -------------------------------------------------------------------------------------

    Map<KeyRAAnnComparaison, ArrayList<Object>> annoncesCrees = new HashMap<KeyRAAnnComparaison, ArrayList<Object>>();
    ...
    public Map<KeyRAAnnComparaison, ArrayList<Object>> getAnnoncesCrees() {
    ...
    private int lireAnnonce51(BITransaction transaction, IHEOutputAnnonce[] annonces, int i) throws Exception {
        ...
        // 8 | Durée de cotisations prise en compte pour le choix de l'échelle de rentes avant 1973 : AAMM
        ann51_02.setDureeCoEchelleRenteAv73(JadeStringUtil.substring(getChampEnregistrement(annonce), 22, 4));

        // 9 | Durée de cotisations prise en compte pour le choix de l'échelle de rentes après 1973 : AAMM
        ann51_02.setDureeCoEchelleRenteDes73(JadeStringUtil.substring(getChampEnregistrement(annonce), 26, 4));

        // 10 | Prise en compte des durées de cotisations manquantes en mois pour les années 1948-72
        ...
        // 34 | Prise en compte des durées de cotisations manquantes en mois pour les années 73-78
        ...
        // 36 | Bonifications pour tâches éducatives moyennes prises en compte en frans
        ...
        ann51.setSession((BSession) getSession());
        ann51.retrieve();
    ...
    private int lireAnnonce53(BITransaction transaction, IHEOutputAnnonce[] annonces, int i) throws Exception {
        ...
        // 4 | Durée de cotisations prise en compte pour le choix de l'échelle de rentes avant 1973 : AAMM
        ann53_02.setDureeCoEchelleRenteAv73(JadeStringUtil.substring(getChampEnregistrement(annonce), 6, 4));

        // 5 | Durée de cotisations prise en compte pour le choix de l'échelle de rentes après 1973 : AAMM
        ann53_02.setDureeCoEchelleRenteDes73(JadeStringUtil.substring(getChampEnregistrement(annonce), 10, 4));

        // 6 | Prise en compte des durées de cotisations manquantes en mois pour les années 1948-72
        ann53_02.setDureeCotManquante48_72(JadeStringUtil.substring(getChampEnregistrement(annonce), 14, 2));

        // 7 | Prise en compte des durées de cotisations manquantes en mois pour les années 73-78
        ...
        // mise à jour de l'idLien de l'annonce 01
        ann53.setSession((BSession) getSession());
        ann53.retrieve();
        ...
        // mise à jour de l'idLien de l'annonce 01
        ann53_02.setSession((BSession) getSession());
        ann53_02.retrieve();
     ...
     */
    public void read(BTransaction transaction) throws REDownloaderException {
        ...
        try {
            ...
            // Pour des raisons de sécurité (crash mémoire), vaut mieux peut-être ne pas tout charger en même temps
    ...
    public void setAnnoncesCrees(Map<KeyRAAnnComparaison, ArrayList<Object>> annoncesCrees) {
