 ...
 */
public class CTDocumentJointDefaultAnnexesViewBean extends CTDocumentJointDefaultAnnexes implements FWViewBeanInterface {
    ...
    private String csGroupeAnnexes = "";
     ...
     * @return
     */
    public String getCsGroupeAnnexes() {
        return csGroupeAnnexes;
    }
     ...
     * @param string
     */
    public void setCsGroupeAnnexes(String string) {
        csGroupeAnnexes = string;
    }
