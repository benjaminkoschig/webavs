...
public class LXPaiementManager extends LXFactureManager {
    ...
    protected String _getWhere(BStatement statement) {
        ...
        sqlWhere.append(" (");
        sqlWhere.append(_getCollection() + LXOperation.TABLE_LXOPERP + "." + LXOperation.FIELD_CSTYPEOPERATION + " = "
                + _dbWriteNumeric(statement.getTransaction(), LXOperation.CS_TYPE_PAIEMENT_BVR_ORANGE));
        sqlWhere.append(" OR ").append(_getCollection()).append(LXOperation.TABLE_LXOPERP).append(".")
                ...
                .append(_dbWriteNumeric(statement.getTransaction(), LXOperation.CS_TYPE_PAIEMENT_BVR_ROUGE));
        sqlWhere.append(" OR ").append(_getCollection()).append(LXOperation.TABLE_LXOPERP).append(".")
                .append(LXOperation.FIELD_CSTYPEOPERATION).append(" = ")
                .append(_dbWriteNumeric(statement.getTransaction(), LXOperation.CS_TYPE_PAIEMENT_CAISSE));
        sqlWhere.append(" OR ").append(_getCollection()).append(LXOperation.TABLE_LXOPERP).append(".")
                .append(LXOperation.FIELD_CSTYPEOPERATION).append(" = ")
                .append(_dbWriteNumeric(statement.getTransaction(), LXOperation.CS_TYPE_PAIEMENT_LSV));
        sqlWhere.append(" OR ").append(_getCollection()).append(LXOperation.TABLE_LXOPERP).append(".")
                .append(LXOperation.FIELD_CSTYPEOPERATION).append(" = ")
                .append(_dbWriteNumeric(statement.getTransaction(), LXOperation.CS_TYPE_PAIEMENT_VIREMENT));
        sqlWhere.append(")");
