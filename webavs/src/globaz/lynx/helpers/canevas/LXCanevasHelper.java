...
public class LXCanevasHelper extends FWHelper {

    /**
     * Constructeur LXCanevasHelper.
     */
    public LXCanevasHelper() {
        super();
    }
    ...
    protected void _add(FWViewBeanInterface viewBean, FWAction action, BISession session) throws Exception {
        LXCanevasAdd.addCanevas(session, viewBean);
    }
    ...
    protected void _delete(FWViewBeanInterface viewBean, FWAction action, BISession session) throws Exception {
        LXCanevasDelete.deleteCanevas(session, viewBean);
    }
    ...
    protected void _retrieve(FWViewBeanInterface viewBean, FWAction action, BISession session) throws Exception {
        LXCanevasRetrieve.retrieveCanevas(session, viewBean);
    }
    ...
    protected void _update(FWViewBeanInterface viewBean, FWAction action, BISession session) throws Exception {
        LXCanevasUpdate.updateCanevas(session, viewBean);
    }
    ...
    protected FWViewBeanInterface execute(FWViewBeanInterface viewBean, FWAction action, BISession session) {
        return super.execute(LXCanevasUse.useCanevas(session, viewBean), action, session);
    }
}
