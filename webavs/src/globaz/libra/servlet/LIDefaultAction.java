 ...
 * 
 */
public class LIDefaultAction extends FWDefaultServletAction {

    // ~ Static fields/initializers
    // -------------------------------------------------------------------------------------

    protected static final String DESACTIVE_VALIDATION = FWServlet.VALID + "=fail&_back=sl";
    protected static final String METHOD_ADD = FWServlet.METHOD + "=" + LIDefaultAction.METHOD_ADD_VALUE;
    ...
    /**
     * Crée une nouvelle instance de la classe LIDefaultAction.
     * 
     * @param servlet
     */
    public LIDefaultAction(FWServlet servlet) {
        super(servlet);
    }
    ...
    protected void actionCustom(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        try {
            Method methode = this.getClass().getMethod(getAction().getActionPart(), LIDefaultAction.PARAMS);
    ...
    protected void delegateActionCustom(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        // selectionner l'action en fonction du parametre transmis
        try {
            Method m = this.getClass().getMethod(getAction().getActionPart(), LIDefaultAction.PARAMS);
    ...
    protected String getSelectedId(HttpServletRequest request) {
        return request.getParameter(LIDefaultAction.SELECTED_ID);
    }
    ...
    protected String getSelectedIdParam(HttpServletRequest request) {
        return LIDefaultAction.SELECTED_ID + "=" + getSelectedId(request);
    }
