 ...
 */
public class COParametreTaxeManager extends COBManager implements java.io.Serializable {
    ...
    protected String _getFrom(globaz.globall.db.BStatement statement) {
        return _getCollection() + COParametreTaxe.TABLE_NAME;
    }
    ...
    protected String _getWhere(globaz.globall.db.BStatement statement) {
        ...
        if (getForIdCalculTaxe().length() != 0) {
            ...
            sqlWhere += COParametreTaxe.FNAME_ID_CALCUL_TAXE + "="
        ...
        if (getForIdRubrique().length() != 0) {
            ...
            sqlWhere += COParametreTaxe.FNAME_ID_RUBRIQUE + "="
