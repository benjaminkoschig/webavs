 ...
 */
public class CO044SaisirPVSaisieBienMobiliers extends COTransitionAction {
    ...
    protected void _validate(COContentieux contentieux, BTransaction transaction) throws COTransitionException {
        if (JadeStringUtil.isEmpty(getDateExecution())) {
            throw new COTransitionException("AQUILA_ERR_CO044_DATE_EXECUTION_SAISIE_BIEN_VIDE",
                    COActionUtils.getMessage(contentieux.getSession(),
                            "AQUILA_ERR_CO044_DATE_EXECUTION_SAISIE_BIEN_VIDE"));
        }
