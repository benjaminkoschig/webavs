 ...
 * @author: btc
 */
public class AFFacturationAffiliationPersoImpl extends AFFacturationGenericImpl implements IntModuleFacturation {
    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public AFFacturationAffiliationPersoImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        if (appAf.wantOldProcessFacturation()) {
            ...
            procFacturation.setTypeFacturationPersonnelle(AFProcessFacturation.PERIODIQUE_COT_PERS);
