 ...
 * @author: btc
 */
public class AFFacturationAffiliationParImpl extends AFFacturationGenericImpl implements IntModuleFacturation {
    /**
     * Commentaire relatif au constructeur FAListGenericImpl.
     */
    public AFFacturationAffiliationParImpl() {
        super();
    }
    ...
    public boolean generer(IFAPassage passage, BProcess context, String idModuleFacturation) throws Exception {
        ...
        if (appAf.wantOldProcessFacturation()) {
            ...
            procFacturation.setFacturerParitaire(true);
