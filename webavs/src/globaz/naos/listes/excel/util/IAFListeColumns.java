...
public interface IAFListeColumns {
    ...
    public static final String[] listeNoms = { IAFListeColumns.CASE_POSTALE, IAFListeColumns.COMMENTAIRE,
            ...
            IAFListeColumns.DATE_RADIATION, IAFListeColumns.DESCRIPTION, IAFListeColumns.ERREUR, IAFListeColumns.ETAT,
            IAFListeColumns.GENRE, IAFListeColumns.ID_TAXE, IAFListeColumns.LOCALITE, IAFListeColumns.MASSE,
            IAFListeColumns.MOTIF_FIN, IAFListeColumns.NOM, IAFListeColumns.NPA, IAFListeColumns.NUM_AFFILIE,
            IAFListeColumns.NUM_CAISSE_AF, IAFListeColumns.NUM_CAISSE_AVS, IAFListeColumns.PRENOM, IAFListeColumns.RUE,
