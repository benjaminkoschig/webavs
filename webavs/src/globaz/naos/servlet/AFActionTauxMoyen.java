...
import globaz.naos.db.tauxAssurance.AFTauxMoyenViewBean;
...
/**
 * Classe permettant la gestion des actions pour l'entité ParticulariteAffiliation.
 * 
 * @author sau
 */
public class AFActionTauxMoyen extends AFDefaultActionChercher {
     ...
     * @param servlet
     */
    public AFActionTauxMoyen(FWServlet servlet) {
        super(servlet);
    }
    ...
    protected void actionChercher(HttpSession session, HttpServletRequest request, HttpServletResponse response,
        ...
        AFTauxMoyenViewBean vBean = new AFTauxMoyenViewBean();
    ...
    protected FWViewBeanInterface beforeNouveau(HttpSession session, HttpServletRequest request,
        ...
        AFTauxMoyenViewBean vBean = (AFTauxMoyenViewBean) viewBean;
        vBean.setAffiliationId(request.getParameter("affiliationId"));
