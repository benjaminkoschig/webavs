 ...
 * @author vch
 */
public class EvalPlanCapage2Pages extends FWEvaluable {
    /**
     * 
     */
    ...
    public EvalPlanCapage2Pages(FWUrlsStack aStack) {
        m_stack = aStack;
    }
    ...
    protected boolean eval() {
        ...
        String[] userActions = { "naos.plan.plan.afficher", "naos.plan.plan..chercher" };
