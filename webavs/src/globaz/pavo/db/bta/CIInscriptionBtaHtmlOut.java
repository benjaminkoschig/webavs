...
public class CIInscriptionBtaHtmlOut {
    ...
    private void write(FileOutputStream out) {
        ...
        CIInscriptionBtaLog log;
        PrintStream ps = new PrintStream(out);
        try {

            ps.println("<html>");
            ps.println("<head>");
            ps.println("<title>" + getSession().getLabel("TITLE_PROCESS_INSCRIPTION_BTA_LOG") + "(" + getAnnee() + ")"
                    + "</title>");
            ps.println("<style>");
            ...
            ps.println("<span class=\"titre\"> " + getSession().getLabel("TITLE_INSCRIPTION_BTA_LOG") + "("
                    + getAnnee() + ")" + " </span>");
            ...
            for (Iterator it = liste.iterator(); it.hasNext();) {
                ...
                log = (CIInscriptionBtaLog) it.next();
