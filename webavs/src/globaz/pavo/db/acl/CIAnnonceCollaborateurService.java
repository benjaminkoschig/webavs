...
public abstract class CIAnnonceCollaborateurService {
    ...
    private final static String ARC_MOTIF_43 = "43";
    private final static String ARC_MOTIF_61 = "61";
    private final static String ARC_MOTIF_65 = "65";
                ...
                if (duplicata.booleanValue()) {
                    ...
                    if (compteIndividuel != null) {
                        ...
                        CIAnnonceCollaborateurService.genererArc(transaction.getSession(), nss, numeroAffilie,
                                dateEngagement, CIAnnonceCollaborateurService.ARC_MOTIF_33, refInterne
                        ...
                        if ((nssInfo != null)
                            ...
                            // arc motif = 43
                            typeArc = CIAnnonceCollaborateurService.ARC_MOTIF_43;
                            CIAnnonceCollaborateurService.genererArc(transaction.getSession(), nss, numeroAffilie,
                                    dateEngagement, CIAnnonceCollaborateurService.ARC_MOTIF_43, refInterne, noEmploye,
                                    noSuccursale);
                        }
                    }
                } else {
                    ...
                    if (compteIndividuel != null) {
                        ...
                        if (compteIndividuel.isCiOuvert()) {
                            ...
                            if (CIUtil.isRetraite(new JADate(compteIndividuel.getDateNaissance()),
                                ...
                                // arc motif = 65
                                typeArc = CIAnnonceCollaborateurService.ARC_MOTIF_65;
                                CIAnnonceCollaborateurService.genererArc(transaction.getSession(), nss, numeroAffilie,
                                        dateEngagement, CIAnnonceCollaborateurService.ARC_MOTIF_65, refInterne,
                                        noEmploye, noSuccursale);
                            }
                        }
                    } else {
