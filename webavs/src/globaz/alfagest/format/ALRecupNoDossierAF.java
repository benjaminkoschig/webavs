package globaz.alfagest.format;
 ...
 */
public class ALRecupNoDossierAF {

    /**
     * Méthode qui renvoie l'ID d'un tiers AVS correspondant au bénéficiaire AF sur la base d'un id de dossier
     * 
     * @param idDossier
