...
/**
 * Adapteur pour les CG
 * 
 * @author fgo date de création : 7 août 2006
 * @version : version 1.0
 * 
 */
public class TUCGAdapter extends TUCommonAdapter implements ICommonAdapter {
    ...
    protected String handleEntete(BTransaction transaction, ITUEntete entete) throws TUProcessTucanaInterfaceException {
        return super.addBouclement(transaction, TUTypesBouclement.BOUCLEMENT_CG, entete);
    ...
    protected void handleLines(BTransaction transaction, Iterator lignes, String idBouclement, String noPassage)
        ...
        try {
            super.addLignes(transaction, TUTypesBouclement.BOUCLEMENT_CG, lignes, idBouclement, noPassage);
