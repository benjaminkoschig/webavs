 ...
 * 
 * @author fgo date de création : 2.10.2007
 * @version : version 1.0
 */
public class TUJournalRecapF3Process extends BProcess {
    /**
     * 
     */
        ...
        try {
            return Jade
                    ...
                    .concat(GlobazSystem.getApplication(TUApplication.DEFAULT_APPLICATION_TUCANA).getProperty(
                            IPropertiesNames.STATISTIQUES_XSL_F3));
    ...
    private String transformFile() throws TUInitStatistiquesConfigException {
        FileWriter writer;
        TUJournalRecapF3ViewBean bean = new TUJournalRecapF3ViewBean();
