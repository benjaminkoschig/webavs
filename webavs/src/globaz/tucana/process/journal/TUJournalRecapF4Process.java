...
/**
 * Process pour l'edition des journaux de consolidation F3
 * 
 * @author fgo date de création : 08.10.2007
 * @version : version 1.0
 */
public class TUJournalRecapF4Process extends BProcess {
    /**
     * 
     */
    ...
    /**
     * Récupération de l'id code système rubrique
     * 
     * @return
     */
        ...
        try {
            return Jade
                    ...
                    .concat(GlobazSystem.getApplication(TUApplication.DEFAULT_APPLICATION_TUCANA).getProperty(
                            IPropertiesNames.STATISTIQUES_XSL_F4));
    ...
    public boolean process(BTransaction transaction) {
        ...
        try {
            ...
            journal = TUJournalGenerator.generate(transaction, getAnnee(), getMois(), getCsAgence(),
                    getCsRubriqueList(), ITUCSConstantes.CS_TY_CATEGORIE_RUBRIQUE_F002,
                    TUJournal.TYPE_CHARGEMENT_CANTON);
    ...
    /**
     * Modification de l'id code système rubrique
     * 
     * @param newCsRubriqueList
     */
    public void setCsRubriqueList(ArrayList newCsRubriqueList) {
        csRubriqueList = newCsRubriqueList;
    }
    ...
    private String transformFile() throws TUInitStatistiquesConfigException {
        FileWriter writer;
        TUJournalRecapF4ViewBean bean = new TUJournalRecapF4ViewBean();
