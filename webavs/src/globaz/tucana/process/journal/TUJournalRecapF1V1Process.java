 ...
 * @version : version 1.0
 */
public class TUJournalRecapF1V1Process extends BProcess {
    /**
     * 
     */
    ...
    protected String getEMailObject() {
        ...
        str.append(getSession().getLabel("PRO_TIT_JOURNAL_RECAP_F1V1"));
        return str.toString();
    }
    ...
    public boolean process(BTransaction transaction) {
        ...
        try {
            ...
            // journal.toXml(xmlString);
            // saveAsHtml(xmlString);
            getMemoryLog().logMessage("Ceci est un essai", FWMessage.INFORMATION, "suite de l'essai");
            // registerAttachedDocument(xmlString.toString());
