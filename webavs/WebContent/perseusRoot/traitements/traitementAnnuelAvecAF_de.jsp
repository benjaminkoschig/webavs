...
<%@page import="globaz.perseus.vb.traitements.PFTraitementAnnuelAvecAFViewBean"%>
...
<%
	...
	PFTraitementAnnuelAvecAFViewBean viewBean = (PFTraitementAnnuelAvecAFViewBean) session.getAttribute("viewBean");
	idEcran="PPF2061";

	userActionValue = "perseus.traitements.traitementAnnuelAvecAF.executer";
...
<script type="text/javascript">
	...
	function validate() {
		return window.confirm("<%=objSession.getLabel("JSP_PF_TRAITEMENT_ANNUEL_AVEC_AF_CONFIRMATION")%>")
	}
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:insert attribute="zoneTitle" --%><ct:FWLabel key="JSP_PF_TRAITEMENT_ANNUEL_AVEC_AF_TITRE"/><%-- /tpl:insert --%>
