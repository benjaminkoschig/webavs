...
<%
	...
	PFPaiementMensuelViewBean viewBean = (PFPaiementMensuelViewBean) session.getAttribute("viewBean");
	idEcran="PPF0821";

	userActionValue = "perseus.paiements.paiementMensuel.executer";
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:insert attribute="zoneTitle" --%><ct:FWLabel key="JSP_PF_PAIEMENT_MENSUEL_TITRE"/><%-- /tpl:insert --%>
