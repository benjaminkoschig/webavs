...
function Creancier (container){
	...
	this.getParametresForFind = function () {
		return {"searchModel.forIdDemande":this.idDemande};
	}
	...
	this.getParametres=function(){
		var o_map = {
			...
			'creancier.simpleCreancier.montantRevendique': this.detail.find('#montantRevendique').val(), 
			'creancier.simpleCreancier.montantAccorde': this.detail.find('#montantAccorde').val(), 
