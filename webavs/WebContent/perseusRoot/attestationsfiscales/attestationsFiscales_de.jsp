...
<%@page import="globaz.perseus.vb.attestationsfiscales.PFAttestationsFiscalesViewBean"%>
...
<%
	...
	idEcran="PPF1811";
	PFAttestationsFiscalesViewBean viewBean = (PFAttestationsFiscalesViewBean) session.getAttribute("viewBean");
...
$(document).ready(function () {
	...
	$caisse.change(function () {
			document.location.href = "perseus?userAction=perseus.attestationsfiscales.attestationsFiscales.afficher"
								+ "&email=" + $email.val()
								+ "&caisse=" + $caisse.val()
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_ATTESTATIONSFISCALES_E_TITRE"/><%-- /tpl:put --%>
