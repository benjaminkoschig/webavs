...
<%
	//Les labels de cette page commence par la préfix "JSP_AD9_D"
	
	idEcran = "PRE0075";

	globaz.corvus.vb.annonces.REAnnoncesDiminution9EmeViewBean viewBean
		= (globaz.corvus.vb.annonces.REAnnoncesDiminution9EmeViewBean) session.getAttribute("viewBean");
...
<%-- tpl:put name="zoneMain" --%>
	...
	<TR>
		<TD><ct:FWLabel key='JSP_AD9_D_ID_ANNONCE'/></TD>
		<TD>
	...
	<TR>
		<TD colspan="6"><b><ct:FWLabel key='JSP_AD9_D_CODE_ENREG_01'/></b></TD>
	</TR>
	<TR>
		<TD colspan="6"><hr></TD>
	</TR>
	<TR>
		<TD><ct:FWLabel key='JSP_AD9_D_CODE_APPLI'/></TD>
		<TD><input type="text" name="codeApplication" value="<%=viewBean.isNew()?"42":viewBean.getCodeApplication()%>" class=disabled readonly></TD>
		<TD><ct:FWLabel key='JSP_AD9_D_CODE_ENREGISTREMENT'/></TD>
		...
		<TD><ct:FWLabel key='JSP_AD9_D_NO_CAISSE'/></TD>
	...
	<TR>
		<TD><ct:FWLabel key='JSP_AD9_D_NO_AGENCE'/></TD>
	...
	<TR>
		...
		<TD><ct:FWLabel key='JSP_AD9_D_MENS_RENTE_ORDIN_REMPLACEE'/></TD>
		<TD><input type="text" name="mensualiteRenteOrdinaire" value="<%=viewBean.getMensualiteRenteOrdinaire()%>"></TD>
	</TR>
	<TR>
		<TD><ct:FWLabel key='JSP_AD9_D_FIN_DROIT'/></TD>
		<TD><input type="text" name="finDroit" value="<%=viewBean.getFinDroit()%>"></TD>
		<TD><ct:FWLabel key='JSP_AD9_D_MOIS_RAPPORT'/></TD>
		<TD><input type="text" name="moisRapport" value="<%=viewBean.getMoisRapport()%>"></TD>
		<TD><ct:FWLabel key='JSP_AD9_D_CODE_MUTATION'/></TD>
