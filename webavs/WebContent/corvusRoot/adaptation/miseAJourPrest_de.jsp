...
<%
	...
	REMiseAJourPrestViewBean viewBean = (REMiseAJourPrestViewBean)session.getAttribute("viewBean");
	globaz.framework.controller.FWController controller = (globaz.framework.controller.FWController) session.getAttribute("objController");
	
	userActionValue=globaz.corvus.servlet.IREActions.ACTION_ADAPTATION_MISE_A_JOUR_PREST + ".executer";
%>
<%-- /tpl:put --%>
...
<%@page import="globaz.corvus.vb.adaptation.REMiseAJourPrestViewBean"%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_LIST_MAJ_PREST_TITRE_PAGE"/> <%-- /tpl:put --%>
