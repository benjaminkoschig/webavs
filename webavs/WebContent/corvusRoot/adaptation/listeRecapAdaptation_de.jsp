...
<%
	...
	REListeRecapAdaptationViewBean viewBean = (REListeRecapAdaptationViewBean)session.getAttribute("viewBean");
	globaz.framework.controller.FWController controller = (globaz.framework.controller.FWController) session.getAttribute("objController");
	
	userActionValue=globaz.corvus.servlet.IREActions.ACTION_ADAPTATION_LISTE_RECAP_ADAPTATION + ".executer";
%>
<%-- /tpl:put --%>
...
<%@page import="globaz.corvus.vb.adaptation.REListeRecapAdaptationViewBean"%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_LST_RECAP_ADAP_TITRE_PAGE"/><%-- /tpl:put --%>
