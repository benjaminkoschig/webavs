...
<%
	...
	REPmtFictifViewBean viewBean = (REPmtFictifViewBean)session.getAttribute("viewBean");
	globaz.framework.controller.FWController controller = (globaz.framework.controller.FWController) session.getAttribute("objController");
	
	userActionValue=globaz.corvus.servlet.IREActions.ACTION_ADAPTATION_PMT_FICTIF + ".executer";
%>
<%-- /tpl:put --%>
...
<%@page import="globaz.corvus.vb.adaptation.REPmtFictifViewBean"%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_PMT_FIC_TITRE_PAGE"/> <%-- /tpl:put --%>
