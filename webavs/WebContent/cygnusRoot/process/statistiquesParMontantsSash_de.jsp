...
<%@page import="globaz.cygnus.servlet.RFStatistiquesParMontantsSashAction"%>
...
<%
	...
	RFStatistiquesParMontantsSashViewBean viewBean = (RFStatistiquesParMontantsSashViewBean) session.getAttribute("viewBean");
	globaz.framework.controller.FWController controller = (globaz.framework.controller.FWController) session.getAttribute("objController");
	globaz.globall.db.BSession objSession = (globaz.globall.db.BSession)controller.getSession();
	String eMailAdr = null;
	userActionValue=IRFActions.ACTION_STATISTIQUES_PAR_MONTANTS_SASH + ".executer";
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_STATISTIQUES_PAR_MONTANTS"/> <%-- /tpl:put --%>
...
<tr>
	<td>
		<table>
			<tr>
				<td><label><ct:FWLabel key="JSP_GESTIONNAIRE_STATS_PAR_MONTANTS"/></label></td>
				<td width="50"></td>
			...
			<tr>
				<td><label><ct:FWLabel key="JSP_ADR_MAIL_STATS_PAR_MONTANTS"/></label></td>
				<td width="50"></td>
...
<tr>
	<td>
		<table>
			...
			<tr>
				<td><label><ct:FWLabel key="JSP_DATE_DEBUT_STATS_PAR_MONTANTS"/></label></td>
				<td width="52"></td>
				<td><input data-g-calendar=" " id="dateDebutStat" name="dateDebutStat" id="dateDebutStat" value="<%=viewBean.getDateDebutStat()%>"/></td>
				<td width="100"></td>
				<td><label><ct:FWLabel key="JSP_DATE_FIN_STATS_PAR_MONTANTS"/></label></td>
				<td width="50"></td>
				<td><input data-g-calendar=" " id="dateFinStat" name="dateFinStat" id="dateFinStat" value="<%=viewBean.getDateFinStat()%>"/></td>
			</tr>
		</table>
	</td>
</tr>
