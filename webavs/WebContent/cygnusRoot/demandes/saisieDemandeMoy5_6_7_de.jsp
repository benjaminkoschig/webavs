...
<ct:FWLabel key="JSP_RF_DEM_S_MOY5_TITRE"/>
<%-- /tpl:put --%>
...
<%-- tpl:put name="zoneMain" --%>
				...
				<TR style="vertical-align:top" >
					...
					<TD colspan="5">
						...
						<INPUT type="hidden" id="typeDemande" name="typeDemande" value="<%=RFSaisieDemandeAbstractViewBean.TYPE_DEMANDE_MOY5_6_7%>" />
				...
				<TR>
					...
					<%if(viewBean.getCodeTypeDeSoinList().equals(RFUtils.CODE_TYPE_DE_SOIN_MOYENS_AUXILIAIRES_5_STR)){%>
						<TD><ct:FWLabel key="JSP_RF_DEM_S_DATE_DECISION_OAI"/></TD>
		                <TD>
		                    <input data-g-calendar=" "  name="dateDecisionOAI" value="<%=viewBean.getDateDecisionOAI()%>"/>
		                </TD>
	                <%}else{%>
				...
				<TR  class="trContainerAdresse">
					<TD><ct:FWLabel key="JSP_RF_DEM_S_MONTANT_FACTURE_44"/></TD>
					<TD>
						<INPUT type="text" name="montantFacture44" value="<%=viewBean.getMontantFacture44()%>" class="montant"  onkeypress="return filterCharForFloat(window.event);"/> 
					</TD>
					<TD  align="right">
				...
				<%if (viewBean.getCodeTypeDeSoinList().equals(RFUtils.CODE_TYPE_DE_SOIN_MOYENS_AUXILIAIRES_5_STR)){%>
					<TR>
						<TD><ct:FWLabel key="JSP_RF_DEM_S_MONTANT_VERSE_PAR_OAI"/></TD>
		                <TD colspan="5">
		                	<INPUT type="text" id="montantVerseOaiId" name="montantVerseOAI" value="<%=viewBean.getMontantVerseOAI()%>" class="montant"  onkeypress="return filterCharForFloat(window.event);"/> 
