...
<%
	...
	idEcran="PRF0066";
	RFAvanceViewBean viewBean = (RFAvanceViewBean) session.getAttribute("viewBean");	
...
<%}%>
	...
	function add(){
	    document.forms[0].elements('userAction').value="cygnus.avances.avance.ajouter";
	}
	...
	function validate() {
	    ...
	    if (document.forms[0].elements('_method').value == "add"){
	        ...
	        document.forms[0].elements('userAction').value="cygnus.avances.avance.modifier";
	    }
	    return state;
	}
	...
	function cancel() {
		if (document.forms[0].elements('_method').value == "add"){
		  ...
		  document.forms[0].elements('userAction').value="cygnus.avances.avance.chercher";
		}
	}

	function del() {
	    if (window.confirm("<ct:FWLabel key='JSP_DELETE_MESSAGE_INFO'/>")){
	        document.forms[0].elements('userAction').value="cygnus.avances.avance.supprimer";
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
								<TD>
									<strong>
										<ct:FWLabel key="JSP_AVANCE_RFM_REQUERANT_INFO"/>
									</strong>
								</TD>							
								<TD colspan="3">													
						...
						<TR>						
							<TD valign="top">
								...
								<IfNPUT type="hidden" name="csDomaine" value="<%=viewBean.getCsDomaine()%>">
								<input type="hidden" name="csDomaineAvance" value="<%= viewBean.getConstantCsDomaineAvanceRFM()%>"/>
							</TD>
						...
						<TR>
							<TD colspan="4">
								<b><ct:FWLabel key="JSP_AVANCE_RFM_D_ACOMPTE_UNIQUE"/></b>
							</TD>
						</TR>
						<tr>
