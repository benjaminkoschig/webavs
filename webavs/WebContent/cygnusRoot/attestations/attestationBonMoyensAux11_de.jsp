...
<!-- Arrivée sur les moyens auxiliaires (bons) -->
<TR>
	<TD>
		<TBODY id="bonMoyensAux">
			<TR>
				<TD><ct:FWLabel key="JSP_RF_ATTESTATION_AUX_BONS_MOYEN_AUX" /></TD>
				<TD><INPUT type="text" name="moyenAuxiliaire" value="<%=viewBean.getMoyenAuxiliaire()%>" /></TD>
			</TR>	
			<tr><td colspan="6"><br></td></tr>		
			<TR>
				<TD><ct:FWLabel key="JSP_RF_ATTESTATION_AUX_BONS_DATE" /></TD>
				<TD><input data-g-calendar=" "  name="dateMoyAuxB" value="<%=viewBean.getDateMoyAuxB()%>"/></TD>
			</TR>			 
			<tr><td colspan="6"><br></td></tr>	
			<TR>
				<TD><ct:FWLabel key="JSP_RF_ATTESTATION_AUX_BONS_DATE_ENTRETIEN_TEL" /></TD>
				<TD><input data-g-calendar=" "  name="dateEntretienTel" value="<%=viewBean.getDateEntretienTel()%>"/></TD>
			</TR>	
			<TR class="hidden">
