...
<%@ include file="/theme/process/bodyStart2.jspf" %>
						...
						<TR>
							<TD>Nombre d'annonces par jour : </TD>
							<TD><INPUT type="text" name="nbreMax"></INPUT></TD>
							<TD>&nbsp;</TD>
						</TR>
						<TR>
							<TD>Nombre d'annonces à envoyer : </TD>
						...
						<TR>
							<TD>Est-ce les dernières inscriptions CI à annoncer cette année ? </TD>
						...
						<TR>
							<TD>Résultat du traitement envoyé par email à </TD>
