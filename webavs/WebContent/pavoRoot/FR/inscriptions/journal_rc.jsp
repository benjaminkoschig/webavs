...
top.document.title = "CI - Gestion des Journaux";
timeWaiting = 1;
bFind = true;
</SCRIPT>
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Aperçu des journaux d'inscriptions aux CI<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<tr>
					      <td style="width: 100px;">No de facturation</td>
					      <td style="width: 150px;"><input type="text" size="15" name="forReferenceExterneFacturation"></td>
					      <td style="width: 100px;">Num&eacute;ro de journal</td>
