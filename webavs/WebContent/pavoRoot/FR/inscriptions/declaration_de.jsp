...
top.document.title = "CI - Importation d'inscriptions CI"
...
<TABLE bgcolor="#B3C4DB" cellspacing="0" cellpadding="0" width="100%" height="<%=tableHeight%>">
	<TBODY>
		...
		<TR>
          ...
          <tr>
          <td>Autoriser les écritures négatives</td>
          	<td>
          ...
          <tr>
           <td>Autoriser l'année en cours</td>
          	<td>
