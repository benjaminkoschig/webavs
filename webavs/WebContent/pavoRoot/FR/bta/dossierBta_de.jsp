...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un dossier BTA<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
			...
			<tr>
				<td>
					<font size="2"><b>Détail de la personne nécessitant les soins</b></font>
				</td>
			</tr>
			<tr>
				<td>
					Sélection de la personne nécessitant les soins
				</td>
				<td>
            		<ct:FWSelectorTag 
					name="tiersSelector" 		
					...
					<ct:ifhasright element="pyxis.tiers.tiers.afficher" crud="r">
						<a href="<%=request.getContextPath()%>/pyxis?userAction=pyxis.tiers.tiers.afficher&selectedId=<%= viewBean.getIdTiersImpotent() %>">Tiers</a>
					</ct:ifhasright>	
					<%} %>
				</td>
			</tr>
                        ...
                        <tr>
						<td>
							<font size="2"><b>Détail sur le dossier</b></font>
						</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								...
								<%if(rightAjout){%>
									<input name="btNewRequerant" class="btnCtrl" type="button"  value="Créer un requérant" onclick="document.location.href='<%=actionNewRequerant%>'">
								<%}%>
							</td>
						</tr>
						<%} %>						
