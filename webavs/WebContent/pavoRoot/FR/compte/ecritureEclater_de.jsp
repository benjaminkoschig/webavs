...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Répartire une écriture<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
							...
							<TR>
								...
								<td>
									Période &nbsp; <INPUT type="text"  readonly tabindex="-1" class="disabled" size="2" value="<%=viewBean.getMoisDebutPad()%>" > - 
							...
							<TR>
								<TD width="150">
								Ecriture avant clotûre
								</TD>
								<TD >
								Période &nbsp; <INPUT type="text" name="moisDebut1" size="2" value="<%=!globaz.globall.util.JAUtil.isStringEmpty(viewBean.getMoisDebut1())?viewBean.getMoisDebut1():""%>" > - 
