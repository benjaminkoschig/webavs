...
<%@ include file="/theme/find/bodyStart2.jspf" %>
 		  		...
 		  		if (ciLies.length>0) {%> 
	                ...
	                %>
							...
							<INPUT type="hidden" name="nomInv" size="70" class="disabled"
						...
						<INPUT type="text" name="nomInv" size="73" class="disabled"
					...
					<tr>
						...
						<td>
							<INPUT type="text" name="pays" class="disabled"
								size="50" readonly value="<%=viewBean.getPaysFormate()%>"></TD>
						</td>
					...
					<TR>
            			...
            			<TD nowrap width="159">Tri</TD>
            			<TD nowrap><SELECT id='tri' name='tri' doClientValidation=''>
            			<OPTION value="beitragsjahr" <%=!"27".equals(globaz.pavo.util.CIUtil.getCaisseInterneEcran())?"selected":""%>>Ann&eacute;e</OPTION>
            			<OPTION value="date">Date d'inscription</OPTION>
            			<OPTION value="numAvs">NSS</OPTION> 
            			<OPTION value="numAff">Numéro affilié</OPTION>
            			<OPTION value="ordreInscription" <%="27".equals(globaz.pavo.util.CIUtil.getCaisseInterneEcran())?"selected":""%> >Année/ordre d'inscription</OPTION>
            			</SELECT>
						<script>
