...
top.document.title = "CI - Gestion des comptes individuels";
timeWaiting = 1;
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Aperçu des comptes individuels<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
		...
		<tr>
			...
			<td><table>	
			<tr> 
	            <td width="100" nowrap>Nom Prénom</td>
		...
		<tr>
			<td><table>				
	          <tr> 
	            <td width="100" nowrap>Date de naissance</td>
			...
			<td><table>				
	          <tr> 
	            <td width="100" nowrap>N° affilié</td>
