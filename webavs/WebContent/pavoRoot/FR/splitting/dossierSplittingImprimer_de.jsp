...
top.document.title = "CI - Impression d'un extrait"
...
<%@ include file="/theme/process/bodyStart2.jspf" %>
		  ...
		  <TR>
            <TD height="2"><a href="<%=servletContext + mainServletPath + "?userAction=pavo.compte.compteIndividuel.afficher&selectedId="+viewBean.getCompteIndividuelId()%>">Assuré</a></TD>
            <TD height="2">
