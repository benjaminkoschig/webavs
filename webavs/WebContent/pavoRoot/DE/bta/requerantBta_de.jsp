			...
			<tr>
				...
				<td>
					...
					<%}%>
						...
						<tr>
							<td>
								<input class="text" type="text" name="lienParenteTexte" tabIndex="-1" size="58" value="Verwandtschaftsgrad mit der Person, die die Pflege benötigt" style="border-width : 0px; background-color: transparent;">
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<input class="text" type="text" name="dateNaissanceCadetTexte" tabIndex="-1" size="25" value="Geburtsdatum des Jüngstens" style="border-width : 0px; background-color: transparent;">
							</td>
							<td>
