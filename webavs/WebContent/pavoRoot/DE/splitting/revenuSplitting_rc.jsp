...
<%@ include file="/theme/capage/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Einkommen
        des Splittings<%-- /tpl:put --%>
<%@ include file="/theme/capage/bodyStart2.jspf" %>
          ...
          <TR>
            ...
            <TD nowrap width="140">Aktuelles Total</TD>
            <TD nowrap>
