<%-- tpl:insert page="/theme/detail.jtpl" --%><%@page import="java.util.HashSet"%>
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail der Ausnahme<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<input type="text" class="disabled" readonly name="infoAssure" size="70" maxlength="73" value="<%=viewBean.getInfoAssure()%>" tabIndex="-1"> 
						...
						<%if("add".equalsIgnoreCase(request.getParameter("_method"))) { %>
							&nbsp;&nbsp;<input type="checkbox" id="chkMemoriserNumeroAffilie" name="chkMemoriserNumeroAffilie" <%="on".equalsIgnoreCase(chkMemoriserNumeroAffilieParamValue)?"checked":""%> >&nbsp; Speichern
						<%}%>
						</td>
						</tr>
						 <tr>
