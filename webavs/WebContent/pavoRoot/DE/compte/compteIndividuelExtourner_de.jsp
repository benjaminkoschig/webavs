...
top.document.title = "IK - IK-Umbuchung"
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>IK-Umbuchung<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						...
						<tr>
							...
							&nbsp;Heimatstaat &nbsp;
							<input type="text" size = "43" class='disabled' name="pays" readonly tabindex='-1' value = "<%=viewBean.getCi().getPaysFormate()%>">
							</td>
						<tr>
						<tr>
						...
						<td valign="top" colspan="4"><IFRAME name="dernieresEcritures"
							...
							&nbsp;Heimatstaat &nbsp;
							<input type="text" size = "43" class='disabled' name="paysSrc" readonly tabindex='-1' value = "">
							</td>
						<tr>
						<tr>
						<td valign="top">IK-Buchungen &nbsp;</td>
						...
						<tr>
							<TD colspan="3">
								Es ist empfohlen die IK's des Ehegatten zu prüfen, wenn die Versicherten Splittingbuchungen haben!
							</TD>
						</tr>
