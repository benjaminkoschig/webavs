...
top.document.title = "IK - Anzeige der Splittingperioden";
timeWaiting = 1;
</script>
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Anzeige der Splittingperioden<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
					<TR>
						<TD nowrap width="90"><a href="javascript:detailAssure();">Versicherte</a></TD>
