...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Anzeige der Zusammenrufe und Eröffnungen<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
					...
					<TR>
						<TD nowrap width="80"><a
							href="javascript:detailAssure();">Versicherte</a></TD>
						<%
 		  		...
 		  		if (ciLies.length>0) {%>
	                ...
	                %>
						...
						<INPUT type="text" name="nom" class="disabled" size="75" readonly
					...
					<TR>
						...
						<TD nowrap><INPUT type="text" name="naissance" class="disabled"
							...
							<INPUT type="text" name="pays" class="disabled"
								size="43" readonly value="<%=viewBean.getPaysFormate()%>">
						</td>
					</TR>
