...
top.document.title = "IK - 	Detail des Zusammenrufs oder Eröffnungen"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail des Zusammenrufs oder Eröffnung<%-- /tpl:put --%>
...
<TR>
  ...
  <TD>
	 ...
	 <INPUT type="text" name="nom" class="disabled" size="72" maxlength="70" readonly value="<%=viewBeanFK.getNomPrenom()%>">
	...
	<TR>
			...
			size="40" readonly value="<%=viewBeanFK.getPaysFormate()%>"></TD>
		</td>
	</TR>
<tr>
...
<tr>
<td>Auftragsdatum des zweiten ZIK</td>
