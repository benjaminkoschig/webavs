  ...
  <TBODY>
    <TR>
      <TH class="title" colspan="2">
				Répertoire des documents imprimés
			</TH>
    </TR>
    <TR>
			...
			<TABLE border="0" height="<%=subTableHeight%>" cellspacing="0" cellpadding="0">
				<TBODY>
					<TR>
   					...
   					<TR>
					    <TD><img valign="bottom" src="<%=request.getContextPath()%>/images/fold.gif" align="bottom"> Contenu du répertoire <B><%= cd %></B></TD>
				    </TR>
			  </TBODY>
			</TABLE>
	</TR>
...
<P>
<IFRAME scrolling="YES"  src="<%=applicationRoot%>/FR/browseDirectory_list.jsp" style="border : solid 1px black; width:100%;" height="<%=IFrameHeight%>">
</IFRAME>
</BODY>
</HTML>
