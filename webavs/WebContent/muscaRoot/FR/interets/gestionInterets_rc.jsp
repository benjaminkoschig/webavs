...
top.document.title = "Apercu des intérêts moratoires - " + top.location.href;
...
<%-- tpl:put name="zoneTitle" --%>Apercu des intérêts moratoires<%-- /tpl:put --%>
...
<ct:ifhasright element="musca.interets.changementJournalIM.afficher" crud="u">
	<INPUT type="button" name="btnTraiter" id="btnTraiter" value="Attacher journal" onClick="onClickCheckBox('musca.interets.changementJournalIM.afficher');" >
</ct:ifhasright>
<%-- /tpl:put --%>
