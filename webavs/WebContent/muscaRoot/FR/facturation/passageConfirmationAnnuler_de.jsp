...
<SCRIPT language="JavaScript">
	...
	function validate() {
	    ...
	    if (window.confirm("Vous êtes sur le point d'annuler ce journal! Il sera impossible de le réactiver. Voulez-vous continuer?")){
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Annulation d'un journal<%-- /tpl:put --%>
...
<%
	if(globaz.musca.db.facturation.FAPassage.CS_ETAT_COMPTABILISE.equalsIgnoreCase(passageStatus)
		|| passageLocked
		|| globaz.musca.db.facturation.FAPassage.CS_ETAT_ANNULE.equalsIgnoreCase(passageStatus) ){
		%> window.alert("Ce passage est soit déjà annulé, comptabilisé ou verrouillé. Impossible de le dévalider.");<%
	}
%>
</script>
