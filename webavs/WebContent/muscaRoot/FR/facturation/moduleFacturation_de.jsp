...
top.document.title = "Facturation - Détail module fact."
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail du module de facturation<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	...
	<TR>
            <TD nowrap colspan="2" width="200">Niveau d'appel</TD>
	...
	<TR>
            <TD nowrap colspan="2" width="200">Afacts modifiables</TD>
            <TD nowrap width="547">
