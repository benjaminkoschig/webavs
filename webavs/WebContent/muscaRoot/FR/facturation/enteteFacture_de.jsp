...
%>
top.document.title = "Facturation - Détail décompte"
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un décompte<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
					...
					<TR>
						<TD>
							<TABLE border="0">
								<TBODY>
									<TR>
										<TD nowrap width="165">Débiteur</TD>
										<TD nowrap>
											<ct:FWPopupList
											...
											<INPUT name="idExterneRole" type="hidden" value="<%=viewBean.getIdExterneRole()%>" doclientvalidation="NOT_EMPTY" maxlength="20" size="20">
										</TD>
										<TD nowrap>
							              <select name="idRole">
									...
									<tr>
									<TD nowrap>Personne de référence</TD>
										<TD nowrap>
				...
				<TABLE border="0" cellspacing="0" cellpadding="0" width="701">
	                <TBODY>
	                <TR>
	                  <TD nowrap colspan="2" width="140">Date de réception</TD>
	                  <TD nowrap width="500">
	                    <ct:FWCalendarTag name="dateReceptionDS" value="<%=viewBean.getDateReceptionDS()%>" />
	                  	&nbsp;&nbsp;&nbsp;<I>Doit être saisie pour les décomptes de type 13 ou 14</TD>
	                ...
	                <TR>
	                  <TD nowrap colspan="2" width="140">Montant du décompte</TD>
	                  <TD nowrap width="150">
	                ...
	                <TR>
	                  <TD nowrap colspan="2">Adresse de facturation</TD>
	                  <TD nowrap>
	                ...
	                <TR>
	                  <TD nowrap colspan="2">Intérêts moratoires</TD>
	                  <TD nowrap>
	                  <%
	                ...
	                <TR>
	                  <TD nowrap colspan="2">Mode de recouvrement</TD>
	                ...
	                <TR>
	                  <TD nowrap colspan="2">Adresse de paiement</TD>
	                  <TD nowrap>
	                ...
	                <TR>
	                  <TD nowrap colspan="2">Remarque<BR>(appara&icirc;t sur le d&eacute;compte)</TD>
	                  <TD nowrap>
