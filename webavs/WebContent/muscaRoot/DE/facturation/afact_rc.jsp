...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Anzeige der Faktzeilen der Abrechnung<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
	  <TR>
            <TD nowrap width="100">Debitor</TD>
            ...
            <TD nowrap valign="middle" align="left" width="80">Modul</TD>
