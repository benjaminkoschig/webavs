...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Anzeige der Abrechnungen des Journals<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
	  ...
	  <TR>
            ...
            <TD nowrap></TD>
            <TD nowrap valign="middle" align="left">Abrechnungen</TD>
		...
		<TR>
            ...
            <TD> </TD>
            <TD nowrap valign="middle" align="left" width="149">Betrag</TD>
