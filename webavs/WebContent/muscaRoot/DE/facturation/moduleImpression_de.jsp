...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail des Ausdruckmoduls<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	 ...
	 <TR>
            <TD nowrap width="150">Bezeichnung</TD>
	...
	<TR>
            <TD nowrap colspan="2" width="200">Erhebungsweise</TD>
            <TD nowrap width="547"> 
	...
	<TR>
            <TD nowrap colspan="2" width="200">Implementierungsklasse</TD>
