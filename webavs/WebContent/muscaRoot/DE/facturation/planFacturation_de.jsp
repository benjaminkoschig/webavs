...
top.document.title = "Facturation - Detail des Fakturierungsplan"
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail des Fakturierungsplans<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	...
	<TR>
            <TD nowrap colspan="2" width="200">Fakturierungstyp</TD>
            <TD nowrap width="547"> 
	...
	<TR>
            <TD nowrap colspan="2" width="200">Standardplan</TD>
            <TD nowrap width="547">
