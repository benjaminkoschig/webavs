...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Anzeige der pendenten Faktzeilen<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
		<TR>
            <TD nowrap width="120">Job</TD>
            ...
            <TD nowrap valign="middle" align="left" width="120">Rolle</TD>
            <TD width="120">
		...
		<TR> 
			<TD nowrap width="120">Sortierung</TD>
			<TD nowrap>
				<SELECT style="width:100%" name="orderBy">
					<OPTION value="<%=FAAfactAQuittancerViewBean.ORDER_NO_DEBITEUR%>">Debitoren-Nr.</OPTION>
					<OPTION value="<%=FAAfactAQuittancerViewBean.ORDER_NOM%>">Name</OPTION>
					<OPTION value="<%=FAAfactAQuittancerViewBean.ORDER_MONTANT%>">Betrag</OPTION>
				</SELECT>
			</TD>
			<TD nowrap></TD>
           <TD nowrap valign="middle" align="left" width="150">Betrag</TD>
           <TD width="159">
           		<INPUT type="text" name="fromMontant" tabindex="-1" class="montant,libelleLong" size="37">
           </TD>
 		</TR>
 		<TR>       
			<TD nowrap width="120">Ab</TD>
			<TD nowrap width="120">
			<INPUT type="text" name="fromIdExterneRole" tabindex="-1" class="libelleLong" size="37"></TD>
		</TR>
		<TR>
			<TD nowrap valign="middle" align="left" width="120">Status</TD>
            <TD width="120">
				<SELECT style="width:100%" name="forAQuittancerString">
					<OPTION value="all"></OPTION>
					<OPTION value="aRefuser">Angenommen</OPTION>
					<OPTION value="aValider">Abgelehnt</OPTION>
				</SELECT>
			</TD>
		</TR>
	 					<%-- /tpl:put --%>
