...
<%@page import="globaz.aries.vb.renouvellementdecisionmasse.ARRenouvellementDecisionMasseViewBean"%>
...
<%
	ARRenouvellementDecisionMasseViewBean viewBean = (ARRenouvellementDecisionMasseViewBean) session.getAttribute(FWServlet.VIEWBEAN);
	String userAction = "aries.renouvellementdecisionmasse.renouvellementDecisionMasse.executer";
...
<script type="text/javascript" src="<%=servletContext%>/ariesRoot/scripts/renouvellementdecisionmasse/renouvellementDecisionMasse_de.js"></script>
...
<ct:FWLabel key="JSP_AR_RENOUVELLEMENT_MASSE_DECISION_TITRE" />
<%-- /tpl:insert --%>
...
<tr>
	<td>
		<table border="0" cellspacing="0" cellpadding="5" width="100%">
			...
			<TR>
		      	<TD><ct:FWLabel key="JSP_AR_RENOUVELLEMENT_MASSE_DECISION_PASSAGE"/></TD>
			...
			<tr>
				<td><label for="numeroAffilieDebut"><ct:FWLabel key="JSP_AR_RENOUVELLEMENT_MASSE_DECISION_NUMERO_AFFILIE_DEBUT" /></label></td>
				<td colspan="3">
			...
			<tr>
				<td><label for="numeroAffilieFin"><ct:FWLabel key="JSP_AR_RENOUVELLEMENT_MASSE_DECISION_NUMERO_AFFILIE_FIN" /></label></td>
				<td colspan="3">
			...
			<tr>
				<td><label for="annee"><ct:FWLabel key="JSP_AR_RENOUVELLEMENT_MASSE_DECISION_ANNEE" /></label></td>
