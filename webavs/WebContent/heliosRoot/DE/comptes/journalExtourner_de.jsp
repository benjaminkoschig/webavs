...
<%
	idEcran="GCF3004";
	CGJournalExtournerViewBean viewBean = (CGJournalExtournerViewBean) session.getAttribute ("viewBean");
	...
	userActionValue = "helios.comptes.journalExtourner.executer";
%>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
      ...
      Stornierung des Journal <%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<tr> 
			<td>Stornieren Datum</td>
			<TD><ct:FWCalendarTag name="dateExtourne" value="<%=viewBean.getDateExtourne()%>"/></TD>
		</tr>
