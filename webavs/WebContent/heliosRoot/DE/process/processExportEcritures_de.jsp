...
top.document.title = "Prozess - Export von Buchungen - " + top.location.href;

// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
<%-- tpl:put name="zoneTitle" --%>Prozess - Export von Buchungen - <%-- /tpl:put --%>
