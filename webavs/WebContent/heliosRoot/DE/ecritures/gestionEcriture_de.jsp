...
<%-- tpl:put name="zoneTitle" --%>Buchungen<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%>

<tr>
  <td width="140">Journalnummer</td>
  ...
  <td width="140">Buchungsnummer</td>
...
<tr>
  <td>
    <a href="#" onclick="switchCentreCharge();" tabindex="-1">Kostenstelle</a>
  </td>
  <td align="right">
    <a href="#" onclick="switchMontantEtranger();" tabindex="-1">Ausland Betrag</a>
  </td>
...
<tr>
  <td colspan="3">
    ...
    <tr>
      ...
      <th align="left"><span class="min_width">Kontobezeichnung</span></th>
      <th><span class="min_width">Bezeichnung</span></th>
      <th>Soll</th>
      <th>Haben</th>
      <th id="colMntTh">Betrag (&euro;,&#36;...)</th>
      <th id="colCoursTh">Kurs</th>
    </tr>
    ...
    <tr class="somme">
      <td colspan="3" align="right" class="mtdBold">Totale :
    ...
    <tr class="balance">
      <td colspan="3" class="mtd" align="right">Saldo :</td>
...
<td width="140">Bemerkung&nbsp;<img src="<%=request.getContextPath()%>/images/attach.png" border="noborder" tabindex="-1" /></td>
<td align="left">
