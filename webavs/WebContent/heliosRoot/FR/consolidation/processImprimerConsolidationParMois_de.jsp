...
globaz.helios.db.consolidation.CGProcessImprimerConsolidationParMoisViewBean viewBean = (globaz.helios.db.consolidation.CGProcessImprimerConsolidationParMoisViewBean) session.getAttribute("viewBean");
userActionValue = "helios.consolidation.processImprimerConsolidationParMois.executer";
%>
<%-- /tpl:put --%>
...
top.document.title = "Process - Imprimer annuel par mois - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Process - Imprimer annuel par mois<%-- /tpl:put --%>
