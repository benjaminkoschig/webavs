...
<%
	...
	CGImprimerPertesProfitsViewBean viewBean = (CGImprimerPertesProfitsViewBean) session.getAttribute ("viewBean");
	...
	userActionValue = "helios.print.imprimerPertesProfits.executer";
...
<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="GCF2007_PERTESPROFITS_TITRE"/><%-- /tpl:put --%>
...
<%-- tpl:put name="zoneMain" --%>
		...
		<tr>
            ...
            <td><input type="checkbox" name="imprimerPageGarde" CHECKED/></td>
        </tr>
		<tr>
			<td><ct:FWLabel key="GCF20XX_CRITERE_PRINT_TITRE"/></td>
            <td><input type="checkbox" name="imprimerTitres" CHECKED/></td>
        </tr>
		<tr>
			<td><ct:FWLabel key="GCF20XX_CRITERE_PRINT_COMPTE"/></td>
            <td><input type="checkbox" name="imprimerComptes" CHECKED/></td>
        </tr>
	    <tr>
