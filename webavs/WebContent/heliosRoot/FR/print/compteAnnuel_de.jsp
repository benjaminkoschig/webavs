...
globaz.helios.db.print.CGCompteAnnuelViewBean viewBean = (globaz.helios.db.print.CGCompteAnnuelViewBean) session.getAttribute("viewBean");
userActionValue = "helios.print.compteAnnuel.executer";
%>
<%-- /tpl:put --%>
...
top.document.title = "Process - Imprimer compte annuel - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Process - Imprimer compte annuels<%-- /tpl:put --%>
