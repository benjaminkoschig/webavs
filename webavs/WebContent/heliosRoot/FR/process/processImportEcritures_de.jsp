...
top.document.title = "Process - Importation d'écritures - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Process - Importation d'écritures<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <TR> 
            <TD align="left" width="180" height="21" valign="middle">Libell&eacute;</TD>
            <TD align="left"> 
