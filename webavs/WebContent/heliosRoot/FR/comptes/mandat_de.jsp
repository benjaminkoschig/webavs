...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un mandat<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
    			<tr><td>
				<table>
					<tr>
						<TD width="155">Numéro</TD>
						<TD width="39"></TD>
					...
					<TR>
						<TD width="155">Numéro de caisse *</TD>
						<TD width="39"></TD>
					...
					<TR>
						<TD width="155">Numéro d'agence *</TD>
						<TD width="39"></TD>
					...
					<tr>
						<TD width="155">Type de plan comptable</TD>
						<TD width="39"></TD>
					...
					<tr>
						<TD width="155">Classification principale</TD>
						<TD width="39"></TD>
						<TD width="458">
				...
				<table>
					...
					<tr>
						<TD width="159">Comptabilité AVS </TD>
						<TD width="187">
						<%if ((request.getParameter("_method")!=null)&&(request.getParameter("_method").equals("add"))) { %>
						...
						<TD width="159">Mandat consolidation</TD>
						<TD>
						<%if ((request.getParameter("_method")!=null)&&(request.getParameter("_method").equals("add"))) { %>
					...
					<tr>
						...
						<TD width="159">Contrôle du compte 1106 et 2740</TD>
					...
					<tr>						
						<td>Ventilation des crédits (605 DCMF)</td>
			...
			<tr><td colspan="3">&nbsp;</td></tr>
			<tr><td colspan="3" class="mtdSpecial">* optionnel</td></tr>
			<%-- /tpl:put --%>
