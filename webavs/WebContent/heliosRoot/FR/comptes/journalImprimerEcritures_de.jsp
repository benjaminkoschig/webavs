...
<%@ page import="globaz.helios.db.comptes.*,globaz.helios.db.interfaces.*,globaz.globall.db.*" %>
<!-- Creer l'enregitrement s'il n'existe pas -->
<%
	idEcran="GCF2009";
	//Récupération des beans
	CGJournalImprimerEcrituresViewBean viewBean = (CGJournalImprimerEcrituresViewBean) session.getAttribute ("viewBean");
	...
	userActionValue = "helios.comptes.journalImprimerEcritures.executer";
...
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<tr>
			<td>Exercice</td>
			<td> <input name='libelle' class='libelleLongDisabled' readonly value='<%=exerciceComptable.getFullDescription()%>'> </td>
		</tr>
		<tr>
