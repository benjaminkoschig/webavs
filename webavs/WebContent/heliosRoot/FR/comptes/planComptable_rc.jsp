...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Plan comptable<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
				<tr>
				<td colspan="4">&nbsp;Mandat&nbsp;<input name='libelle' class='libelleLongDisabled' readonly value='<%=exerciceComptable.getMandat().getLibelle()%>'>&nbsp;Exercice&nbsp;<input name='fullDescription' class="disabled" readonly value='<%=exerciceComptable.getFullDescription()%>'>&nbsp;Comptabilité&nbsp;<ct:FWCodeSelectTag name="reqComptabilite" defaut="<%=CodeSystem.CS_DEFINITIF%>" codeType="CGPRODEF"/>
					<script>
