...
<br>
<b>Veuillez sélectionner une classification !!!</b>
...
<he:CGTreeSelectionTag name="classesCompte" defaut="<%=idClasseCompte%>" data="<%=globaz.helios.translation.CGTrees.getClassesCompteExtendedTree(session,idClassification)%>" exportValues="false" exportValuesInputName="parent.mainForm.classesCompteList" expandLevel="1" rootLabel="Tous" rootValue=" " displayRoot="true"/>
