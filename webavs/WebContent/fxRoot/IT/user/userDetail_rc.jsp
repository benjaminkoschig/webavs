...
boolean bButtonNew = objSession.hasRight("fx.user.userDetail.ajouter", FWSecureConstants.ADD);
...
<%
actionNew +="&idUser="+request.getParameter("idUser");
%>
<script>
	usrAction = "fx.user.userDetail.lister";
	...
	<TBODY style="border-width: 0px">
		<TR>
			<TH class="title" colspan="2">
				...
				<DIV style="width: 100%">
					<SPAN class="idEcran">FX0102</SPAN>
					Dettagli
				</DIV>
				<%--custom /tpl:put --%>
			</TH>
				...
				<TABLE border="0" height="<%=subTableHeight%>" cellspacing="0" cellpadding="0">
					<TBODY>
						...
						<tr>
							<td>Visto&nbsp;</td>
							<td>
								<input type="text" class="libelleDisabled" readonly name="visa" value="<%=request.getParameter("visa")%>">
								<input type="hidden" class="libelleDisabled" readonly name="forIdUser" value="<%=request.getParameter("forIdUser")%>">
							</td>
						</tr>
