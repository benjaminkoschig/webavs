...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Dettaglio di un utente<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<tr><td valign="top">
							<table>
								...
								<tr>
									<td nowrap>Creare gli stessi diritti dell'utente </td>
									<td >
