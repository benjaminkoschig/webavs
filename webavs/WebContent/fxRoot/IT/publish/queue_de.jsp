...
<%
	globaz.fx.publish.client.bean.FXPublishQueueViewBean viewBean = (globaz.fx.publish.client.bean.FXPublishQueueViewBean) request.getAttribute("viewBean");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'une file d'attente de publication<%-- /tpl:put --%>
...
<ct:menuSetAllParams key="queueName" value="<%=viewBean.getQueueName()%>" menuId="optionsPublishQueueDetail"/>
<ct:menuChange menuId="optionsPublishQueueDetail" displayId="options" showTab="options"/>
<%-- /tpl:put --%>
