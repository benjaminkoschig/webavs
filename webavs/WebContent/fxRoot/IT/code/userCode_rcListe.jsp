...
<% 
		globaz.fx.code.client.bean.FXUserCodeListViewBean viewBean =
		(globaz.fx.code.client.bean.FXUserCodeListViewBean) request.getAttribute("viewBean");
		size= viewBean.getSize();
		target="parent.fr_detail";
		targetLocation = target + ".location.href";
		detailLink ="fx?userAction=fx.code.userCode.afficher&selectedId=";
...
<%
	actionDetail = targetLocation+ "='" +detailLink+viewBean.getIdCodeSystems()[i]+"&idLangue="+viewBean.getLangues()[i]+"'";
%>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getLibelles()[i]%>&nbsp;</TD>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getUserCodes()[i]%>&nbsp;</TD>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getLangues()[i]%>&nbsp;</TD>
