...
<% 
		globaz.fx.gsc.client.bean.FXRoleUserListViewBean viewBean =
		(globaz.fx.gsc.client.bean.FXRoleUserListViewBean) request.getAttribute("viewBean");
		size= viewBean.getSize();
		target="parent.fr_detail";
		targetLocation = target + ".location.href";
		detailLink ="fx?userAction=fx.gsc.roleUser.afficher&selectedId=";
...
<%
	actionDetail = targetLocation+ "='" +detailLink+viewBean.getIdRoles()[i]+"&idRole="+viewBean.getIdRoles()[i]+"&idUser="+viewBean.getIdUsers()[i]+"&dateStart="+viewBean.getDateStarts()[i]+"'";
%>
	<TD class="mtd" onClick="<%=actionDetail%>" ><%=viewBean.getRoleNames()[i]%>&nbsp;</TD>
