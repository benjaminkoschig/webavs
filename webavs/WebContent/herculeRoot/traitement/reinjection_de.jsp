...
<%@page import="globaz.hercule.vb.traitement.CEReinjectionViewBean"%>
<%@page import="globaz.jade.client.util.JadeStringUtil"%>

<%
	CEReinjectionViewBean viewBean = null;

	idEcran="CCE3004";
	viewBean = (CEReinjectionViewBean) session.getAttribute("viewBean");                            
    userActionValue="hercule.traitement.rattrapageGlobal.executer";
    formAction= request.getContextPath()+mainServletPath+"Root/traitement/reinjectionFile_de.jsp";
...
<TR> 
	...
	<TD><INPUT name="eMailAddress" size="40" type="text" style="text-align : left;" value="<%=email%>"></TD>                        
 	<TD>&nbsp;</TD>
</TR>
