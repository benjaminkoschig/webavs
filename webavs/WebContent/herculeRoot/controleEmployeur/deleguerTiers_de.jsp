...
<%
	...
	CEDeleguerTiersViewBean viewBean = (CEDeleguerTiersViewBean) session.getAttribute ("viewBean");

	//Définition de l'action pour le bouton valider
	userActionValue = "hercule.controleEmployeur.deleguerTiers.executer";
...
<%@page import="globaz.hercule.db.controleEmployeur.CEDeleguerTiersViewBean"%>
...
<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="TITRE_DELEGUER_TIERS"/><%-- /tpl:put --%>
...
<%-- tpl:put name="zoneMain" --%>
    ...
    <TR> 
		<TD><ct:FWLabel key="DELEGUER_A"/></TD>
	    <TD><INPUT name="nomDeleguation" size="40" type="text" style="text-align : left;" value="<%=!JadeStringUtil.isEmpty(viewBean.getNomDeleguation())?viewBean.getNomDeleguation():""%>"></INPUT></TD>
	</TR>
