...
<%@ page import="globaz.hercule.db.controleEmployeur.CELettreProchainControleViewBean"%>
<%@page import="java.net.URLDecoder"%>

<%
	CELettreProchainControleViewBean viewBean = (CELettreProchainControleViewBean)session.getAttribute("viewBean");
    idEcran="CCE2005";                             
    userActionValue="hercule.controleEmployeur.lettreProchainControle.executer";
	...
	String rev = viewBean.getReviseur();
	if(JadeStringUtil.isEmpty(rev)) {
		rev = viewBean._getReviseurPreRempli();
	}
%>
...
<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="TITRE_LETTRE_PROCHAIN_CONTROLE"/><%-- /tpl:put --%>
...
<%-- tpl:put name="zoneMain" --%>
	...
	<TR> 
        ...
        <TD> 
			<INPUT name="eMailAddress" size="20" type="text" style="text-align : left;width:8cm;" value="<%=viewBean.getEMailAddress()!=null?viewBean.getEMailAddress():""%>">                        
	  	</TD>
	  	<TD>&nbsp;</TD>
    </TR>
	<TR><TD colspan="2">&nbsp;</TD></TR>
    <TR>
    	<TD><ct:FWLabel key="MODELE_IMPRESSION"/></TD>
		<td>
			<ct:FWListSelectTag data="<%=viewBean.returnDocumentsPossible()%>" name="idDocument" defaut="<%=viewBean.getIdDocumentDefaut()%>" />
		</TD>
        <TD>&nbsp;</TD>
    </TR>
    <TR> 
	    ...
	    <TD> 
			<INPUT name="reviseur" size="40" type="text" style="text-align : left;" value="<%=rev%>">                        
		</TD>
		<TD>&nbsp;</TD>
	</TR>
	<TR> 
		<TD><ct:FWLabel key="DATE_ET_HEURE"/></TD>
		<TD> 
