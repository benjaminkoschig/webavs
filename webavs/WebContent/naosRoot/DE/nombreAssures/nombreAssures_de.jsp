...
function del() {
	if (window.confirm("Sie sind dabei, eine Information zu löschen! Wollen Sie fortfahren?")) {
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR> 
							<TD nowrap width="125" height="31">Jahr</TD>
						...
						<TR> 
							<TD nowrap width="125" height="31">Anzahl Versicherte</TD>
						...
						<TR> 
							<TD nowrap width="125" height="31" colspan="2"><font size="2"><b>Versicherung</b></font></TD>
						</TR>
						<TR> 
							<TD nowrap width="125" height="31">Bezeichnung</TD>
						...
						<TR> 
							<TD nowrap width="125" >Versicherungsart</TD>
						...
						<TR> 
							<TD nowrap width="157" height="30">Versicherungstyp</TD>
						...
						<% } else { %>
						<TR> 
							<TD nowrap width="125">Versicherung auswählen</TD>
