...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	%>
	<TH width="30">&nbsp;</TH>
	<TH align="left" width="150">Kassenart</TH>
	<TH align="left" width="100">Kassen-Nr.</TH>
	<TH align="center" width="100">Beginndatum</TH>
	<TH align="center" width="100">Enddatum</TH>
	<TH align="left" width="200">Grund warum nicht unterstellt</TH>
	<%-- /tpl:put --%> 
...
<%@ include file="/theme/list/lineStyle.jspf" %>
	...
	<% 	
		...
		String libelleGenre = globaz.naos.translation.CodeSystem.getLibelle(session,viewBean.getGenreCaisse(i)).trim();
