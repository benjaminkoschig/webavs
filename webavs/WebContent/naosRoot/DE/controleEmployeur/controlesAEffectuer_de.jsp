...
top.document.title = "Naos - Ausdruck der Liste der Kontrolle zu ausführen"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste der Kontrolle zu ausführen ausdrucken<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<TR>
							<TD width="26%">Lohnsumme</TD>
							<TD>von CHF <INPUT type="text" name="masseSalDe" size="15" onchange="validateFloatNumber(this);" value="<%=viewBean.getMasseSalDe()%>" > bis CHF
						...
						<TR>
							<TD width="23%" height="2">Kontrollart</TD>
            				<TD height="2"> 
						...
						<TR>
							<TD width="26%">Mit zugeteilten Kontrollen ?</TD>
