...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
							<TBODY> 
								...
								<TR> 
									<TD nowrap width="121" height="35">Versicherung</TD>
								...
								<TR> 
									<TD nowrap width="121" height="31">Kanton</TD>
									<TD nowrap width="29"></TD>
									<TD nowrap colspan="3"> 
								...
								<TR> 
									<TD width="121" height="31">Geschlecht</TD>
									<TD width="29"></TD>
									<TD> 
								...
								<TR> 
									<TD nowrap width="121" height="31" >Beginndatum</TD>
							...
							<TABLE border="0" cellspacing="0" cellpadding="0" id="taux">
								<TBODY> 
								<TR> 
									<TD nowrap width="120" height="31">Arbeitgeber Beitragsatz</td>
									...
									<TD nowrap width="100" rowspan="2">Total Beitragsatz</td>
								...
								<TR> 
									<TD nowrap width="120" height="31">Arbeitnehmer Beitragsatz</TD>
									<TD nowrap width="30"></TD>
									<TD nowrap colspan="6"> 
							...
							<TABLE border="0" cellspacing="0" cellpadding="0" id="montant">
								<TBODY> 
								<TR> 
									<TD nowrap width="120" height="31">Betrag Arbeitgeber</TD>
									<TD nowrap width="30"></TD>
									<TD nowrap width="200"> 
									...
									<TD nowrap width="100" rowspan="2">Total Betrag</TD>
									<TD width="30" rowspan="2"></TD>
								...
								<TR> 
									<TD nowrap width="120" height="31">Arbeitnehmer Betrag</TD>
									<TD nowrap width="30"></TD>
									<TD nowrap width="200"> 
								...
								<TR> 
									...
									<TD nowrap width="100">Periodizität;</TD>
									<TD width="30"></TD>
									<TD nowrap width="173">
										<ct:FWCodeSelectTag 
								...
								<TR>
									<TD>
										<TABLE border="0" cellspacing="0" cellpadding="0">
											<TR> 
												<TD nowrap width="150" height="31">Typ</TD>
												<TD nowrap width="275">
													<ct:FWCodeSelectTag 
														name="typeId" 
									...
									<TD>
										<TABLE border="0" cellspacing="0" cellpadding="0" id="categorie">
											<TR>
												<TD nowrap width="130">Kategorie</TD>
												<TD nowrap>
													<ct:FWCodeSelectTag 
