...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	<TH width="30">&nbsp;</TH>
	<TH align="left" width="80">Art</TH>
	<TH width="80">Beginn</TH>
	<!--TH width="120">Fin</TH-->
	<TH align="center" width="80">Geschlecht</TH>
	<TH align="right" width="80">Wert</TH>
	<TH width="80">Reihe</TH>
	<TH width="80">Aufschnitt</TH>
	<TH width="80">Typ</TH>
	<TH width="80">Kategorie</TH>
	<%-- /tpl:put --%> 
