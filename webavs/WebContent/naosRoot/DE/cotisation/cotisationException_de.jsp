...
<%
	...
	String titre="Versicherungserfassung - Ausnahme ändern";
	if(request.getParameter("_method")!=null){
		if(request.getParameter("_method").equals("add")){
			titre="Versicherungserfassung - Ausnahme erstellen";	
		}
	}
%>
...
function del() {
	if (window.confirm("Sie sind dabei, die ausgewählte Ausnahme zu löschen! Wollen Sie fortfahren?")) {
							...
							<TD> 
								<TABLE border="0" cellspacing="0" cellpadding="0">
									...
									<TR> 
										...
										<TD width="32"></TD>										
										<TD nowrap width="125">Fakturierungsperiodizität</TD>
										<TD width="31"></TD>
