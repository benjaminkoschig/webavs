...
function add() {
	document.forms[0].elements('userAction').value="naos.fact.factAffilie.ajouter";
}
...
function validate() {
	...
	{
		message = message + "\nSie haben das Begindatum nicht eingegeben !";
		exit = false;
	}
	...
	document.forms[0].elements('userAction').value="naos.fact.factAffilie.modifier";
...
function cancel() {
	if (document.forms[0].elements('_method').value == "add")
 		document.forms[0].elements('userAction').value="back";
  		...
  		document.forms[0].elements('userAction').value="naos.fact.factAffilie.afficher";
}

function del() {
	if (window.confirm("?Sie sind dabei, das Detail der ausgewählten Fakturierung zu löschen! Wollen Sie fortfahren?"))
	{
		document.forms[0].elements('userAction').value="naos.fact.factAffilie.supprimer";
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
						<TD nowrap height="31" width="150">Miglied</TD>
						...
						<TR> 
							<TD nowrap width="111" height="31" >Alten Beitragsatz</TD>
							<TD nowrap width="30"></TD>
							<TD> 
						...
						<TR> 
							<TD nowrap width="111" height="31" >Neuen Beitragsatz</TD>
							<TD nowrap width="30"></TD>
							<TD> 
