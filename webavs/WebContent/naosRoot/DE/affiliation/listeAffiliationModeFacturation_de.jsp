...
top.document.title = "Web@AVS - Liste der Erfassungen mit Ihrem Fakturierungsmodus";
</SCRIPT>
...
<%-- tpl:put name="zoneTitle" --%>Liste der Erfassungen mit Ihrem Fakturierungsmodus<%-- /tpl:put --%>
