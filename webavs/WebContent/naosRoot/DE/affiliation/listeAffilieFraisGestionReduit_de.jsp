...
top.document.title = "Web@AHV - Liste der Arbeitgeber mit reduzierten Verwaltungskosten";
</SCRIPT>
...
<%-- tpl:put name="zoneTitle" --%>Liste der Arbeitgeber mit reduzierten Verwaltungskosten<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%>
		
		<TR>
        	<TD width="23%" height="2">Ansatz kleiner oder gleich</TD>
        	<TD height="2"> 
