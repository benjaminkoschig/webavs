...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Löschen der nicht unterstellten Fälle<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<TR>
							<TD>E-Mail Adresse:</TD>
							<TD><INPUT type="text" name="email" value="<%=viewBean.getEmail()%>"></TD>
							<TD width='500'>Prozess, welcher Fälle als "inaktiv" definiert, die bei der Kassenerfassung nicht der Beitragspflicht unterstellt werden müssten, bei denen das Beginndatum kleiner oder gleich dem angegebenen Datum auf dem soeben geöffneten Programmfenster ist.</TD>
						</TR>
						<TR>
							<TD>Bis :</TD>
