...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
				Ausdruck einer vorgedruckten Quittung
			<%-- /tpl:put --%>
...
<TR>
	<TD>Quittungen zum zurückschicken, Anzahl</TD>
...
<TR> 
            <TD height="50%" width="212">Versand der Quittungen durch</TD>
            <TD width="50%"> 
