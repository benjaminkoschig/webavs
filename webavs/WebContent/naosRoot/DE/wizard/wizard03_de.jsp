...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					Erstellung des Erfassungsplans - 03
					<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TBODY> 
							...
							<TR>
								<TD nowrap width="161">Periode</TD>
								<TD nowrap > 
								...
								<TD nowrap width="161">Erfassungsart</TD>
								<TD nowrap>
						...
						<TBODY>
							...
							<TR>
								...
								<TD nowrap width="310"><B>Bezeichnung des Plans</B></TD>
								<TD width="25"></TD>
								<TD nowrap width="310"><B>Bezeichnung der Rechnung</B> (Separate Rechnung nach unterschiedlichem Bezeichnung)</TD>
								<% if(sizePlanAff==1) { %>
									<TD nowrap width="80" align="center"></TD>
								<% } else { %>
									<TD nowrap width="80" align="center"><B>Löschen</B></TD>
								<% } %>
							</TR>
							<% 
							...
							<%
								if (i == 0) {
							%>
								<TD nowrap width="150" rowSpan="<%=sizePlanAff%>" valign="baseline"><B>Erfassungspläne</B></TD>
							<% } %>	
							...
							<% } // end for %>	
							<TR><TD></TD><TD height="50"><INPUT class="btnCtrl" id="btnAddPlan" type="button" value="Plan hinzufügen" onclick="addPlanAffiliation();"></TD></TR>						
						</TBODY> 
						</TABLE>
						</DIV>
					</TD>
