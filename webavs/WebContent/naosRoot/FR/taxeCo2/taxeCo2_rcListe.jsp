...
<%@page import="globaz.jade.client.util.JadeStringUtil"%><th width="20">&nbsp;</th>
      <th width="40%" align="left">Numéro Affilié</th>
      <th width="5%">Année Masse</th>
      <th width="5%">Année Redi.</th>
      <th width="10%">Masse</th>
      <th width="25%">Motif de fin</th>
      <th width="5%">Taux forcé</th>
      <th width="*">Etat</th>
