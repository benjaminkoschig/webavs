...
%>
top.document.title = "Affiliation - Détail taxe CO2"
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Affiliation - Détail taxe CO2<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
			...
			<tr><td colspan="2">
				<TABLE border="0" cellspacing="0" cellpadding="0" id="tPartie1">
					...
					<TR><TD>&nbsp;</TD></TR>
					<TR> 
						<TD nowrap width="128">Motif de fin</TD>
			       ...
			       <TR><TD>&nbsp;</TD></TR>
					<TR>
						<TD nowrap width="128">Taux Forcé</TD>
            			<TD nowrap> 
					...
					<TR><TD>&nbsp;</TD></TR>
					<TR>
						<TD nowrap width="128">Numéro de passage</TD>
            			<TD nowrap> 
