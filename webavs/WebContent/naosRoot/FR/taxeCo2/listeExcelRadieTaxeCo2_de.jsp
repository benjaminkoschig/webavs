...
<%@page import="globaz.naos.db.taxeCo2.AFListeExcelRadieTaxeCo2ViewBean"%>
...
<%
	...
	AFListeExcelRadieTaxeCo2ViewBean viewBean = (AFListeExcelRadieTaxeCo2ViewBean) session.getAttribute ("viewBean");

	//Définition de l'action pour le bouton valider
	userActionValue = "naos.taxeCo2.listeExcelRadieTaxeCo2.executer";
	String pageName = "listeExcelRadieTaxeCo2";
%>

<SCRIPT language="JavaScript">
top.document.title = "Naos - Imprimer liste excel des radiés (Taxe CO2)"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Imprimer liste excel des radiés (Taxe CO2)<%-- /tpl:put --%>
