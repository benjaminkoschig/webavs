...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	<%
		...
		float montPersPeriode 	= 0;
		float montPersAnnuel = 0;
		String triGenre = "";
	%>
	<%@page import="globaz.jade.client.util.JadeStringUtil"%>
<TH width="30">&nbsp;</TH>
	<TH nowrap width="200" align="left">Assurance</TH>
	<TH width="70" align="center">Caisse</TH>
	<TH width="70" align="center">D&eacute;but</TH>
	<TH width="70" align="center">Fin</TH>
	<TH width="100" align="left">P&eacute;riodicit&eacute;</TH>
	<TH width="150" align="center">Montant période</TH>
	<TH width="150" align="center">Montant annuel</TH>
	<TH width="150" align="left" nowrap>Motif de fin</TH>
...
<%@ include file="/theme/list/lineStyle.jspf" %>
	...
	<TD class="mtd" width="150" style="align:right" onClick="<%=actionDetail%>" align="right" ><FONT color="<%=fontColor%>">
		<%=globaz.globall.util.JANumberFormatter.fmt(globaz.globall.util.JANumberFormatter.deQuote(viewBean.getMontantPeriodicite(i)),true,true,true,2)%>
		<%=globaz.globall.util.JANumberFormatter.fmt(globaz.globall.util.JANumberFormatter.deQuote(viewBean.getMassePeriodicite(i)),true,true,true,2)%></FONT></TD>
	<TD class="mtd" width="150" onClick="<%=actionDetail%>" align="right"><FONT color="<%=fontColor%>">
		...
		<% if (viewBean.getMotifFin(i).equals(CodeSystem.MOTIF_FIN_EXCEPTION)) {%>
			<%=("0")%>
		<% 	} else { %>
			<%=	JANumberFormatter.fmt(JANumberFormatter.deQuote(viewBean.getMasseAnnuelle(i)),true,true,true,2)%>
			<%}%>
			</FONT></TD>
...
<%@ include file="/theme/list/lineEnd.jspf" %>
	...
	<TR class="<%=rowStyle%>"
		...
		<TD class="mtd" align="left" colspan="6"><b>Total des cotisations personnelles actives</b></TD>
