...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					Wizard - Saisie de Suivi de Caisse - 01b
					<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TBODY> 
							...
							<TR> 
								...
								<TD nowrap  width="133">Motif de cr&eacute;ation</TD>
								<TD nowrap width="210">
							...
							<TR> 
								<TD nowrap height="31"  width="161">P&eacute;riode</TD>
								<TD nowrap > 
								...
								<TD nowrap width="133">Motif de fin</TD>
								<TD nowrap width="210">
