...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR> 
							...
							<TR>	
								<TD width="110" height="31">P&eacute;riode :</TD>	
						...
						<TR>
							...
							<TBODY>
								<TR>	
									<TD nowrap height="24">&nbsp;<b>Assurance</b></TD>
									<TD nowrap align="left"><b>Masse salariale</b></TD>
									<TD nowrap align="left"><b>Périodicité masse saisie</b></TD>
									<TD nowrap align="left"><b>Périodicité cotisation</b></TD>
									<TD nowrap align="left"><B>Valable dès le</B><TD>
								</TR> 
								<% 
								...
								<TR> 	
									...
									<TD nowrap rowspan="2">
										...
										<INPUT type="radio" name="periodiciteNouvelleMasse<%=i%>" 
											value="<%=globaz.naos.translation.CodeSystem.PERIODICITE_ANNUELLE%>" checked onclick="reportPer(1,<%=i%>, 0)">
											Annuelle
											<br/>
										<INPUT type="radio" name="periodiciteNouvelleMasse<%=i%>" 
											value="<%=globaz.naos.translation.CodeSystem.PERIODICITE_TRIMESTRIELLE%>" onclick="reportPer(4,<%=i%>, 1)">
											Trimestrielle  
											<br/>
										<INPUT type="radio" name="periodiciteNouvelleMasse<%=i%>" 
											value="<%=globaz.naos.translation.CodeSystem.PERIODICITE_MENSUELLE%>" onclick="reportPer(12,<%=i%>, 2)">
											Mensuelle
									</TD>
									<TD nowrap> 
								...
								<TR>
									<TD nowrap align="right"><b>Nouveau:</b></TD>
									<TD nowrap> 
