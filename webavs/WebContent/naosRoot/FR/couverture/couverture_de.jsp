...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer une couverture ! Voulez-vous continuer?")) {
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR> 
							<TD nowrap width="176" height="31">Date D&eacute;but</TD>
						...
						<TR> 
							<TD nowrap width="176" height="31">Date Fin</TD>
							<TD width="30" height="31"></TD>
							<TD nowrap width="310"> 
						...
						<TR> 
							<TD nowrap height="31" colspan="3"> 
								<font size="2"><b>Assurance</b></font>
							</TD>
						</TR>
						<TR> 
							<TD nowrap width="176">Libell&eacute;</TD>
							<TD width="30" height="31"></TD>
							<TD nowrap width="310"> 
						...
						<TR> 
							<TD nowrap width="176" height="31">Libell&eacute; court</TD>
							<TD width="30" height="31"></TD>
						...
						<TR> 
							<TD nowrap width="176" height="30">Rubrique comptable</TD>
							<TD width="30" height="31"></TD>
							<TD width="310"> 
						...
						<TR> 
							<TD nowrap width="176">Genre d'assurance</TD>
							<TD width="30" height="31"></TD>
							<TD nowrap height="31" width="310" > 
						...
						<TR> 
							<TD nowrap width="176" height="30">Type d'assurance</TD>
							<TD width="30" height="31"></TD>
							<TD nowrap height="31" width="310"> 
						...
						<% } else {%>
						<TR> 
							<TD nowrap width="176">S&eacute;lectionner une Assurance</TD>
							<TD width="30" height="31"></TD>
							<% 
								String tmpValue;
