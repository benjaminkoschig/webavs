...
function del() {
    if (window.confirm("Vous êtes sur le point de supprimer le plan d'assurance sélectionné! Voulez-vous continuer?")){
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					D&eacute;tail du plan d'assurance
					<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
          				<TR> 
            				<TD width="101">Nom du plan d'assurance 
