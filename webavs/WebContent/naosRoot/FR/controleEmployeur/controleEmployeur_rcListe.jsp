...
<TH width="30">&nbsp;</TH>
	<TH nowrap width="200">Affili&eacute;</TH>
	<TH width="150">Genre de contr&ocirc;le</TH>
	<TH width="100">Date effective</TH>
	<TH width="100">Date pr&eacute;vue</TH>
	<TH width="100">D&eacute;but p&eacute;riode de contr&ocirc;le</TH>
	<TH width="100">Fin p&eacute;riode de contr&ocirc;le</TH>
	<TH width="70">Contr&ocirc;leur</TH>
	<TH width="70">N° Rapport</TH>
	<%-- /tpl:put --%> 
