...
<%@ include file="/theme/find/bodyStart2.jspf" %>
						...
						<TR>
							<TD nowrap width="140" height="31">Num&eacute;ro d'affili&eacute;<input type="hidden" name="idAFF" value="<%=idAff%>"/></TD>
							<TD nowrap width="220">
							...
							<TD nowrap width="140" height="31">Année</TD>
							<TD nowrap width="220"> 
								<INPUT name="forAnnee" type="text" size="10">
							</TD>
							<TD nowrap width="140" height="31">N° Rapport</TD>
							<TD nowrap width="220"> 
