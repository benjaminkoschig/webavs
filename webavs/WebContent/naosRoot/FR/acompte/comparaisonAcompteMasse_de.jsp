...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste de comparaison entre les acomptes et la masse facturée.<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
                    	...
                    	<TR> 
			            	<TD>Différence tolérée en CHF</TD>
			            	<td>
