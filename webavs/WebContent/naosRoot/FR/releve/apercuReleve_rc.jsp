...
<%@ include file="/theme/find/bodyStart.jspf" %>
				...
				Gestion des Relev&eacute;s<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<TR>
							<TD nowrap width="140" height="31">Num&eacute;ro d'affili&eacute;</TD>
							<TD nowrap width="225">
						...
						<TR>
							<TD nowrap width="140" height="31">Date d&eacute;but relev&eacute;</TD>
							<TD nowrap width="220">
								<ct:FWCalendarTag name="forDateDebut" 
									displayType ="month" value="" />mois.ann&eacute;e
								<!--ct:FWCalendarTag name="forDateDebut" value="" /-->
								<!--script language="Javascript" >
									document.getElementById("dateDebut").style.width=135;
								</script-->
							</TD>
							<TD nowrap width="110">Collaborateur</TD>
							<TD nowrap width="160">
								<input name="forCollaborateur">
							</TD>
						</TR>
						<TR>
							<TD nowrap width="140" height="31">Num&eacute;ro de facture</TD>
							<TD nowrap width="220">
								<input name="forIdExterneFacture">
							</TD>
							<TD nowrap width="110">Journal de facturation</TD>
							<TD nowrap width="160">
								<input name="forJob">
							</TD>
						</TR>
