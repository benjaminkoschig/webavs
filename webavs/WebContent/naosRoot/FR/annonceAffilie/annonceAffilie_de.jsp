...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer l'annonce d'affilie sélectionné! Voulez-vous continuer?"))
	{
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					D&eacute;tail de la pr&eacute;paration &agrave; l'annonce d'affili&eacute;
					<%-- /tpl:put --%>
