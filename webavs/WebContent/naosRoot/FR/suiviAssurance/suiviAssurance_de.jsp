...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					Suivi d'une assurance - D&eacute;tail
					<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR> 
							<TD width="125" height="31">Statut du suivi</TD>
							...
							<TD width="30"></TD>
							<TD  width="117">Date effective</TD>
							<TD width="30"></TD>
							<TD  width="200">
						...
						<TR> 
							<TD nowrap width="125" height="30">Date pr&eacute;vue</TD>
							<TD width="30"></TD>
							<TD nowrap width="200">
								<ct:FWCalendarTag name="datePrevue" value="<%=viewBean.getDatePrevue()%>" /> 
							</TD>
							<TD width="30"></TD>
							<TD nowrap height="31" width="117">Date de fin </TD>
							<TD width="30"></TD>
							<TD nowrap width="200">
