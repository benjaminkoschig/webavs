...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>
					Liste des affiliations non provisoires sans cotisation
					<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>		
							<TD> Envoyer la liste &agrave;: 
								<input type="text" name="eMailAddress" class='libelleLong' data-g-string="mandatory:true" value="<%=viewBean.getSession().getUserEMail()%>" >
							</TD>
						</TR>
						<TR>
							<TD>&nbsp;</TD>
