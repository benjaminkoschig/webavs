...
<%
// Les labels de cette page commence par la préfix "JSP_PC_PRE_R"
...
<SCRIPT language="javascript">
	bFind = true;
	usrAction = "pegasus.lot.prestation.lister";
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_PC_PRE_R_TITRE"/><%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<TR>
							<TD><ct:FWLabel key="JSP_PC_PRE_R_LOT"/></TD>
							<TD colspan="3">
						...
						<TR>
							<TD><ct:FWLabel key="JSP_PC_PRE_R_ETAT"/></TD>
							<TD>
							...
							<TD><ct:FWLabel key="JSP_PC_PRE_R_TYPE"/></TD>
							<TD>
						...
						<TR><TD>&nbsp;</TD></TR>
						<TR>
							<TD><LABEL for="likeNumeroAVS"><ct:FWLabel key="JSP_PC_PRE_R_NSS"/></LABEL>&nbsp;</TD>
							<TD>
							...
							<TD><LABEL for="forCsSexe"><ct:FWLabel key="JSP_PC_PRE_R_SEXE"/></LABEL>&nbsp;</TD>
							<TD colspan="3"><ct:FWCodeSelectTag name="prestationSearch.forSexe" codeType="PYSEXE" defaut="" wantBlank="true"/></TD>	
						</TR>
						<TR>
							<TD><LABEL for="likeNom"><ct:FWLabel key="JSP_PC_PRE_R_NOM"/></LABEL>&nbsp;</TD>
							<TD><INPUT type="text" name="prestationSearch.likeNom" value=""></TD>
							<TD><LABEL for="likePrenom"><ct:FWLabel key="JSP_PC_PRE_R_PRENOM"/></LABEL>&nbsp;</TD>
							<TD><INPUT type="text" name="prestationSearch.likePrenom" value=""></TD>
							<TD><LABEL for="forDateNaissance"><ct:FWLabel key="JSP_PC_PRE_R_DATENAISSANCE"/></LABEL>&nbsp;</TD>
