...
<%@page import="globaz.pegasus.vb.annonce.PCGenererAnnonceLapramsViewBean"%>
...
<%
	...
	PCGenererAnnonceLapramsViewBean viewBean = (PCGenererAnnonceLapramsViewBean)session.getAttribute("viewBean");
...
var userAction = "<%=IPCActions.ACTION_ANNONCE_LAPRAMS_GENERER %>.executer";
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_ANNONCE_COMMUNICATION_LAPRAMS_D_TITRE"/> <%-- /tpl:put --%>
