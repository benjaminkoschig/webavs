...
<%@page import="globaz.pegasus.vb.fortuneparticuliere.PCVehiculeViewBean"%>
<%@page import="ch.globaz.pegasus.business.models.fortuneparticuliere.SimpleVehicule"%>
...
<%
	...
	PCVehiculeViewBean viewBean = (PCVehiculeViewBean) session.getAttribute("viewBean");
...
<script language="JavaScript">
	...
	var ACTION_AJAX_DONNEE_FINANCIERE="<%=IPCActions.ACTION_DROIT_VEHICULE_AJAX%>";	
</script>

<script type="text/javascript" src="<%=servletContext%><%=(mainServletPath+"Root")%>/scripts/droit/Vehicule_MembrePart.js"/></script>
<script type="text/javascript" src="<%=servletContext%><%=(mainServletPath+"Root")%>/scripts/droit/Vehicule_de.js"/></script>
						...
						<div class="conteneurMembres">
								...
								<table class="areaDFDataTable">
									<thead>
										<tr>
											...
											<th><ct:FWLabel key="JSP_PC_VEHICULE_L_TYPE_PROPRIETE"/></th>
											<th><ct:FWLabel key="JSP_PC_VEHICULE_L_PART"/></th>
											<th><ct:FWLabel key="JSP_PC_VEHICULE_L_MONTANT"/></th>
											<th><ct:FWLabel key="JSP_PC_VEHICULE_L_DESIGNATION"/></th>
											<th data-g-cellformatter="css:formatCellIcon"><ct:FWLabel key="JSP_PC_VEHICULE_L_DESSAISISSEMENT_FORTUNE"/></th>
											<th data-g-periodformatter=" " data-g-deallaterperiod=" "><ct:FWLabel key="JSP_PC_VEHICULE_L_PERIODE"/></th>
										</tr>
									</thead>
									<tbody>
							<%
									...
									for(Iterator itDonnee=viewBean.getDonnees(membreFamille.getId()).iterator();itDonnee.hasNext();){
										...
										SimpleVehicule donnee=(SimpleVehicule)donneeComplexe.getDonneeFinanciere();
							...
							%>
								...
								<div class="areaDFDetail">
									<table>
										<tr>
											<td><ct:FWLabel key="JSP_PC_VEHICULE_D_TYPE_PROPRIETE"/></td>
