...
<div class="bigContainer">
	<div class="headContainer">
		...
		<span class="menuHeader" id="optionsButton" onclick="selectOptions();" onMouseOver="changeOver(this)" onMouseOut="changeOut(this)"><ct:FWLabel key="OPTION_PRINCIPAL"/></span>
	</div>
	<div class="bodyContainer">
		<div class="singleMenu" style="height:250;" id="menu"><ct:FWMenuTag displayId="menu"/></div>
		<div class="singleMenu" style="height:250;" id="options"><ct:FWMenuTag displayId="options" /></div>
	</div>
</div>
