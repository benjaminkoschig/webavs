...
top.document.title = "ARC - ARC en envoi";
/*
function init(){}
*/
</script>
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>ARC en envoi<%-- /tpl:put --%>
							...
							<TD>
								<DIV align="left">
									...
									%>
											...
											<%if(request.getParameter("forIdLot")!=null){%>
												&nbsp;n° Lot&nbsp;<input align="right" size="<%=request.getParameter("forIdLot").length()+1%>" type="text" name="forIdLot" value="<%=(request.getParameter("forIdLot")==null?"":request.getParameter("forIdLot"))%>" class="disabled" readonly>
											<%}%>
									<%} else { %>
