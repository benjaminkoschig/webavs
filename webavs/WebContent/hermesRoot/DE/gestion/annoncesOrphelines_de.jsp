...
top.document.title = "MZR - Detail der unzugeordnete MZ";
</SCRIPT>
<%
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail einer unzugeordnete MZR<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
					<TR>
						<TD colspan="1">Grund der MZR :&nbsp;</TD>
					...
					<tr>
						...
						<TD><A href="<%=detailLink%>" target="fr_main">Detail der empfangene MZR</A></TD>
					</tr>
					<TR>
						<TD>Datum :&nbsp;</TD>
