...
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <tr> 
            <td>Liste der empfangene MZR ausdrucken, für die man einen VA erwartet</td>
            <td> 
          ...
          <% if(!isDateNSS) {%>
           <tr> 
            <td>Briefe für die Mitglieder ausdrucken</td>
            <td> 
          ...
          <%} %>
          <tr> 
            <td>Vollständige IK-Auszüge ausdrucken</td>
            <td> 
