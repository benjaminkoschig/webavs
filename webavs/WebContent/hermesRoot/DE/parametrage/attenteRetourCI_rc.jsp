...
top.document.title = "MZR - Detail der empfangene IK-Auszug";
bFind = true;
// redéfinition de la méthode onClickNew()
function onClickNew() {
	if(window.confirm("Möchten Sie diesen IK-Auzug wirklich lösen ?")){
...
<%@ include file="/theme/find/bodyStart2.jspf" %>
  ...
  <tr> 
    ...
    <td width="16%">&nbsp;</td>
            <td width="11%" nowrap>IK führende AK :&nbsp;</td>
    <td width="52%"> 
