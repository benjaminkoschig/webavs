...
<SCRIPT language="JavaScript">
	top.document.title = "MZR - Detail der empfangene MZR";
</SCRIPT>
<%-- /tpl:put --%>
...
function del() {
	...
	if(document.forms[0].elements('statut').value=='true'){
		alert('Unmöglich eine bereits gesendete MZR zu löschen !');
	} else {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail der empfangene MZR<%-- /tpl:put --%>
