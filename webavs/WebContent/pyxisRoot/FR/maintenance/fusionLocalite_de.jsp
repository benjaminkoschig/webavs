<%-- tpl:insert page="/theme/process.jtpl" --%><%@page import="com.sun.star.lib.connections.socket.socketAcceptor"%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Localité - Fusion<%-- /tpl:put  --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
		      ...
		      <% if (objSession.hasRight("pyxis", globaz.framework.secure.FWSecureConstants.ADD)|| objSession.hasRight("pyxis", globaz.framework.secure.FWSecureConstants.UPDATE)){%>
							...
							<td>E-Mail</td><td><input  name="eMailAddress" value="<%=eMailAddress!=null?eMailAddress:""%>"></td>		
 			...
 			<tr>
          		...
          		<td>
          		<% if (objSession.hasRight("pyxis", globaz.framework.secure.FWSecureConstants.ADD)|| objSession.hasRight("al", globaz.framework.secure.FWSecureConstants.UPDATE)){%>
