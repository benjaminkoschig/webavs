...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><span style="font-family:wingdings;font-weight:normal">*</span> - Adresse de paiement<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
		...
		<tr>
			<td colspan="2"><hr><b>Bénéficiaire : </b></td>
		</tr>
		<tr>
			<td>
				<select name="cr1" id="cr1" onchange="cr1Changed()">
					<option value="crLocalite">Localité</option>
					<option value="crNpa">NPA</option>
					<option value="crPays">Pays</option>
					<option value="crNomPrenom">Nom,Prénom</option>
					<option value="crDestinataire">Destinataire</option>
					<option value="crAvs" selected >NSS</option>
					<option value="crAffilie">N° Affilié</option>
			...
			<td>
				...
				<select name="cr2" id="cr2" onchange="cr2Changed()">
					<option value="crLocalite" selected>Localité</option>
					<option value="crNpa">NPA</option>
					<option value="crPays">Pays</option>
					<option value="crNomPrenom">Nom,Prénom</option>
					<option value="crDestinataire">Destinataire</option>
		...
		<tr>
			<td colspan="2"><hr><b>Administration  : </b></td>
		</tr>
		<tr>
			<td colspan="2">
					
					Genre <ct:FWCodeSelectTag name="forGenreAdministration"
			         	  defaut=""
						  codeType="PYGENREADM"
						  wantBlank="true"/>
				
					Canton <ct:FWCodeSelectTag name="forCantonAdministration"
							defaut=""
							codeType="PYCANTON"
							wantBlank="true"
							/>
