...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liens entre tiers - Détail<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 
		<tr>
			<TD nowrap width="128"><A href='<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=request.getParameter("idTiers")%>'>Tiers</A></TD>
...
<%if (!"".equals(viewBean.getIdTiersEnfant())) {%>
			<TD nowrap width="128"><A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=viewBean.getIdTiersEnfant()%>">Tiers en relation</A></TD>

<%} else {%>

			<td>Tiers en relation</TD>
<%}%>
		...
		<TD align="left" width="100%">
			...
			<script>
				document.getElementById("tiersSelector").value="Tiers ...";
				document.getElementById("adminSelector").value="Administration ...";
				document.getElementById("banqueSelector").value="Banque ...";
			</script>
