...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Moyen de communication<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 
		<TR>
			<TD nowrap width="250">Type de moyen de communication</TD>
			<TD nowrap width="250">
		...
		<TR>
			<TD nowrap width="250">Valeur</TD>
			<TD nowrap width="250">
				<INPUT width="220" maxlength="100" size="50" type="text" name="moyen" value="<%=viewBean.getMoyen()%>">
			</TD>
			<TD width="*">(e.g. numéro de teléphone, adresse e-mail...)</TD>

		</TR>
		<TR>
			<TD nowrap width="250">Domaine d'application</TD>
			<TD nowrap width="250">
