...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><span style="font-family:webdings;font-weight:normal">€</span> - Tiers, recherche<%-- /tpl:put  --%>
						...
						<tr>
							...
							<tr>
								<td style="border-top:solid 1px gray"  colspan = 6>
									...
									<input type="checkbox" name="CforUseFilters" CHECKED onclick="checkInput(this)" <%=(!JadeStringUtil.isEmpty((String)session.getAttribute("filtreActif")) && session.getAttribute("filtreActif").equals("true"))?"disabled='disabled'":""%>>Utiliser les filtres&nbsp;|&nbsp;
