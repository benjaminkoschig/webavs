...
<div class="bigContainer">
	<div class="headContainer">
		<span class="menuHeader" id="menuButton" onclick="selectMenu();" onMouseOver="changeOver(this)" onMouseOut="changeOut(this)">Menü</span>
		<span class="menuHeader" id="optionsButton" onclick="selectOptions();" onMouseOver="changeOver(this)" onMouseOut="changeOut(this)">Optionen</span>
	</div>
	<div class="bodyContainer">
		<div class="singleMenu" style="height=420" id="menu"><ct:FWMenuTag displayId="menu"/></div>
		<div class="singleMenu" style="height=420" id="options"><ct:FWMenuTag displayId="options" /></div>
	</div>
</div>
<div class="smallContainer" id="apps"> 
	<div class="smallbodyContainer"> 
		<div class="singleMenu" style="height=200" id="applications"></div> 
	</div> 
</div>
</BODY>
</html>