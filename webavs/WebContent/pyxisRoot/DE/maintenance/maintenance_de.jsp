...
top.document.title = "Tiers - Wartung"
	...
	<TBODY>
		<TR>
			<TH colspan="3" height="10" class="title">
				<DIV style="width: 100%">
					<SPAN class="idEcran"><%=(null==idEcran)?"":idEcran%></SPAN>Wartung</DIV>
			</TH>
		</TR>
		<TR>
		...
		<tr id="message_confirmation" style="display:none">
			<td colspan="3" style="height: 2em; color: white; font-weight: bold; text-align: center;background-color: green">Die Datei wird geladen, bitte warten Sie</td>
		</tr>
		<TR>
