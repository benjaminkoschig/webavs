...
<SCRIPT language="JavaScript">
top.document.title = "Tiers - Land Détail"
function add() {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Land - Detail
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR>
           ...
           <TR>
            <TD nowrap width="140">ISO Code</TD>
	   ...
	   <TR>
            <TD nowrap width="140">ZAS Code</TD>
	   ...
	   <TR>
            <TD nowrap width="140">Währung</TD>
            <TD nowrap>
	   ...
	   <TR>
           ...
           <TR>
            <TD nowrap width="140">Telefonvorwahl</TD>
   	  ...
   	  <TR>
            <TD nowrap width="140">Telefon Formatcode</TD>
