...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><span style="font-family:webdings;font-weight:normal">€</span> - Partner, Suche<%-- /tpl:put  --%>
						...
						<tr>
							...
							<table   >
								...
								<ct1:nssPopup prefixePays="<%=globaz.pyxis.application.TIApplication.pyxisApp().getNSSPrefixe()%>"  avsMinNbrDigit="99" nssMinNbrDigit="99" newnss="<%=ean13%>" name="forNumAvs"/>
									...
									<TD align="right">Abr.-Nr. </TD>
									<TD><INPUT name="forNumAffilie"></TD>
									<TD align="right">UID-Nr. </TD>
								...
								<TD align="right">Rolle [Alt+<%=("FR".equals(languePage))?"R":"S"%>]</TD>
								<TD ><%
								...
								<TD align="right">Mitglieder aktiv am</TD>
							...
							<tr>
								<td style="border-top:solid 1px gray"  colspan = 6>
									<input type="checkbox" name="CforSingleAdresseMode"  CHECKED onclick="checkInput(this)">Nur Wohnsitz&nbsp;|&nbsp;
									<input type="checkbox" name="CforIncludeInactif" onclick="checkInput(this)">Inaktive Partner einschliessen&nbsp;|&nbsp;
									<input type="checkbox" name="CforInclurePersonnesDecedees" CHECKED onclick="checkInput(this)">Verstorbenen Personen einschliessen&nbsp;|&nbsp;
									<input type="checkbox" name="CforUseFilters" CHECKED onclick="checkInput(this)" <%=(!JadeStringUtil.isEmpty((String)session.getAttribute("filtreActif")) && session.getAttribute("filtreActif").equals("true"))?"disabled='disabled'":""%>>Filter benutzen&nbsp;|&nbsp;
									<input type="checkbox" name="CforPersonneMorale"  onclick="checkInput(this)">Nur juristische Personen&nbsp;|&nbsp;
									<input type="checkbox" name="CforHistoriqueNom" onclick="checkInput(this)">Namen-Verlauf einschliessen
							...
							<!--
							<tr>
								<TD align="right">Adressen aktiv am </TD>
								<TD><ct:FWCalendarTag name="forDateEntreDebutEtFin" value=""/></TD>
							
								<TD align="right">Typ [Alt+T]</TD>
								<TD>
