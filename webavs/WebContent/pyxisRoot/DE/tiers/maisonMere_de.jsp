...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Definition des Hauptsitzes/Filiale - Detail<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 
          <TR>
            <TD nowrap width="117">Ausgewählter Partner</TD>
            <TD nowrap width="274" > 
              <INPUT type="text" name="nom" tabindex="-1" value="<%=viewBean.getNom(viewBean.getIdTiersParent())%>" readonly class="libelleLongDisabled">
	     </TD>
             <TD width="55"></TD>
	        <TD nowrap width="43" align="right">Mitglied</TD>
            <TD nowrap colspan="2">
	...
	<TR>
            <TD nowrap width="117">Ist Hauptsitz</TD>
            <TD nowrap colspan="3">
		<input type="checkbox" name="maisonMere" <%=(viewBean.isMaisonMere().booleanValue())? "checked" : "unchecked"%>>
	      <I>(Kasten anwenden, wenn der ausgewählter Partner Hauptsitz ist)</I></TD>
            <TD width="134"></TD>
	...
	<TR>
            <TD nowrap colspan="2">Auswahl Hauptsitz oder Filiale</TD>
            <TD width="55"></TD>
            <TD nowrap width="43"></TD>
            <TD nowrap width="134"></TD>
          </TR>
...
<TEXTAREA name="descriptionAffilie" rows="5" cols="25" class="inputDisabled" disabled readonly><%=viewBean.getDescriptionTiers(viewBean.getIdSelection())%></TEXTAREA></TD>
	...
	<TR>
            <TD nowrap width="117">Filiale seit</TD>
	  ...
	  /> &nbsp;bis&nbsp; <ct:FWCalendarTag name="finRelation" 
