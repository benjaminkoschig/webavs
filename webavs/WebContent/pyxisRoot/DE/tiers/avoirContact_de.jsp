...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Kontakte eines Partners - Detail<%-- /tpl:put  --%>
...
<%if ("add".equals(request.getParameter("_method"))) {%>
	...
	<%}%>
     <tr>
            <TD ><span style="font-family:webdings;font-size:12 pt">€</span><A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=viewBean.getIdTiers()%>">Partner</A></TD>
