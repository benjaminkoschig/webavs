...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Suche einer Verwaltung<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
          ...
          <TR>
            ...
            <td nowrap align="right">&nbsp;&nbsp;Sortieren nach : <select name="orderBy"><option value="code">Code</option><option value="name">Bezeichnung</option></select></td>
          ...
          <TR>
            <TD nowrap  align="right">Kanton&nbsp;</TD>
           <TD><ct:FWCodeSelectTag name="forCantonAdministration"
            ...
            <TD nowrap width="64"  align="right" >Art&nbsp;</TD>
		...
		<td nowrap align="right">Inaktive umfassen
