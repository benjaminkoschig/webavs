...
top.document.title = "Tiers - Indirizzo paiement Détail"
function add() {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><span style="font-family:wingdings;font-weight:normal">*</span> - Dettaglio di un indirizzo di pagamento<%-- /tpl:put  --%>
