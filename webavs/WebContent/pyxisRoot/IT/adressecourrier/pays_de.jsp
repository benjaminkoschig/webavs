...
<SCRIPT language="JavaScript">
top.document.title = "Tiers - Paese Détail"
function add() {
...
function del() {
	if (window.confirm("Errore durante l'aggiornamento /soppressione dei dati"))
	{
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Paese - dettaglio
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
	   ...
	   <TR>
            <TD nowrap width="140">Codice centrale</TD>
	   ...
	   <TR>
           ...
           <TR>
            <TD nowrap width="140">Indicativo telefonico</TD>
	   ...
	   <TR>
            <TD nowrap width="140">Codice formato NAP</TD>
            <TD nowrap>
