...
<TABLE width="100%" border="0" cellspacing="0">
  ...
  <TR align="center" >
    ...
    <%
	globaz.pyxis.db.adressecourrier.TIAdresseListViewBean viewBean = (globaz.pyxis.db.adressecourrier.TIAdresseListViewBean )request.getAttribute ("viewBean");
	size = viewBean.getSize ();
	%>
        
    <Th nowrap width="30%">Destinatario</Th>
     <Th width="30%">Via o località</Th>
...
<%-- tpl:put name="zoneList"  --%>
      <TD class="mtd" width="30%" align="left"><%=viewBean.getNom(i)%>&nbsp;</TD>
      <TD class="mtd" width="30%" align="left"><%=viewBean.getRue(i)%>&nbsp;</TD>
    <TD class="mtd" width="30%" align="left"><%=viewBean.getLocalite(i)%>&nbsp;</TD>
    <TD class="mtd" width="10%" align="center"><%=viewBean.getDateFinAdresse(i)%>&nbsp;</TD>
