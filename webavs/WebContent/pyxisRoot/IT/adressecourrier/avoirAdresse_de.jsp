...
top.document.title = "Tiers - Indirizzo suite détail"
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%><span style="font-family:wingdings;font-weight:normal">+</span><span style="font-family:webdings;font-weight:normal">€</span> - Allegare un indirizzo di corrispondenza
<%-- /tpl:put --%>
...
<table >
	...
	<%}%>
     ...
     <tr>
       <TD colspan=2>
		...
		<A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&selectedId=<%=viewBean.getIdTiers()%>">Terzo</A>
	<br>
	...
	<tr>
            <TD nowrap colspan=2><span style="font-family:wingdings;font-size:12 pt">+</span> Indirizzo<br>
	...
	<tr>
	        <td colspan=2><br><span style="font-family:wingdings;font-size:12 pt">1</span>Dominio<br>
	...
	<tr>
	        <td colspan=2><br>Tipo<br><ct:FWCodeSelectTag 
				name="typeAdresse" 
...
<table cellpadding=0 cellspacing=0 width="100%">
			<tr>
				...
				<td>
					<ct:ifhasright crud="r" element="pyxis.tiers.tiers">
						<input name="navLink" class="navLinkTiers"  value="2 Terzo" accesskey="2" type="button" 
