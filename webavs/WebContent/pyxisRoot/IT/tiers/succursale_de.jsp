...
top.document.title = "Tiers - Succursale Détail"
function add() {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Succursale - dettaglio<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 

	 <TR>
            <TD nowrap width="132">Succursale</TD>
 ...
 <!--           <INPUT type="button" value="..." onclick="_act.value='pyxis.tiers.succursale.afficher';userAction.value='pyxis.tiers.gestion.chercher';submit()"></TD> -->
	...
	<TR>
            <TD nowrap width="132">Succursale a partire dal</TD>
