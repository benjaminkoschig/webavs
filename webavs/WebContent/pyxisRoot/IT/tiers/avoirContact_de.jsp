...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Contatti di un terzo - Dettaglio<%-- /tpl:put  --%>
...
<%if ("add".equals(request.getParameter("_method"))) {%>
	...
	<%}%>
     <tr>
            <TD ><span style="font-family:webdings;font-size:12 pt">€</span><A href="<%=request.getContextPath()%>\pyxis?userAction=pyxis.tiers.tiers.diriger&idTiers=<%=viewBean.getIdTiers()%>">Terzi</A></TD>
			...
			<tr>
				...
				<td>
					<ct:ifhasright crud="r" element="pyxis.adressecourrier.avoirAdresse">
						<input name="navLink" class="navLinkTiers"  value="3 Indirizzo della corrispondenza" accesskey="3" type="button"
