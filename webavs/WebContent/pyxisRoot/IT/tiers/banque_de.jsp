...
top.document.title = "Tiers - Banca Détail"
...
function checkModification() {
	...
	cspNom.setMotifElement("motifModifDesignation1");
    	...
    	cspNom.setLibelle("Scegliete il motivo della modifica del campo 'Banca' e la data di entrata in vigore");
	...
	cspDesi2.setMotifElement("motifModifDesignation2");
    	...
    	cspDesi2.setLibelle("Scegliete il motivo della modifica del campo 'Banca seguito' e la data di entrata in vigore");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Banca - Dettaglio<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 

          
          <TR>
            <TD width="119">N° di clearing</TD>
	...
	<tr>
            <TD width="119"><span style="font-family:wingdings;font-size:12 pt">+</span>Indirizzo principale della corrispondenza</TD>
            <TD width="211">
