...
function checkModification() {
    ...
    cspAvs.setLibelle("Scegliete il motivo della modifica del NSS e la data di entrata in vigore");
	...
	cspContribuable.setMotifElement("motifModifContribuable");
    	...
    	cspContribuable.setLibelle("Scegliete il motivo della modifica del n° di contribuente e la data di entrata in vigore");
	...
	cspTitre .setMotifElement("motifModifTitre");
    	...
    	cspTitre .setLibelle("Scegliete il motivo della modifica del titolo e la data di entrata in vigore");
	...
	cspNom.setMotifElement("motifModifDesignation1");
    	...
    	cspNom.setLibelle("Scegliete il motivo della modifica del cognome e la data di entrata in vigore");
	...
	cspDesi2.setMotifElement("motifModifDesignation2");
    	...
    	cspDesi2.setLibelle("Scegliete il motivo della modifica del nome e la data di entrata in vigore");
	...
	cspDesi3.setMotifElement("motifModifDesignation3");
    	...
    	cspDesi3.setLibelle("Scegliete il motivo della modifica del cognome (seguito 1) e la data di entrata in vigore");
	...
	cspDesi4.setMotifElement("motifModifDesignation4");
    	...
    	cspDesi4.setLibelle("Scegliete il motivo della modifica del cognome (seguito 2) e la data di entrata in vigore");
    ...
    if (result) {
    	...
    	cspNationalite.setLibelle("Scegliete il motivo della modifica della nazionalità e la data di entrata in vigore");
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			...
			<%} %>
			<span style="font-family:webdings;font-weight:normal">€</span> - Dettaglio di un terzo <%=viewBean.getDecorations()%><%-- /tpl:put  --%>
