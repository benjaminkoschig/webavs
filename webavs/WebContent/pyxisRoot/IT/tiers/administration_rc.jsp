...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Ricerca di un amministrazione<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 
         
   
          <TR>
            <TD nowrap  align="right">Designazione&nbsp;</TD>
            <TD nowrap colspan="2"> 
            ...
            <td nowrap align="right">&nbsp;&nbsp;Trier par : <select name="orderBy"><option value="code">Code</option><option value="name">Designazione</option></select></td>
          ...
          <TR>
            <TD nowrap  align="right">Cantone&nbsp;</TD>
           <TD><ct:FWCodeSelectTag name="forCantonAdministration"
            ...
            <TD nowrap width="64"  align="right" >Genere&nbsp;</TD>
		...
		<td nowrap align="right">Includere i 'senza attività'
