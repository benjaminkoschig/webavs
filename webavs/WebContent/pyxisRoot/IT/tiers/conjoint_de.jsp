...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Congiunto - dettaglio<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
					...
					<tr>
						<td colspan=2 >
							...
							<ct:FWPanelContainerTag style="height:200">
								<ct:FWPanelTag value="Selezione" defaultTab="yes">
									<table> 
										<col width="80">
										<TR>
								...
								<ct:FWPanelTag value="Creazione" >
									<table>
										...
										<TR>
											<TD nowrap width="120">Data di nascita</TD>
											<td>
					...
					<TR>
						<TD align="right" >Congiunto dal  &nbsp;</TD>
						<TD width="*" >
					...
					<tr>
						<td nowrap>Mettere lo stato civile delle due persone a &nbsp;</td>
