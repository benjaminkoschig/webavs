...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Legami tra terzi<%-- /tpl:put  --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%>

		<TR>
	    	<td nowrap>
	    		<input name="navLink" class="navLinkTiers"  value="Terzi" accesskey="2" type="button" style="cursor:hand;border : 0 0 0 0;color:blue;text-decoration:underline;background : #B3C4DB;margin : 0 0 0 0;padding : 0 0 0 0;font-weight:normal;font-size: 8pt"
