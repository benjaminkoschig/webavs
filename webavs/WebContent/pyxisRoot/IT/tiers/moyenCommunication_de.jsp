...
function del() {
	if (window.confirm("Siete in fase di sopprimere tutti i mezzi di comunicazione ! Volete continuare?"))
	{
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Mezzo di comunicazione<%-- /tpl:put  --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain"  --%> 
		<TR>
			<TD nowrap width="250">Tipo di mezzo di comunicazione</TD>
			<TD nowrap width="250">
		...
		<TR>
			<TD nowrap width="250">Valore</TD>
			<TD nowrap width="250">
				<INPUT width="220" maxlength="100" size="50" type="text" name="moyen" value="<%=viewBean.getMoyen()%>">
			</TD>
			<TD width="*">(e.g. numero di telefono, indirizzo e-mail...)</TD>

		</TR>
		<TR>
			<TD nowrap width="250">Dominio dell'applicazione</TD>
			<TD nowrap width="250">
