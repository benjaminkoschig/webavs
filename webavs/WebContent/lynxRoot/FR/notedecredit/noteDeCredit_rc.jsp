...
top.document.title = "Recherche des notes de crédit " + top.location.href;
// stop hiding -->
</SCRIPT>
...
<%-- tpl:put name="zoneTitle" --%>Recherche des notes de cr&eacute;dit <%-- /tpl:put --%>
...
<table cellspacing="0" cellpadding="0" style="height: 100px; width: 100%">
	<tbody>
			...
			<TR>
                   	<TD>Date note de cr&eacute;dit</TD>
                   	<TD>
