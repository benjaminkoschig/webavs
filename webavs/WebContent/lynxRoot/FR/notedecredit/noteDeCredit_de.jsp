...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer la note de crédit sélectionnée! Voulez-vous continuer?")) {
...
D&eacute;tail d'une note de cr&eacute;dit
<%-- /tpl:put --%>
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
	<TBODY>
		...
		<TR>
			<TD>N° de note de credit interne</TD>
			<%
			...
			<TD>&nbsp;</TD>
			<TD>N° de note de credit fournisseur</TD>
			<TD><INPUT type="text" onKeyPress="fillCell(this);"
