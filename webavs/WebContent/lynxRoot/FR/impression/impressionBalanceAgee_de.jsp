...
Imprimer la balance agée <%-- /tpl:put --%>
...
<%-- tpl:put name="zoneMain" --%> 
	...
	<TR>
       	<TD>Fournisseur(s)</TD>
       	<TD>De <input type="text" name="fournisseurBorneInf" size="30" maxlength="40" tabindex="1"/> à <input type="text" name="fournisseurBorneSup" size="30" maxlength="40" tabindex="1"/></TD>
       	<TD colspan="3">&nbsp;</TD>
	</TR>
	<TR>
       	<TD>Numéro Fournisseur(s) </TD>
       	<TD>De <input type="text" name="fournisseurIdBorneInf" size="30" maxlength="40" tabindex="1"/> à <input type="text" name="fournisseurIdBorneSup" size="30" maxlength="40" tabindex="1"/></TD>
       	<TD colspan="3">&nbsp;</TD>
	</TR>
	<TR>
		<TD>Catégorie fournisseur</TD>
	...
	<TR> 
		<TD>Echéance</TD>
		<TD>de <input type="text" name="echeanceUne" size="5" maxlength="40" value="0" style="text-align:right" class="libelleDisabled"/> à <input type="text" name="echeanceDeux" size="5" maxlength="40" value="30" style="text-align:right" class="libelle" tabindex="1"/> à <input type="text" name="echeanceTrois" size="5" maxlength="40" value="60" style="text-align:right" class="libelle" tabindex="1"/> à <input type="text" name="echeanceQuatre" size="5" maxlength="40" value="90" style="text-align:right" class="libelle" tabindex="1"/></TD>	
		<TD colspan="3">&nbsp;</TD>
 	</TR>	
 	<TR>
