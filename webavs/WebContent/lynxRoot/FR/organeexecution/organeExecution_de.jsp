...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer l'organe d'exécution sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Détail de l'organe d'exécution - " + top.location.href;
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>D&eacute;tail de l'organe d'ex&eacute;cution<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<TR> 
         ...
         <TR>
            <TD>Domaine de l'adresse de paiement</TD>
            <TD colspan="2">
