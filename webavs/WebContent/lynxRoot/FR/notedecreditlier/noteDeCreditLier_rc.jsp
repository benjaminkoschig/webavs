...
top.document.title = "Recherche des notes de crédit liées" + top.location.href;
// stop hiding -->
</SCRIPT>
...
Recherche des notes de cr&eacute;dit li&eacute;es
<%-- /tpl:put --%>
...
<TR> 
	...
	<TD>&nbsp;</TD>
	<TD width="128">Montant restant</TD>
	<TD>	
