...
function onCanevasFailure(event) {
	...
	if(event.keyCode != 8 && event.keyCode != 46) {
		alert(" Der Kanevas existiert nicht.");
	}
}
...
top.document.title = "Auswahl eines Kanevasses - " + top.location.href;
</SCRIPT>

<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
<%-- tpl:put name="zoneTitle" --%>Auswahl eines Kanevasses<%-- /tpl:put --%>
