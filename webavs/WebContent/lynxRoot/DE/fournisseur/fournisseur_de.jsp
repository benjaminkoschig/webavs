...
function del() {
	if (window.confirm("Sie sind dabei, der ausgewählte Lieferant zu löschen! Wollen Sie fortfahren?")) {
...
top.document.title = "Detail der Lieferant - " + top.location.href;
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail der Lieferant<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
        ...
        <TR>
            <TD>Adresse</TD>
            <TD colspan="2">Zahlungsadresse</TD>
        </TR>
        <TR>
            <TD>
		...
		<TR>
            <TD title="numéro d'identification des entreprises (UID)">MWST Steuernummer-Nr. / UID</TD>
            <TD colspan="2" title="numéro d'identification des entreprises (UID)">
