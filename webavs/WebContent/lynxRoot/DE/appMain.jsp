...
<HEAD>
<TITLE>Web@AHV - Kreditorenbuchhaltung</TITLE>
...
location.replace("<%=request.getContextPath()%>/lynx?userAction=lynx.journal.journal.chercher");
</SCRIPT>
</HEAD>
...
<table width="100%" height="100%" border="0">  
  <tr valign="bottom">
    <td height="10%" align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">(C) 
      2002 Globaz SA - Kreditorenbuchhaltung</font></td>
  </tr>
</table>
</body>
</HTML>