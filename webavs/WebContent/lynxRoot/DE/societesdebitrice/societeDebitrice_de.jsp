...
function del() {
	if (window.confirm("Sie sind dabei, die ausgewählte Schuldnerfirma zu löschen! Wollen Sie fortfahren?")) {
...
top.document.title = "Detail der Schuldnerfirma - " + top.location.href;
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail der Schuldnerfirma<%-- /tpl:put --%>
