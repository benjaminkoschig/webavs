...
<%
	idEcran="GLX0032";
	LXOrdreGroupeImprimerViewBean viewBean = (LXOrdreGroupeImprimerViewBean) session.getAttribute ("viewBean");
	userActionValue = "lynx.ordregroupe.ordreGroupeImprimer.executer";
...
Sammelauftrag ausdrucken <%-- /tpl:put --%>
