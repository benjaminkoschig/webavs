...
function del() {
	if (window.confirm("Sie sind dabei, die ausgewählte Stornierung zu löschen! Wollen Sie fortfahren?")) {
...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
	<TBODY>
		...
		<TR>
			<TD>Interne Rechnungsnummer &nbsp; (<A href="<%=request.getContextPath()%>/lynx?userAction=<%=actionAfficherOperationSrc%>&idOperation=<%=viewBean.getIdOperationSrc()%>" class="link">Verknüpfte Operation</A>)</TD>
			...
			<TD>&nbsp;</TD>
			<TD>Lieferant Rechnungsnummer</TD>
