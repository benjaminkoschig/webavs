...
<tr>
	<td  height="65" width="250">
		...
		<input type="text" name="idExterneFournisseur"  value="<%=tmpIdExterneFournisseur%>" className="libelle"/>&nbsp;&nbsp;&nbsp;</BR>
...
<tr>
	<td>
		...
		<legend><%= viewBean.getSession().getLabel("INCLUDE_PAIEMENT") %></legend>
			&nbsp;</BR>
			<%= viewBean.getSession().getLabel("INCLUDE_MONTANT") %> : &nbsp;<input type="text" onKeyPress="fillCell(this);" id="montant" name="montant" value="<%=showValue?viewBean.getMontantFormatted():""%>" tabindex="1" style="width: 180px;text-align:right;height:22px" onChange="validateFloatNumber(this);updateMontant();updateSum();"/>
			<%
