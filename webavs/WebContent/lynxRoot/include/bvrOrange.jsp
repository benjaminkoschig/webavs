...
<table border="0" cellspacing="4" class="bvrOrange">
...
<tr>
	<td valign="top">&nbsp;
		...
		%>
		<br/><br/><textarea name="nomBanque" style="width:230px;height:65px" class="libelleBvrOrangeDisabled" readonly="readonly"><%=showValue?viewBean.getNomBanque():""%></textarea>
	<script language="JavaScript">
	...
	<td colspan="2"><textarea name="libelleSociete" style="width:330px;height:100px" class="libelleBvrOrangeDisabled" readonly="readonly"><%=viewBean.getSociete().getAdresse()%></textarea></td>	
</tr>	
<tr>
