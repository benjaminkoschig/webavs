<table border="0" cellspacing="4" class="lsv">
<tr>
...
<tr>
	...
	<td colspan="2">
		<fieldset class="fieldSetVirement" style="height:155px;">
			...
			&nbsp;</BR>
			<textarea name="libelleSociete" style="width:320px;height:100px" class="libelleLsvDisabled" readonly="readonly"><%=viewBean.getSociete().getAdresse()%></textarea>&nbsp;&nbsp;&nbsp;</br>
		</fieldset>
	</td>	
</tr>	
</table>
