<table border="0" cellspacing="4" class="canevasBvrRouge">

<tr>
	<td height="26" colspan="3">&nbsp;</td>
</tr>  		
<tr>
	<td  height="65" width="250"><textarea name="adressePaiementFournisseur" style="width:240px;height:65px" class="libelleBvrRougeDisabled" readonly="readonly"><%=showValue?viewBean.getAdressePaiementFournisseur():""%></textarea></td>
...
<tr>
	...
	<td colspan="2">
		<textarea name="libelleSociete" style="width:330px;height:100px" class="libelleBvrRougeDisabled" readonly="readonly"><%=viewBean.getSocieteAdresse()%></textarea><BR/>
