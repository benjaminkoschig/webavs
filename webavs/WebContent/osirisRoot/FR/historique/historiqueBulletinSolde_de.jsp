...
top.document.title = "Détail historique d'un bulletin de soldes - " + top.location.href;
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail historique d'un bulletin de soldes<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
	       <TR>
            <TD nowrap width="125">Date d'exécution</TD>
            <TD width="30">&nbsp;</TD>
            <TD nowrap>
