...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer le role sélectionné! Voulez-vous continuer?")) {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un retour<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <%if(!viewBean.isRetourModifiable()){%>
			...
			<TR>
				<TD colspan="4"><b>Compensations sur factures existantes</b></TD>
			</TR>
				...
				<TD colspan="4">
					<table width="100%">
						<TR>
							<TD>Ecritures</TD>
						  	<TD>
								<ct:FWListSelectTag data="<%=viewBean.getSectionsLibres()%>" defaut="<%=JadeStringUtil.toNotNullString(viewBean.getIdSectionLigneRetourSurSection())%>" name="idSectionLigneRetourSurSection"/>
						  	</TD>
							<TD>Montant à compenser</TD>
							<TD>
							...
							<TD>
								<INPUT type="button" name="ajouterLigneRetourSurSection" value="Ajouter" onclick="addLigneRetourSurSection();">
							</TD>
						</TR>
					</table>
				</TD>
			...
			<TR>
				<TD colspan="4"><b>Paiements sur adresse de paiement</b></TD>
			</TR>
				...
				<TD colspan="4">
					<table width="100%">
						<TR>
							...
							<TD>
								<INPUT type="button" name="ajouterLigneRetourSurAdressePaiement" value="Ajouter" onclick="addLigneRetourSurAdressePaiement();">
							</TD>
						</TR>
					</table>
				</TD>
...
<%@ include file="/theme/detail/bodyButtons.jspf" %>
				...
				<%if(viewBean.isRetourAnnulable()){%>
					<ct:ifhasright element="osiris.process.annulerRetours.afficher" crud="u">
						<INPUT type="button" value="Annuler retour" onclick="annulerRetour();"/>
					</ct:ifhasright>
				<%}%>
				<%-- /tpl:put --%>
