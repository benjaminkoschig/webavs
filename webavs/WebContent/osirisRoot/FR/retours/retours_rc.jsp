...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Retours<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
		  <%if(!JadeStringUtil.isIntegerEmpty(idLot)){ %>				
		  <TR>
		  	 <TD width="160">No lot</TD>
		  	 <TD>
		  	 ...
		  	 <TD width="160">Montant total du lot</TD>
		  	 <TD>
          ...
          <TR>
            ...
            <TD>
              ...
              <%}else{ %>
              <ct:FWListSelectTag name="forCsEtatRetour" data="<%=viewBean.getEtatRetourData()%>" defaut="<%=viewBean.getForCsEtatRetour()%>"/>
              <%}%>
            </TD>
            <TD width="160">Motif</TD>
            <TD>
            <%if(wasVbNull){ %>
		  ...
		  <TR>
            <TD width="160">Date des retours</TD>
            <TD>
            <%if(wasVbNull){ %>
            ...
            <%}%>
           	...
           	<TD nowrap width="160">Libellé</TD>
		  	<TD>
