...
top.document.title = "Contentieux - Aperçu - Contentieux - " + top.location.href;
...
<%@ include file="/theme/find/bodyStart2.jspf" %>
          ...
          <TR>
            <TD width="128" rowspan="2" valign="top">Compte</TD>
            <TD rowspan="2">
          ...
          <TR>
            <TD width="128" valign="top">Section</TD>
            <TD>
