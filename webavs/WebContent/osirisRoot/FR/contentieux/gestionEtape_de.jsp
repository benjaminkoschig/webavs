...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer le paramètre d'étape  sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Contentieux - détail d'un paramètre d'étape - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un paramètre d'étape <%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
          <TR> 
            <td nowrap width="118">S&eacute;quence</td>
            <td width="17">&nbsp;</td>
            <td width="616"> 
          ...
          <TR> 
            <td nowrap width="118">N&deg; ordre</td>
            <td width="17">&nbsp;</td>
            <td width="616"> 
          ...
          <TR> 
            <td nowrap width="118" height="36">Delai</td>
          ...
          <TR> 
            <td nowrap width="118" height="36">Imputer taxe</td>
            <td width="17" height="36">&nbsp;</td>
            <td nowrap width="616" height="36"> 
          ...
          <TR> 
            <td nowrap width="118" height="36">Nom classe impl.</td>
            <td width="17" height="36">&nbsp;</td>
            <td nowrap width="616" height="36"> 
          ...
          <TR> 
            <td nowrap width="118" height="36">Date r&eacute;ference</td>
            <td width="17" height="36">&nbsp;</td>
            <td nowrap width="616" height="36"> 
          ...
          <TR> 
            <td nowrap width="118" height="36">Montant limite</td>
            <td width="17" height="36">&nbsp;</td>
            <td nowrap width="616" height="36"> 
