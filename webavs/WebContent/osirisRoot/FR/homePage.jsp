...
String fullContext = context + "osirisRoot/" + globaz.framework.controller.FWDefaultServletAction.getIdLangueIso(session) + "/";
String logoSrc = fullContext + "appLogo.jsp";
String labelSrc = fullContext + "appLabel.jsp";
String iconSrc = context + globaz.framework.controller.FWDefaultServletAction.getIdLangueIso(session) + "/appIcons.jsp?servlet=osiris";
