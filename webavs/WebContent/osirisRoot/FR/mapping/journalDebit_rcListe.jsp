...
<%-- tpl:put name="zoneHeaders" --%>
    <th nowrap colspan="2" width="10%">Num&eacute;ro</th>
    <th nowrap width="10%">Mandat</th>
    <th nowrap width="20%">Compte courant src</th>
    <th nowrap width="20%">Contre partie src</th>
    <th nowrap width="20%">Compte courant dest</th>
    <th nowrap width="20%">Contre partie dest</th>
<%-- /tpl:put --%>
