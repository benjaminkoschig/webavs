...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer l'ordre de recouvrement sélectionné! Voulez-vous continuer?")) {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Saisir un ordre de recouvrement<%-- /tpl:put --%>
...
<!--              <input type="hidden" name="btnSection" value="..." onClick="jsRechercheSectionEcran()" >-->
          ...
          <TR>
            <TD nowrap width="129">Montant</TD>
          ...
          <TR>
            <TD nowrap width="129">Adresse de recouvrement</TD>
            <TD width="5"></TD>
            <TD width="147">
            ...
            <TD width="7">&nbsp;</TD>
            <TD width="100">Motif du recouvrement</TD>
            <TD colspan="5">
          ...
          <TR>
            <TD nowrap width="129">Nature du recouvrement</TD>
            <TD width="5"></TD>
            <TD width="147">
            ...
            <TD width="20">&nbsp; </TD>
            <TD width="7">&nbsp;</TD>
            <TD width="100">R&eacute;f&eacute;rence</TD>
            <TD colspan="5">
          ...
          <TR>
            <TD nowrap width="129">Bloquer le recouvrement</TD>
            <TD width="5"></TD>
            <TD width="147">
