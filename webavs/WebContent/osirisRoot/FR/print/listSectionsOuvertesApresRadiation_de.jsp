...
%>
top.document.title = "Liste - Liste des sections ouvertes après radiation - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste des sections ouvertes après radiation<%-- /tpl:put --%>
...
%>         
          ...
          <tr> 
            <td nowrap width="128">S&eacute;quence</td>
            <td nowrap width="576"> 
