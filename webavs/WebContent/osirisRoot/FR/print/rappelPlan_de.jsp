...
top.document.title = "Génération des rappels de sursis au paiement - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Impression du rappel de sursis au paiement<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<tr>
			<td class="label">Imprimer </td>
			<td class="control"><input type="checkbox" name="withEcheancier" id="echeancier" value="on"><label for="echeancier">avec l'échéancier</label></td>
		</tr>
        <%-- /tpl:put --%>
