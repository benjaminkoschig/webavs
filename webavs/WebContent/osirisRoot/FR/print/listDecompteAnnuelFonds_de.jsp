...
%>
top.document.title = "Décompte annuel au fond - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Décompte annuel autre tâche<%-- /tpl:put --%>
          ...
          <tr> 
            ...
            <td> 
              <input type="text" name="eMailAddress" value="<%=viewBean.getEMailAddress()%>" class="libelleLong">
				...
				<tr>
					<td>Période </td>
					<td>du <ct:FWCalendarTag name="dateDebutPeriode" value="" /> <span style="margin-left:10px">au</span> <ct:FWCalendarTag name="dateFinPeriode" value="" /></td>
				</tr>						    	        	
				<tr>
