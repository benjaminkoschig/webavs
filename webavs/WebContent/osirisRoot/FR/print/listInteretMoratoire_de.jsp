...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste des décisions d'intérêts<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						    ...
						    <tr>
						      <td style="width: 200px;">Genre d'int&eacute;r&ecirc;t</td>
			...
			%>
						    ...
						    <tr>
						      <td>No. de journal de calcul</td>
						      <td><input name="idJournalCalcul" value="" /></td>
						    </tr>
						    <tr>
						      <td>No. de journal de facturation</td>
						      <td><input name="idJournalFacturation" value="" disabled="disabled" /></td>
						    </tr>
						    <tr>
						      <td>Date du calcul </td>
						      <td>du <ct:FWCalendarTag name="dateCalculDebut" value="" /> <span style="margin-left:10px">au</span> <ct:FWCalendarTag name="dateCalculFin" value="" /></td>
						    </tr>
						    <tr>
						      <td>Suspens</td>
