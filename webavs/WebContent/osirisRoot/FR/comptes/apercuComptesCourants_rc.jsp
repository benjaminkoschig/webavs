...
top.document.title = "Comptes - Aperçu des comptes courants - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Aper&ccedil;u des comptes courants<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
          <%  join += "&idCompteAnnexe=" + viewBean.getIdCompteAnnexe(); %>
				<input type="hidden" name="id" value="<%=requestId%>"/>
            <TR>
              <TD width="10%" valign="top">Compte</TD>
              <TD valign="top" rowspan="3">
                <TEXTAREA cols="40" rows="3" class="libelleLongDisabled" readonly><%=viewBean.getTitulaireEntete()%></TEXTAREA>
              </TD>
              <TD width="80%" align="right" valign="top">S&eacute;lection des comptes
                <SELECT name="forSelectionCompte" class="libelleCourt">
                  <option value="1000" selected>tous</option>
