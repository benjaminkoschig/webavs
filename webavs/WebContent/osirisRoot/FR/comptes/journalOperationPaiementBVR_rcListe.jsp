...
size = viewBean.size();
detailLink ="osiris?userAction=osiris.comptes.journalOperationPaiementBVR.afficher&selectedId=";
%>
...
<%@ include file="/theme/list/lineStyle.jspf" %>
    ...
    %>
<!--    <TD width="10" valign="top"><a href="<%=request.getContextPath()%>/osiris?userAction=osiris.comptes.journalOperationPaiementBVR.afficher&id=<%=_ecriture.getIdOperation()%>" target="fr_main"><img src="<%=request.getContextPath()%>/images/loupe.gif" border="0"></a></TD>-->
