...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Saisir une &eacute;criture<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR>
            <TD nowrap width="129">Ann&eacute;e de cotisation</TD>
            <TD width="1">&nbsp;</TD>
            <TD width="147">
          ...
          <TR>
            <TD nowrap width="129">Masse &amp; taux</TD>
            <TD width="1">&nbsp;</TD>
            <TD colspan="3">
              ...
              <%if(viewBean.getUnsynchronizeSigneMasse().booleanValue()){%>Signe inversé!<%}%>
            </TD>
            <TD width="300">
		...
		class="montant">
          ...
          <TR>
            <TD nowrap width="129">Quittancer</TD>
            <TD width="1">&nbsp;</TD>
            <TD colspan="9">
