...
top.document.title = "Comptes - détail d'un paiement - " + top.location.href;
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Saisir un paiement<%-- /tpl:put --%>
...
%>
          ...
          <TR>
            <TD>N&deg; de pi&egrave;ce comptable</TD>
          	<TD colspan="4">
