...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Recherche des comptes annexes<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
          <TR>
            <TD nowrap width="70">N&deg; ou nom</TD>
            <TD nowrap width="200">
            ...
            <TD width="300" align="left" ><div id="msgPonctuation" style='display:none'><font color='#000000'><strong>Saisie de la ponctuation obligatoire</strong></font></div></TD>
            <TD nowrap width="179">&nbsp; </TD>
            <TD nowrap colspan="2"> S&eacute;lection des comptes
