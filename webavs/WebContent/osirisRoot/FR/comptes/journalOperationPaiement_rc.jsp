...
CAPaiementViewBean element = (CAPaiementViewBean) session.getAttribute (globaz.osiris.servlet.action.CADefaultServletAction.VB_ELEMENT);
...
usrAction = "<%=globaz.osiris.application.CAApplication.DEFAULT_OSIRIS_NAME %>.comptes.journalOperationPaiement.lister";
bFind = true;
...
top.document.title = "Comptes - Recherche des paiements du journal - " + top.location.href;
</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>
        <div align="left">Recherche des paiements du journal</div>
        <%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
          ...
          <TR>
            ...
            <TD width="8"></TD>
            <TD nowrap width="107">
              <input type="text" class="dateDisabled" value="<%=element.getJournal().getDate()%>" readonly name="dateJournal">
            </TD>
            <TD nowrap width="8">
              <input type="hidden" name="forIdTypeOperation" value="<%=CAOperation.CAPAIEMENT%>" readonly >
            </TD>
            <TD>&nbsp;</TD>
            <TD width="4"></TD>
            <TD width="272">&nbsp; </TD>
          ...
          <TR>
			...
			String redirectUrl = "/osirisRoot/FR/comptes/journalOperationPaiement_rc.jsp";
			%>
			<ct:FWSelectorTag
