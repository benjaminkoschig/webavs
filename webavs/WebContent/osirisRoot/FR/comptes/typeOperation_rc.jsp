...
%>
<script>
	top.document.title = "Comptes - Recherche des types d'opérations - " + top.location.href;
</script>
<%-- /tpl:put --%>
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Recherche des types d'opérations<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
          <TR>
            <TD width="126">Type</TD>
            <TD nowrap colspan="2">
