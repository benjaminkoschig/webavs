...
top.document.title = "Comptes - Recherche des paiements étrangers du journal - " + top.location.href;
</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>
        <div align="left">Recherche des paiements étrangers du journal</div>
        <%-- /tpl:put --%>
          ...
          <tr>
            ...
            <td height="18" colspan="5">
              <select name="forSelectionTri" style="width : 4cm;">
                ...
                <option value="1000">Ordre saisie</option>
