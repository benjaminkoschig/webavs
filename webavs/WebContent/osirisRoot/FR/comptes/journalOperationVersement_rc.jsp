...
CAVersementViewBean element = (CAVersementViewBean) session.getAttribute (globaz.osiris.servlet.action.CADefaultServletAction.VB_ELEMENT);
bButtonNew = false;
...
usrAction = "<%=globaz.osiris.application.CAApplication.DEFAULT_OSIRIS_NAME %>.comptes.journalOperationVersement.lister";
bFind = true;
...
top.document.title = "Comptes - Recherche des versements du journal - " + top.location.href;
</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>
        <div align="left">Recherche des versements du journal</div>
        <%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
          ...
          <TR>
            ...
            <TD nowrap width="8">
              <input type="hidden" name="forIdTypeOperation" value="<%=CAOperation.CAVERSEMENT%>" readonly >
            </TD>
            <TD>&nbsp;</TD>
            <TD width="4"></TD>
            <TD width="272">&nbsp; </TD>
          ...
          <TR>
			...
			String redirectUrl = "/osirisRoot/FR/comptes/journalOperationVersement_rc.jsp";
			%>
			<ct:FWSelectorTag
