...
top.document.title = "Transfert de soldes - " + top.location.href;
// stop hiding -->
</SCRIPT>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Transfert de soldes<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
					...
					<tr>
					<td colspan="2">Transférer vers :</td>
					</tr>

					<tr>
						<td nowrap width="200">Débiteur</td>
						<td nowrap class="gText">
					...
					<tr>
						<td nowrap width="200">Section (optionnel)</td>
						<td nowrap class="gText">
            		...
            		<tr>
						<td nowrap width="200">Montant à transférer</td>
						<td nowrap class="gText">
							<%
