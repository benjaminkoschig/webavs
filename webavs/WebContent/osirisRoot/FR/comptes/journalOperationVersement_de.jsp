...
function del() {
	if (window.confirm("Vous êtes sur le point de supprimer le versement sélectionné! Voulez-vous continuer?")) {
...
top.document.title = "Comptes - Détail d'un versement - " + top.location.href;
// stop hiding -->
</SCRIPT>
	<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Détail d'un versement<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
		...
		<TR>
          ...
          <TR>
            <TD width="129">Ordre de versement associ&eacute;</TD>
            <TD width="1">&nbsp;</TD>
            <TD nowrap colspan="4">
          ...
          <tr>
            ...
            <td colspan="3" align="right">Journal CG&nbsp;
