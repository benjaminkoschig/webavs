...
<%
CAOperationOrdreVersementViewBean element = (CAOperationOrdreVersementViewBean) session.getAttribute (globaz.osiris.servlet.action.CADefaultServletAction.VB_ELEMENT);
globaz.osiris.db.comptes.CAOperationOrdreVersementManagerListViewBean viewBean = (globaz.osiris.db.comptes.CAOperationOrdreVersementManagerListViewBean) session.getAttribute (globaz.osiris.servlet.action.CADefaultServletAction.VBL_ELEMENT);
...
usrAction = "<%=globaz.osiris.application.CAApplication.DEFAULT_OSIRIS_NAME %>.comptes.journalOperationOrdreVersement.lister";
bFind = true;
...
top.document.title = "Comptes - Recherche des ordres de versement du journal - " + top.location.href;

</script>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>
        <div align="left">Recherche des ordres de versement du journal</div>
        <%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
          ...
          <TR>
            ...
            <TD nowrap width="8">
              <input type="hidden" name="forIdTypeOperation" value="<%=CAOperation.CAOPERATIONORDREVERSEMENT%>" readonly >
            </TD>
            <TD>&nbsp;</TD>
            <TD width="4"></TD>
            <TD width="272">&nbsp; </TD>
          ...
          <TR>
			...
			String redirectUrl = ((String)request.getAttribute("mainServletPath")+"Root")+"/"+globaz.framework.controller.FWDefaultServletAction.getIdLangueIso(session)+"/comptes/journalOperationOrdreVersement_rc.jsp";
			%>
			<ct:FWSelectorTag
