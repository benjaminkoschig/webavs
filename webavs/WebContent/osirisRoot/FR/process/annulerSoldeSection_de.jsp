...
top.document.title = "Process - Annuler le solde des sections - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Annuler le solde des sections<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <TR> 
            <TD nowrap width="30%" height="14">Montant minimum</TD>
            <TD nowrap width="50%" height="14">               
          ...
          <TR> 
            <TD nowrap width="30%" height="14">Type de section</TD>
            <TD nowrap width="50%" height="14">               
			...
			%>			          
          <TR>
           <TD nowrap width="30%" height="14">Rubrique</TD> 
          ...
          <TR> 
		<TR>
			<TD nowrap width="30%" height="14">Comptes Annexes actifs</TD>
            <TD colspan="2">
		...
		<TR>
			<TD nowrap width="30%" height="14">Comptes Annexes radiés</TD>
            <TD colspan="2">
		...
		<TR>
			<TD nowrap width="30%" height="14">Rôles</TD>
            <TD colspan="2">
