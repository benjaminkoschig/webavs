...
top.document.title = "Process - Préparer l'ordre groupé - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Préparer l'ordre groupé<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <tr>
            <td nowrap width="128">ordre group&eacute;</td>
            <td nowrap width="576">
