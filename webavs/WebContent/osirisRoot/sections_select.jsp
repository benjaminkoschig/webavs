...
<%
    ...
    String options = globaz.osiris.parser.CAAutoComplete.getSections(objSession, request.getParameter("like"), request.getParameter("tempIdExterneRole"), request.getParameter("tempIdRole"));
%>	
<body>
<form>
