...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Erstellung einer Zahlungsvereinbarung - Phase 2 - Suche der Sektionen für die Zahlungsvereinbarung<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						<!--selectedId=1&idExterneRole=100.008&description=Jeanmaire Vivien-->
							<tr>
								<td><h5>Bitte wählen Sie eine oder mehrere Sektionen aus :</h5></td>
								<td></td>
								<td></td>
								<td></td>
							</tr>
