...
<%
globaz.osiris.db.process.CARouvrirJournalViewBean viewBean = (globaz.osiris.db.process.CARouvrirJournalViewBean) session.getAttribute(globaz.osiris.servlet.action.CADefaultServletAction.VB_ELEMENT);
userActionValue = "osiris.process.rouvrirJournal.executer";
...
top.document.title = "Prozess - Journal wieder eröffnen - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Journal wieder eröffnen<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <TR> 
            <TD nowrap width="30%">Beschreibung</TD>
            <TD nowrap width="50%"> 
