...
top.document.title = "Prozess - Vorauszahlungen ausführen - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Vorauszahlungen ausführen<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <TR> 
            <TD align="left" width="180" height="21" valign="middle">Motiv</TD>
            <TD align="left"> 
          ...
          <TR> 
            <TD align="left" width="180" height="21" valign="middle">Ablauf</TD>
            <TD align="left"> 
				<SELECT id="forEcheanceType" name="forEcheanceType">
					...
					<OPTION selected value="<%=globaz.osiris.db.avance.CAAvanceViewBean.CS_ECHEANCE_MENSUELLE%>">Monatlich</OPTION>
					<OPTION value="<%=globaz.osiris.db.avance.CAAvanceViewBean.CS_ECHEANCE_TRIMESTRIELLE%>">Trimesterlich</OPTION>
				</SELECT>
            </TD>
          </TR>		
          
          <TR> 
            <TD align="left" width="180" height="21" valign="middle">Art</TD>
            <TD align="left"> 
            	<%
          ...
          <TR> 
            <TD align="left" width="200" height="21" valign="middle">Verzeichnis</TD>
            <TD align="left"> 
          ...
          <TR> 
            <TD align="left" width="180" height="21" valign="middle">Gewünschtes Ausführungsorgan</TD>
            <TD align="left">
