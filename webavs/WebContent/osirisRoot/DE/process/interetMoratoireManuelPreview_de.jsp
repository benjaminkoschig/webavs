...
top.document.title = "Verzugszinsen berechnen - Etappe 2/3 - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Verzugszinsen berechnen - Step 2/3<%-- /tpl:put --%>
...
%>
	...
	<tr>
	    ...
	    &nbsp;<a href="<%=request.getContextPath()%>/osiris?userAction=osiris.process.interetMoratoireManuel.afficher&idSection=<%=section.getIdSection()%>&eMailAddress=<%=viewBean.getEMailAddress()%>&dateFin=<%=viewBean.getDateFin()%>&numeroFactureGroupe=<%=viewBean.getNumeroFactureGroupe()%>" class="back_link">Ändern</a>&nbsp;
		</td>
	</tr>
