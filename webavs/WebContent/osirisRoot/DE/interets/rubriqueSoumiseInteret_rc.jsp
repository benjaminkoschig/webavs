...
<%-- tpl:insert page="/theme/find.jtpl" --%><%@page import="globaz.osiris.db.interets.CARubriqueSoumiseInteretViewBean"%>
...
usrAction = "<%=globaz.osiris.application.CAApplication.DEFAULT_OSIRIS_NAME %>.interets.rubriqueSoumiseInteret.lister";
bFind = true;
...
top.document.title = "<ct:FWLabel key='GCA4034_TITRE_ECRAN'/>" + top.location.href;
// stop hiding -->

</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="GCA4034_TITRE_ECRAN"/><%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
				<TR>
				<TD valign="top" ><ct:FWLabel key="GCA4034_PLAN"/>
