...
function del() {
	if (window.confirm("Sie sind dabei, das Rechtspflege Ereignis zu löschen! Wollen Sie fortfahren?")) {
...
top.document.title = "Rechtspflege - Detail " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail Vorgang in der Rechtspflege<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR> 
            ...
            <TD width="10">&nbsp;</TD>
            <TD colspan="2" nowrap width="160">Davon Gebühren</TD>
            <TD>&nbsp;</TD>
          ...
          <TR> 
            <TD width="160">Ausführungsdatum</TD>
            <TD>
...
<!--              <INPUT type="text" name="dateDeclenchement" value="<%= parametreEtape.getDateDeclenchement(section)%>" class="date" size="11" maxlength="10" tabindex="1" onblur="focusDateExecution();">-->
            ...
            <TD width="10"></TD>
            <TD colspan="2" nowrap width="160">Korrespondenzadresse</TD>
            <TD></TD>
          ...
          <tr> 
            <td width="160">Korrespondenzadresse</td>
            <td>
...
<!--              <INPUT type="text" name="dateExecution" value="<%=viewBean.getDateExecution()%>" class="date" size="11" maxlength="10" tabindex="2">-->
          ...
          <TR> 
            <TD width="160">Mutationsgrund</TD>
            <TD>
