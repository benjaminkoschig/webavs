...
<%@ include file="/theme/list/javascripts.jspf" %>
	...
	<TH align="left">Buchungsdatum</TH>
    <TH align="left">Valutadatum</TH>
    <TH nowrap width="90" align="left">Sektion-Nr.</TH>
    <TH width="332" align="left">Beschreibung</TH>
    <TH width="110" align="right">Ausserhalb Abrechnungskontos</TH>
    <TH width="110" align="right">Soll</TH>
    <TH width="110" align="right">Haben</TH>
    <TH width="200" align="right">Saldo</TH>
    <TH width="332" align="left">Zahlungsherkunft</TH>
