...
<!--    <TD width="10" valign="top"><a href="<%=request.getContextPath()%>/osiris?userAction=osiris.comptes.journalOperationPaiement.afficher&id=<%=_ecriture.getIdOperation()%>" target="fr_main"><img src="<%=request.getContextPath()%>/images/loupe.gif" border="0"></a></TD>-->
    ...
    <TD class="mtd" nowrap onClick="<%=actionDetail%>" width="70" valign="top" <%=styleAndTitle%>><%=_ecriture.getDate()%></TD>
    ...
    <TD class="mtd" nowrap onClick="<%=actionDetail%>" valign="top" align="right" <%=styleAndTitle%>><%= JANumberFormatter.formatNoRound(_ecriture.getMontantEcran())%>
    </TD>
    <TD class="mtd" nowrap onClick="<%=actionDetail%>" valign="top" align="right" <%=styleAndTitle%>><%= _ecriture.getCodeDebitCreditEcran()%> </TD>
    <TD class="mtd" nowrap onClick="<%=actionDetail%>" valign="top" align="left" <%=styleAndTitle%>>
