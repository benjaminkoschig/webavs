...
<%
	CARecouvrementViewBean viewBean = (CARecouvrementViewBean) session.getAttribute (globaz.osiris.servlet.action.CADefaultServletAction.VB_ELEMENT);
	userActionValue = "osiris.comptes.journalOperationRecouvrement.modifier";
...
function add() {
	...
	//document.forms[0].etatJournal.value="";
  	document.forms[0].elements('userAction').value="osiris.comptes.journalOperationRecouvrement.ajouter";
	document.forms[0].idExterneRoleEcran.focus();
}

function upd() {
  document.forms[0].elements('userAction').value="osiris.comptes.journalOperationRecouvrement.modifier";
	document.forms[0].idExterneRoleEcran.focus();
}

function del() {
	if (window.confirm("Sie sind dabei, die ausgewählte ESR-Zahlung zu löschen ! Wollen Sie fortfahren?")) {
        document.forms[0].elements('userAction').value="osiris.comptes.journalOperationRecouvrement.supprimer";
...
function cancel() {
	if (document.forms[0].elements('_method').value == "add")
		...
		document.forms[0].elements('userAction').value="osiris.comptes.journalOperationRecouvrement.afficher";
}
function init(){}
...
function jsRechercheRubriqueEcran(){
	...
	getSl('osiris.comptes.journalOperationRecouvrement.afficher','osiris.comptes.rechercheRubrique.chercher', 'idCompte','' );
}
...
function jsRechercheCompteCourantEcran(){
	...
	getSl('osiris.comptes.journalOperationRecouvrement.afficher','osiris.comptes.rechercheCompteCourant.chercher', 'idCompteCourant','' );
}
...
top.document.title = "Konto - Detail des Inkassos" + top.location.href;
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Erfassung einer Inkasso<%-- /tpl:put --%>
...
%>
          ...
          <TR>
            ...
            <TD width="147">
              <INPUT type="text" onchange="validateFloatNumber(this)" onkeypress="filterCharForFloat(window.event)" name="montantEcran" size="30" maxlength="30" value="<%=viewBean.getMontantEcran()%>"  class="montant">
            </TD>
            <TD width="7">&nbsp;</TD>
            <TD width="300">
          ...
          <TR>
            <TD nowrap width="129">Buchungsbelegs-Nr.</TD>
			<TD colspan="4">
...
%>
          ...
          <tr>
            <td nowrap width="129">ESR Transaktionsart</td>

            <td width="147">
              <input type="text" name="genreTransaction" size="10" maxlength="10" value="<%=viewBean.getGenreTransaction()%>"  >
            </td>
            <td width="4">&nbsp;</td>
            <td colspan="2">&nbsp;</td>
          </tr>
          <tr>
            <td nowrap width="129">Ablehnungsgrund</td>
            <td colspan="4">
	            <input type="hidden" name="codeRefus" value="<%=viewBean.getCodeRefus()%>" tabindex="-1" >
             	<input type="text" name="codeRefusLibelle" value="<%=viewBean.getSession().getCodeLibelle(viewBean.getCodeRefus())%>" class="inputDisabled" tabindex=-1 readonly>
            </td>
          </tr>
          <tr>
            <td width="129">ESR-Referenznummer</td>
            <td width="147">
              <input type="text" name="reference" size="35" maxlength="27" value="<%=viewBean.getReference()%>"  >
            </td>
            ...
            <td colspan="2">
                <table width="100%">
	              <tr>
	                <td width="130">Verarbeitungsdatum</td>
	                <td><ct:FWCalendarTag name="dateEcheance" doClientValidation="CALENDAR" value="<%=viewBean.getDateEcheance()%>"/></td>
	              </tr>
	            </table>
            </td>
          </tr>
          ...
          <tr>
            <td nowrap width="129">Ausführungsorgan</td>
