...
function del() {
	if (window.confirm("Sie sind dabei, die ausgewählte Zahlung zu löschen! Wollen Sie fortfahren?")) {
...
top.document.title = "Konti - Detail einer Zahlung ins Ausland - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR> 
            <TD nowrap width="128">ISO Code</TD>
            <TD nowrap width="500">                                  
          ...
          <TR> 
            <TD nowrap width="128">Betrag CHF</TD>
            <TD nowrap width="500"> 
...
%>			          
     ...
     <%String date = "";
       String libelle = "";
          ...
          <TR>
            <TD nowrap width="128">Mitteilung</TD>
            <TD nowrap width="500"> 
          ...
          <TR>
            <TD nowrap width="128">Quittieren</TD>
            <TD width="500">
