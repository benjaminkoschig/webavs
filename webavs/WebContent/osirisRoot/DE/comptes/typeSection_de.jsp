...
function del() {
	if (window.confirm("Sie sind dabei, den ausgewählten Sektionstyp zu löschen! Wollen Sie fortfahren?")) {
...
top.document.title = "Konti - Detail eines Sektionstyps" + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail einer Sectionstyp<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR> 
            <TD nowrap width="174">Name der Detailseite</TD>
            <TD width="10">&nbsp;</TD>
            <td nowrap width="393"> 
