...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
         ...
         <TR>
          ...
          <TR>
            <TD nowrap width="200">Bezeichnung</TD>
            <TD width="30"></TD>
            <TD nowrap>
          ...
          <TR>
            <TD nowrap width="200">Buchungsdatum</TD>
            <TD width="30"></TD>
            <TD nowrap>
          ...
          <TR>
            <TD nowrap width="200">Benutzer</TD>
            <TD width="30"></TD>
            <TD nowrap>
    ...
    <% if (!"1".equals(viewBean.getIdJournal())) { %>
          <TR>
            <TD nowrap width="200">Total der Buchungen</TD>
            <TD width="30"></TD>
            <TD nowrap>
              <INPUT type="text" name="totEcritures" style="width:7cm" maxlength="30" value="<%=viewBean._getTotalEcritures()%>" class="libelleDisabled" tabindex="-1" readonly>
            </TD>
            <TD width="10"></TD>
            <TD nowrap></TD>
          </TR>
          <TR>
            <TD nowrap width="200">Total der Zahlungsaufträge</TD>
            <TD width="30"></TD>
            <TD nowrap>
          ...
          <TR>
            <TD nowrap width="200">Total der Inkassoaufträge</TD>
            <TD width="30"></TD>
            <TD nowrap>
