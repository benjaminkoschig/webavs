...
function del() {
	if (window.confirm("Sie sind dabei, das ausgewählte Zahlungsauftrag zu löschen! Wollen Sie fortfahren?")) {
...
top.document.title = "Konto - Detail eines Zahlungsauftrages " + top.location.href;
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Erfassung eines Zahlungsauftrages<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR>
            <TD nowrap width="129">Auftragstyp</TD>
          ...
          <TR>
            <TD nowrap width="129">Fälligkeitsdatum</TD>
            <TD width="147">
          ...
          <TR>
            ...
            <TD nowrap width="100">Verg&uuml;tungsw&auml;hrung</TD>
            <TD nowrap colspan="2">
              <%	viewBean.getCsMonnaies();
          ...
          <TR>
            <td rowspan="3" align="left" width="129">Zahlungsadresse</td>
            <!--<TD width="5"></TD>-->
			  ...
			  String[] _fullAdr = new String[0];
			   ...
			   try {
              	if(!globaz.globall.util.JAUtil.isIntegerEmpty(viewBean.getIdAdressePaiement())) {
					...
					_fullAdr[0] = "FEHLER Zahlungsadresse fehlt !";
			  }
			  %>
          ...
          <TR>
            <TD nowrap width="129">Zahlungsnatur</TD>
            <TD width="147">
          ...
          <TR>
            ...
            <TD width="7">&nbsp;</TD>
            <TD width="100">Rückzug durchgeführt</TD>
            <TD colspan="2">
          ...
          <TR>
            ...
            <td nowrap width="7">&nbsp;</td>
            <td nowrap width="100">Transaktionsnummer</td>
            <td nowrap>
          ...
          <TR>
            <TD width="129">Indentifikation</TD>
            <TD nowrap colspan="5">
