...
%>
	...
	<TD class="mtd" nowrap onClick="<%=actionDetail%>" width="20" align="right"><%if (_ligne.getAttenteLSVDD().booleanValue()){%> <IMG src="<%=servletContext%>/images/pending.gif" title="Anhängig LSV/DD"><%} else {%>&nbsp;<%}%></TD>
