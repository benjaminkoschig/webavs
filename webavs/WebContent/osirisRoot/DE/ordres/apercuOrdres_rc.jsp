...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Uebersicht über Ueberweisungsaufträge<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
          <TR>
            <TD width="126">Sammelauftrag</TD>
            <TD nowrap colspan="2">
            ...
            <TD align="right" valign="bottom" width="500">Datum &nbsp;
