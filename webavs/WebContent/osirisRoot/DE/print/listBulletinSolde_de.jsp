...
%>
top.document.title = "Liste - Ausdrucken der Saldi ESR - " + top.location.href;
// stop hiding -->
</SCRIPT>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Ausdruck der Saldi ESR<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <tr> 
            <td nowrap width="128">Abr.-Nr. von &nbsp;</td>
            <td nowrap width="576"> 
