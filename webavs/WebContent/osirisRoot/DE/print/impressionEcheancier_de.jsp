...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Ausdruck der Fälligkeitsdaten<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<TR>
			...
			<TD class="control"><INPUT type="checkbox" id="checkBVR" name="impAvecBVR" value="on"><label for="checkBVR">mit ESR</label></TD>
		</TR>
		<%-- /tpl:put --%>
