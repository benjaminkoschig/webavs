...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Saldi-ESR generieren<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <tr>
			<td nowrap>ESR forcieren</td>
            <td nowrap>
              <input type="checkbox" name="forcerBV" id="forcerBV"> <label for="forcerBV"> Geringfügige Beträge nicht berücksichtigen.</label>
            </td>
            <td>&nbsp;</td>
            <td nowrap>&nbsp;</td>
            <td nowrap>&nbsp;</td>
