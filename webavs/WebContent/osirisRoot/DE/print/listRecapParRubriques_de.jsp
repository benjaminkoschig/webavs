...
%>
top.document.title = "Zusammenfassende Liste nach Rubrik - " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Zusammenfassende Liste nach Rubrik<%-- /tpl:put --%>
...
%> 				
				...
				<tr>
	            	<td width="128">Von Valutadatum...</td>
