...
<%-- tpl:put name="zoneTitle" --%>Konkordanzliste HB / FB (Excel)<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%>
	<tr height="40">
		<td colspan="4" class="control">
			Konkordanzliste für das Konto :
	...
	<tr>
		<td></td>
		<td colspan="3">
			<input type="checkbox" name="printOnlyDiff" id="printOnlyDiff"><label for="printOnlyDiff">Nur Differenzen anzeigen.</label>
		</td>
	</tr>
<%-- /tpl:put --%>
