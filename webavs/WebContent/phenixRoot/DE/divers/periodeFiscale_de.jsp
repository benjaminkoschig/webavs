...
top.document.title = "Beiträge - Steuerperiode - Detail"
function add() {
...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
          ...
          <TR>
            <TD nowrap width="160">Erstes Einkommen</TD>
  	 ...
  	 <TR> 
          ...
          <TR>
            <TD nowrap width="150">Letztes Einkommen</TD>
