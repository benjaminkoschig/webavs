...
<%@ include file="/theme/list/javascripts.jspf" %>
    	...
    	<Th width="">Versicherung</Th>
    	<Th width="">Beitragsperiode</Th>
		<Th width="">Jährlich </Th>
		<Th width="">Halbjährlich</Th>    
		<Th width="">Vierteljährlich</Th>    
		<Th width="">Monatlich </Th> 
		<Th width="">Beitragssatz </Th>   
		<Th width="">Periodizität</Th>
<%-- /tpl:put --%> 
...
%>
     <TD class="mtd" width="16" ></TD>
      <TD class="mtd" width="20%" style="font-weight : bold;">Geschuldeter Gesamtbetrag</TD>
