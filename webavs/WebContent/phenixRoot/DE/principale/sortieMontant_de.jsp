...
top.document.title = "Beitrag - Abgangsbeträge"
function add() {
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Abgangsbeträge<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
					...
					<TR> 
			            <TD nowrap width="180">Versicherung</TD>
            			<TD nowrap colspan="2">
