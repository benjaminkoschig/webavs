...
top.document.title = "Steuermeldungen - Massengenerierung"
</SCRIPT>
<%-- /tpl:put --%>
...
<%-- tpl:put name="zoneTitle" --%>Verfügungen in Masse generieren<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%> 

		  <TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Dieses Programm generiert die Verfügungen gemäss den Steuerdaten.</TD>
          </TR>
          <TR>
