...
<%
	...
	userActionValue = "phenix.communications.apercuCommunicationFiscaleRetour.enqueterEnMasseExecuter";
...
<%-- tpl:put name="zoneTitle" --%>Untersuchung der Steuermeldungen zurück<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%> 

<TR>
	<TD colspan="2"><b><u><%=viewBean.getListIdRetour() == null ? "0" : ""+viewBean.getListIdRetour().length%></u> Steuermeldungen zurück werden in Untersuchung gesetzt </b></TD>
</TR>
<TR>
