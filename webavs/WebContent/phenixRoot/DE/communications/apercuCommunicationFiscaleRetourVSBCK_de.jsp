...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
 ...
 <div id="tabs"> 
		<ul>
  			<li><a class="gen" href="javascript:showPartieGenerique()">Données génériques</a></li>
  			<li><a class="caisse" href="javascript:showPartieCaisse()">Données caisses</a></li>
  			<li><a class="fisc" href="javascript:showPartieFisc()">Données du fisc</a></li>
   ...
   <TR>
        ...
        <TD nowrap>
         ...
         <TR>
			...
			<% if (!JadeStringUtil.isIntegerEmpty(viewBean.getIdAffiliation())) {%>
				...
				<A href="<%=request.getContextPath()%>\phenix?userAction=phenix.principale.decision.chercher&selectedId=<%=viewBean.getIdTiers()%>&selectedId2=<%=viewBean.getIdAffiliation()%>" class="external_link">Verfügungs</A>
				</ct:ifhasright>
			<%}%>
			</TD>
			<TD></TD>
	...
	<TABLE border="0" cellspacing="0" cellpadding="0" id="tPartieFisc">
	 <TR>
	  ...
	  <TR>
	    <TD nowrap>Übermittelte Name</TD>
       ...
       <TR>
 	     <TD nowrap align="left">Übermittelte NSS</TD>
	   ...
	   <TD nowrap><INPUT value="<%=viewBean.getVsFinActiviteCtb()+ " - " + viewBean.getVsFinActiviteConjoint()%>" class="libelleLongDisabled" readonly></TD>
        ...
        <TR>
           <TD nowrap="nowrap">Privates Vermögen</TD>
