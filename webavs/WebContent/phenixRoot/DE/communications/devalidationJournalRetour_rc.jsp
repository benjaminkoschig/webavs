...
String btnCustomLabel = "Auswahl devalidieren";
...
<SCRIPT>
// menu 
top.document.title = "Devalidierung der Steuermeldungen zurück"
...
function del() {
	if (window.confirm("Sie sind dabei, die Steuermeldung zu löschen! Wollen Sie fortfahren?"))
	{
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Devalidierung der Steuermeldungen zurück<%-- /tpl:put --%>
