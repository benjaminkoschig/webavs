...
top.document.title = "Detail eines Empfangsjournal"
</SCRIPT>
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail eines Empfangsjournal<%-- /tpl:put --%>
