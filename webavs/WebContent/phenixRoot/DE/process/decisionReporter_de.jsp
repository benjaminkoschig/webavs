...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Übernahme der voreingegebenen Verfügungen<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
						
		   <TR>
				<TD nowrap colspan="2" style="font-weight : bolder;"><p><b><font size="2">Dieses Programm berechnet die Verfügungen basierend auf das Vorjahr, zum Beispiel
				 die Verfügungen <%=JACalendar.getYear(JACalendar.today().toString())%> wie sie im <%=JACalendar.getYear(JACalendar.today().toString())-1%> eingegeben wurden.</font></b></p></TD>
			</TR>
			  <TR>
