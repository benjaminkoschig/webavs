		...
		<tr>
            ...
            <td>
            	<select name="userChoice" style="width:10cm;" onchange="lien();">
            		<option></option>
            		<option>Liste der Verfügungen</option>
	           		<option>Liste der fehlenden Verfügungen</option>
	           		<option>Liste der zu nehmende Verfügungen </option>
	           		<option>Liste der verbuchten Verfügungen während einer bestimmten Periode.</option>
	           		<option>Liste gleiches Jahr in einem Job</option>
	           		<option>Liste Differenz Anschluss-Beiträge</option>
	           		<option>Liste Persönliche AHV-Beiträge - IK</option>
	           		<option>Liste Persönliche AHV-Beiträge - Buchhaltung</option>
	           		<option>Liste der endgültig Verfügungen</option>
            	</select>
            </td>
          </tr>
          <%-- /tpl:put --%>
