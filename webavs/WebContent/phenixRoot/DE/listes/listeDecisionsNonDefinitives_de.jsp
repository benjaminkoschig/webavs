...
top.document.title = "Phenix - Ausdruck der zu nehmende Verfügungen"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste zu nehmende Verfügungen <%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
	   ...
	   <TR>
            <TD height="2" width="165">E-Mail Addresse</TD>
