...
top.document.title = "Liste der unterschiedliche Beitragsbeträge";
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Beiträge-Abgleich zwischen Versicherungsfaktor und Persönliche Beiträge<%-- /tpl:put --%>
