...
top.document.title = "Decision - Impression par lot"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%> Impression par lot des décisions <%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
          ...
          <tr id="plageNumAff"> 
            <TD width="50%" height="20">N° Affilié</TD>
            <td>de:&nbsp;
	           	<ct:FWPopupList 
          ...
          <tr> 
            <TD width="50%" height="20">Type de décision</TD>
            <td>
          ...
          <tr> 
            <TD width="50%" height="20">N° agence</TD>
            <td width="50%"> 
              <INPUT type="text" name="forAgence" maxlength="20" size="20">
            </td>
          </tr>  
          <tr> 
            <TD width="50%" height="20">Date d'impression sur les décisions</TD>
            <TD width="50%"> 
          ...
          <tr>
          	<TD width="50%" height="20">Tri</TD>
          	<TD width="50%">
          	<select name="forOrder" tabindex="3">
          	<option value="3">N°.Affilié</option>
          	<option value="1">Collaborateur, N° Affilié</option>
          	<option value="2">Agence, N° Affilié</option>
  			</select>
  	      	</TD>
          </tr>
          <TR> 
            <TD height="50%" width="240" nowrap>Adresse E-Mail</TD>
            <TD width="50%"> 
              <input name='eMailAddress' class='libelleLong' data-g-string="mandatory:true" value='<%=viewBean.getEMailAddress()%>'>
            </TD>
          </TR>
          <TR> 
            <TD height="50%" width="212">Décision identique</TD>
            <TD nowrap height="31"><input type="checkbox" name="impressionMontantIdentique">
            &nbsp;&nbsp; imprime les cas dont la décision générée par les communications fiscales a les mêmes revenus et fortunes que l'actuelle décision</TD>
          </TR>
          <% 
