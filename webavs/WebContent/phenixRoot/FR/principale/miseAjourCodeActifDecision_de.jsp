...
top.document.title = "Mise à jour du code actif"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Mise à jour du code actif<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
         ...
         <TR>
          ...
          <TR>
           ...
           <tr> 
            <TD width="165" height="20">N° affilié de départ</TD>
            <td width="513"> 
              <INPUT type="text" name="fromNumAffilie" maxlength="20" size="20">
            </td>
          </tr>
          <tr> 
            <TD width="165" height="20">N° affilié de fin</TD>
            <TD width="513"> 
