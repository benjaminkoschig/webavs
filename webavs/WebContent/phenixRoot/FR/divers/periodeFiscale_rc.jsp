...
<SCRIPT>
// menu 
top.document.title = "Cotisation - Période fiscale"
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Période fiscale<%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
	  ...
	  <TR>
            <TD nowrap width="130">Numéro IFD</TD>
		<%
		...
		<%}%>
            ...
            <TD nowrap width="120">Année de décision</TD>
           <%
