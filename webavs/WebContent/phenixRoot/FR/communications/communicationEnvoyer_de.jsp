...
top.document.title = "Communications fiscales - Envoi"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Envoi des communications fiscales<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
		<TR>
			<TD width="400">Envoyer le fichier à travers la plateforme Sedex </TD>	
			<TD><INPUT type="checkbox" name="throughSedex" id="throughSedex" onclick="showHideCanton()" checked="checked" >
				<label id="libDonneesCommerciales"><ct:FWLabel key="DONNEES_COMMERCIALES"/></label><input type="checkbox" name="donneesCommerciales" id="donneesCommerciales">
				<label id="libDonneesPrivees"><ct:FWLabel key="DONNEES_PRIVEES"/></label><input type="checkbox" name="donneesPrivees" id="donneesPrivees">
			</TD>
    	</TR>
		<TR>
        	<TD>Envoi des demandes d'annulation</TD>
           <td> 
           		<INPUT type="checkbox" name="demandeAnnulee" > </td>
        </tr>
          <tr>
            <TD>Genre d'affilié</TD>
            <TD>
       		 <%
		...
		<TR>
            <TD>Envoyer uniquement celles que l'on a jamais envoyées</TD>
            <td > 
              <INPUT type="checkbox" name="dateEnvoiVide" checked="checked"> </td>
          </tr>
          <tr>
            <TD>Envoyer uniquement celles dont la date d'envoi est égale à</TD>
            <TD>
