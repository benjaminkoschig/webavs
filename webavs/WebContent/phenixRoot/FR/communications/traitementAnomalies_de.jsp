...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Traitement des anomalies du FISC<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 

		<TR>
			<TD nowrap colspan="2" style="font-weight : bolder;">Ce programme va enlever la date d'envoi pour les communications d'anomalies transmises par le FISC.</TD>
		</TR>
		<TR>
