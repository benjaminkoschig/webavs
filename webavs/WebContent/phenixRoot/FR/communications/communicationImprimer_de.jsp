...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Impression des communications fiscales<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
		  <TR> 
            <TD height="20" width="150">Impression liste</TD>
            <TD nowrap height="31" width="259"><input type="checkbox" name="impressionListe" "checked"></TD>
          </TR>
          <tr>
            <TD width="150" height="20">Genre d'affilié</TD>
            <TD width="266">
             <%
		...
		/>
          ...
          <tr>
            <TD width="279" height="20">Année de décision</TD>
            <td> 
	   ...
	   <tr>
            <TD width="279" height="20">Canton</TD>
          ...
          <tr>
            <TD width="300" height="20">Imprimer uniquement celles que l'on a jamais éditées</TD>
            <td height="2"> 
              <INPUT type="checkbox" name="dateEnvoiVide" checked="checked"></td>
          </tr>
          <tr>
            <TD width="279" height="20">Imprimer celles dont la date d'envoi est égale à</TD>
            <TD width="266">
