...
String btnCustomLabel = "Valider sélection";
String btnCustomLabel1 = "Abandonner sélection";
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Validation des journaux de communications en retour<%-- /tpl:put --%>
