...
<%@ include file="/theme/list/javascripts.jspf" %>
  	  ...
  	  <th width="16">&nbsp;</th>
      <TH  width="10%">N° Journal</TH>
      <TH  width="10%">Erreur</TH>
      <th  width="10%">Abandonné</th>
      <th  width="10%">Avertissement</th>
      <th  width="10%">Réceptionné</th>
      <th  width="5%">Validé</th>
      <th  width="10%">Sans anomalie</th>
      <th  width="10%">A contrôler</th>
      <th  width="10%">En enquête</th>
      <th  width="10%">Comptabilisé</th>
      <th  width="5%">Total</th>
	<%-- /tpl:put --%>  
