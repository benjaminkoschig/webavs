...
<%
		...
		selectedIdValue = "";
		userActionValue = "phenix.communications.journalRetour.executerSupprimer";
		subTableWidth = "75%";
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Suppression des communications fiscales en retour<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
		<TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Ce programme supprime, selon la sélection choisie, les communications ainsi que les éventuelles décisions générées.</TD>
          </TR>
          <TR>
	    ...
	    <!--      <tr>
            <TD width="279" height="20">Date de réception</TD>
            <TD width="266">
		<ct:FWCalendarTag name="forDateRetour" 
		value="" 
		errorMessage="la date de retour est incorrecte"
