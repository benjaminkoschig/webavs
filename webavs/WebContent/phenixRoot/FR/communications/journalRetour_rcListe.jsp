...
<%@ include file="/theme/list/javascripts.jspf" %>
		...
		<th width="20">&nbsp;</th>
	    <TH width="10">&nbsp;</TH>
      	<TH width="5" align="left">N°</TH>
      	<TH width="*" align="left">Nom du journal</TH>
      	<TH width="5" align="left">Canton</TH>
      	<th  width="15%">Date de reception</th>
		<th  width="10%">Nb. Communication</th>
		<th  width="15%">Etat</th>
		<th  width="15%">Type</th>
		<th  width="15%">Journal ouvert</th>  
