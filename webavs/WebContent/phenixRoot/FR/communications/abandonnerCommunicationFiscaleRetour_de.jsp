...
<%
	...
	userActionValue = "phenix.communications.apercuCommunicationFiscaleRetour.abandonnerEnMasse";
...
<%-- tpl:put name="zoneTitle" --%>Abandon des communications en retour<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
<%-- tpl:put name="zoneMain" --%> 

<TR>
	<TD colspan="2"><b><u><%=viewBean.getListIdRetour() == null ? "0" : ""+viewBean.getListIdRetour().length%></u> communications fiscales en retour vont être abandonnées </b></TD>
</TR>
<TR>
