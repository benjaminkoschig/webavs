...
<SCRIPT>
top.document.title = "Avancement des journaux de CF"
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%>Avancement des journaux de CF<%-- /tpl:put --%>
...
<%@ include file="/theme/find/bodyEnd.jspf" %>
	<table class="find" cellspacing="0">
		<tr class="somme">
			<TD class="mtdBold" width="*" align="left">&nbsp;Totaux</TD>	
