...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Report des décision pré-encodées<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>
 		  	<TR>
				<TD nowrap colspan="2" style="font-weight : bolder;"><p><b><font size="2">Ce programme recalcule les décisions qui ont été encodées en avance, par exemple
				 les décisions <%=JACalendar.getYear(JACalendar.today().toString())%> qui ont été encodées en <%=JACalendar.getYear(JACalendar.today().toString())-1%>.</font></b></p></TD>
			</TR>
			<TR>
