...
top.document.title = "Décision - Re-Comptabiliser"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart2.jspf" %>
		...
		<TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">En cas de problème de comptabilisation, la description de l'erreur vous parviendra par eMail à l'adresse suivate :</TD>
          </TR>
          <TR>
