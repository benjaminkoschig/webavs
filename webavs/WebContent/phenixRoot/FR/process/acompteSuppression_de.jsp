...
top.document.title = "Acomptes - Suppression"
</SCRIPT>
<%-- /tpl:put --%>
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Suppression des acomptes<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%> 
		<TR>
            <TD nowrap colspan="2" style="font-weight : bolder;">Ce programme supprime les acomptes liés au passage sélectionné.</TD>
          </TR>
          <TR>
     	...
     	<tr> 
          ...
          <TR>
          <TD width="150" height="20">Type de décision</TD>
            <TD width="266">
             <%
