...
<!--  balise exclusivement dédiée à Excel pour un entête de page :-(-->
		@page	{
			mso-header-data:"&amp;C&amp;EA L F A&amp;E&#160;PAR MOIS / PAR TRIMESTRE / PAR SEMESTRE&#160;Exercice :&#160;<xsl:value-of select="@annee"/>";
		}
	</style>
		<div id="journal">
<!--		<table class="entete" cellpadding="2" cellspacing="8" border="0"> 
 ...
 -->				
<!-- 				<tr>					
						<td class="entete" align="center" height="20px">PAR MOIS/TRIMESTRE/SEMESTRE :&#160;<xsl:value-of select="@annee"/></td>
						<xsl:element name="td">
