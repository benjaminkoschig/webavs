...
<%
	globaz.tucana.vb.journal.TUJournalRecapF3ViewBean viewBean = (globaz.tucana.vb.journal.TUJournalRecapF3ViewBean) session.getAttribute("viewBean");
	idEcran = "TU-251";
...
function onClickGenerer(){
    ...
    document.forms[0].elements('userAction').value="tucana.journal.journalRecapF3.generer";
	chargeUrl(state);
}
function onClickPdf(){
    state = validateFields();
    document.forms[0].elements('userAction').value="tucana.journal.journalRecapF3.pdf";
	chargeUrl(state);
}
...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			...
			<ct:FWLabel key="TIT_JOURNAL_RECAP_F3"/>
			<%-- /tpl:put --%>
