	...
	<tr>
		...
		<TD>
			<SELECT id="typeDocument" name="typeDocument" onchange="changeTypeDoc();">
	        	<OPTION value="<%=DSLettreReclamationNss_doc.DOCUMENT_LETTRE_RECLAMATION %>" <%=DSLettreReclamationNss_doc.DOCUMENT_LETTRE_RECLAMATION.equals(viewBean.getTypeDocument())?"selected":""%>><ct:FWLabel key="LETTRE_RECLAMATION"/></OPTION>
	            <OPTION value="<%=DSLettreReclamationNss_doc.DOCUMENT_LETTRE_RAPPEL %>" <%=DSLettreReclamationNss_doc.DOCUMENT_LETTRE_RAPPEL.equals(viewBean.getTypeDocument())?"selected":""%>><ct:FWLabel key="LETTRE_RAPPEL"/></OPTION>
			</SELECT>	
	    </TD>
		<TD>&nbsp;</TD>
	</TR>
	...
	<tr>
		...
		<TD>
			<SELECT id="genreEdition" name="genreEdition">
	        	<OPTION value="<%=DSLettreReclamationNss_doc.GENRE_DOCUMENT_SIMULATION%>" <%=DSLettreReclamationNss_doc.GENRE_DOCUMENT_SIMULATION.equals(viewBean.getGenreEdition())?"selected":""%>><ct:FWLabel key="SIMULATION"/></OPTION>
	            <OPTION value="<%=DSLettreReclamationNss_doc.GENRE_DOCUMENT_DEFINITIF%>" <%=DSLettreReclamationNss_doc.GENRE_DOCUMENT_DEFINITIF.equals(viewBean.getGenreEdition())?"selected":""%>><ct:FWLabel key="DEFINITIF"/></OPTION> 
			</SELECT>
		</TD>
		<TD>&nbsp;</TD>
	</TR>
