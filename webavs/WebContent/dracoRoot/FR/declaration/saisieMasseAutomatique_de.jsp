...
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Saisie de la date de réception - détail<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						<%-- tpl:put name="zoneMain" --%>

<TR>
	
    <TD nowrap height="14" width="128">Code-barres <input type="hidden" name="saisieEcran" value="true" tabindex="-1"></TD>
