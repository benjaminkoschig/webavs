...
function checkKey(input){
	...
	document.forms[0].elements('numeroAvs1NssPrefixe').onmouseover = new Function("",'helpOver2 (event,0);');
	document.forms[0].elements('numeroAvs2NssPrefixe').onmouseover = new Function("",'helpOver2 (event,1);');
	document.forms[0].elements('numeroAvs3NssPrefixe').onmouseover = new Function("",'helpOver2 (event,2);');
	document.forms[0].elements('numeroAvs4NssPrefixe').onmouseover = new Function("",'helpOver2 (event,3);');
	document.forms[0].elements('numeroAvs5NssPrefixe').onmouseover = new Function("",'helpOver2 (event,4);');
	document.forms[0].elements('numeroAvs6NssPrefixe').onmouseover = new Function("",'helpOver2 (event,5);');
	document.forms[0].elements('numeroAvs7NssPrefixe').onmouseover = new Function("",'helpOver2 (event,6);');
	document.forms[0].elements('numeroAvs8NssPrefixe').onmouseover = new Function("",'helpOver2 (event,7);');
	document.forms[0].elements('numeroAvs9NssPrefixe').onmouseover = new Function("",'helpOver2 (event,8);');
	document.forms[0].elements('numeroAvs10NssPrefixe').onmouseover = new Function("",'helpOver2 (event,9);');
	document.forms[0].elements('numeroAvs11NssPrefixe').onmouseover = new Function("",'helpOver2 (event,10);');
	document.forms[0].elements('numeroAvs12NssPrefixe').onmouseover = new Function("",'helpOver2 (event,11);');
	document.forms[0].elements('numeroAvs13NssPrefixe').onmouseover = new Function("",'helpOver2 (event,12);');
	document.forms[0].elements('numeroAvs14NssPrefixe').onmouseover = new Function("",'helpOver2 (event,13);');
	document.forms[0].elements('numeroAvs15NssPrefixe').onmouseover = new Function("",'helpOver2 (event,14);');
                                    	...
                                    	<TABLE>
                            				<tr>
												...
												<SELECT id='tri' name='tri' doClientValidation=''>
            										<OPTION value="nom" <%="nom".equals(viewBean.getTri())?"selected":""%>>Nom</OPTION>
            										<OPTION value="nss" <%="nss".equals(viewBean.getTri())?"selected":""%>>Nss</OPTION>
            										<OPTION value="ordre" <%="ordre".equals(viewBean.getTri())?"selected":""%>>Ordre d'inscription</OPTION> 
            										<OPTION value="montant" <%="montant".equals(viewBean.getTri())?"selected":""%>>Montant</OPTION>
            										<OPTION value="canton" <%="canton".equals(viewBean.getTri())?"selected":""%> >Canton</OPTION>
            									</SELECT>
											...
											<TR>
													...
													<TD colspan="3">
														...
														Total ACI &nbsp; <input class="montantDisabled" readonly type= "text" value="<%=viewBean.getTotalControleAcForDisplay()%>" tabindex="-1"> &nbsp;
													</TD>
													<TD>
														
														Total AF  &nbsp; <input class="montantDisabled" readonly type= "text" value="<%=viewBean.getTotalControleAfForDisplay()%>" tabindex="-1">
													</TD>
											</tr>
											<tr>
												<td>Nom
												...
												<td>
													...
													<td colspan = "6">
														<%if(!viewBean.isApresMiseEnProdEtCompl()){%>
															<p style ="color : #d57a01; font-size:15px" >Attention, l'AC 1 et 2 sont à contrôler pour les déclarations 
																					antérieures à la mise en production de webavs
															</p>
														<%}%>	
