...
<%@ include file="/theme/list/javascripts.jspf" %>
	    <%-- tpl:put name="zoneHeaders" --%>
            ...
            <TH nowrap width="100" align="left">Versicherung</TH>            
            <TH align="right">Jahr</TH>
            <TH align="right">Effektive Lohnsumme</TH>
            <TH align="right">Beitragsatz</TH>
            <TH align="right">Bruchteil</TH>
            <TH align="right">Geschuldeter Beitrag</TH>
            <%
            	BigDecimal cotisationDue = new BigDecimal(0);
            	
            %>            	
            <TH align="right">Anzahlung</TH>
            <%
            	BigDecimal acompte = new BigDecimal(0);
            	
            %>
            <TH align="right">Saldo Beiträge</TH>
            <%
