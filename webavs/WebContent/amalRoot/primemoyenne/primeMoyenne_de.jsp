...
<%@page import="globaz.amal.vb.primemoyenne.AMPrimeMoyenneViewBean"%>
...
<%
	...
	AMPrimeMoyenneViewBean viewBean = (AMPrimeMoyenneViewBean) session.getAttribute("viewBean");
...
<script language="JavaScript">
	...
	var ACTION_AJAX_PRIME_MOYENNE="<%=IAMActions.ACTION_PARAMETRES_PRIME_MOYENNEAJAX%>";
...
<script type="text/javascript" src="<%=servletContext%><%=(mainServletPath + "Root")%>/scripts/primemoyenne/PrimeMoyenne_MembrePart.js"/></script>
				...
				<td colspan="4">
					<div class="conteneurDF">
						...
						<div class="areaSearch">
								<table>
									<tr>
										<td width="60px"><ct:FWLabel key="JSP_AM_PARAM_PRIMES_MOYENNES_D_ANNEE"/></td>
							...
							<!--  *** Membre unique de la famille *** -->
								...
								<table class="areaDataTable" width="100%">
									<thead><!--  en tete de table -->
										<tr>
											<th width="70px" data-orderKey="annee"><ct:FWLabel key="JSP_AM_PARAM_PRIMES_MOYENNES_D_ANNEE"/></th>
											<th data-orderKey="montantPrimeAdulte"><ct:FWLabel key="JSP_AM_PARAM_PRIMES_MOYENNES_D_MONTANT_ADULTE"/></th>											
											<th data-orderKey="montantPrimeFormation"><ct:FWLabel key="JSP_AM_PARAM_PRIMES_MOYENNES_D_MONTANT_FORMATION"/></th>												
											<th data-orderKey="montantPrimeEnfant"><ct:FWLabel key="JSP_AM_PARAM_PRIMES_MOYENNES_D_MONTANT_ENFANT"/></th>
										</tr>
									</thead>
									<tbody>
								...
								<div class="areaDetail">								
									<table>
										<TR>
											...
											<TD><input tabindex="1" type="text" name="simplePrimeMoyenne.anneeSubside" id="anneeSubside" value="<%=viewBean.getSimplePrimeMoyenne().getAnneeSubside()%>" class="numeroCourt" data-g-integer="sizeMax:4"/></TD>
											<TD></TD>
											<TD></TD>							
										</TR>
										<TR>
											<TD><ct:FWLabel key="JSP_AM_PARAM_PRIMES_MOYENNES_D_MONTANT_ADULTE"/></TD>
											<TD><input tabindex="2" type="text" name="simplePrimeMoyenne.montantPrimeAdulte" id="montantPrimeAdulte" value="<%=viewBean.getSimplePrimeMoyenne().getMontantPrimeAdulte()%>" data-g-amount=" " class="montant"/></TD>
											<TD></TD>
											<TD></TD>							
										</TR>
										<TR>
											<TD><ct:FWLabel key="JSP_AM_PARAM_PRIMES_MOYENNES_D_MONTANT_FORMATION"/></TD>
											<TD><input tabindex="3" type="text" name="simplePrimeMoyenne.montantPrimeFormation" id="montantPrimeFormation" value="<%=viewBean.getSimplePrimeMoyenne().getMontantPrimeFormation()%>" data-g-amount=" " class="montant"/></TD>
											<TD></TD>
											<TD></TD>							
										</TR>
										<TR>
											<TD><ct:FWLabel key="JSP_AM_PARAM_PRIMES_MOYENNES_D_MONTANT_ENFANT"/></TD>
											<TD><input tabindex="4" type="text" name="simplePrimeMoyenne.montantPrimeEnfant" id="montantPrimeEnfant" value="<%=viewBean.getSimplePrimeMoyenne().getMontantPrimeEnfant()%>" data-g-amount=" " class="montant"/></TD>
											<TD></TD>
											<TD></TD>							
										</TR>
									</table>
									<div align="right" class="btnAjax">
									<ct:ifhasright element="<%=IAMActions.ACTION_PARAMETRES_PRIME_MOYENNEAJAX%>" crud="cud">
