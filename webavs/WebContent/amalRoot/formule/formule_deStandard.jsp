...
<%@page import="java.util.Collection"%>
					...
					<TR>
						...
						<TD width="80%" colspan="4"  align="left">
							...
							<%} else{%>
							<INPUT type="hidden"" id="definitionformule.csDocument" name="definitionformule.csDocument" value="<%=viewBean.getDefinitionFormule().getCsDocument()%>" tabindex="-1">
							<INPUT type="text" id="definitionformule.lcsDocument" name="definitionformule.lcsDocument" value="<%=objSession.getCodeLibelle(viewBean.getDefinitionFormule().getCsDocument())%>" class="libelleLongDisabled" readonly="readonly" tabindex="-1">
							<%}%>
						</TD>
					</TR>
									...
									<TR>
										...
										<TABLE border="0" cellpadding="2"  cellspacing="0" width="100%" style="margin:10px 0px;">
											<TR>
												...
												<TD width="25%">
												<%if(viewBean.isNew()){%>
													 <INPUT type="text" class="numeroId" name="formule.libelleDocument" value="<%=viewBean.getLibelleDocument()%>" tabindex="1">							
												<%} else{%>
													 <INPUT type="text" class="numeroId" name="formule.libelleDocument" disabled="disabled" value="<%=viewBean.getLibelleDocument()%>" tabindex="1" readonly="readonly">
												<%}%>
												
												   
												</TD>
												<TD width="10%">&nbsp;</TD>
												<TD width="20%">Annonce caisse</TD>
												<TD width="25%"><ct:FWCodeSelectTag codeType="LEOUINON" name="parametreModelComplex.simpleParametreModel.codeAnnonceCaisse"  wantBlank="false" defaut="<%=viewBean.getParametreModelComplex().getSimpleParametreModel().getCodeAnnonceCaisse()%>"/>
												</TD>
											</TR>
											...
											<TR>
												...
												<TD width="25%">
													<ct:FWCodeSelectTag codeType="PYLANGUE" name="formule.csLangue" wantBlank="false" defaut="<%=viewBean.getFormule().getCsLangue()%>"/>
												</TD>
												<TD width="10%">&nbsp;</TD>
												<TD width="20%">Code dossier</TD>
												<TD width="25%"><INPUT type="text" class="numeroId" name="parametreModelComplex.simpleParametreModel.codeTraitementDossier" disabled="disabled" value="<%=viewBean.getParametreModelComplex().getSimpleParametreModel().getCodeTraitementDossier()%>" tabindex="1" readonly="readonly">
												</TD>
											</TR>
											...
											<TR>
												...
												<TD width="25%">
													...
													<ct:FWCodeSelectTag codeType="AMTYENVOI" name="definitionformule.csManuAuto"  wantBlank="false" defaut="<%=viewBean.getDefinitionFormule().getCsManuAuto()%>"/>
																
												</TD>
												<TD width="10%">&nbsp;</TD>
												<TD width="20%">Année début</TD>
												<TD width="25%"><INPUT type="text" class="numeroId" name="parametreModelComplex.simpleParametreModel.anneeValiditeDebut" disabled="disabled" value="<%=viewBean.getParametreModelComplex().getSimpleParametreModel().getAnneeValiditeDebut()%>" tabindex="1" readonly="readonly">
												</TD>
											</TR>
											...
											<TR>
												...
												<TD width="10%">&nbsp;</TD>
												<TD width="20%">Année fin</TD>
												<TD width="25%"><INPUT type="text" class="numeroId" name="parametreModelComplex.simpleParametreModel.anneeValiditeFin" disabled="disabled" value="<%=viewBean.getParametreModelComplex().getSimpleParametreModel().getAnneeValiditeFin()%>" tabindex="1" readonly="readonly">
												</TD>
											</TR>
											...
											<TR>
												...
												<TD width="25%">
													...
													<ct:FWCodeSelectTag codeType="LEOUINON" name="definitionformule.csDestinataire"  wantBlank="false" defaut="<%=viewBean.getDefinitionFormule().getCsDestinataire()%>"/>
												</TD>
												<TD width="10%">&nbsp;</TD>
												...
												<%--	<INPUT type="hidden" name="csCopie" value='viewBean.getCsCopie()'> 
													...
													<ct:FWCodeSelectTag codeType="LEOUINON" name="definitionformule.csCopie"  wantBlank="false" defaut="<%=viewBean.getDefinitionFormule().getCsCopie()%>"/>
												</TD>
											</TR>
...
<ct:menuSetAllParams key="idFormule" value="viewBean.getId()" menuId="amal-optionsformules"/>
