...
<%
idEcran="GCT0005";
globaz.babel.vb.copies.CTDocumentJointDefaultCopiesViewBean viewBean = (globaz.babel.vb.copies.CTDocumentJointDefaultCopiesViewBean) request.getAttribute("viewBean");
...
<SCRIPT language="JavaScript">
	...
	usrAction = "<%=globaz.babel.servlet.CTMainServletAction.ACTION_DEFAULT_COPIE%>.lister";
	
	function rechargerPage() {
		document.forms[0].elements("userAction").value = "<%=globaz.babel.servlet.CTMainServletAction.ACTION_DEFAULT_COPIE%>.chercher";
...
<%@ include file="/theme/capage/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="JSP_CTC_R_TITRE"/><%-- /tpl:put --%>
						...
						<TR>
							<TD>
								<TABLE border="0" cellspacing="2" cellpadding="0" width="700">
									<TR>
										<TD><LABEL for="csTypeDocument"><ct:FWLabel key="JSP_CTC_R_TYPE_DOCUMENT"/></LABEL></TD>
										<TD>
										...
										<TD><LABEL for="csDomaineDocument"><ct:FWLabel key="JSP_CTC_R_DOMAINE"/></LABEL></TD>
										<TD>
									...
									<TR>
										<TD><LABEL for="csDestinataireDocument"><ct:FWLabel key="JSP_CTC_R_DESTINATAIRE"/></LABEL></TD>
										<TD>
										...
										<TD><LABEL for="nomDocument"><ct:FWLabel key="JSP_CTC_R_DOCUMENT"/></LABEL></TD>
										<TD>
