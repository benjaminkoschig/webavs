...
<%idEcran = "GCO3009"; %>
<%
COValiderJournalViewBean viewBean = (COValiderJournalViewBean) session.getAttribute("viewBean");
userActionValue = "aquila.process.validerJournal.executer";
%>
<%-- /tpl:put --%>
...
top.document.title = "Prozess - Journal validieren - " + top.location.href;
...
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Journal validieren<%-- /tpl:put --%>
