...
%>
top.document.title = "Liste der Anzeigen - Rechtspflege " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/process/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Liste der Anzeigen (Excel)<%-- /tpl:put --%>
...
<TR>
	<TD style="width:200;">Periode von</TD>
	<td style="width:300;">
 ...
 <tr>
 <TD style="width:200;" >Ohne Enddatum</TD>
