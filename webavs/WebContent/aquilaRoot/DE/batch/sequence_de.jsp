...
function init(){}
top.document.title = "Detail einer Rechtspflegesequenz " + top.location.href;
// stop hiding -->
</SCRIPT>
<%-- /tpl:put --%>
<%@ include file="/theme/detail/bodyStart.jspf" %>
			<%-- tpl:put name="zoneTitle" --%>Detail einer Rechtspflegesequenz <%-- /tpl:put --%>
