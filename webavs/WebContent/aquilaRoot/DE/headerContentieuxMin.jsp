...
<TR>
	<TD class="label">
		...
		<A href="osiris?userAction=osiris.comptes.apercuComptes.afficher&selectedId=<%=idCompteAnnexe%>&idContentieuxSrc=<%=contentieuxViewBean.getIdContentieux()%>&libSequence=<%=contentieuxViewBean.getSequence().getLibSequence()%>" class="external_link">Konto</A>
	</TD>
...
<TR>
	<TD class="label"><A href="osiris?userAction=osiris.comptes.apercuParSection.afficher&id=<%=idSection%>&idContentieuxSrc=<%=contentieuxViewBean.getIdContentieux()%>&libSequence=<%=contentieuxViewBean.getSequence().getLibSequence()%>" class="external_link">Sektion</A></TD>
	<TD class="control" colspan="3"><INPUT type="text" value="<%=sectionText%>" class="disabled" style="width: 100%" readonly></TD>
	<TD class="label">Sektionssaldo</TD>
	<TD class="control"><INPUT type="text" name="montantInitial" value="<%=sectionSoldeFormate%>" class="montantDisabled" readonly></TD>
	<TD class="label">Sektionsdatum</TD>
