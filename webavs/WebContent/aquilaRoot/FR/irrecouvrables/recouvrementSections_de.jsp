...
<%@page import="globaz.aquila.db.irrecouvrables.CORecouvrementSectionsViewBean"%>
...
<%
	CORecouvrementSectionsViewBean viewBean = (CORecouvrementSectionsViewBean) session.getAttribute("viewBean");
