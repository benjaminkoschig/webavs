...
<%@ include file="/theme/detail/bodyStart2.jspf" %>
						...
						<TR>
							<TD>Exécution automatique autorisée</TD>
							<TD>
								<INPUT type="checkbox" name="auto" value="on"<%=viewBean.isAuto() ? " checked" : ""%>>
							</TD>
						</TR>
						<TR>
							<TD>Priorité d'exécution automatique</TD>
							<TD colspan="3">
								<ct:inputText
									name="priorite"
						...
						<TR>
							<TD>Exécution manuelle autorisée</TD>
							<TD>
