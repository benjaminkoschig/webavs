...
<%@ include file="/theme/find/bodyStart2.jspf" %>
            ...
            <TD nowrap align="right">Journaux
              <SELECT name="forCsEtat" class="libelleCourt">
                ...
                <option value="<%=COJournalBatchViewBean.OUVERT%>">Ouverts</option>
                <option value="<%=COJournalBatchViewBean.TRAITE%>">Trait&eacute;s</option>
                <option value="<%=COJournalBatchViewBean.PARTIEL%>">Partiels</option>
                <option value="<%=COJournalBatchViewBean.ERREUR%>">En erreur</option>
                <option value="<%=COJournalBatchViewBean.ANNULE%>">Annul&eacute;s</option>
                <option value="<%=COJournalBatchViewBean.TRAITEMENT%>">En traitement</option>
              </SELECT>
			</TD>
			</TR>
