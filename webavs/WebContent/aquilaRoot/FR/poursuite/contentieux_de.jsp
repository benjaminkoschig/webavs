...
<tr>
	<td>
		<table>
			...
			<tr>
				<td class="label">Type séquence</td>
				...
				<td class="control" colspan="4">Prochaine date déclench.&nbsp;&nbsp;<ct:FWCalendarTag name="prochaineDateDeclenchement" doClientValidation="CALENDAR" value="<%=viewBean.getProchaineDateDeclenchement()%>"/></td>
			</tr>

			<tr>
				<td class="label">Suspendu</td>
				<td class="control" colspan="3">
				...
				<td class="label">Dossier créé par</td>
			...
			<tr>
				...
				<td class="label">Montant taxes</td>
