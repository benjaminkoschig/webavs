              ...
              <table CELLSPACING="0" CELLPADDING="0" width="100%" height="100%">
                <tr class="title">
                  ...
                  <td align="right">
                    <font face="webdings">
                      <xsl:element name="a">
                        <xsl:attribute name="onMouseOver">changeOver(this)</xsl:attribute>
                        <xsl:attribute name="onMouseOut">changeOut(this)</xsl:attribute>
                        <xsl:attribute name="href">javascript:collapseall(<xsl:value-of select="/menu/@id"/>)</xsl:attribute>
                        <xsl:attribute name="style">color=silver</xsl:attribute>4</xsl:element>
                      <xsl:element name="a">
                        <xsl:attribute name="onMouseOver">changeOver(this)</xsl:attribute>
                        <xsl:attribute name="onMouseOut">changeOut(this)</xsl:attribute>
                        <xsl:attribute name="href">javascript:expandall(<xsl:value-of select="/menu/@id"/>)</xsl:attribute>
                        <xsl:attribute name="style">color=silver</xsl:attribute>6</xsl:element>
          &#160;
          </font>
                  </td>
                </tr>
  ...
  <xsl:template name="items">
    ...
    <xsl:choose>
      ...
      <xsl:when test="item">
        ...
        <!-- <div style="border-top:solid 0px #B3C4DB"></div> -->
        <div id="{$numItem}">
            <!--  <div> -->
            ...
            </td><td style="padding-left:2px" valign="top" width="100%">
      ...
      <xsl:otherwise>
        <xsl:variable name="numDiv" select="generate-id()"/>
          ...
          <xsl:choose>
	        ...
	        <xsl:when test="@frame='_blank'">
	          <xsl:attribute name="onClick">javascript:window.open('<xsl:value-of select="@link"/>', 'Popup', '');</xsl:attribute>
            </xsl:when>
            <xsl:otherwise>
