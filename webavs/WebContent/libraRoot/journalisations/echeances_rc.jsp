...
<SCRIPT language="JavaScript">
	bFind = true;
	usrAction = "<%=globaz.libra.servlet.ILIActions.ACTION_ECHEANCES_RC%>.lister";
	bButtonNew = false;
	...
	function printScreenHtml(){
	    document.forms[0].elements('userAction').value= "<%=globaz.libra.servlet.ILIActions.ACTION_ECHEANCES_RC%>.exporter";
	    document.forms[0].target="_blank";
	    document.forms[0].submit();
	   	document.forms[0].target="fr_list";
	    document.forms[0].elements('userAction').value= "<%=globaz.libra.servlet.ILIActions.ACTION_ECHEANCES_RC%>.lister";
	}
...
<%@ include file="/theme/find/bodyStart.jspf" %>
				<%-- tpl:put name="zoneTitle" --%><ct:FWLabel key="ECRAN_ECH_RC_TITRE"/><%-- /tpl:put --%>
<%@ include file="/theme/find/bodyStart2.jspf" %>
	...
	<TR>
		...
		<TD valign="top">
			...
			&nbsp;
			<ct:select name="forCsType" defaultValue="" wantBlank="true">
	...
	<TR>			
		<% if (!globaz.jade.client.util.JadeStringUtil.isBlankOrZero(idDossier) && !viewBean.getDossier().isNew()) { %> 																				
...
<%@ include file="/theme/find/bodyButtons.jspf" %>
				...
				<ct:ifhasright element="<%=globaz.libra.servlet.ILIActions.ACTION_JOURNALISATIONS %>" crud="r">
					<INPUT class="btnCtrl" type="button" id="btnEcheancesDocuments" value="<ct:FWLabel key="MENU_OPTION_DOCUMENTS"/>" onclick="echeancesDocuments()">
				</ct:ifhasright>
